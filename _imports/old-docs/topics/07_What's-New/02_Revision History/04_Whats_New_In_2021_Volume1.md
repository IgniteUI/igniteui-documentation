...
* New Series [`OutlineMode`](%%jQueryApiUrl%%/ui.igDataChart#options:series.outlineMode) Property:
...
* [`LegendHighlightingMode`](%%jQueryApiUrl%%/ui.igDataChart#options:legendHighlightingMode) - Enables series highlighting when hovering over legend items
