...
以下の表に、%%ProductName%% 2012 Volume 1 リリースの既知の問題と制限事項の概要を示します。各コントロールの既知の問題のトピックに、既知の問題および考えられる回避策の詳細が説明されています。
...
- [igDataChart の既知の問題](igDataChart-Known-Issues.html): このトピックでは、`igDataChart`™ コントロールに固有の既知の問題に関する情報を提供します。
