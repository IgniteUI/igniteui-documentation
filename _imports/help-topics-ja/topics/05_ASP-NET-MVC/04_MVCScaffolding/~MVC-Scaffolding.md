...
|metadata|
-->
# %%ProductNameMVC%% Scaffolder の Visual Studio 拡張機能

### 概要


2015.2 リリースでは、拡張機能 **%%ProductNameMVC%%** Scaffolder が導入されました。
...
![](images/Step1.png)
4. 次に、スキャフォールディング項目の選択を促されます。「%%ProductName%% ビュー」または「ビューを持つ %%ProductName%% コントローラー」のどちらかを選択します。
...
%%ProductName%% のウィジェット ラッパーを含む標準のビューで通常行う場合と同様に、ビューのカスタマイズの追加、プロパティやメソッドの追加または削除をすることができます。
