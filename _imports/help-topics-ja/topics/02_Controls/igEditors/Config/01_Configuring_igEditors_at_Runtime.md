...
###<a id="_Bind_events_on_initialization"></a>初期化でイベントへバインドする
...
###<a id="_Set_options_on_initialization"></a>初期化でオプションを設定
...
###<a id="_Bind_events_after_initialization"></a>初期化後にイベントへバインド
...
###<a id="_Set_options_after_initialization"></a>初期化後にオプションを設定
