...
特定のプロファイルごとのテンプレートはレスポンシブ ウェブ デザイン モード機能の [`singleColumnTemplate`](%%jQueryApiUrl%%/ui.iggridresponsive#options:singleColumnTemplate) オプションで指定されます。 
...
<div class="embed-sample">
   [レスポンシブ単一列テンプレート](%%SamplesEmbedUrl%%/grid/responsive-single-column-template)
</div>
