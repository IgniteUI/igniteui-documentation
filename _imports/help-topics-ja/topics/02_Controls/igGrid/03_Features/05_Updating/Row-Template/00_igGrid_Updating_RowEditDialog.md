...
パブリック API メソッド [startEdit](%%jQueryApiUrl%%/ui.igGridUpdating#methods:startEdit) と [endEdit](%%jQueryApiUrl%%/ui.igGridUpdating#methods:endEdit) では、行編集ダイアログを開閉できます。
...
|イベント|説明|
|---|---|
|[rowEditDialogBeforeOpen](%%jQueryApiUrl%%/ui.iggridupdating#events:rowEditDialogBeforeOpen)|このイベントは行編集ダイアログが開く前に発生します。キャンセルはできません。|
|[rowEditDialogAfterOpen](%%jQueryApiUrl%%/ui.iggridupdating#events:rowEditDialogAfterOpen)|このイベントは行編集ダイアログが開いてから発生します。|
|[rowEditDialogContentsRendered](%%jQueryApiUrl%%/ui.iggridupdating#events:rowEditDialogContentsRendered)|このイベントは行編集ダイアログのコンテンツのレンダリングのあとに発生します。|
|[rowEditDialogBeforeClose](%%jQueryApiUrl%%/ui.iggridupdating#events:rowEditDialogBeforeClose)|このイベントは行編集ダイアログが閉じる前に発生します。キャンセルはできません。|
|[rowEditDialogAfterClose](%%jQueryApiUrl%%/ui.iggridupdating#events:rowEditDialogAfterClose)|このイベントは行編集ダイアログが閉じた後にに発生します。|
