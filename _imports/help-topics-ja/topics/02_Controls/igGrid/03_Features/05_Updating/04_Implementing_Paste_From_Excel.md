...
1. 更新および選択の機能で igGrid を構成します。
    ...
    - [更新を有効にする](igGrid-Updating.html#enable)
    - [選択の有効化](igGrid-Selection-Overview.html#enabling-selection)
...
<div class="embed-sample">
   [Excel から貼り付け](%%SamplesEmbedUrl%%/grid/paste-from-excel)
</div>

## <a id='related'></a> 関連コンテンツ

- [概要の更新 (igGrid)](igGrid-Updating.html): このトピックでは、`igGrid`™ コントロールの更新機能の使用方法を説明します。
