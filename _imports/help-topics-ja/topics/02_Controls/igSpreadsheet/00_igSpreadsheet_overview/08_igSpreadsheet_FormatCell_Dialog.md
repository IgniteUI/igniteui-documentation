...
このトピックを有効に使用するために [Infragistics JavaScript Excel Library](javascript-excel-library.html) および [igSpreadsheet](igSpreadsheet-Feature-Overview.html) の概念とその関連トピックの理解が前提条件となります。
