...
const PLATFORMS: Record<PlatformName, PlatformContext> = {
    Angular: {
        ...
        apiPackages: {
            ...
            fdc3:        { docRoot: 'https://staging.infragistics.com/api/angular/igniteui-angular-fdc3/latest',        packageId: 'igniteui-angular-fdc3',        noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
            dashboards:  { docRoot: 'https://staging.infragistics.com/api/angular/igniteui-angular-dashboards/latest',  packageId: 'igniteui-angular-dashboards',  noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
    ...
    React: {
        ...
        apiPackages: {
            ...
            fdc3:        { docRoot: 'https://staging.infragistics.com/api/react/igniteui-react-fdc3/latest',        packageId: 'igniteui-react-fdc3',          noPackagePrefix: true, preserveCase: true },
            dashboards:  { docRoot: 'https://staging.infragistics.com/api/react/igniteui-react-dashboards/latest',  packageId: 'igniteui-react-dashboards',    noPackagePrefix: true, preserveCase: true },
    ...
    WebComponents: {
        ...
        apiPackages: {
            ...
            // Web Components inputs/layouts are published in the main TypeDoc package.
            // Dock Manager is the exception and has its own `dockmanager` package below.
            inputs:      { docRoot: 'https://staging.infragistics.com/api/webcomponents/igniteui-webcomponents/latest',             packageId: 'igniteui-webcomponents',             noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
            layouts:     { docRoot: 'https://staging.infragistics.com/api/webcomponents/igniteui-webcomponents/latest',             packageId: 'igniteui-webcomponents',             noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
            ...
            fdc3:        { docRoot: 'https://staging.infragistics.com/api/webcomponents/igniteui-webcomponents-fdc3/latest',        packageId: 'igniteui-webcomponents-fdc3',        noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
            dashboards:  { docRoot: 'https://staging.infragistics.com/api/webcomponents/igniteui-webcomponents-dashboards/latest',  packageId: 'igniteui-webcomponents-dashboards',  noPackagePrefix: true, preserveCase: true, classSuffix: 'Component' },
    ...
    Blazor: {
        ...
        apiPackages: {
            ...
            dashboards:  { docRoot: 'https://staging.infragistics.com/api/blazor/IgniteUI.Blazor/latest', packageId: 'IgniteUI.Blazor', noPackagePrefix: true, preserveCase: true, pascalCaseMembers: true },
