...
以下の表は、`igOlapXmlaDataSource`™ コンポーネントの API 参照ドキュメントのリンクの一覧です。(この参照コンテンツは、コントロールの開発者ガイドの他、[こちら](igOlapXmlaDataSource.html)で使用できます。)
...
- [igOlapXmlaDataSource の追加](igOlapXmlaDataSource-Adding.html): これは、`igOlapXmlaDataSource`™ コンポーネントを HTML ページと ASP.NET MVC アプリケーションへ追加する方法を示すトピックのグループです。
