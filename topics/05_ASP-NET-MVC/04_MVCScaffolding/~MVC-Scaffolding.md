...
![](images/Step1.png)
4. 次に、スキャフォールディング項目の選択を促されます。「Ignite UI ビュー」または「ビューを持つ Ignite UI コントローラー」のどちらかを選択します。
...
Ignite UI のウィジェット ラッパーを含む標準のビューで通常行う場合と同様に、ビューのカスタマイズの追加、プロパティやメソッドの追加または削除をすることができます。
