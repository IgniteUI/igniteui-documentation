...
**Printing** -- The simplest method of publishing. Call the [Print](Infragistics.Web.Documents.Reports~Infragistics.Documents.Reports.Report.Report~Print.html "Link to the Web API Reference Guide to the Print member.") method from the Report object and you'll be able to print your report directly to a local printer.
