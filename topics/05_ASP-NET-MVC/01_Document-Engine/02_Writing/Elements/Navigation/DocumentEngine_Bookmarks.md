...
- [TextHeading](Infragistics.Web.Documents.Reports~Infragistics.Documents.Reports.Report.TextHeading.html):  Link to the Web API Reference Guide to the TextHeading member.
- [Heading](Infragistics.Web.Documents.Reports~Infragistics.Documents.Reports.Report.Text.IText~Heading.html): Link to the Web API Reference Guide to the Heading member.
