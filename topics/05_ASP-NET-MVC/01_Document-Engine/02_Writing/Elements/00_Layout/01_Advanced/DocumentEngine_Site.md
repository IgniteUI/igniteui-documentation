...
以下のコードは、Site 要素を Section 要素に追加し、次に Text 要素と Image 要素を Site 要素に追加します。上記の画像のように、Text 要素は 45 度回転され、Image 要素は -45 度回転されます。このトピックは、[Report](Infragistics.Web.Mvc.Documents.Reports~Infragistics.Documents.Reports.Report.Report.html) が定義済みで、[Section](Infragistics.Web.Mvc.Documents.Reports~Infragistics.Documents.Reports.Report.Section.ISection.html) 要素が追加されていることを前提としています。
