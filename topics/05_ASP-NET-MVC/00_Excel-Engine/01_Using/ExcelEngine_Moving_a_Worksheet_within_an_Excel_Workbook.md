...
Excel Workbook に 3 つのワークシートがある場合、[`Worksheet`](Infragistics.Web.Mvc.Documents.Excel~Infragistics.Documents.Excel.Worksheet.html) クラスの [`MoveToIndex`](Infragistics.Web.Mvc.Documents.Excel~Infragistics.Documents.Excel.Worksheet~MoveToIndex.html) メソッドを使用して worksheet3 を先頭の位置に配置できます。
