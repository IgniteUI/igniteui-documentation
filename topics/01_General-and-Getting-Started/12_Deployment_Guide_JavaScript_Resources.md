...
Volume 2012.2 より製品の一部としてロシア語 ([ru])、ブルガリア語 ([bg])、ドイツ語 ([de])、スペイン語 ([es])、およびフランス語 ([fr]) のローカライズが含まれます。ローカライズ ファイルは、ローカライズ フォルダー `../js/i18n` に入れる必要があります (*js* は Ignite UI プログラムの JavaScript ファイルのルート フォルダーです)。
...
*i18n* フォルダーは *modules* フォルダーの中にあり、ウィジットを日本語、ブルガリア語、ロシア語、ドイツ語、スペイン語、フランス語にローカライズする JavaScript ファイルを保持します。
