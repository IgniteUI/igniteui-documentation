...
%%ProductName%% を使用して作業する場合、Web アプリケーションで Infragistics リソースを参照してください。これらのリソースは、4 種類の方法で参照できます。
...
英語と日本語の再配布可能なパッケージが 2 つあります。それぞれ英語版および日本語版の製品インストーラーによってインストールされます。

英語版のパッケージを使用する場合、 ローカライズ文字列がコントロールのコードにあるため、**-en.js** ロケール スクリプトへの参照を含む必要はありません。

同様に、日本語版のパッケージを使用する場合はファイルに結合されるため、**-ja.js** ロケール スクリプトを含む必要はありません。
