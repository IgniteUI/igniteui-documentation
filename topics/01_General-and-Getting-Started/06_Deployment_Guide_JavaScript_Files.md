...
ブルガリア語、ロシア語、および日本語の、結合スクリプト バージョンのローカライズ リソースもあります。ファイル名は `infragistics-bg.js`, `infragistics-ja.js` および `infragistics-ru.js` であり、これらは `../js/i18n` フォルダーにあります。
...
コントロールのローカライズ リソースは、ブルガリア語、ロシア語、および日本語です。これらは、js/modules/i18n (*js* は、Ignite UI プログラムのインストール パス内の JavaScript ファイルのルート フォルダー) にあります。
