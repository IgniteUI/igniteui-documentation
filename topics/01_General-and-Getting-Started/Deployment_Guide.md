...
Sometimes your application is required to run in some old contexts. Make sure to read [Using %%ProductName%% in Browsers Without HTML5 or CSS3 Support](Deployment-Guide-Using-IgniteUI-for-jQuery-in-Browsers-that-Dont-Support-HTML5-or-CSS3.html) to mitigate any issues working with old browsers.
