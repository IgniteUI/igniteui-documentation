...
16. Added support to automatically expanding the horizontal margins of the chart based on the initial labels displayed 

### Chart Legend Features:

1. [`LegendHighlightingMode`](%%jQueryApiUrl%%/ui.igDataChart#options:legendHighlightingMode) - Enables series highlighting when hovering over legend items
