...
ASP.NET Core 1.0 MVC ヘルパー | Ignite UI MVC ヘルパーで ASP.NET Core 1.0 がサポートされるようになりました。[Ignite UI コントロールを ASP.NET Core 1.0 で使用](Using-IgniteUI-Controls-in-ASP.NET-Core-1.0-project.html) トピックを参照してください。|
