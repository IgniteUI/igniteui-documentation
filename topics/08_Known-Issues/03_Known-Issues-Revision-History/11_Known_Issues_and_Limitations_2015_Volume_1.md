...
This summarizes the known issues and limitations of the %%ProductName%%™ 2015 Volume 1 release. Information about previous releases can be found [here](Known-Issues-Revision-History.html).
...
The following table summarizes the known issues and limitations of the %%ProductName%% 2015 Volume 1 release. Detailed explanations of known issues and the possible workarounds are provided in the known issues topics for each control.
<a id="legend"></a>
