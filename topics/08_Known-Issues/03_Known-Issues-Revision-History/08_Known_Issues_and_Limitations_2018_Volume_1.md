...
# 2018 Volume 1 の既知の問題と制限

## トピックの概要

### 目的

以下に %%ProductName%%™ 2018 Volume 1 リリースの既知の問題と制限事項の概要を示します ([改訂履歴](https://jp.infragistics.com/support/online-documentation/revision-history))。旧リリースに関する情報は、[こちら](Known-Issues-Revision-History.html)を参照してください。
