...
|metadata|
{
    "fileName": "known-issues-and-limitations-2016-volume-2",
    "controlName": "",
...
# 2016 Volume 2 の既知の問題と制限

## トピックの概要

### 目的

以下に Ignite UI™ 2016 Volume 2 リリースの既知の問題と制限事項の概要を示します。旧リリースに関する情報は、[こちら](Known-Issues-Revision-History.html)を参照してください。
...
以下の表に、Ignite UI 2016 Volume 2 リリースの既知の問題と制限事項の概要を示します。各コントロールの既知の問題点に関するトピックでは、それぞれの既知の問題点と考えられる回避策について詳しく説明します。
<a id="legend"></a>
...
グリッドのデータソースがリモートの場合、タッチ環境でカスタムのスクロールバーが表示されない。 |データソースがリモートの場合、タッチ環境でカスタムのスクロールバーが表示されません。 | ![](../images/plannedFix.png)
