...
AngularJS アプリケーションで %%ProductName%%® コントロールを使用する場合に、[AngularJS 用の %%ProductName%%® ディレクティブ](https://github.com/IgniteUI/igniteui-angular)によりデータ バインディングと宣言型プログラミングを利用できます。
