...
-   [AngularJS での %%ProductName%% の使用](Using-Ignite-UI-with-AngularJS.html) - このトピックでは、AngularJS の %%ProductName%% ディレクティブの使用方法の概要を説明します。
...
-   [AngularJS サンプル](angularjs-samples.html) - このトピックは、AngularJS の %%ProductName%% ディレクティブを使用するサンプルを含みます。