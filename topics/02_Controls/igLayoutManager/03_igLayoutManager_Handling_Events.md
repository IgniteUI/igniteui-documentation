...
-	[Using Events in %%ProductName%%](Using-Events-in-IgniteUI-for-jQuery.html): This topic explains how to manage the required resources to work with %%ProductName%%® within a Web application.
...
For details on how to handle events, refer to the [Using Events in %%ProductName%%](Using-Events-in-IgniteUI-for-jQuery.html) topic.
