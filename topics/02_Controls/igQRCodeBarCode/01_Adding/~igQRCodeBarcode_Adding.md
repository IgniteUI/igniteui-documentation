...
- [Adding igQRCodeBarcode to an ASP.NET MVC Application](igQRCodeBarcode-Adding-Using-the-MVC-Helper.html): This topic walks through instantiating an `igQRCodeBarcode` in an ASP.NET MVC application using the %%ProductNameMVC%%.
