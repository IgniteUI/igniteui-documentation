...
- [Adding igQRCodeBarcode](igQRCodeBarcode-Adding.html): This topic walks through instantiating an `igQRCodeBarcode` in an ASP.NET MVC application using %%ProductNameMVC%%.
