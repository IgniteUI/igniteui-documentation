...
`igQRCodeBarcode` のエンコードの構成は、このコントロールの [data](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:data) プロパティに渡された文字をエンコードするコントロールの機能と関連します。
...
構成可能な項目|詳細|プロパティ
---|---|---
[文字エンコード モード](#config-character-encoding)|エンコードが必要なデータの型に応じて、使用するエンコード モードを指定できます。|<ul><li>[encodingMode](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:encodingMode)</li></ul>
[文字セット](#config-character-set)|`igQRCodeBarcode` コントロールにより、さまざまな文字セットのデータをエンコードすることができます。|<ul><li>[eciNumber](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciNumber)</li></ul>
...
`igQRCodeBarcode` コントロールを適切に使用するには、文字セットで使用するそれぞれの文字エンコード ファイルがアプリケーションに読み込まれている必要があります。これは、すべてのエンコード情報が含まれたファイルを、または使用するエンコード情報が含まれるファイルのみのいずれかを読み込むことを意味します。代わりに以下を読み込みます。
...
`igQRCodeBarcode` コントロールには、既定の文字セット以外のデータをエンコーするサポートが組み込まれています。このサポートは、[eciNumber](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciNumber) プロパティで Extended Channel Interpretation (ECI) を適切に設定すると機能します。
...
目的:|使用するプロパティ:|設定の選択肢:
---|---|---
文字セットの指定|[eciNumber](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciNumber)|使用する ISO 文字セットの ECI 番号
バーコードに含まれる ISO 文字セットの番号のエンコード|[eciHeaderDisplayMode](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciHeaderDisplayMode)|show
バーコードの ISO 文字セットの番号の省略|[eciHeaderDisplayMode](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciHeaderDisplayMode)|hide (デフォルト)


### <a id="set-example"></a>例

エンコードされるデータはギリシア語で、[eciNumber](%%jQueryApiUrl%%/ui.igQRCodeBarcode#options:eciNumber) は ISO/IEC 8859-7 文字セットに対応する 9 を使用します。
