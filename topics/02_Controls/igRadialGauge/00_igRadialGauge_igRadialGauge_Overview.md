...
ゲージの針は、あらかじめ定義されたいくつかの図形の中から選択できます。針は、ゲージの中心に置かれるピボット図形を持つことができます。ピボット図形は、事前定義された図形の 1 つを使用することもできます。オーバーレイまたはアンダーレイを含むピボット図形には、異なるピボット ブラシを設定し図形に適用することができます。詳細は、「針の構成」のトピックをご覧ください。
