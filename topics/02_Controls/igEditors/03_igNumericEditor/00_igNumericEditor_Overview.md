...
The easiest way to add a new igNumericEditor to your application is via the %%ProductFamilyName%% CLI. After you have created a new application, you just need to execute the following command and a numeric editor will be added to the project:
```
