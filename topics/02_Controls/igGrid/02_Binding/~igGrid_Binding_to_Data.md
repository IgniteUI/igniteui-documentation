...
- [Binding igGrid to DataTable (*igGrid*)](igGrid-Binding-to-DataTable.html): This topic introduces the feature and demonstrates how to configure and use a `DataTable` with the %%ProductNameMVC%% Grid.
