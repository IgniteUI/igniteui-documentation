...
- [igGrid の概要](igGrid-Overview.html): このトピックでは、機能、データ ソースへのバインド、要件、テンプレート、相互作用に関する情報を含めて、igGrid コントロールの概要を示します。
...
## <a id="overview"></a> ASP.NET MVC Web API へのバインド – 概念的な概要
...
ボタンを追加し、その click イベントにイベント ハンドラーをアタッチします。イベントで、保留中の変更をサーバーに送信するために igGrid の [saveChanges](%%jQueryApiUrl%%/ui.igGrid#methods:saveChanges) メソッドを呼び出します。
