...
igHierarchicalGrid の選択では、デフォルトで UP/DOWN/LEFT/RIGHT キーでの子グリッドへの移動を スキップします。([skipChildren](%%jQueryApiUrl%%/ui.igg%%jQueryApiUrl%%/ui.iggridselection#options:skipChildren) オプションを参照)。
