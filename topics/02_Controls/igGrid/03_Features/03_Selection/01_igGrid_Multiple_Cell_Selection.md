...
- [Touch Support for %%ProductName%% Control](Touch-Support-for-IgniteUI-for-jQuery-Controls.html): This topic introduces to user to the new updates that %%ProductName%% controls has to support touch interactions.
