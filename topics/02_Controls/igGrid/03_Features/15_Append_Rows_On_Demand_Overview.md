...
機能は [$.ig.DataSource](%%jQueryApiUrl%%/ig.datasource) のページング機能の一番上に構築されるため、`$.ig.DataSource` でサポートされるすべての範囲のデータ ソースをサポートします。しかし、この機能はページング機能自体と互換性がありません。統合シナリオのサポートについては、｢[機能マトリックス (igGrid)](Feature-Compatibility-Matrix.html)｣のトピックを参照してください。
...
- [機能マトリックス (igGrid)](Feature-Compatibility-Matrix.html)
