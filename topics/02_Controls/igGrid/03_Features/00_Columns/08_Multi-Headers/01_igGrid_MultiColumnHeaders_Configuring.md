...
2. バインドするデータを定義します。 <a id="js-define-the-data"></a>
	...
	次のコードは、オブジェクトの JavaScript 配列を定義するものです。このデータが igGrid のデータ ソースとして使用されます。
...
-   ASP.NET MVC 3 Framework のインストール
...
- [igGrid の機能](igGrid-Features-Landing-Page.html): `igGrid` の機能に関連するトピックについてのランディング ページ。
