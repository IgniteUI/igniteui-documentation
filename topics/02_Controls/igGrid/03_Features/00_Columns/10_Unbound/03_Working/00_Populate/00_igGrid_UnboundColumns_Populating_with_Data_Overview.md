...
定義済みデータ (外部ソースから、など) を使用してクライアントまたはサーバー上で非バインド列にデータを事前設定できます (ASP.NET MVC ラッパーを使用している場合) またはグリッド データ ソースからのデータを計算します。
...
MVC ラッパーでは、非バインド列は View (チェーン使用時) またはコントローラー (`GridModel` クラス使用時) において設定できます。
