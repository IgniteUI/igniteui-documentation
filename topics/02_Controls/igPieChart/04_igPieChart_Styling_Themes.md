...
Ignite UI ライブラリでテーマを使用する方法の詳細については、「[スタイル設定とテーマ設定](Deployment-Guide-Styling-and-Theming.html)」トピックをご覧ください。
...
<table cellspacing="0" cellpadding="0" class="table table-bordered">
    <tbody>
        ...
        <tr>
            ...
            <td>
                このテーマは、すべての Ignite UI コントロールの一般的なビジュアル機能を定義します。IG テーマの使用方法の詳細については、「<a href="Deployment-Guide-Styling-and-Theming.html" data-auto-update-caption="true">Ignite UI のスタイル設定とテーマ設定</a>」トピックをご覧ください。
            </td>
        </tr>
