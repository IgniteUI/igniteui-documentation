...
- [Bind to Collection](%%SamplesUrl%%/doughnut-chart/bind-to-collection): This sample demonstrates how to render `igDoughnutChart` using the %%ProductNameMVC%% and bind it to a collection of objects on the server.
