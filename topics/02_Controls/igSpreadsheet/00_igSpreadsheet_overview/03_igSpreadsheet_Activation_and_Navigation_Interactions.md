...
## <a id="spreadsheet_panes"></a>スプレッドシートのペイン
...
## <a id="user_interactions_and_usability"></a>ユーザー インタラクションと操作性
...
| ページを右にナビゲート									| P<kbd>Alt</kbd>+<kbd>Page Down</kbd> を押す											| シート ペインに表示されている列と同数のセルの分だけ、アクティブ セルを右に移動します |
