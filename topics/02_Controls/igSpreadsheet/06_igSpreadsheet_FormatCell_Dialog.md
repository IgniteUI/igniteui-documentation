...
このトピックを有効に使用するために [Infragistics JavaScript Excel Library](javascript-excel-library.html) および [igSpreadsheet](igSpreadsheet_Feature_Overview.html) の概念とその関連トピックの理解が前提条件となります。
...
パーセンテージ| 既存のセルの値の百分率にパーセント記号を付けて表示します。
