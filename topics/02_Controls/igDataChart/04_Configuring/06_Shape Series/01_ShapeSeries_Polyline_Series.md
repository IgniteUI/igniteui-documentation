...
- [散布多角形シリーズの構成](shapeseries-polygon-series.html): このトピックでは、`igDataChart` コントロールで散布多角形シリーズを構成する方法について説明します。

### <a id="samples"></a>サンプル

- [散布ポリライン シリーズ](%%SamplesUrl%%/data-chart/polyline): このサンプルでは、`igDataChart` コントロールのポリライン シリーズを紹介します。