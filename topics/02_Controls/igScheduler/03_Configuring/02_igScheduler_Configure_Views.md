...
このトピックは、igScheduler の週ビューでデータの表示方法を説明します。

### 構成

以下の表は、週ビューの構成可能な要素または動作に対応するオプション/メソッドにマップします。

要素 | 説明 | プロパティ
---|---|---
表示モード | 週ビューはすべての 7 日または稼動日として構成される日のみを表示できます。 | [weekViewDisplayMode](%%jQueryApiUrl%%/ui.igscheduler#options:weekViewSettings.weekViewDisplayMode)
...
このトピックは、igScheduler の日ビューでデータの表示方法を説明します。

### 構成

以下の表は、日ビューの構成可能な要素または動作をオプション/メソッドにマップします。

要素 | 説明 | プロパティ
---|---|---
表示日 | 日ビューで表示される日数を制御できます。現在 1 日から 7 日間がサポートされます。 | [dayViewNumberOfDays](%%jQueryApiUrl%%/ui.igscheduler#options:dayViewSettings.dayViewNumberOfDays)
