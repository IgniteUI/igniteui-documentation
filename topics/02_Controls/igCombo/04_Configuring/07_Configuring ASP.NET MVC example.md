...
ビューでコンボをインスタンス化するために igCombo ASP.NET MVC ヘルパーが使用されます。また、従業員のコレクションのリモート要求を処理し、リモート フィルタリング パラメーターを処理するために `ComboDataSourceAction` 属性が使用されます。モデルのフィールドを更新するためにコンボの使用方法を紹介します。
