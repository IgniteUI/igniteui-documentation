...
ビューでコンボをインスタンス化するために %%ProductNameMVC%% Combo が使用されます。また、従業員のコレクションのリモート要求を処理し、リモート フィルタリング パラメーターを処理するために `ComboDataSourceAction` 属性が使用されます。最後に、フォームで モデルのフィールドを更新するために使用されるコンボを確認できます。

#### 概念

-   %%ProductNameMVC%% Combo の使用
