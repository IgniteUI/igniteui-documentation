...
このセクションのコードはカスタム解決を紹介します。ViewModel および View のコードに変更せずに新しい igCombo および Knockout 拡張子を使用できます。このポリフィルは、%%ProductName%% の最新バージョンにアップグレードしますが、現在のコードを選択通知を処理するために変更できない場合に便利です。
