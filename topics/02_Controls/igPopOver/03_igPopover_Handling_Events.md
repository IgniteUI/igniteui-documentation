...
イベント ハンドラー関数の Ignite UI コントロールへのアタッチは、一般的にコントロールの初期化時に行われます。このイベントが発生すると、処理関数を呼び出します。
...
### <a id="modify-content-code"></a>コード
...
### <a id="re-positioning-code"></a>コード
