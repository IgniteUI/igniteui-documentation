...
[igSparkline](%%jQueryApiUrl%%/ui.igSparkline.html)™ は、ASP.NET MVC ヘルパー付随の jQuery UI ウィジェットとしてビルドされます。各 API の詳細については、以下の API マニュアルへのリンクを参照してください。
...
- [API およびイベント](%%SamplesUrl%%/sparkline/api-and-events)
