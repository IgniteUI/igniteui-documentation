...
このトピックでは、[igSparkline](%%jQueryApiUrl%%/ui.igSparkline.html)™ コントロール、そのメリットおよびサポートされるチャート タイプの概要を示します。
...
-   [ツールチップとマーカー](%%SamplesUrl%%/sparkline/tooltips-and-markers)
...
-   [標準範囲およびトレンドライン](%%SamplesUrl%%/sparkline/normal-range-and-trend-lines)
...
---|---
いいえ|![](images/igSparkline_Overview_31.png)
はい|![](images/igSparkline_Overview_32.png)
...
- [ツールチップとマーカー](%%SamplesUrl%%/sparkline/tooltips-and-markers): このサンプルは、`igSparkline` でツールチップとマーカーを有効にする例を示します。
