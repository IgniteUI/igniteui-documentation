...
# jQuery and Ignite UI for MVC API Links (igFunnelChart)
...
- [*igFunnelChart* **Ignite UI for MVC** API](Infragistics.Web.Mvc~Infragistics.Web.Mvc.FunnelChart`1.html): This is a set of documents containing the `FunnelChart` class description and a list of all of its members.
