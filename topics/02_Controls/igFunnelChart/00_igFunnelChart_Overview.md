...
--- | --- | --- | ---
スライスを選択|<ul><li>マウス クリック</li><li>スクリーン タップ</li></ul> |`igFunnelChart` により、ユーザーはホスト アプリケーションにおける目的のためにスライスを選択および選択解除できます。 | ![](images/igFunnelChart_Overview_%28Control_Overview%29_6.png)
