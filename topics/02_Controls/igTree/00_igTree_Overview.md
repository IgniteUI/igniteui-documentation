...
[チェックボックスおよび選択を構成する](igTree-Configure-Checkboxes-And-Selection.html)

## <a id="navigation-and-selection"></a>ナビゲーションと選択 
...
[igTree のノードを構成する](igTree-Configure-Nodes.html)

## <a id="adding-and-removing-nodes"></a>ノードの追加と削除 
`igTree` コントロールのノードの追加と削除機能を使用すると、ツリー ノードを追加または削除できます。

### 関連トピック

[ノードの追加と削除](igTree-Adding-Removing-Nodes.html)

## <a id="drag-and-drop"></a>ドラッグ アンド ドロップ 
`igTree` コントロールのドラッグ アンド ドロップ機能では、ツリー ノードをドラッグ アンド ドロップできます。

![](images/igTree_Overview_05.png)

ドラッグ アンド ドロップは、同じ `igTree` コントロール内だけでなく、2 つの `igTree` コントロール間で操作できます。2 つの igTree コントロール間で動作するよう設定できます。ドラッグ アンド ドロップ機能の操作方法を指定できます。サポートされる[ドラッグ アンド ドロップ モード](igTree-Drag-and-Drop-Configuring-Mode.html) に設定する必要があります。
...
- [ロード オン デマンドを構成する](igTree-Optimize-Performance.html)
...
Ignite UI の共用 JavaScript リソース|Ignite UI には、ほとんどのウィジェットが使用する共用 JavaScript リソースがいくつかあります。`infragistics.ui.util.js` infragistics.ui.shared.js
...
## <a id="template-use-chart"></a>テンプレート使用チャート 
...
## <a id="template-selection-chart"></a>テンプレート選択チャート 
...
## <a id="user-interaction-and-usability"></a>ユーザー相互作用と操作性 
### <a id="user-interactions-chart"></a>ユーザー相互作用チャート 
