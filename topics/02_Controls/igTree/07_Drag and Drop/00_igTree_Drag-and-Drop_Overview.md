...
デフォルトでは、ドラッグ アンド ドロップ機能は無効です。ドラッグ アンド ドロップ機能を有効にするには、`dragAndDrop` プロパティを true に します。詳細については、[ドラッグ アンド ドロップを有効にする (`igTree`)](Drag-and-Drop-Enabling.html) を参照してください。
...
ドラッグ アンド ドロップ モード|[](#_Drag-and-Drop_modes)ドラッグ アンド ドロップ モードを指定します。詳細については、[ドラッグ アンド ドロップを構成する (igTree)](igTree-Drag-and-Drop-Configuring-Mode.html) を参照してください。
