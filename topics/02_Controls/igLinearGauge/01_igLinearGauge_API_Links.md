...
以下は、`igLinearGauge`™ コントロールの API 参照ドキュメントのリンクの一覧です。(この参照コンテンツは、コントロールの開発者ガイドの他、[こちら](igLinearGauge-Overview.html)で使用できます。)
...
-	[igLinearGauge の追加](igLinearGauge-Adding.html): このトピックでは、ASP.NET MVC ヘルパーを使用して、ASP.NET MVC アプリケーションに `igLinearGauge` のインスタンスを作成する方法を紹介します。
