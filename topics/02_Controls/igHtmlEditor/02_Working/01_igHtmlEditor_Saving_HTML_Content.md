...
##<a id="asp-net-mvc-form"></a>ASP.NET MVC フォームでの HTML コンテンツの投稿
...
-   %%ProductName%% リソースが組み込まれた ASP.NET MVC 3 プロジェクト
...
##<a id="ajax-call"></a>AJAX 呼び出しでの HTML コンテンツの送信


###<a id="ajax-call-introduction"></a> 概要
...
###<a id="ajax-call-review"></a> プレビュー

以下のスクリーンショットは最終結果のプレビューです。

![](images/Saving_html_content_with_igHtmlEditor_1.png)

###<a id="ajax-call-requirements"></a> 要件

この手順を実行するには、以下が必要です。

-   %%ProductName%% リソースが組み込まれた ASP.NET MVC 3 プロジェクト

###<a id="ajax-call-overview"></a> 概要
