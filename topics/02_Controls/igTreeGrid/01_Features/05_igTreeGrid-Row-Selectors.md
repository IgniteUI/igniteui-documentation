...
![igTreeGrid sequential numbering](images/igtree-grid-row-numbering-mode-sequential.png.png)

### <a id="hierarachical-numbering-mode"></a>階層番号付け
...
### <a id="biState-checkobox-mode"></a>bi-state チェックボックス
...
![igTreeGrid biState checkbox mode](images/igtree-grid-checkobox-mode-biState.png)

### <a id="triState-checkobox-mode"></a>tri-state チェックボックス
...
![igTreeGrid biState checkbox mode](images/igTreeGridCheckBoxModeTriStateNew2.png)

tri-state チェックボックス - チェックボックスの選択

![igTreeGrid biState checkbox mode](images/igTreeGridCheckBoxModeTriStateNew.png)


## <a id="paging-integration"></a> ページングとの統合
