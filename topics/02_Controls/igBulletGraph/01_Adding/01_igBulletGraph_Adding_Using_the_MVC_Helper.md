...
Instantiate the `igBulletGraph` control. As with all %%ProductNameMVC%% controls, you must call the Render method to render the HTML and JavaScript to the View.
