...
---|---|---|---
[ID](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonGroupWrapper~ID.html)|string|`RadioButtonGroup` ID を取得または設定します。|rdbtngrp1
[Text](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonGroupWrapper~Text.html)|string|`RadioButtonGroup` のテキストを取得または設定します。|“RadioButtonGroup”
...
[Theme](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonGroupWrapper~Theme.html)|string|`RadioButtonGroup` のテーマを取得または設定します。|**null**<br>“a”<br>“b”<br>“c” <br>“d”<br>“e”
...
プロパティ|タイプ|説明|値（**デフォルト値**）
---|---|---|---
[ID](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonWrapper~ID.html)|string|Radio Button ID を取得または設定します。|buttonID
[Text](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonWrapper~Text.html)|string|Radio Button のテキストを取得または設定します。|Button
...
[Theme](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.RadioButtonWrapper~Theme.html)|string|Radio Button のテーマを取得または設定します。|**null**<br>“a”<br>“b”<br>“c”<br>“d”<br>“e”
