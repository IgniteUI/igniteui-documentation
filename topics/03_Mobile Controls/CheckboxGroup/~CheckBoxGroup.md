...
このトピック グループでは、`チェックボックス グループ` MVC ラッパーを使用して jQuery モバイルの [checkboxradio](http://jquerymobile.com/demos/1.1.1/docs/forms/checkboxes/) ウィジェットを表示/使用する方法について説明します。

### トピック

このセクションには、`CheckBoxGroup` MVC ラッパーの使用法に関する以下のトピックが含まれます。
