...
---|---|---|---
[ID](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.TextBoxWrapper~ID.html)|文字列|`TextBox` ID を取得または設定します。|“txtbx1”
[Text](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.TextBoxWrapper~Text.html)|文字列|`TextBox` テキストを取得または設定します。|“Search…” <br>“Type your search here…”
...
[Label](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.TextBoxWrapper~Label.html)|文字列|`TextBox` ラベルを取得または設定します。|TextBox Label
...
[Theme](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.TextBoxWrapper~Theme.html)|文字列|`TextBox` テーマを取得または設定します。|**null**<br>“a”<br>“b”<br>“c”<br>“d”<br>“e”
