...
---|---|---|---
[ID](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~ID.html)|文字列|Link ID を取得または設定します。|LinkID
[Text](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~Text.html)|文字列|Link テキストを取得または設定します。|Link
[NavigateUrl](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~NavigateUrl.html) |文字列|Link コントロールが参照しているターゲットを取得または設定します。|"http://www.infragistics.com"
[Target](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~Target.html) |文字列|アンカー ターゲットを取得または設定します。|“_blank” <br />“_parent” <br />“_self” <br />“_top” <br />“framename”
...
[Transition](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~Transition.html) |文字列|新しいコンテンツに移動する時に [transition](http://jquerymobile.com/demos/1.0a4.1/docs/pages/docs-transitions.html) を取得または設定します|“slide” <br />“slideup” <br />“slidedown” <br />“pop” <br />“fade” <br />“flip”
...
[Icon](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~Icon.html)|文字列|Link がボタンとして描画されるときに、[icon](http://api.jquerymobile.com/icons/) を取得または設定します。|“arrow-l” <br />“delete” <br />“plus” <br />“minus” <br />“check” <br />“gear”
[IconPosition](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~IconPosition.html)|文字列|Link がボタンとして描画されるときに、[icon](http://api.jquerymobile.com/icons/) 位置を取得または設定します。|"right"<br />"left"<br />“top”<br />“bottom”
...
[Theme](Infragistics.Web.Mvc.Mobile~Infragistics.Web.Mvc.Mobile.LinkWrapper~Theme.html)|文字列|Link テーマを取得または設定します。|null<br />“a” <br />“b” <br />“c” <br />“d” <br />“e”
