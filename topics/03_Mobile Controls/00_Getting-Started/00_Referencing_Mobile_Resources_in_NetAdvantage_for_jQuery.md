...
-   [**jQuery コントロール用の Infragistics Mobile リソースの参照**](#ig-resources)
...
## <a id="ig-resources"></a> jQuery コントロール用の Infragistics Mobile リソースの参照
...
基本構造 CSS ファイルを含めて、どのコントロールに関する CSS ファイルも、すべて structure フォルダーに収められています。Infragistics Mobile のテーマは **themes** フォルダーに置かれています。
...
このトピックのセクション「[jQuery コントロール用の Infragistics Mobile リソースの参照](#ig-resources)」に示した手順どおりに Infragistics のリソースを追加すると、Web アプリケーションの **scripts** フォルダーに modules フォルダーが作成されます。modules フォルダーの中には **i18n** フォルダーが作成され、このフォルダーには、`igListView` を日本語にローカライズするための JavaScript ファイルが収められます。
