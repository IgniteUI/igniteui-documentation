...
すべての Ignite UI™ モバイル コントロールおよびコンポーネントは、1973 年リハビリテーション法第 508 条第 1194 部 22 条を遵守しています。後に続くアクセシビリティ準拠一覧表には、コントロールに関連する第 1194 部 第 22 節の特定の規則が含まれています。また、list view コントロールが各規則を順守する方法に関する詳細も含まれています。
