...
機能|説明
---|---
[データ バインディング](#data_binding)|`igListView` は、`igDataSource` 、および UL または OL HTML 要素で使用可能なすべてのデータ ソースにバインドできます。
...
[ロード オン デマンド](#load_on_demand)|`igListView` ロード オン デマンドによって、ユーザーの要求に応じて、より多くの項目をリストに追加できます。
