...
3.  Add the shape to the Worksheet's [Shapes](Infragistics.Web.Documents.Excel~Infragistics.Documents.Excel.Worksheet~Shapes.html "Link to the Web API Reference Guide to the Shapes member.") collection.
