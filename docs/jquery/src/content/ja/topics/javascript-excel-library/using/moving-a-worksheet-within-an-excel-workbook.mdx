...
Excel Workbook に 3 つのワークシートがある場合、<ApiLink pkg="ig" type="excel.Worksheet" label="Worksheet" /> クラスの <ApiLink pkg="ig" type="excel.Worksheet" member="moveToIndex" section="methods" label="moveToIndex" /> メソッドを使用して worksheet3 を先頭の位置に配置できます。
