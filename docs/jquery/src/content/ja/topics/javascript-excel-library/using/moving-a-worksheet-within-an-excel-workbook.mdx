...
Excel Workbook に 3 つのワークシートがある場合、[`Worksheet`](&#123;environment:jQueryApiUrl&#125;/ig.excel.Worksheet) クラスの [`moveToIndex`](&#123;environment:jQueryApiUrl&#125;/ig.excel.Worksheet#methods:moveToIndex) メソッドを使用して worksheet3 を先頭の位置に配置できます。
