...
xlsx フォーマットをロードおよび保存する時のプロジェクトの依存および参照についての詳細は、トピック [Office® 2007 xlsx ファイル生成の参照と依存](/asp-net-mvc/excel-engine/using/office-2007-xlsx-file-generation-references-and-dependencies)を参照してください。
