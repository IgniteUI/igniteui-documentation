...
![](../../../../../images/images/DocumentEngine_Grids_01.png)
...
[パターン コンテンツ](/asp-net-mvc/document-engine/writing/elements/pattern/pattern-content) ファミリーのメンバーとして、さまざまなグリッド レベルでパターンを適用することにより、さまざまなグリッド 要素のスタイルを修正できます。
