...
前述したように、この機能の名称は、他の機能との混同を避けるために「ロード オン デマンド｣から｢オンデマンドによる行追加｣に変更されました。%%ProductName%% の以前のバージョンからアップグレードする場合、以下の情報を知っておく必要があります。
...
-   igGrid [features](%%jQueryApiUrl%%/ui.iggrid#options:features) オプションの配列では、機能の名称が「LoadOnDemand」から「AppendRowsOnDemand」に変更されています。
