...
### スクリプティング要件 
%%ProductNameMVC%% が jQuery ウィジェットを再描画するため、jQuery と MVC 両方のサンプルに必要なスクリプトは同じです。次が必要になります。
...
<div class="embed-sample">
   [igHierarchicalGrid JSON のバインド](%%SamplesEmbedUrl%%/hierarchical-grid/json-binding)
</div>
