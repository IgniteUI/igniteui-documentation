...
## <a id ="continuous_virtualization"></a> 連続仮想化 
...
### 関連トピック:
-   [仮想化を有効にし、構成する](igHierarchicalGrid-Enabling-and-Configuring-Virtualization.html)
...
- [仮想化を有効にし、構成する](igHierarchicalGrid-Enabling-and-Configuring-Virtualization.html): このトピックでは、igHierarchicalGrid コントロールの連続仮想化機能を有効にする方法を説明します。
