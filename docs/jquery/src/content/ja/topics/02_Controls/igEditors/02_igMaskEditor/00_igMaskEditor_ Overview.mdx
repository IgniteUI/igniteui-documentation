...
## %%ProductFamilyName%% CLI を使用して igMaskEditor の追加

新しい igMaskEditor を簡単にアプリケーションに追加するには、%%ProductFamilyName%% CLI を使用します。新しいアプリケーションを作成した後、以下のコマンドを実行すると、マスク エディターがプロジェクトに追加されます。
