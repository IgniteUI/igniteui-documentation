...
予定一覧と月表示の分割の方向|MonthView および AgendaView が垂直方向または水平方向に分割されるかどうかを決定する方向を制御します。このオプションは、AgendaView が MonthView で表示される場合に使用可能です。| [viewSplitOrientation](%%jQueryApiUrl%%/ui.igscheduler#options:monthViewSettings.viewSplitOrientation)
...
要素 | 説明 | プロパティ
---|---|---
表示モード | 週表示はすべての 7 日または稼動日として構成される日のみを表示できます。 | [weekViewDisplayMode](%%jQueryApiUrl%%/ui.igscheduler#options:weekViewSettings.weekViewDisplayMode)
時間帯の期間 | 時間帯の期間を構成します。現在 5、6、10、15、30、および 60 分がサポートされます。 | [timeSlotInterval](%%jQueryApiUrl%%/ui.igscheduler#options:weekViewSettings.timeSlotInterval)
稼動日および稼働時間 | このビューは、稼働時間または全 24 時間を表示するために構成できます。 | [workingHoursDisplayMode](%%jQueryApiUrl%%/ui.igscheduler#options:weekViewSettings.workingHoursDisplayMode)
...
要素 | 説明 | プロパティ
---|---|---
表示日 | 日表示で表示される日数を制御できます。現在 1 日から 7 日間がサポートされます。 | [dayViewNumberOfDays](%%jQueryApiUrl%%/ui.igscheduler#options:dayViewSettings.dayViewNumberOfDays)
時間帯の期間 | 時間帯の期間を構成します。現在 5、6、10、15、30、および 60 分がサポートされます。 | [timeSlotInterval](%%jQueryApiUrl%%/ui.igscheduler#options:dayViewSettings.timeSlotInterval)
稼動日および稼働時間 | このビューは、稼働時間または全 24 時間を表示するために構成できます。 | [workingHoursDisplayMode](%%jQueryApiUrl%%/ui.igscheduler#options:dayViewSettings.workingHoursDisplayMode)
