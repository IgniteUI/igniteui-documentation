...
### 前提条件
[「igTree を使用した作業の開始」](/controls/igtree/getting-started)というトピックを最初にお読みください。
...
| --- | --- | --- |
| ノード イメージを構成する | 画像は `igTree` コントロールの各ノードの次を表示するようバインディング、CSS、または URL で構成できます。 | [parentNodeImageUrl](environment:jQueryApiUrl/ui.igTree#options:parentNodeImageUrl) [parentNodeImageClass](environment:jQueryApiUrl/ui.igTree#options:parentNodeImageClass) [leafNodeImageUrl](environment:jQueryApiUrl/ui.igTree#options:leafNodeImageUrl) [leafNodeImageClass](environment:jQueryApiUrl/ui.igTree#options:leafNodeImageClass) [imageUrlKey](environment:jQueryApiUrl/ui.igTree#options:bindings.imageUrlKey) [imageUrlXPath](environment:jQueryApiUrl/ui.igTree#options:bindings.imageUrlXPath) |
...
---|---|---
[URL を使用して親ノードおよびリーフ ノードの画像を構成する](#example_configure_using_url)|[parentNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageUrl)<br/>[leafNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageUrl)|string URL<br/>string URL
[CSS を使用して親ノードおよびリーフ ノードの画像を構成する](#example_configure_using_css)|[parentNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageClass)<br/>[leafNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageClass)|string CSS クラス名<br/>string CSS クラス名
[バインディングにより個々のデータ項目のノード イメージを構成する](#example_configure_through_binding)|[imageUrlKey](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlKey)<br/>(XML の場合)<br/>[imageUrlXPath](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlXPath)|画像への URL がある string 型データ メンバー <br/> XML にバインドされた場合の画像 URL への string 型 XPath
...
オプション|設定|プレビュー
---|---|---
[imageUrlKey](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlKey) | ImageUrl|![](../../images/images/igTree_Configure_Node_Images_Pic03.png)
...
-   [igTree でノードを構成する](/controls/igtree/configure-nodes)
