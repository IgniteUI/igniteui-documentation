...
### <a id="BindingaJavaScriptArray"></a> JavaScript 配列へのバインド
...
[igCategoryChart の追加](/controls/igcategorychart/adding) インスタンスの作成および構成の詳細については、「igDataChart の追加」を参照してください。 
...
### <a id="BindingaHierarchicalJavaScriptArray"></a> 階層 JavaScript 配列にバインド

#### <a id="HIntroduction"></a> 概要
ここでは、igCategoryChart コントロールをセミネスト階層 JavaScript データ配列にバインドする際の手順を示します。

#### <a id="HPrerequisites"></a> 前提条件
