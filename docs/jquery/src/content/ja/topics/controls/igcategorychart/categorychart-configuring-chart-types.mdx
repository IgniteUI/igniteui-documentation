...
[チャート タイプ](/controls/igcategorychart/categorychart-chart-types)トピックに説明されているとおり、チャートはプロパティを変更するだけでさまざまなチャートタイプを描画できます。
...
- [軸の間隔と重複](/controls/igcategorychart/axes/categorychart-configuring-axis-gap-and-overlap)
