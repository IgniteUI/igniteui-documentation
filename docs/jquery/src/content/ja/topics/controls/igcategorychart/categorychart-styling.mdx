...
-	[igCategoryChart の概要](/categorychart-overview): `igCategoryChart` コントロールについての概要。

-	[igCategoryChart の追加](/igcategorychart-adding): `igCategoryChart` をコントロールを作成して、データにバインドする方法を紹介します。
