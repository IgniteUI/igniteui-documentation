---
title: "igCategoryChart のスタイル設定"
slug: categorychart-styling
---
...
-	[igCategoryChart の概要](/controls/igcategorychart/categorychart-overview): `igCategoryChart` コントロールについての概要。

-	[igCategoryChart の追加](/controls/igcategorychart/adding): `igCategoryChart` をコントロールを作成して、データにバインドする方法を紹介します。
