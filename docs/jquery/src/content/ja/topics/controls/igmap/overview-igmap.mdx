...
| 地理記号シリーズ | 地理座標に基づいて、マップ上のマーカーを視覚化します。, 関連トピック: [地理シンボル シリーズの構成](/igmap-configuring-geographic-symbol-series) | geographicSymbol | [latitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.latitudeMemberPath) [longitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.longitudeMemberPath) |
| 地理図形シリーズ | シェープ (SHP) ファイルまたはカスタム形状データ ソースが提供する形状データに基づいて、国や地域などの、マップ上の囲まれた領域を視覚化します。, 関連トピック: [地理図形シリーズの構成](/igmap-configuring-geographic-shapes) | geographicShape | [shapeDataSource](environment:jQueryApiUrl/ui.igMap#options:series.shapeDataSource) [databaseSource](environment:jQueryApiUrl/ui.igMap#options:series.databaseSource) [shapeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.shapeMemberPath) |
...
| 地理散布エリアシリーズ | 三角測量 (ITF) ファイルまたはその他のカスタム三角測量データ ソースで定義される不規則三角網 (TIN) に基づいて、色分けされた地理領域を表示します。地理座標および値メンバーも必要です。これは地形高度、人口密度、平均/現在の気温などを示すために使用されます。, 関連トピック: [地理散布エリア シリーズの構成](/igmap-configuring-geographic-scatter-area-series) | geographicScatterArea | [triangulationDataSource](environment:jQueryApiUrl/ui.igMap#options:series.triangulationDataSource) オプション: [triangleVertexMemberPath1](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath1) [triangleVertexMemberPath2](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath2) [triangleVertexMemberPath3](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath3) [longitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.longitudeMemberPath) [latitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.latitudeMemberPath) [colorMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.colorMemberPath) |
| 地理等高線シリーズ | 三角測量 (ITF) ファイルまたはその他のカスタム三角測量データ ソースで定義される不規則三角網 (TIN) に基づいて、色付けされた閉じたパスを視覚化します。地理座標および値メンバーも必要です。これは地形高度、人口密度、平均/現在の気温などを示すために使用されます。, 関連トピック: [地理等高線シリーズの構成](/igmap-configuring-geographic-contour-line-series) | geographicContourLine | [triangulationDataSource](environment:jQueryApiUrl/ui.igMap#options:series.triangulationDataSource) オプション: [triangleVertexMemberPath1](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath1) [triangleVertexMemberPath2](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath2) [triangleVertexMemberPath3](environment:jQueryApiUrl/ui.igMap#options:series.triangleVertexMemberPath3) [longitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.longitudeMemberPath) [latitudeMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.latitudeMemberPath) [valueMemberPath](environment:jQueryApiUrl/ui.igMap#options:series.valueMemberPath) |
