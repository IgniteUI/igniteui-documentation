...
- [igGrid の概要](/controls/iggrid/overview) - `igGrid` コントロールについての一般的情報。
...
エクスポーターで使用可能なすべてのプロパティの詳細は、 [API ヘルプ](&#123;environment:jQueryApiUrl&#125;/ig.gridexcelexporter#overview) を参照してください。
