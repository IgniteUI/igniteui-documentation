...
- トピック
	- まず[列の非表示を有効にする](/controls/iggrid/features/columns/hiding/column-hiding-enabling-column-hiding)トピックを読む必要があります。
- 外部リソース
...
> **注:** 以下の表には、[列チューザーの非表示](/controls/iggrid/features/columns/hiding/hiding-column-chooser)に固有のプロパティとメソッドは記載されていません。それらについては、[列チューザーを非表示にする](/controls/iggrid/features/columns/hiding/hiding-column-chooser)トピックをご覧ください。
...
![](../../../../../images/images/Hiding_Configure_Pic1.png)
...
プロパティ|設定
----|----
[columnKey](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnSettings.columnKey) |ReorderPoint
[allowHiding](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnSettings.allowHiding) |true
[hidden](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnSettings.hidden) |true
...
![](../../../../../images/images/Hiding_Configure_Pic2.png)
...
プロパティ|設定
----|----
[columnKey](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnSettings.columnKey)|true
[allowHiding](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnSettings.allowHiding)|false
...
-   [igGridColumnHiding イベント](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#events)
...
![](../../../../../images/images/Hiding_Configure_Pic3.png)
...
プロパティ|設定
---------|-------
[columnChooserWidth](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnChooserWidth) |300
[columnChooserHeight](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnChooserHeight) |300
[columnChooserCaptionText](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnChooserCaptionText) |New Caption Text
[columnChooserDisplayText](&#123;environment:jQueryApiUrl&#125;/ui.igGridHiding#options:columnChooserDisplayText) |New Chooser Text
...
-   [列非表示イベント API](&#123;environment:jQueryApiUrl&#125;/ui.iggridhiding#events)
