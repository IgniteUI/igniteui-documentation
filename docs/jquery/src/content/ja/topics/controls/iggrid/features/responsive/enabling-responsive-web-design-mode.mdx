---
title: "レスポンス Web デザイン (RWD) モード構成を有効にする (igGrid)"
...
## コード例: JavaScript で レスポンス Web デザイン モードを有効にする
...
## コード例: ASP.NET MVC で レスポンス Web デザイン モードを有効にする
