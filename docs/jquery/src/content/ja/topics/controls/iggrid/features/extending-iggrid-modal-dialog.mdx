...
- [ColumnMoving](&#123;environment:jQueryApiUrl&#125;/ui.iggridcolumnmoving#options:dialogWidget)
- [Filtering](&#123;environment:jQueryApiUrl&#125;/ui.iggridfiltering#options:dialogWidget)
- [GroupBy](&#123;environment:jQueryApiUrl&#125;/ui.iggridgroupby#options:dialogWidget)
- [Hiding](&#123;environment:jQueryApiUrl&#125;/ui.iggridhiding#options:dialogWidget)
- [Sorting](&#123;environment:jQueryApiUrl&#125;/ui.iggridsorting#options:dialogWidget)
- [Updating](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:dialogWidget)
...
-   [行編集ダイアログ (igGrid)](/controls/iggrid/features/updating/row-template/updating-roweditdialog-landingpage)
-   [列チューザーの構成 (igGrid)](/controls/iggrid/features/columns/hiding/hiding-column-chooser)
-   [グループ化ダイアログの概要 (igGrid)](/controls/iggrid/features/columns/grouping/group-by-dialog-overview)
...
-   [複数並べ替えダイアログ (igGrid)](/controls/iggrid/features/columns/sorting/multiple-sorting-dialog)
