---
title: "igLayoutManager の概要"
slug: iglayoutmanager-overview
---
...
![](../../images/images/igLayoutManager_Overview_1.png)
...
任意のレイアウトを選択するには、`igLayoutManager` コントロールの [layoutMode](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options) プロパティを設定します。デフォルトのレイアウトは、[**列レイアウト**](#column-layout)です。レイアウトの構成やカスタマイズの詳細は、[igLayoutManager の追加](/controls/iglayoutmanager/adding)および[igLayoutManager の構成](/controls/iglayoutmanager/configuring-layouts)のトピックを参照してください。
...
以下の表に、`igLayoutManager` コントロールのレイアウトの概要を示します。各レイアウトの詳細を概要表の後に各レイアウトの詳細を説明します。また、[igLayoutManager の構成](/controls/iglayoutmanager/configuring-layouts)のトピックも参照してください。

レイアウト|説明|外観
---|---|---
[](#border-layout)[境界線レイアウト](#border-layout)|境界線レイアウトはコンテナーを、ヘッダー、フッター、ボディ、左サイドバーおよび右サイドバーの各要素 (領域) に分割します。各要素には異なるコンテンツ項目が格納されています。|![](../../images/images/igLayoutManager_Overview_2.png)
[](#column-layout)[列レイアウト](#column-layout)|列レイアウトでは、コンテナーが 12 列に分割されます。列の各セットは独立した行に配置され、コンテンツ項目は左右の複数の列にまたがることができます。|![](../../images/images/igLayoutManager_Overview_3.png)
[](#flow-layout)[フロー レイアウト](#flow-layout)|フロー レイアウトではコンテンツ項目が左から右に配置され、コンテナーの右端に到達すると、折り返して左端から新しい行になります。|![](../../images/images/igLayoutManager_Overview_4.png)
[](#grid-layout)[グリッド レイアウト](#grid-layout)|グリッド レイアウトでは、列や行の数をカスタマイズできるグリッド システムに項目が配置されます。コンテンツ項目は、左右の複数列、および上下の複数行にまたがることができます。 |![](../../images/images/igLayoutManager_Overview_5.png)
[](#vertical-layout)[垂直レイアウト](#vertical-layout)|垂直レイアウトの場合、単一列の配列で形成されるため、コンテンツ項目は積み重ねるように上から下に配置されます。|![](../../images/images/igLayoutManager_Overview_6.png)
...
![](../../images/images/igLayoutManager_Overview_7.png)

境界線レイアウトは、ニュース配信や公告領域があるサイト、ブログなど、最も一般的なさまざまなレイアウト要件に適しています。

地域|クラス名
---|---
ヘッダー|[header](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options)
フッター|[footer](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options)
左サイドバー|[left](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options)
右サイドバー|[right](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options)
ボディ|[center](&#123;environment:jQueryApiUrl&#125;/ui.iglayoutmanager#options)
...
---|---
![](../../images/images/igLayoutManager_Overview_2.png)|![](../../images/images/igLayoutManager_Overview_9.png)
...
![](../../images/images/igLayoutManager_Overview_10.png)
...
![](../../images/images/igLayoutManager_Overview_11.png)
...
拡大されたブラウザー ビューポート|縮小されたブラウザー ビューポート
---|---
![](../../images/images/igLayoutManager_Overview_1.png)|![](../../images/images/igLayoutManager_Overview_3.png)
...
拡大されたブラウザー ビューポート|縮小されたブラウザー ビューポート
---|---
![](../../images/images/igLayoutManager_Overview_1.png)|![](../../images/images/igLayoutManager_Overview_15.png)
...
![](../../images/images/igLayoutManager_Overview_16.png)
...
![](../../images/images/igLayoutManager_Overview_17.png)

以下の画像は、列レイアウトのリキット デザインとレスポンシブ デザインの両方の効果を示します (項目はサイズ変更され、次の行に再配置されています)。

拡大されたブラウザー ビューポート|縮小されたブラウザー ビューポート
---|---
![](../../images/images/igLayoutManager_Overview_18.png)|![](../../images/images/igLayoutManager_Overview_19.png)
...
![](../../images/images/igLayoutManager_Overview_20.png)
...
![](../../images/images/igLayoutManager_Overview_21.png)
...
拡大されたブラウザー ビューポート|縮小されたブラウザー ビューポート
---|---
![](../../images/images/igLayoutManager_Overview_22.png)|![](../../images/images/igLayoutManager_Overview_23.png)
...
---|---
![](../../images/images/igLayoutManager_Overview_24.png)|![](../../images/images/igLayoutManager_Overview_25.png)
...
![](../../images/images/igLayoutManager_Overview_26.png)

垂直レイアウトは、モバイル デバイス向けのプログラミングの使用に適しています。ニュース配信や、ストリームを生じるスポーツ中継などに最適です。

垂直レイアウトでは項目をさまざまな高さや幅に設定できます。このレイアウトで保持する列は 1 列のみです。

![](../../images/images/igLayoutManager_Overview_27.png)

以下の画像は、垂直レイアウトのリキット デザインの効果を示します。

拡大されたブラウザー ビューポート|縮小されたブラウザー ビューポート
---|---
![](../../images/images/igLayoutManager_Overview_28.png)|![](../../images/images/igLayoutManager_Overview_29.png)
...
`igLayoutManager` コントロールは jQuery UI ウィジェットであるため、jQuery と jQuery の UI ライブラリに依存します。これらのリソースへの参照は、実際の jQuery または &#123;environment:ProductNameMVC&#125; が使用されているとしても必要となります。コントロールが ASP.NET MVC のコンテクスト内で使用されている場合、Infragistics.Web.Mvc の組立が必要になります。

完全な要件の一覧については、[igLayoutManager の追加](/controls/iglayoutmanager/adding)のトピックを参照してください。
...
-	[igLayoutManager の構成](/controls/iglayoutmanager/configuring-layouts): このトピックではコード例を使用して、`igLayoutManager` コントロールがサポートする別のレイアウトを設定する方法を説明します。
