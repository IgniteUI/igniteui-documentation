...
任意のレイアウトを選択するには、`igLayoutManager` コントロールの <ApiLink type="iglayoutmanager" label="layoutMode" /> プロパティを設定します。デフォルトのレイアウトは、[**列レイアウト**](#column-layout)です。レイアウトの構成やカスタマイズの詳細は、[igLayoutManager の追加](/iglayoutmanager-adding)および[igLayoutManager の構成](/iglayoutmanager-configuring-layouts)のトピックを参照してください。
...
地域|クラス名
---|---
ヘッダー|<ApiLink type="iglayoutmanager" label="header" />
フッター|<ApiLink type="iglayoutmanager" label="footer" />
左サイドバー|<ApiLink type="iglayoutmanager" label="left" />
右サイドバー|<ApiLink type="iglayoutmanager" label="right" />
ボディ|<ApiLink type="iglayoutmanager" label="center" />
