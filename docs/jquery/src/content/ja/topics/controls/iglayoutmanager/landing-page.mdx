...
-	[igLayoutManager アクセシビリティの遵守](/iglayoutmanager-accessibility-compliance): このトピックでは、`igLayoutManager` コントロールのアクセシビリティ機能を説明し、このコントロールを含むページのアクセシビリティ遵守を実現する方法を説明します。
