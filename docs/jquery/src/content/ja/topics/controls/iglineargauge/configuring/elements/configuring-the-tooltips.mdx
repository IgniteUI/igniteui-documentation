...
<table cellspacing="0" cellpadding="0" class="table">
	...
	<tbody>
        <tr>
            <th>[可視性](#enable-disable-tooltips)</th>
        ...
        <tr>
            ...
            <td>[針](#config-custom-tooltip)</td>
            <td>[needleToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleToolTipTemplate)</td>
            <td>[needleName](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleName) の初期化状態による ([針のカスタム ツールチップの構成](#config-custom-tooltip)を参照)</td>
</tr>
        <tr>
...
目的:|使用するプロパティ:|設定の選択肢:
---|---|---
ツールチップの表示|[showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options;showToolTip)|true
ツールチップの非表示|[showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:showToolTip)|false
...
目的:|使用するプロパティ:|設定の選択肢:
---|---|---
ツールチップが表示される前の初期遅延の設定|[showToolTipTimeout](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:showToolTipTimeout)|任意の値 (ミリ秒)
...
ツールチップの既定値は、[needleName](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleName) プロパティが初期化されているかどうかにより事前に設定されます。
...
目的:|使用するプロパティ:|設定の選択肢:
---|---|---
針のカスタム ツールチップの設定|[needleToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleToolTipTemplate)|必要なテンプレートの ID。
...
-	プロパティ: [needleToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleToolTipTemplate)
...
![](../../../../images/images/igLinearGauge_Configuring_the_Tooltips_1.png)
...
目的:|使用するプロパティ:|設定の選択肢:
---|---|---
比較範囲のカスタム ツールチップの構成|[rangeToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:rangeToolTipTemplate)|必要なテンプレートの ID。
...
-	プロパティ: [rangeToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:rangeToolTipTemplate)
...
![](../../../../images/images/igLinearGauge_Configuring_the_Tooltips_2.png)
