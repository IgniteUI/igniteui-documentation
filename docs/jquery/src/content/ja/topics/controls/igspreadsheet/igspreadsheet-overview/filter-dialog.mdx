...
### 前提条件
このトピックを理解するために [Infragistics JavaScript Excel Library](../../../09_JavaScript Excel Library/~JavaScript_Excel_Library.mdx) および [igSpreadsheet](/controls/igspreadsheet/igspreadsheet-overview/feature-overview) の概念とトピックが前提条件です。
