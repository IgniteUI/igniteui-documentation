...
このトピックを有効に使用するために [Infragistics JavaScript Excel Library](../../../09_JavaScript Excel Library/~JavaScript_Excel_Library.mdx) および [igSpreadsheet](/controls/igspreadsheet/igspreadsheet-overview/feature-overview) の概念とその関連トピックの理解が前提条件となります。
