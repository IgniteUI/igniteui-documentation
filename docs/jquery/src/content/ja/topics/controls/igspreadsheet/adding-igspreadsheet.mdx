...
[Infragistics Loader による必要なリソースを自動で追加する](/general-and-getting-started/using-infragistics-loader)
...
## 関連リンク
 ...
 -   [igSpreadsheet のビジュアル要素](/controls/igspreadsheet/igspreadsheet-overview/visual-elements)
