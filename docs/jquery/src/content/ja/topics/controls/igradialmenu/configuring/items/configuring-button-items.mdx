...
このトピックでは、[`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ のボタン項目について説明します。
...
![](../../../../images/images/igRadialMenu_04.png)
...
- [ボタン項目](&#123;environment:SamplesUrl&#125;/radial-menu/button-items): このサンプルは、ボタン項目の定義および構成方法を紹介します。
