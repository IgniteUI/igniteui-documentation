...
このトピックでは、[`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ の色項目について説明します。
...
- [数値項目の構成](/controls/igradialmenu/configuring/items/configuring-numeric-items): このトピックでは、`igRadialMenu` の数値項目について説明します。
