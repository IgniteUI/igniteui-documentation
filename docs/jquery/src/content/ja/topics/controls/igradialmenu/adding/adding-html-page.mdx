...
このトピックではコード例を使用して、[`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ を HTML ページに追加する方法を説明します。
...
- [ASP.NET MVC アプリケーションへの igRadialMenu の追加](/controls/igradialmenu/adding/adding-mvc-app): このトピックではコード例を使用して、&#123;environment:ProductNameMVC&#125; で `igRadialMenu` を ASP.NET MVC アプリケーションに追加する方法を紹介します。
