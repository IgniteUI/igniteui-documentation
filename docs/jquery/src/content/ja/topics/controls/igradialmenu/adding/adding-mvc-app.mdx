...
このトピックでは、コード例を使用して、&#123;environment:ProductNameMVC&#125; で ASP.NET MVC アプリケーションに [`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ を追加する方法を説明します。
...
-   「[HTML ページへの igRadialMenu の追加](/controls/igradialmenu/adding/adding-html-page)」のトピックで説明するように、すべての `igRadialMenu` 関連のファイルを明示的に含める方法
...
- [igRadialMenu の HTML ページへの追加](/controls/igradialmenu/adding/adding-html-page): このトピックでは、コード例を使用して、igRadialMenu を HTML ページに追加する方法を説明します。
