...
構成可能な要素|詳細|プロパティ
--- | --- | ---
モーダル `igDialog` の構成|`igDialog`モーダルの作成時に構成する必要のあるプロパティ。|[modal](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:modal)
...
目的:|使用するプロパティ:|設定の選択肢:
--- | --- | ---
igDialog モーダルにする|[modal](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:modal)|true
igDialog フッター タイトルを設定する|[pinned](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:pinned)|false
igDialog 状態を設定する|[state](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:state)|opened
