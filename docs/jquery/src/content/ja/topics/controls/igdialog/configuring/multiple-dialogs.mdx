...
--- | --- | --- | ---
最上位モーダル ダイアログとの参照情報を取得します。|[getTopModal()](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:getTopModal) |なし|object - `igDialog` への参照情報
ダイアログがモーダルで、現在アクティブかどうかを確認します。|[isTopModal()](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:isTopModal) |なし|boolean
モーダルでないダイアログを先頭に移動する|[moveToTop(e)](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:moveToTop) |*e* - ブラウザー イベント|object - 移動した `igDialog` への参照情報
