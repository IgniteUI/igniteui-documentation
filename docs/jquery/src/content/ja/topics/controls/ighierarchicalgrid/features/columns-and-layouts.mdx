...
- [Columns](&#123;environment:jQueryApiUrl&#125;/ui.ighierarchicalgrid#options): グリッドの列を定義します。
- [Layouts](&#123;environment:jQueryApiUrl&#125;/ui.ighierarchicalgrid#options): グリッドのレイアウトを定義します。
