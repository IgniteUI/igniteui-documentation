...
この例では、ユーザーは ASP.NET MVC で igHierarchicalGrid コントロールを作成する方法と、組み込むべきスクリプトと CSS リソースを理解していることを前提としています。詳細については、「[igHierarchicalGrid の概要](/controls/ighierarchicalgrid/overview)」のトピックを参照してください。
