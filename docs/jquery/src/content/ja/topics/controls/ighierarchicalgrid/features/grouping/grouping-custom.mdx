...
トピック|目的
---|---
[igHierarchicalGrid の概要](/controls/ighierarchicalgrid/overview)|igHierarchicalGrid™ の概要で機能、データ ソースへのバインド、要件、テンプレート、および相互作用などの情報を含みます。
[igHierarchicalGrid の初期化](/controls/ighierarchicalgrid/initializing)|jQuery と MVC による igHierarchicalGrid の初期化方法を示します。
[グループ化の概要 (igHierarchicalGrid)](/controls/ighierarchicalgrid/features/grouping/grouping-overview)|igHierarchicalGrid コントロールのグループ化関数を紹介します。
...
- [グループ化の有効化と構成](/controls/ighierarchicalgrid/features/grouping/grouping-enabling-and-configuring): このトピックでは、igHierarchicalGrid コントロールにグループ化機能を追加する方法を説明します。