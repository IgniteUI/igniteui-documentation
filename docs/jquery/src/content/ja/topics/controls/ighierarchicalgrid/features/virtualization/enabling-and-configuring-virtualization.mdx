...
#### 仮想化を有効にする方法の概要
- 仮想化は [`virtualization`](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) プロパティを `true` に設定することで有効になります。仮想化のタイプは、[`virtualizationMode`](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) プロパティを continuous に設定することで指定できます。
