...
| 構成可能な要素 | メソッド |
| --- | --- |
| セル選択 | <ApiLink type="iggridselection_hg" label="selectCell" /> <ApiLink type="iggridselection_hg" label="deselectCell" /> |
| 行の選択 | <ApiLink type="iggridselection_hg" label="selectRow" /> <ApiLink type="iggridselection_hg" label="deselectRow" /> |
| 選択のクリア | <ApiLink type="iggridselection_hg" label="clearSelection" /> <ApiLink type="iggridselection_hg" label="clearSelectionAll" /> <ApiLink type="iggridselection_hg" label="clearSelectionAllChildren" /> <ApiLink type="iggridselection_hg" label="clearSelectionAllOthers" /> |
