...
| 構成可能な要素 | メソッド |
| --- | --- |
| 行の展開 | [expand](environment:jQueryApiUrl/ui.ighierarchicalgrid#methods) [expanded](environment:jQueryApiUrl/ui.ighierarchicalgrid#methods) |
| 行の縮小 | [collapse](environment:jQueryApiUrl/ui.ighierarchicalgrid#methods) [collapsed](environment:jQueryApiUrl/ui.ighierarchicalgrid#methods) |
| 行の切り替え | [toggle](environment:jQueryApiUrl/ui.ighierarchicalgrid#methods) |
...
- [igHierarchicalGrid イベント API](/controls/ighierarchicalgrid/events-api): このトピックでは、igHierarchicalGrid に固有のイベントについて説明します。
- [igHierarchicalGrid の列とレイアウト](/controls/ighierarchicalgrid/features/columns-and-layouts): このトピックでは、自動生成などで igHierarchicalGrid の列およびレイアウトを定義する方法を示しています。
