...
- 概念
	...
	-   ASP.NET MVC
-   トピック
	-   [*igDataSource* の概要](/igdatasource-igdatasource-overview): このトピックでは、`igDataSource`™ コンポーネントの概要を提供し、HTML ページへの追加方法をコードを説明します。
...
-   XML
-   IQueryable&lt;T&gt;
-   [*igDataSource*](/igdatasource-igdatasource)
