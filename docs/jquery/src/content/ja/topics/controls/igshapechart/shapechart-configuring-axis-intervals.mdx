...
### <a id="ConfiguringXAxis"></a>X 軸と Y 軸に主間隔と副間隔を構成
...
![](../../images/images/shapechart-intervals-01.PNG)
...
-	[軸間隔の構成](&#123;environment:SamplesUrl&#125;/shape-charts/axis-intervals): このサンプルでは、`igShapeChart` コントロールの軸間隔を構成する方法を紹介します。
