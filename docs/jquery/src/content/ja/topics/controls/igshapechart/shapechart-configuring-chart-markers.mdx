...
#### <a id="requiredbackground"></a> 前提条件
トピック|目的
---|---
[igShapeChart の概要](/controls/igshapechart/shapechart-overview)|このトピックは、主要機能、最小要件およびユーザー機能性など、igShapeChart コントロールの概念的な情報を提供します。
[igShapeChart を使用した作業の開始](/controls/igshapechart/shapechart-getting-started-with-shapechart)|このトピックでは、データを igShapeChart コントロールにバインドする方法を説明します。

#### <a id="supportedcharttypes"></a> サポートされるチャート タイプ
...
#### <a id="markerproperties"></a> マーカー プロパティ
...
![](../../images/images/shapechart-chart-markers-01.PNG)
...
![](../../images/images/shapechart-chart-markers-02.PNG)



## <a id="relatedtopics"></a>関連トピック:

- [軸ラベルの構成](/controls/igshapechart/shapechart-configuring-axis-labels)

- [軸範囲の構成](/controls/igshapechart/shapechart-configuring-axis-ranges)