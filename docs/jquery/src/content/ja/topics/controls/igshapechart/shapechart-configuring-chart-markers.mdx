...
[igShapeChart を使用した作業の開始](/shapechart-getting-started-with-shapechart)|このトピックでは、データを igShapeChart コントロールにバインドする方法を説明します。
...
- [軸ラベルの構成](/shapechart-configuring-axis-labels)

- [軸範囲の構成](/shapechart-configuring-axis-ranges)