---
title: "軸範囲の構成 (igShapeChart)"
slug: shapechart-configuring-axis-ranges
---
...
![](../../images/images/shapechart_ranges.PNG)

<a id="Related" />
## 関連コンテンツ
- [軸ラベルの構成](/controls/igshapechart/shapechart-configuring-axis-labels)
- [軸間隔の構成](/controls/igshapechart/shapechart-configuring-axis-intervals)
