...
- [三角測量シリーズの構成](/controls/igdatachart/configuring/triangulation-series/triangulation-series): このトピックでは、`igDataChart` コントロールで散布エリアおよび散布等高線シリーズの概要を提供します。

- [散布エリア シリーズの構成](/controls/igdatachart/configuring/triangulation-series/area-series): このトピックでは、`igDataChart` コントロールで散布エリア シリーズを構成する方法について説明します。
