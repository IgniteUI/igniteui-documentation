...
- [三角測量シリーズの構成](/triangulationseries-triangulation-series): このトピックでは、`igDataChart` コントロールの散布エリアおよび散布等高線シリーズの構成の概要を提供します。

- [散布等高線シリーズの構成](/triangulationseries-contour-series): このトピックでは、`igDataChart` コントロールで散布等高線シリーズを構成する方法について説明します。
