---
title: "ASP.NET MVC 検証の構成"
slug: configuring-asp.net-mvc-validation
---
...
このトピックでは、&#123;environment:ProductNameMVC&#125; エディター コントロールで構成されるフォームの最初のステップとして、フォームの作成とデータ注釈付きでフォームを検証する方法を紹介します。また、ASP.NET MVC ValidationMessage を構成し、検証テキストをさらにカスタマイズする方法も説明します。
...
-   &#123;environment:ProductNameMVC&#125; エディターおよびコンボの使用

####トピック

-	[コントロールを MVC プロジェクトに追加](../../../01_General-and-Getting-Started/00_Adding IgniteUI Controls to an MVC Project.mdx): &#123;environment:ProductName&#125; スクリプト、CSS、およびアセンブリを使用した ASP.NET MVC アプリケーションの設定の基本事項の習得

-	[igTextEditor の概要](/controls/igbulletgraph/overview) : ASP.NET MVCでの igTextEditor 使用の基本事項の習熟

-	[igNumericEditor の概要](/controls/igbulletgraph/overview): ASP.NET MVCでの igNumericEditor 使用の基本事項の習熟

-	[igCombo を使用した作業の開始](/controls/igcombo/getting-started): ASP.NET MVCでの igCombo 使用の基本事項の習熟
...
この手順では、&#123;environment:ProductNameMVC&#125; コントロールを使用した ASP.NET MVC データ注釈検証の Person モデルを作成し構成します。

### <a id="_Preview"></a>プレビュー

以下のスクリーンショットは最終結果のプレビューです。

![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_1.png)
...
以下の手順は、&#123;environment:ProductName&#125; コントロールのデータ注釈検証を構成する方法を示します。
...
1. Person クラスの追加
	...
	![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_2.png)
...
1. PersonController の作成
	...
	![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_3.png)
...
3. ビューの作成
	...
	![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_4.png)
...
6. サンプルの実行
	...
	![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_5.png)
...
6. サンプルの実行
	...
	![](../../../images/images/Configuring_ASP.NET_MVC_Data_Annotations_with_IgniteUI_for_jQuery_6.png)
...
-	[ランタイム時の igEditors の構成](/controls/igeditors/config/configuring-igeditors-at-runtime) : &#123;environment:ProductNameMVC&#125;によりコントロールが表示される方法に関する重要な情報を含め、実行時のエディターの使用の詳細について学びます。
...
-	[データ注釈の検証](&#123;environment:SamplesUrl&#125;/editors/data-annotation-validation): このサンプルは、送信ボタンが押されたときのデータ注釈検証を示します。
