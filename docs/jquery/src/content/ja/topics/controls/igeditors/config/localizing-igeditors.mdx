...
コントロールのローカライズ リソースは、ブルガリア語、ロシア語、日本語、ドイツ語、スペイン語、フランス語です。これらは、js/modules/i18n (js は、&#123;environment:ProductName&#125; プログラムのインストール パス内の JavaScript ファイルのルート フォルダー) にあります。ローカライズ リソースの詳細については、[&#123;environment:ProductName&#125; コントロールのローカライズのカスタマイズ](/general-and-getting-started/customizing-the-localization-of-igniteui-for-jquery-controls)をご覧ください。
...
-   [&#123;environment:ProductName&#125; コントロールのローカライズのカスタマイズ](/general-and-getting-started/customizing-the-localization-of-igniteui-for-jquery-controls)
