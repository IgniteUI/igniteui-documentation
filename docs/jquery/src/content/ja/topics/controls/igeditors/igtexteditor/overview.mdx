...
4.  前述のセットアップ完了後、テキスト エディターを初期化し、[`width`](&#123;environment:jQueryApiUrl&#125;/ui.igTextEditor#options:width)、[`placeHolder`](&#123;environment:jQueryApiUrl&#125;/ui.igTextEditor#options:placeHolder) などの必要なオプションを設定します。 
