...
イベント|説明
---|---
<ApiLink type="igpopover" member="showing" section="events" label="showing" />|ポップオーバーを表示する前に発生します。
<ApiLink type="igpopover" member="shown" section="events" label="shown" />|ポップオーバーを表示した後に発生します。
<ApiLink type="igpopover" member="hiding" section="events" label="hiding" />|ポップオーバーを非表示にする前に発生します。
<ApiLink type="igpopover" member="hidden" section="events" label="hidden" />|ポップオーバーを非表示にした後に発生します。
...
例|説明
---|---
[jQuery における初期化時のイベント処理](#jquery-handling)|この例は、初期化時に <ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントにイベント処理関数を割り当てます。
[ASP.NET MVC での実行時のイベント処理](#mvc-handling)|この例は、実行時に <ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントにイベント ハンドラーを割り当てます。
[イベントのハンドラーでの igPopover のコンテンツの変更](#modify-content)|この例は、<ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントのハンドラーを使用して igPopover のコンテナーのコンテンツを変更する方法を紹介します。
[イベントのハンドラーでの igPopover の配置の変更](#re-positioning-igPopover)|この例は、実行時に <ApiLink type="igpopover" member="shown" section="events" label="shown" /> イベントを使用して、ポップオーバー コンテナーの位置を変更する方法を紹介します。


## コード例: jQuery での初期化時の showing イベントの処理
### 説明

この例は、初期化時に <ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントにイベント処理関数を割り当てます。
...
この例は、実行時に <ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントにイベント ハンドラーを割り当てます。
...
この例は、<ApiLink type="igpopover" member="showing" section="events" label="showing" /> イベントのハンドラーを使用して `igPopover` のコンテナーのコンテンツを変更する方法を紹介します。
...
この例は、実行時に <ApiLink type="igpopover" member="shown" section="events" label="shown" /> イベントを使用して、ポップオーバー コンテナーの位置を変更する方法を紹介します。
