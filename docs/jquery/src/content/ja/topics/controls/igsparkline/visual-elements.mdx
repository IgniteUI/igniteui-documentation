...
このトピックは、[`igSparkline`](&#123;environment:jQueryApiUrl&#125;/ui.igSparkline.html)™ 視覚要素を説明する概要と画像を提供します。
...
- [jQuery と MVC API リンク (igSparkline)](/controls/igsparkline/jquery-and-aspnet-mvc-api): `igSparkline` は、ASP.NET MVC ヘルパーが付属する jQuery UI ウィジェットとして構築されます。各 API の詳細については、以下の API マニュアルへのリンクを参照してください。
