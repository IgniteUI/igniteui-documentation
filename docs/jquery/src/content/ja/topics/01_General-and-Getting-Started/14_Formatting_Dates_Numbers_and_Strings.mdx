...
`infragistics.util` ファイルは、%%ProductName%% コントロールで日付、数値、文字列を書式設定するための `$.ig.formatter` のユーティリティ関数を含みます。たとえば、igGrid の [format](%%jQueryApiUrl%%/ui.iggrid#options:columns.format) オプションで使用されます。
