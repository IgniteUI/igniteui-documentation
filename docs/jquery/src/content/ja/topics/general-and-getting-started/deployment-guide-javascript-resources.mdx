...
JavaScript ファイルは、Infragistics CDN 上のホスト環境でも使用可能です。CDN を使用する利点の詳細は、「[Infragistics コンテンツ配信ネットワーク (CDN)](/general-and-getting-started/deployment-guide-infragistics-content-delivery-networkcdn).mdx)」のトピックを参照してください。
...
- [&#123;environment:ProductName&#125; の JavaScript ファイル](/general-and-getting-started/deployment-guide-javascript-files): このトピックは、&#123;environment:ProductName&#125;™ に含まれるコントロールを使用して作業するために必要な JavaScript ファイルへの参照です。

- [Infragistics Loader の使用](/general-and-getting-started/using-infragistics-loader): このトピックでは、Infragistics Loader を使用して &#123;environment:ProductName&#125; を使用して作業するために必要なリソースを管理する方法について説明します。 

- [&#123;environment:ProductName&#125; のスタイル設定とテーマ設定](/general-and-getting-started/styling-and-theming/deployment-guide-styling-and-theming): アプリケーションの設計時間の設定に関する指示、生産で CSS を使用するためのオプション、およびテーマの作成またはカスタマイズに関する概要です。

- [&#123;environment:ProductName&#125; 対応 Infragistics コンテンツ配信ネットワーク (CDN)](/general-and-getting-started/deployment-guide-infragistics-content-delivery-networkcdn).mdx): &#123;environment:ProductName&#125; 対応 Infragistics Content Delivery Network (CDN) の使用方法。
