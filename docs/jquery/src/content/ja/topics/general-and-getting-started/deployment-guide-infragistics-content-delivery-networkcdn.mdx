...
## 標準 HTML ページの CDN サポートを有効にする


#### 標準 HTML ページの CDN サポートを有効にする - 概要
...
#### CDN ホスト JavaScript および CSS ファイルを静的に参照する
...
#### ローダーを使用して CDN ホスト JavaScript および CSS ファイルを参照する
...
## ASP.NET MVC の CDN サポートを有効にする


#### ASP.NET MVC の CDN サポートを有効にする - 概要
...
#### CDN ホスト JavaScript ファイルを静的に参照する
