...
#### 関連トピック
-   [カスタム並べ替えダイアログ](/controls/igspreadsheet/igspreadsheet-overview/sort-dialog)
...
#### 関連トピック
-   [カテゴリ ハイライト レイヤー](/controls/igcategorychart/annotations-and-interactions/category-highlight-layer) 
-   [項目ハイライト レイヤー](/controls/igcategorychart/annotations-and-interactions/item-highlight-layer)
...
#### 関連トピック
-   [コールアウト レイヤー](/controls/igcategorychart/annotations-and-interactions/callouts-layer) 
...
#### 関連トピック
-   [十字線レイヤー](/controls/igcategorychart/annotations-and-interactions/crosshairs-layer) 
...
#### 関連トピック
-   [最終値レイヤー](/controls/igcategorychart/annotations-and-interactions/final-value-layer) 
...
#### 関連トピック
-   [カテゴリ ツールチップ レイヤー](/controls/igcategorychart/annotations-and-interactions/category-tooltip-layer)
-   [項目ツールチップ レイヤー](/controls/igcategorychart/annotations-and-interactions/item-tooltip-layer)
