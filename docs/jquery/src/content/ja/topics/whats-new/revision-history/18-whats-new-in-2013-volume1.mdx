...
<table class="table table-bordered">
	...
	<tbody>
        <tr>
            <td>igCombo™</td>
            <td>[Knockout のサポート](/controls/igcombo/configuring/knockoutjs-support)</td>
        ...
        <tr>
            ...
            <td>`igPivotDataSelector` は、データが [igPivotGrid](/controls/igpivotgrid/igpivotgrid)™ で可視化されている場合にユーザーがデータ スライスを選択できるインタラクティブな UI コントロール (jQuery UI ウィジェット) です。</td>
</tr>
...
[Knockout サポートの構成 (igCombo)](/controls/igcombo/configuring/knockoutjs-support)
...
[igFunnelChart の概要](/controls/igfunnelchart/overview)
...
[列移動の概要 (igGrid)](/controls/iggrid/features/columns/moving/columnmoving-overview)
...
[**レスポンス Web デザイン (RWD) モードの概要 (igGrid)**](/controls/iggrid/features/responsive/responsive-web-design-mode-overview)
...
[**グリッド Knockoutjs の結合**](/controls/iggrid/features/configuring-knockout-support)
...
`igOlapFlatDataSource` コンポーネントは、フラットなデータ コレクション上で多次元の (OLAP のような) 解析を実施できます。データ収集または [igDataSource](/data-sources/igdatasource/igdatasource)™ インスタンスが与えられユーザー構成に基づく場合、`igOlapFlatDataSource` は階層およびメジャーの分析コードを作成するため必要なメタデータを抽出します。

#### 関連トピック

[igOlapFlatDataSource の概要](/data-sources/olap/flat/igolapflatdatasource-overview)
...
[igOlapXmlaDataSource の概要](/data-sources/olap/xmla/igolapxmladatasource-overview)
...
[igSparkline の概要](/controls/igsparkline/overview)
...
[igSplitter の概要](/controls/igsplitter/overview)
...
[Knockout サポートの構成 (igTree)](/controls/igtree/knockoutjs-support)
...
- [列移動の概要 (igGrid)](/controls/iggrid/features/columns/moving/columnmoving-overview): このトピックでは、`igGrid`™ コントロールの列移動機能およびこの機能が提供する機能性について概念的に説明します。
...
- [レスポンス Web デザイン (RWD) モードの概要 (igGrid)](/controls/iggrid/features/responsive/responsive-web-design-mode-overview): このトピックは、`igGrid`™ コントロールの レスポンス Web デザイン (RWD) モード機能およびこの機能が提供する機能について概念的に説明します。

- [igOlapFlatDataSource の概要](/data-sources/olap/flat/igolapflatdatasource-overview): このトピックは、`igFlatDataSource`™ コンポーネントおよびその機能の概要を説明します。

- [igOlapXmlaDataSource の概要](/data-sources/olap/xmla/igolapxmladatasource-overview): このトピックは、`igXmlaDataSource`™ コンポーネントおよびその機能の概要を説明します。

- [igPivotDataSelector の概要](/controls/igpivotdataselector/overview): このトピックは、主要機能、最小要件、ユーザー機能性など、`igPivotDataSelector`™ コントロールに関する概念的な情報を提供します。

- [igPivotGrid の概要](/controls/igpivotgrid/overview): このトピックは、主要機能、最小要件、ユーザー機能性など、`igPivotGrid`™ コントロールに関する概念的な情報を提供します。

- [igPivotView 概要](/controls/igpivotview/overview): このトピックは、主要機能、最小要件、ユーザー機能性など、`igPivotView`™ コントロールに関する概念的な情報を提供します。

- [igSparkline の概要](/controls/igsparkline/overview): このトピックでは、`igSparkline`™ コントロール、そのメリットおよびサポートされるチャート タイプの概要を示します。

- [igSplitter の概要](/controls/igsplitter/overview): このトピックでは、機能、ユーザー機能性など、`igSplitter`™ コントロールに関する概念的な情報を提供します。

- [Knockout サポートの構成 (igTree)](/controls/igtree/knockoutjs-support): このトピックは、Knockout ライブラリにより管理される View-Model オブジェクトをバインドするために `igTree`™ コントロールを構成する方法について説明します。
