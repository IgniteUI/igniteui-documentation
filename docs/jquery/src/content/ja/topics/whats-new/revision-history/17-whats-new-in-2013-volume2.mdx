...
-   [**チャートのタイトル / サブタイトルの構成 (igDataChart)**](/controls/igdatachart/configuring/chart-titles-and-subtitles)
...
-   [**軸のタイトルの構成 (igDataChart)**](/controls/igdatachart/configuring/axis-title)
...
-   [シリーズの強調表示の構成 (igDataChart)](/controls/igdatachart/configuring/series-highlighting)

#### 関連サンプル

-   [シリーズの強調表示](/controls/igdatachart/configuring/series-highlighting#series-highlighting-examples)
...
-   [トランジション イン アニメーション](/controls/igdatachart/configuring/igchart-transitions-in-animations)

#### 関連サンプル

-   [トランジション アニメーション](&#123;environment:SamplesUrl&#125;/data-chart/transition-animation)
-   [トランジション アニメーション (財務)](/controls/igdatachart/configuring/igchart-transitions-in-animations#transition-example)
...
-   [設定可能なビジュアル要素](/controls/igdatachart/overview/visual-elements)
...
-   [データのビジュアル化でのグラデーション カラーの使用](/general-and-getting-started/styling-and-theming/using-gradient-colors-in-data-visualizations)
...
-   [シリーズのツールチップ](/controls/igdatachart/overview/visual-elements#samples)
...
-   [チャート シリーズのスタイル設定 (igDataChart)](/controls/igdatachart/styling/styling-the-chart-series)
...
-   [**Knockout サポートの構成 (igDataChart)**](/controls/igdatachart/configuring/knockoutjs-support)
...
-   [**列固定の概要 (igGrid)**](/controls/iggrid/features/columns/fixing/columnfixing-overview)
...
-   [**jsRender の統合 (igGrid)**](/controls/iggrid/features/jsrender-integration)
...
-   [**垂直柱レンダリングの構成 (RWD モード、igGrid)**](/controls/iggrid/features/responsive/configure/responsive-web-design-mode-configuring-vertical-column-rendering)
...
-   [igLayoutManager](/controls/iglayoutmanager/landing-page)
...
-   [**地理高密度散布シリーズの構成 (igMap)**](/controls/igmap/configuring/series/using-geographic-high-density-scatter-series)
...
-   [igTileManager](/controls/igtilemanager/landing-page)
...
-   [igZoombar](/controls/igzoombar/landingpage)
