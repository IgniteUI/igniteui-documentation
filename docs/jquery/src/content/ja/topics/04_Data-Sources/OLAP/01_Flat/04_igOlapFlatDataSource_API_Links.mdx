...
以下の表は、`igOlapFlatDataSource`™ コンポーネントの API 参照ドキュメントのリンクの一覧です。(この参照コンテンツは、コントロールの開発者ガイドの他、[こちら](igOlapFlatDataSource.html)で使用できます。)
...
- [igOlapFlatDataSource の追加](igOlapFlatDataSource-Adding.html): これは、`igOlapFlatDataSource`™ コンポーネントを HTML ページと ASP.NET MVC アプリケーションへ追加する方法を示すトピックのグループです。
