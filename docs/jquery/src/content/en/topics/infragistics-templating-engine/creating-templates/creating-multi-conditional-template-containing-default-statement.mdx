---
title: "Creating a Multi-Conditional Template Containing a Default Statement (igTemplating)"
...
For details, refer to the [Adding igTemplating References](/adding-igtemplating-references.mdx) topic.
