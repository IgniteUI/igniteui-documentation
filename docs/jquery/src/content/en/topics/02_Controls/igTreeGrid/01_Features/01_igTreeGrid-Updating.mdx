...
-   [**Updating UI**](#ui)
    -   [Mouse UI](#mouse)
    -   [Touch UI](#touch)
-  [**Adding igTreeGrid with Updating feature configured using the %%ProductFamilyName%% CLI**](#adding-using-CLI)
...
## <a id="adding-using-CLI"></a> Adding igTreeGrid with Updating feature configured using the %%ProductFamilyName%% CLI

The easiest way to add a new  igTreeGrid with Updating feature configured to your application is via the %%ProductFamilyName%% CLI. 

To install the %%ProductFamilyName%% CLI:
```
npm install -g igniteui-cli
```
Once the %%ProductFamilyName%% CLI is installed the commands for generating an %%ProductName%% project, adding a new  igTreeGrid with Updating feature configured, building and serving the project are as following:
```
ig new <project name>
cd <project name>
