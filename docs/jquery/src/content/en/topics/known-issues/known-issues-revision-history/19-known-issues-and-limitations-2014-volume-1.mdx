...
| Grid and its columns widths are mandatory and should be defined in pixels units | Grid and its columns (either explicitly or using the [defaultColumnWidth](&#123;environment:jQueryApiUrl&#125;/ui.iggrid#options:defaultColumnWidth) option) widths are mandatory and should be defined in pixels units. |  |
