---
title: "Known Issues and Limitations in 2012 Volume 2"
...
[Using Document Engines from Infragistics ASP.NET and &#123;environment:ProductName&#125; together workaround](#document-engines-workaround) | Using both the Infragistics ASP.NET and &#123;environment:ProductName&#125; documents assemblies together will cause namespace conflict exceptions. | ![](../../images/images/positive.png)
...
## Cannot use formulae for grid unbound columns when the MergeUnboundColumns option is set to true
...
## Cannot use row template in igGrid /igHirerarchcalGrid to set attributes to table rows
...
- [*igCombo* Known Limitations](//controls/igcombo/known-limitations.mdx): This topic provides information about the known issues specific to the `igCombo`™ control.
...
- [*igTree* Known Limitations](//controls/igtree/known-limitations.mdx): This topic provides information about the known issues specific to the `igTree`™ control.
...
- [Known Issues and Limitations (igCombo)](//controls/igcombo/known-limitations.mdx): This topic lists all known issues and limitations in the `igCombo`™ control.
