---
title: "Known Issues and Limitations in 2012 Volume 1"
...
## Changing locale dynamically for igEditor is not possible with the igLoader solution
...
## JavaScript and CSS resources renamed and restructured
...
## Screen taps misinterpreted on Android 4.* devices for grid group-by modal dialog solution
...
## MVC helper configuration for flat grids solution
...
## Cell selection in iOS does not work properly
...
## MVC Loader does not function properly in an MVC Razor layout view solution
...
- [igDataChart Known Issues](//controls/igdatachart/known-issues.mdx): This topic provides information about the known issues specific to the `igDataChart`™ control.
