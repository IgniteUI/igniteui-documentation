---
title: "Known Issues and Limitations in 2018 Volume 1"
...
This summarizes the known issues and limitations of the &#123;environment:ProductName&#125;™ 2018 Volume 1 release. Information about previous releases can be found [here](/known-issues-revision-history.mdx).
...
| The DataChart does not align items of multiple data sources when plotting series with CategoryDateTimeXAxis or TimeXAxis. | Developers should align data items by inserting null items where one data source that does not have corresponding items with another data source. |  |
