...
This topic shows you how to add a hyperlink to a cell in a Microsoft® Excel™ file using the [`WorksheetCell`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetCell "Link to the API Reference Guide to the worksheetCell member.") object’s [applyFormula](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetCell#methods:applyFormula "Link to the API Reference Guide to the applyFormula member.") function. The following code creates an Excel file with a hyperlink in cell 0 of the worksheet by using the Microsoft Excel `HYPERLINK` formula.
