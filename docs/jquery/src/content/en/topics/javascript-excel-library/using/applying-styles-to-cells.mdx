---
title: "Applying Styles to Cells"
...
Most styles can be applied by setting properties on the `cellFormat` property of [`WorksheetCell`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetCell "Link to the API Reference Guide to the worksheetCell member.") , [`WorksheetRow`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetRow "Link to the Web API Reference Guide to the WorksheetRow member.") , [`WorksheetColumn`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetColumn "Link to the Web API Reference Guide to the WorksheetColumn member.") , and [`WorksheetMergedCellsRegion`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetMergedCellsRegion "Link to the Web API Reference Guide to the WorksheetMergedCellsRegion member.") .
...
![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Applying_Styles_to_Cells_01.png)
