...
Most styles can be applied by setting properties on the `cellFormat` property of <ApiLink pkg="ig" type="excel.WorksheetCell" label="WorksheetCell" /> , <ApiLink pkg="ig" type="excel.WorksheetRow" label="WorksheetRow" /> , <ApiLink pkg="ig" type="excel.WorksheetColumn" label="WorksheetColumn" /> , and <ApiLink pkg="ig" type="excel.WorksheetMergedCellsRegion" label="WorksheetMergedCellsRegion" /> .
