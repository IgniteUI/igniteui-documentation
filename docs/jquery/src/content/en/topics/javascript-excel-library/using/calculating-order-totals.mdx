...
```
	...
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Calculating_Order_Totals_01.png)
...
```
	...
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Calculating_Order_Totals_02.png)
...
```
	...
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Calculating_Order_Totals_03.png)
