...
In addition to resizing individual rows and columns, you can resize all rows and columns by setting the Worksheet's <ApiLink pkg="ig" type="excel.Worksheet" member="defaultRowHeight" section="methods" label="defaultRowHeight" /> and  <ApiLink pkg="ig" type="excel.Worksheet" member="defaultColumnHeight" section="methods" label="defaultColumnWidth" /> properties.
