...
In addition to resizing individual rows and columns, you can resize all rows and columns by setting the Worksheet's [`defaultRowHeight`](&#123;environment:jQueryApiUrl&#125;/ig.excel.Worksheet#methods:defaultRowHeight "Link to the Web API Reference Guide to the DefaultRowHeight member et class.") and  [`defaultColumnWidth`](&#123;environment:jQueryApiUrl&#125;/ig.excel.Worksheet#methods:defaultColumnHeight "Link to the Web API Reference Guide to the DefaultColumnWidth member .") properties.
...
```
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_01.png)
...
```
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_02.png)
...
```
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_03.png)
...
```
		![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_04.png)
...
```
	![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_05.png)
...
```
		...
		![Displays the results of using the code listed above.](../../asp-net-mvc/excel-engine/using/images/ExcelEngine_Resizing_Rows_and_Columns_06.png)
