---
title: "Getting the Value of a Formula from an Excel File"
...
In order to get the evaluated value of an Excel Cell that is represented by a Formula, you simply access the <ApiLink pkg="ig" type="excel.WorksheetCell" member="value" section="methods" label="value" /> property of the <ApiLink pkg="ig" type="excel.WorksheetCell" label="WorksheetCell" />.
