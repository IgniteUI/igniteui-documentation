...
In order to get the evaluated value of an Excel Cell that is represented by a Formula, you simply access the [`value`](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetCell#methods:value "Link to the API Reference Guide to the value member.") property of the [WorksheetCell](&#123;environment:jQueryApiUrl&#125;/ig.excel.WorksheetCell "Link to the API Reference Guide to the worksheetcell member.").
