---
title: "JavaScript Excel Library Overview"
...
To use the Excel library, you must reference the following JavaScript files from the &#123;environment:ProductName&#125; product, which are the minimum required:
