---
title: "Performing Data Transformations Using DataSchema (igDataSource)"
...
-   [Binding to XML](/igdatasource-binding-to-xml.mdx)
-   [Binding to HTML Table](/igdatasource-binding-to-html-table-data.mdx)
