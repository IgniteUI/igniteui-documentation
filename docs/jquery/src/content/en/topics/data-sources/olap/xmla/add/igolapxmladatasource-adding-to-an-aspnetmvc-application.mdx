---
title: "Adding igOlapXmlaDataSource to an ASP.NET MVC Application"
...
- [**igOlapXmlaDataSource Overview**](/igolapxmladatasource-overview.mdx): This topic provides conceptual information about the `igOlapXmlaDataSource` component including its main features, minimum requirements, and user functionality.

- [**Adding igOlapXmlaDataSource to an HTML Page**](/igolapxmladatasource-adding-to-an-html-page.mdx): This topic explains, in both conceptual and step-by-step form, how to add the `igOlapXmlaDataSource` component to an HTML page.
...
## Adding igOlapXmlaDataSource to an ASP.NET MVC Application – Conceptual Overview
...
-   The required JavaScript files added to your application (For the complete listing, refer to [**Adding igOlapXmlaDataSource to an HTML Page**](/igolapxmladatasource-adding-to-an-html-page.mdx).)
