---
title: "Configuring igOlapXmlaDataSource Through a Remote Provider"
...
- [Data Provider Configuration Overview (igOlapXmlaDataSource)](/igolapxmladatasource-data-provider-configuration-overview.mdx): This topic provides an overview of the supported data providers for the `igOlapXmlaDataSource` component and conceptual-level information on how to configure them.
...
For conceptual explanation of configuring remote data providers, refer to [Data Provider Configuration Overview (igOlapXmlaDataSource)](/igolapxmladatasource-data-provider-configuration-overview.mdx)


## Configuring a Remote Data Provider – Conceptual Overview
### Remote data provider configuration summary
...
## Configuring a Remote Data Provider – Example
### Introduction
...
2. Configure `igOlapXmlaDataSource`.
	...
	For `igOlapXmlaDataSource` to work with the remote data provider, set the <ApiLink pkg="ig" type="OlapXmlaDataSource" member="serverUrl" section="options" label="serverUrl" /> to the URL of the action defined in step 1 and set the <ApiLink pkg="ig" type="OlapXmlaDataSource" member="isRemote" section="options" label="isRemote" /> option to true.
