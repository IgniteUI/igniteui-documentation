...
2. Configure `igOlapXmlaDataSource`.
	...
	For `igOlapXmlaDataSource` to work with the remote data provider, set the [serverUrl](&#123;environment:jQueryApiUrl&#125;/ig.OlapXmlaDataSource#options:serverUrl) to the URL of the action defined in step 1 and set the [isRemote](&#123;environment:jQueryApiUrl&#125;/ig.OlapXmlaDataSource#options:isRemote) option to true.
