...
To specify the initial hierarchies and/or measures, you need to set the respective properties to the unique names of the hierarchies (= the [uniqueName](&#123;environment:jQueryApiUrl&#125;/ig.Hierarchy#methods:uniqueName) property values).The syntax requirements are:
...
<table class="table table-bordered">
	...
	<tbody>
        <tr>
            ...
            <td>[columns](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#options:columns)</td>
        ...
        <tr>
            ...
            <td>[rows](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#options:rows)</td>
</tr>

        <tr>
            <td>Set the filter hierarchies</td>
            <td>[filters](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#options:filters)</td>
</tr>

        <tr>
            <td>Set the measures</td>
            <td>[measures](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#options:measures)</td>
</tr>
    </tbody>
</table>
...
---|---
Add an item to columns, rows, filters, or measures|[addColumnItem(item) or insertColumnItem(index, item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [addRowItem(item) or insertRowItem(index, item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [addFilterItem(item) or insertFilterItem(index, item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [addMeasureItem(item) or insertMeasureItem(index, item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods)
Remove an item from columns, rows, filters, or measures|[removeColumnItem(item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [removeRowItem(item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [removeFilterItem(item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods) <br/> [removeMeasureItem(item)](&#123;environment:jQueryApiUrl&#125;/ig.OlapFlatDataSource#methods)
