...
Syntax for using &#123;environment:ProductName&#125; controls in TypeScript application is the same as you write vanilla JavaScript application. This means that you can refer to the [&#123;environment:ProductName&#125; API documentation](&#123;environment:jQueryApiUrl&#125;) for code snippets reference.

## <a id="creating-app"></a>Creating TypeScript App with &#123;environment:ProductName&#125;
