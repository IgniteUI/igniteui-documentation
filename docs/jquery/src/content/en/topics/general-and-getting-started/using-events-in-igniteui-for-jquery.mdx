...
### Binding to events on initialization
...
## Binding to events after initialization
...
-   <ApiLink type="iggrid" label="igGrid Events" />
-   <ApiLink type="igcurrencyeditor" label="igCurrencyEditor Events" />
-   <ApiLink type="igdateeditor" label="igDateEditor Events" />
-   <ApiLink type="igeditor" label="igEditor Events" />
-   <ApiLink type="igmaskeditor" label="igMaskEditor Events" />
-   <ApiLink type="ignumericeditor" label="igNumericEditor Events" />
-   <ApiLink type="igpercenteditor" label="igPercentEditor Events" />
-   <ApiLink type="igtexteditor" label="igTextEditor Events" />
-   <ApiLink type="igcombo" label="igCombo Events" />
-   <ApiLink type="igdatepicker" label="igDatePicker Events" />
-   <ApiLink type="igrating" label="igRating Events" />
-   [igTree Events](/controls/igtree/event-reference.mdx)
-   <ApiLink type="igupload" label="igUpload Events" />
-   <ApiLink type="igvideoplayer" label="igVideoPlayer Events" />
