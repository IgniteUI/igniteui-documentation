---
title: "Using Events in &#123;environment:ProductName&#125;"
slug: using-events-in-igniteui-for-jquery
---

# Using Events in &#123;environment:ProductName&#125;
...
This topic demonstrates how to handle events raised by &#123;environment:ProductName&#125;™ controls. Also included is an explanation of the differences between binding events on initialization and after initialization.
...
-   The required scripts for both jQuery and MVC approach are the same because the MVC wrappers render similar JavaScript as the jQuery widget. You will need:
	...
	3.  The required &#123;environment:ProductName&#125; script files for the widgets used on your page
...
>**Note:** The &#123;environment:ProductName&#125; API documentation includes a full list of each control's available options, methods and events.
...
-   [Configuring igEditors at Runtime](/controls/igeditors/config/configuring-igeditors-at-runtime.mdx)
-   [igGrid Events](&#123;environment:jQueryApiUrl&#125;/ui.iggrid#events)
-   [igCurrencyEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igcurrencyeditor#events)
-   [igDateEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igdateeditor#events)
-   [igEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igeditor#events)
-   [igMaskEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igmaskeditor#events)
-   [igNumericEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.ignumericeditor#events)
-   [igPercentEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igpercenteditor#events)
-   [igTextEditor Events](&#123;environment:jQueryApiUrl&#125;/ui.igtexteditor#events)
-   [igCombo Events](&#123;environment:jQueryApiUrl&#125;/ui.igcombo#events)
-   [igDatePicker Events](&#123;environment:jQueryApiUrl&#125;/ui.igdatepicker#events)
-   [igRating Events](&#123;environment:jQueryApiUrl&#125;/ui.igrating#events)
-   [igTree Events](/controls/igtree/event-reference.mdx)
-   [igUpload Events](&#123;environment:jQueryApiUrl&#125;/ui.igupload#events)
-   [igVideoPlayer Events](&#123;environment:jQueryApiUrl&#125;/ui.igvideoplayer#events)
...
-   [Tree API and Events](../02_Controls/igTree/15_igTree_Event_Reference.mdx#attaching-handlers-jquery)
