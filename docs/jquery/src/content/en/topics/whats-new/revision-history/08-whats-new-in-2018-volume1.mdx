...
### Support for creating, saving, and loading conditional formats
...
#### Related Topic
-   [Excel Engine Conditional Formatting](../../09_JavaScript Excel Library/01_Using/JavaScript_Excel_Library_Conditional_Formatting.mdx)

### Worksheet Level Filtering and Sorting
...
### Spreadsheet Worksheet Level Sorting
...
#### Related Topic
- [Conditional Formatting](//controls/igspreadsheet/conditional-formatting.mdx)
...
#### Related Topic
- [igTimePicker Overview](//controls/igeditors/igtimepicker/overview.mdx)

## igUpload

### Use Single Request to Upload Multiple Files

The <ApiLink type="igupload" member="useSingleRequest" section="options" label="useSingleRequest" /> option is used to configure the multiple files upload process.
