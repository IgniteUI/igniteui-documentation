---
title: "What's New in 2018 Volume 2"
...
#### Related Topic
-   [Adding a Chart to a Worksheet](../../09_JavaScript Excel Library/01_Using/JavaScript_Excel_Library_Worksheet_Charts.mdx)
...
#### Related Topic
-   [Working with Sparklines](../../09_JavaScript Excel Library/01_Using/JavaScript_Excel_Library_Adding_a_Sparkline_to_an_excel_worksheet.mdx)
...
#### Related Topics
-   [Category Highlight Layer](//controls/igcategorychart/annotations-and-interactions/category-highlight-layer.mdx) 
-   [Item Highlight Layer](//controls/igcategorychart/annotations-and-interactions/item-highlight-layer.mdx)
...
#### Related Topic
-   [Callouts Layer](//controls/igcategorychart/annotations-and-interactions/callouts-layer.mdx) 
...
#### Related Topic
-   [Crosshairs Layer](//controls/igcategorychart/annotations-and-interactions/crosshairs-layer.mdx) 
...
#### Related Topic
-   [Final Value Layer](//controls/igcategorychart/annotations-and-interactions/final-value-layer.mdx) 
...
#### Related Topics
-   [Category ToolTip Layer](//controls/igcategorychart/annotations-and-interactions/category-tooltip-layer.mdx)
-   [Item ToolTip Layer](//controls/igcategorychart/annotations-and-interactions/item-tooltip-layer.mdx)
...
#### Related Topic
-   [Callouts Layer](../../02_Controls/igDataChart/04_Configuring/04_Hover Interactions/06_HoverInteractions_Callout_Layer.mdx) 
...
#### Related Topic
-   [Crosshair Layer](../../02_Controls/igDataChart/04_Configuring/04_Hover Interactions/03_HoverInteractions_Crosshair_Layer.mdx) 
...
#### Related Topic
-   [Final Value Layer](../../02_Controls/igDataChart/04_Configuring/04_Hover Interactions/05_HoverInteractions_Final_Value_Layer.mdx) 