...
A new property – [persist](&#123;environment:jQueryApiUrl&#125;/ui.iggridsorting#options) – has been added to those features. Feature state persistence is enabled by default.
