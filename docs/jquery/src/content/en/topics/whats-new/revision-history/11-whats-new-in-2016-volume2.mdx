...
#### Related Topic:
-   [igCategoryChart Overview](//controls/igcategorychart/categorychart-overview.mdx)
...
### <a id="ignite-ui-nuget-packages"></a>\{environment:ProductName\} NuGet packages
...
#### Related Topic:
- [Series Types](//controls/igdatachart/overview/series-types.mdx)
...
You can now specify the color of the labels depending on whether they are rendered inside or outside of the funnel chart using the <ApiLink type="igfunnelchart" member="textColor" section="options" label="textColor" /> and <ApiLink type="igfunnelchart" member="outerLabelTextColor" section="options" label="outerLabelTextColor" /> options. You can also style the text of both the inner and outer labels using the <ApiLink type="igfunnelchart" member="textStyle" section="options" label="textStyle" />   and <ApiLink type="igfunnelchart" member="outerLabelTextStyle" section="options" label="outerLabelTextStyle" /> options. 
...
Also two new API methods are added to <ApiLink type="iggridgroupby" member="expand" section="methods" label="expand" /> and <ApiLink type="iggridgroupby" member="collapse" section="methods" label="collapse" /> group rows.
...
Updating feature now works in row and cell edit mode when Multi-Row Layout is configured. Use <ApiLink type="iggrid" member="columns.navigationIndex" section="options" label="navigationIndex" /> option to configure the tab order of the editors when in edit mode.
...
You can now select a pie slice on the igPieChart control. This feature is enabled by default. You can set the <ApiLink type="igPieChart" member="selectionMode" section="options" label="selectionMode" /> option in order to support single or multiple slice selection and then check the <ApiLink type="igPieChart" member="selectedItem" section="options" label="selectedItem" />  or <ApiLink type="igPieChart" member="selectedItems" section="options" label="selectedItems" /> options in order to see what data items are associated with those selected slices.
...
#### Related topics:
[igPieChart](//controls/igpiechart/igpiechart.mdx)

### <a id="pie-event"></a> New Event for the Pie Chart

The igPieChart control now has a <ApiLink type="igPieChart" member="labelClick" section="events" label="labelClick" /> that fires when the labels of the pie slices are clicked.
...
Two new options are added to the igPieChart control, these are intended to replace the existing <ApiLink type="igPieChart" member="valueMemberPath" section="options" label="valueMemberPath" />  and <ApiLink type="igPieChart" member="labelMemberPath" section="options" label="labelMemberPath" /> options. The new options are <ApiLink type="igPieChart" member="dataValue" section="options" label="dataValue" /> and <ApiLink type="igPieChart" member="dataLabel" section="options" label="dataLabel" />. With the addition of these options, <ApiLink type="igPieChart" member="valueMemberPath" section="options" label="valueMemberPath" />  and <ApiLink type="igPieChart" member="labelMemberPath" section="options" label="labelMemberPath" /> are now deprecated.
...
#### Related Topics
-   [igScroll Overview](//controls/igscroll/overview.mdx)
...
Adding <ApiLink type="igValidator" member="creditCard" section="options" label="creditCard" /> option and validation rule.
