---
title: "igSpreadsheet FormatCell Dialog"
...
To understand this topic you need to be familiar with the concept and topics related to the [Infragistics JavaScript Excel Library](../../../09_JavaScript Excel Library/~JavaScript_Excel_Library.mdx) and [igSpreadsheet](/igspreadsheet-feature-overview.mdx). 
