...
The `igSpreadsheet` control allows visualizing and editing of spreadsheet data, represented by the data model supported by the Infragistics Excel Engine comprising of <ApiLink pkg="ig" type="excel.Workbook" label="Workbooks" />, <ApiLink pkg="ig" type="excel.Worksheet" label="Worksheets" />, <ApiLink pkg="ig" type="excel.WorksheetCell" label="Cells" />, <ApiLink pkg="ig" type="excel.Formula" label="Formulas" /> and more.
