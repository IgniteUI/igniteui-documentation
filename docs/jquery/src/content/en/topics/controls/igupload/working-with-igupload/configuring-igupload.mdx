...
| --- | --- | --- |
| [File selection mode (Single/Multiple)](#config-selection-mode) | You can configure whether users, when selecting the files to upload, will be able to select multiple files or only one file at a time. | [mode](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:mode) [multipleFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:multipleFiles) |
| [Upload trigger (Manual/Auto)](#config-upload-trigger) | You can configure whether the upload will start automatically once the user has added the file(s) to the `igUpload` panel or manually (on user’s pressing the Upload button). | [autostartupload](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:autostartupload) |
| [The Allowed File Types](#config-allowed-files) | You can configure which types of files will be allowed for users to upload. | [allowedExtensions](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:allowedExtensions) |
| [Maximum number of files to upload](#max-number-files) | You can configure the maximum number of files that can be uploaded per page refresh. | [maxUploadedFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxUploadedFiles) |
| [Maximum number of simultaneously uploading files](#simultaneously-uploaded-files) | This setting configures the threshold on the number of simultaneous file uploads. | [maxSimultaneousFilesUploads](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxSimultaneousFilesUploads) |
| [Using a single request when uploading multiple files](#singleRequest) | This setting configures the control to upload multiple files using one single HTTP request. | [useSingleRequest](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:useSingleRequest) |
| [File display mode](#file-display-mode) | You can configure how many files to be displayed in the panel of the `igUpload` control. | [mode](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:mode) |
...
The file selection mode is managed by the [mode](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:mode) and [multipleFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:multipleFiles) options. Setting [multipleFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:multipleFiles) to true makes sense only when [mode](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:mode) is multiple. When [mode](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:mode) is single, [multipleFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:multipleFiles) has no effect.
...
---|---|---
Enable automatic upload|[autostartupload](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:autostartupload)|true
Disable automatic upload|[autostartupload](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:autostartupload)|false
...
Property|Value
---|---
[autostartupload](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:autostartupload)|true
...
In order to:| Use this property:| And set it to:
---|---|---
Define allowed extensions|[allowedExtensions](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:allowedExtensions)|An array of strings representing the allowed file extensions
...
Property| Value
---|---
[allowedExtensions](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:allowedExtensions)|["xls","doc"]
...
In order to:| Use this property:| And set it to:
---|---|---
Set maximum uploaded files| [maxUploadedFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxUploadedFiles)| The desired integer value
...
Property| Value
---|---
[maxUploadedFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxUploadedFiles)|2
...
the maximum number of files that can be uploading simultaneously is managed by the [maxSimultaneousFilesUploads](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxSimultaneousFilesUploads) property.
...
In order to:| Use this property:| And set it to:
---|---|---
Set the maximum number of simultaneous file uploads| [maxSimultaneousFilesUploads](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxSimultaneousFilesUploads)| The desired integer value
...
Property| Value
---|---
[maxSimultaneousFilesUploads](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxSimultaneousFilesUploads)|2
...
In order to:| Use this property:| And set it to:
---|---|---
Upload multiple files each in a separate request| [useSingleRequest](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:useSingleRequest)| false (default)
Upload multiple files each in one single request| [useSingleRequest](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:useSingleRequest)| true
...
Property| Value
---|---
[useSingleRequest](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:useSingleRequest)| true
...
The number of displayed files in Multiple Files mode cannot exceed the [maxUploadedFiles](&#123;environment:jQueryApiUrl&#125;/ui.igupload#options:maxUploadedFiles) setting.
