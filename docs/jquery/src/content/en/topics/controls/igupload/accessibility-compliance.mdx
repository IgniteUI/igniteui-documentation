---
title: "Accessibility Compliance (igUpload)"
slug: igupload-accessibility-compliance
---

# Accessibility Compliance (igUpload)

## Upload Accessibility Compliance
All of the &#123;environment:ProductName&#125;™ controls and components comply with Section 508, Subpart 1194.22 of the Rehabilitation Act of 1973. **Table 1** contains the specific rules of Subpart 1194.22 that pertain to the control. Also detailed is how the `igUpload` control complies with each rule.
