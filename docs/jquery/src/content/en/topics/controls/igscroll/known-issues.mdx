...
> **Workaround** 
> 
> The [`scrollHeight`](&#123;environment:jQueryApiUrl&#125;/ui.igscroll#options:scrollHeight)/[`scrollWidth`](&#123;environment:jQueryApiUrl&#125;/ui.igscroll#options:scrollWidth) options should be set to the related container height and width after the container is shown.
