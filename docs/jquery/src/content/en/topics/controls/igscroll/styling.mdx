...
## Styling Summary
The &#123;environment:ProductName&#125;™ Scroll (or `igScroll`), like other jQuery widgets, provides a number of CSS classes that apply to
...
> **Note**: Similar classes are used for the horizontal scrollbar. Their naming can be seen in the <ApiLink type="igscroll" label="igScroll API" />.
...
### Samples
-   [Styling static scrollbars](&#123;environment:SamplesUrl&#125;/scroll/styling-static)
-   [Styling dynamic scrollbars](&#123;environment:SamplesUrl&#125;/scroll/styling-dynamic)
