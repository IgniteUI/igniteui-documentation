...
---|---|---
[Error correction level](#error-correction-level)|A built-infunctionality of the `igQRCodeBarcode` control that enables restoring of encoded data that has become unreadable because of the barcode being damaged or dirty|<ul><li>[errorCorrectionLevel](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)</li></ul>
[Size version](#config-size-version)|Specifies the size version QR code barcode matrix in number of modules|<ul><li>[sizeVersion](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)</li></ul>
[FNC1 mode](#config-FNC1-mode)|Specifies the format of the encoded data according to a pre-defined data encoding standard|<ul><li>[fnc1Mode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)</li></ul>
[Application indicator](#config-application-indicator)|Identifies the relevant specification by AIM Inc.|<ul><li>[applicationIndicator](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)</li></ul>
...
---|---|---
7%| [errorCorrectionLevel](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|<ul><li>“low”</li></ul>
...
[errorCorrectionLevel](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:errorCorrectionLevel)|“high”
...
---|---|---
The smallest version that accommodates the data|[sizeVersion](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|<ul><li>“undefined”</li></ul>
...
Property|Value
---|---
[width](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“200px”
[height](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“200px”
[data](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“http://www.infragistics.com”
[sizeVersion](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“version7”
...
---|---|---
Specify that data is not identified as encoded according to a specific pre-defined encoding specification|[fnc1Mode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|<ul><li>“none”</li></ul>
...
[width](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“200px”
[height](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“200px”
[data](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|"(15)679356"
[fnc1Mode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options)|“gs1”
...
In order to:| Use this property:| And set it to:
---|---|---
Specify the application indicator|[applicationIndicator](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:applicationIndicator)|A string representing the AIM Inc. specification code. The allowed symbols belong to the set &#123;a - z, A - Z&#125; or represent a two-digit number, denoting the specification concerned by AIM Inc..
