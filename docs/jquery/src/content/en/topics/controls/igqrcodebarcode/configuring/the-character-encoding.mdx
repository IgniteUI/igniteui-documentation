---
title: "Configuring the Character Encoding (igQRCodeBarcode)"
...
The configuration of the encoding for `igQRCodeBarcode` is related to the ability of the control to encode the characters fed to its <ApiLink type="igQRCodeBarcode" member="data" section="options" label="data" /> property.
...
---|---|---
[The character encoding mode](#config-character-encoding)|You can specify what encoding mode to use depending on the type data that needs to be encoded.|<ul><li><ApiLink type="igQRCodeBarcode" member="encodingMode" section="options" label="encodingMode" /></li></ul>
[The character set](#config-character-set)|The `igQRCodeBarcode` control allows for encoding data from different character sets.|<ul><li><ApiLink type="igQRCodeBarcode" member="eciNumber" section="options" label="eciNumber" /></li></ul>
...
1.  The desired encoding files can be found at the following location under the \{environment:ProductName\}™ package folder structure:
...
---|---|---
Automatic recognition of the optimal encoding mode for the different sequences of data (if there are such)|<ApiLink type="igQRCodeBarcode" member="encodingMode" section="options" label="encodingMode" />|undefined
...
2.  For details on the different encoding modes, refer to the [jQuery and MVC API Links (igQRCodeBarcode)](/igqrcodebarcode-api-links.mdx) topic.
...
<ApiLink type="igQRCodeBarcode" member="data" section="options" label="data" />|“花"
<ApiLink type="igQRCodeBarcode" member="encodingMode" section="options" label="encodingMode" />|“kanji”
...
The `igQRCodeBarcode` control has a built-in support for encoding data from character sets other than the default one. This support is managed by setting the Extended Channel Interpretation (ECI) number represented by the <ApiLink type="igQRCodeBarcode" member="eciNumber" section="options" label="eciNumber" /> property.
...
---|---|---
Specify the character set|<ApiLink type="igQRCodeBarcode" member="eciNumber" section="options" label="eciNumber" />|The ECI number for the ISO character set you want to use
Encode the number of the ISO character set in the barcode|<ApiLink type="igQRCodeBarcode" member="eciHeaderDisplayMode" section="options" label="eciHeaderDisplayMode" />|show
Omit the number of the ISO character set from the barcode|<ApiLink type="igQRCodeBarcode" member="eciHeaderDisplayMode" section="options" label="eciHeaderDisplayMode" />|hide (default)


### <a id="set-example"></a>Example

Assuming that the data to be encoded is in Greek and the <ApiLink type="igQRCodeBarcode" member="eciNumber" section="options" label="eciNumber" /> to be used is 9 which corresponds to character set ISO/IEC 8859-7.
...
<ApiLink type="igQRCodeBarcode" member="width" section="options" label="width" />|“200px”
<ApiLink type="igQRCodeBarcode" member="height" section="options" label="height" />|“200px”
<ApiLink type="igQRCodeBarcode" member="data" section="options" label="data" />|“ΑΒΓΔΕ”
<ApiLink type="igQRCodeBarcode" member="eciNumber" section="options" label="eciNumber" />|9
<ApiLink type="igQRCodeBarcode" member="eciHeaderDisplayMode" section="options" label="eciHeaderDisplayMode" />|“show”
