...
The configuration of the encoding for `igQRCodeBarcode` is related to the ability of the control to encode the characters fed to its [data](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:data) property.
...
---|---|---
[The character encoding mode](#config-character-encoding)|You can specify what encoding mode to use depending on the type data that needs to be encoded.|<ul><li>[encodingMode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:encodingMode)</li></ul>
[The character set](#config-character-set)|The `igQRCodeBarcode` control allows for encoding data from different character sets.|<ul><li>[eciNumber](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciNumber)</li></ul>
...
---|---|---
Automatic recognition of the optimal encoding mode for the different sequences of data (if there are such)|[encodingMode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:encodingMode)|undefined
...
The `igQRCodeBarcode` control has a built-in support for encoding data from character sets other than the default one. This support is managed by setting the Extended Channel Interpretation (ECI) number represented by the [eciNumber](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciNumber) property.
...
---|---|---
Specify the character set|[eciNumber](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciNumber)|The ECI number for the ISO character set you want to use
Encode the number of the ISO character set in the barcode|[eciHeaderDisplayMode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciHeaderDisplayMode)|show
Omit the number of the ISO character set from the barcode|[eciHeaderDisplayMode](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciHeaderDisplayMode)|hide (default)


### <a id="set-example"></a>Example

Assuming that the data to be encoded is in Greek and the [eciNumber](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:eciNumber) to be used is 9 which corresponds to character set ISO/IEC 8859-7.
