...
---|---|---
Color of the barcode bars|You can set the color of the barcode.|<ul><li>[barBrush](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:barBrush)</li></ul>
Background color|You can specify the color of the background area behind the bars of the barcode.|<ul><li>[backingBrush](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingBrush)</li></ul>
Border thickness and color|You can customize the barcode’s border thickness and color.|<ul><li>[backingOutline](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingOutline)</li><li>[backingStrokeThickness](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingStrokeThickness)</li></ul>
...
---|---|---
Configure the background color|[backingBrush](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingBrush)|The desired color
Configure the color of the barcode bars|[barBrush](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:barBrush)|The desired color
Configure the border thickness|[backingStrokeThickness](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingStrokeThickness)|The desired value
Configure the border color|[backingOutline](&#123;environment:jQueryApiUrl&#125;/ui.igQRCodeBarcode#options:backingOutline)|The desired color
