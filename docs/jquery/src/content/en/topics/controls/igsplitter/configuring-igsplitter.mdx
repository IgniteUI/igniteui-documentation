...
| [Panels’ initial states](#config-initial-states) | The initial state of the panels is configurable. | [collapsed](&#123;environment:jQueryApiUrl&#125;/ui.igsplitter#options:collapsed) |
| [Panels’ initial sizes](#initial-size) | The panels’ initial size is configurable. | [size](&#123;environment:jQueryApiUrl&#125;/ui.igsplitter#options:size) |
| [Panels’ resizing limits](#resizing-limits) | The limits within which the splitter bar can be moved by the user are configurable. | [min](&#123;environment:jQueryApiUrl&#125;/ui.igsplitter#options:min) [max](&#123;environment:jQueryApiUrl&#125;/ui.igsplitter#options:max) |
| [Splitter bar orientation](#splitter-orientation) | The splitter bar orientation is managed through a dedicated property. | [orientation](&#123;environment:jQueryApiUrl&#125;/ui.igsplitter#options:orientation) |
