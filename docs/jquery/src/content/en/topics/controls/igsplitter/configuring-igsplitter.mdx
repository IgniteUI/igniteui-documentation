...
### igSplitter configuration summary
...
### igSplitter configuration summary chart
...
| [Panels’ initial states](#config-initial-states) | The initial state of the panels is configurable. | <ApiLink type="igsplitter" member="collapsed" section="options" label="collapsed" /> |
| [Panels’ initial sizes](#initial-size) | The panels’ initial size is configurable. | <ApiLink type="igsplitter" member="size" section="options" label="size" /> |
| [Panels’ resizing limits](#resizing-limits) | The limits within which the splitter bar can be moved by the user are configurable. | <ApiLink type="igsplitter" member="min" section="options" label="min" /> <ApiLink type="igsplitter" member="max" section="options" label="max" /> |
| [Splitter bar orientation](#splitter-orientation) | The splitter bar orientation is managed through a dedicated property. | <ApiLink type="igsplitter" member="orientation" section="options" label="orientation" /> |
| [User interaction capabilities](#user-interaction-capabilities) | Users’ interaction capabilities are configurable, meaning that you can allow or prevent users from resizing and/or expanding/collapsing the panels. | <ApiLink type="igsplitter" member="collapsible" section="options" label="collapsible" /> <ApiLink type="igsplitter" member="resizable" section="options" label="resizable" /> |
...
## Configuring the Initial States of the Panels (Collapsed/Expanded)
### Overview
...
<table class="table">
	...
	<tbody>
        <tr>
            <td rowspan="3">Set the left/top panel as collapsed and the right/bottom panel as expanded. (The property has to be set for only one of the panels.)</td>
            <td>\*\*collapsed\*\*</td>
            <td>left/top panel</td>
            <td>true</td>
</tr>
        ...
        <tr>
            <td>\*\*collapsed\*\*</td>
            <td>right/bottom panel</td>
            <td>false</td>
</tr>

        <tr>
            <td rowspan="3">Set the right/bottom panel as collapsed and the left/top panel as expanded. (The property has to be set for only one of the panels.)</td>
            <td>\*\*collapsed \*\*</td>
            <td>right/bottom panel</td>
            <td>true</td>
</tr>
...
## Configuring the Initial Size of the Panels
### Overview
...
<table class="table">
	...
	<tbody>
        <tr>
            <td rowspan="3">Set the size panels.</td>
            <td>\*\*size \*\*</td>
            <td>left/top panel</td>
            <td>The desired size of panels in pixels.</td>
</tr>
...
## Configuring the Panels’ Resizing Limits
### Overview
...
| --- | --- | --- |
| Set both resizing limits | min max | The desired value in pixels |
| Set the left/top resizing limit only | min | The desired value in pixels |
| Set the right/bottom resizing limit only | max | The desired value in pixels |
...
## Configuring the Orientation of the Splitter Bar
### Overview
...
## Configuring the User Interaction Capabilities
### Overview
...
<table class="table">
	...
	<tbody>
        <tr>
            <td rowspan="3">Disable resizing of panels.</td>
            <td>\*\*resizable\*\*</td>
            <td>left/top panel</td>
            <td>false</td>
</tr>
        ...
        <tr>
            <td rowspan="3">Enable resizing of panels.</td>
            <td>\*\*resizable\*\*</td>
            <td>left/top panel</td>
            <td>true</td>
</tr>
        ...
        <tr>
            <td rowspan="3">Enable expanding/collapsing of panels.</td>
            <td>\*\*collapsible\*\*</td>
            <td>left/top panel</td>
            <td>false</td>
</tr>
        ...
        <tr>
            <td rowspan="3">Disable expanding/collapsing of panels.</td>
            <td>\*\*collapsible\*\*</td>
            <td>left/top panel</td>
            <td>true</td>
</tr>
...
- [Handling Events (igSplitter)](/igsplitter-handling-events.mdx): The topics provide information and examples about the handling events of the `igSplitter` control.
