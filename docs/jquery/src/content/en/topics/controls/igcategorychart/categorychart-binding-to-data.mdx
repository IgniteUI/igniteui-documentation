...
### <a id="BindingJavaScriptArray"></a> Binding to a JavaScript Array
...
For detailed information on instantiation and configuration of an igCategoryChart see [Adding igCategoryChart](/igcategorychart-adding.mdx). 
...
### <a id="BindingHierarchicalJavaScriptArray"></a> Binding to a Hierarchical JavaScript Array

#### <a id="HIntroduction"></a> Introduction
This procedure demonstrates how to bind the igCategoryChart control to a “semi-nested” hierarchical JavaScript data array.

#### <a id="HPrerequisites"></a> Prerequisites
...
## <a id="relatedcontent"></a>Related Topics:
