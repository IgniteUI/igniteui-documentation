...
-	[igCategoryChart Overview](/categorychart-overview.mdx):  Conceptual information about the `igCategoryChart` control.

-	[Adding igCategoryChart](/igcategorychart-adding.mdx):  Demonstrates how to create the `igCategoryChart` control and bind it to data.
