...
As described in the [Chart Types](/categorychart-chart-types.mdx) topic the chart can render different types of chart with a simple change of a property.
...
- [Axis Gap and Overlap](/axes/categorychart-configuring-axis-gap-and-overlap.mdx)