...
--- | --- | ---
Animate *igDialog* on opening | [openAnimation](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:openAnimation) | “slide”
Animate *igDialog* on closing | [closeAnimation](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:closeAnimation) | “explode”
