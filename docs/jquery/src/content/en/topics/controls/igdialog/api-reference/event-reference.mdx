...
------|-------------|-----------
[stateChanging](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#events:stateChanging) | Event is raised before the state of dialog was changed. | True
[stateChanged](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#events:stateChanged) | Event is raised after the state of dialog was changed. | False
[animationEnded](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#events:animationEnded) | Event is raised after the end animation, when the dialog was closed or opened. | False
[focus](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#events:focus) | Event is raised when the dialog or its content gets focus. | False
[blur](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#events:blur) | Event is raised when the dialog or its content loses focus. | False
