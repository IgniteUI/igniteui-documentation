...
--- | --- | ---
Configuring modal `igDialog` | The properties that need to be configured to make an `igDialog` modal. | [modal](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:modal)
...
--- | --- | ---
Make the igDialog modal | [modal](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:modal) | true
Set the igDialog footer title | [pinned](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:pinned) | false
Set the igDialog state | [state](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#options:state) | “opened”
