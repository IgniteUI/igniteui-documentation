...
--- | --- | --- | ---
Get reference to the top modal dialog | [getTopModal()](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:getTopModal) | None | object – reference to the `igDialog`
Check if dialog is modal and it is currently active | [isTopModal()](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:isTopModal) | None | boolean
Moves not a modal dialog to the top | [moveToTop(e)](&#123;environment:jQueryApiUrl&#125;/ui.igDialog#methods:moveToTop) | *e* – browser event | object – reference to the moved `igDialog`
