...
Region|Class name
---|---
Header|<ApiLink type="iglayoutmanager" label="header" />
Footer|<ApiLink type="iglayoutmanager" label="footer" />
Left Sidebar|<ApiLink type="iglayoutmanager" label="left" />
Right Sidebar|<ApiLink type="iglayoutmanager" label="right" />
Body|<ApiLink type="iglayoutmanager" label="center" />
