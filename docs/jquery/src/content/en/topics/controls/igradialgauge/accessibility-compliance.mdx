...
slug: igradialgauge-accessibility-compliance
---
...
- [igRadialGauge](/igradialgauge.mdx): This topic provides conceptual information about the `igRadialGauge` control including its main features, minimum requirements, and user functionality.

- [Adding igRadialGauge](/igradialgauge-getting-started-with-igradialgauge.mdx): This is a group of topics demonstrating how to add the `igRadialGauge` control to an HTML page and to an ASP.NET MVC application.


## Accessibility Compliance Reference
### Introduction

All of the &#123;environment:ProductName&#125;™ controls and components comply with Section 508, Subpart 1194.22 of the Rehabilitation Act of 1973. The table below contains the specific rules of Subpart 1194.22 that pertain to the control. Also, detailed is how the `igRadialGauge` control complies with each of these rules.
