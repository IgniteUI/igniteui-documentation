---
title: "Configuring Labels (igRadialGauge)"
slug: igradialgauge-configuring-labels
---
...
<Sample src="/radial-gauge/label-settings/index.html" height={428} alt="Radial Gauge Label Settings"/>
