---
title: "Optimize the igTree’s Performance"
...
---|---|---
[Enable load-on-demand](#enable-load-on-demand) | Enabling load-on-demand instructs the tree to only create the necessary HTML elements of the tree when a node is expanded. | <ApiLink type="igTree" member="loadOnDemand" section="options" label="loadOnDemand" /> <br/>  <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" />(optional)
[Configure load-on-demand for ASP.NET MVC](#configure-load-on-demand-for-mvc) | By setting up an action method to return JSON in your ASP.NET MVC controller, new data can be fetched remotely when a node is expanded. | <ApiLink type="igTree" member="loadOnDemand" section="options" label="loadOnDemand" /> <br/> <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" />
[Configure load-on-demand for OData](#configure-load-on-demand-odata) | When supplying the `igTree` control with an OData data source, enabling load-on-demand instructs the `igTree` to make calls to the service to retrieve the next level of data. | <ApiLink type="igTree" member="loadOnDemand" section="options" label="loadOnDemand" /> <br/><ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" /> <br/><ApiLink type="igTree" member="responseDataKey" section="options" label="responseDataKey" /> <br/><ApiLink type="igTree" member="responseDataType" section="options" label="responseDataType" />


## Enable load-on-demand
### Load-on-demand details
Load-on-demand provides various performance enhancements to the behavior of the `igTree` control. By enabling load-on-demand on the client, the tree creates HTML elements on demand when necessary to display data. Nodes hidden from view initially have no HTML elements created for them. When enabling load-on-demand using <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" />, the data is retrieved on demand from the server.

### Load-on-demand configuration settings
...
---|---|---
Enable load-on-demand|<ApiLink type="igTree" member="loadOnDemand" section="options" label="loadOnDemand" />|true
 |<ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" /> | Optionally set string Url of custom action method
 
### Example: basic load-on-demand
...
In addition to the above configuration the <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" /> option can also be set
...
Those are separated by ':' where the first part is the name of the respective <ApiLink type="igTree" member="bindings" section="options" label="bindings" /> option 
...
## Configure load-on-demand for ASP.NET MVC
### Load-on-demand for ASP.NET MVC details
...
### Load-on-demand for ASP.NET MVC property settings
...
In order to… | Use this property: | And set it to…
---|---|---
Configure load-on-demand for ASP.NET MVC| <ApiLink type="igTree" member="loadOnDemand" section="options" label="loadOnDemand" /> <br/> <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" />| true <br/> string Url of custom action method

### Example: load-on-demand with ASP.NET MVC
#### Introduction
...
## Configuring load-on-demand for OData
### Load-on-demand for OData details
...
### Load-on-demand for OData property settings
...
In order to… | Use this property: | And set it to…
---|---|---
Configure load-on-demand for OData | <ApiLink type="igTree" member="dataSourceUrl" section="options" label="dataSourceUrl" /> <br/> <ApiLink type="igTree" member="responseDataKey" section="options" label="responseDataKey" /> <br/> <ApiLink type="igTree" member="responseDataType" section="options" label="responseDataType" /> <br/> <ApiLink type="igTree" label="loadOnDemand" />|string URL of OData service <br/> string data key <br/> string type “json”, “jsonp” <br/> true

### Example: load-on-demand with OData
#### Introduction
