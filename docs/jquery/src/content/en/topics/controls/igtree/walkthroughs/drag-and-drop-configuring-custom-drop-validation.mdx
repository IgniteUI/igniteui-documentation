---
title: "Configuring Custom Drop Validation (igTree)"
...
- [Drag-and-Drop Overview (igTree)](../07_Drag and Drop/00_igTree_Drag-and-Drop_Overview.mdx): This topic provides an overview the Drag-and-Drop feature of the `igTree` control.
