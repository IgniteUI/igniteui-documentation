---
title: "Adding and Removing Nodes Overview and Examples (igTree)"
...
Adding a node is done by [addNode](/igtree-adding-removing-node-method-api-reference.mdx) method.

Removing Nodes

You can remove a a node by either of the following:

-   Path – removing a node is done by [removeAt](/igtree-adding-removing-node-method-api-reference.mdx)
-   Value – removing a node is done by [removeNodesByValue](/igtree-adding-removing-node-method-api-reference.mdx)
...
- [Add and Remove Nodes Method Reference (igTree)](/igtree-adding-removing-node-method-api-reference.mdx): This topic provides a reference for the methods for adding and removing nodes in the `igTree` control.
