---
title: "Configuring the Drag-and-Drop Mode (igTree)"
...
- [Drag-and-Drop Overview (igTree)](../07_Drag and Drop/00_igTree_Drag-and-Drop_Overview.mdx): This topic provides overview the Drag-and-Drop feature of the `igTree` control, including explanation of the Drag-and-Drop modes.

- [Enabling Drag-and-Drop (igTree)](../07_Drag and Drop/01_igTree_Drag-and-Drop_Enabling.mdx): This topic explains, with code examples, how to enable the Drag-and-Drop feature in the `igTree` control.
...
The [Drag-and-Drop mode](/igtree-drag-and-drop-configuring-mode.mdx) of the `igTree` control is managed from the [dragAndDropMode](../07_Drag and Drop/04_API Reference/01_igTree_Drag-and-Drop_Property_API_Reference.mdx) property. For the specific settings, see the [Drag-and-Drop mode configuration summary chart](#config-summary-chart). Full configuration procedures are provided in the blocks following the chart.
...
In order to: | Set the [dragAndDropMode](../07_Drag and Drop/04_API Reference/01_igTree_Drag-and-Drop_Property_API_Reference.mdx) property to:
---|---
...
- [Configuring the Look of the Drag Visual Tokens (igTree)](../07_Drag and Drop/02_Configuring/00_igTree_Drag-and-Drop_Configuring_Tokens.mdx): This topic explains, with code examples, how to configure the look of the drag visual tokens the `igTree` control, in both JavaScript and MVC.

- [Drag-and-Drop API Reference (igTree)](../07_Drag and Drop/04_API Reference/~igTree_Drag-and-Drop_API_Reference.mdx): The topics in this group provide reference information about the events and properties of the `igTree` control that are related to the Drag-and-Drop feature.
