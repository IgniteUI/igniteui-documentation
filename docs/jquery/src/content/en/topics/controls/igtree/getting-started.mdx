---
title: "Getting Started with igTree"
...
```
    ...
    3.  (ASP.NET MVC) Call Render().
        ...
        When instantiating the &#123;environment:ProductNameMVC&#125; Tree, call the Render method last after all other options have been configured. This is the method that renders the HTML and JavaScript necessary to instantiate the igTree on the client
...
The code below demonstrates how to create and configure the &#123;environment:ProductNameMVC&#125; `Tree`.
