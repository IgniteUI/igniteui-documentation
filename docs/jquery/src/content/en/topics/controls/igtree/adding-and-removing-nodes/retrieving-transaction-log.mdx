---
title: "Retrieving the Transaction Log of Added and Removed Nodes (igTree)"
...
- [API Links (igTree)](/igtree-jquery-and-asp-net-mvc-helper-api-links.mdx): This topic provides links to the jQuery and MVC API of the igTree control.
