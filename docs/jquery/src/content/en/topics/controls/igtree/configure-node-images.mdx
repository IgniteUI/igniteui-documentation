...
| --- | --- | --- |
| Configure node images | Images can be configured through binding, CSS, or URL to show next to each node in the `igTree` control. | [parentNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageUrl) [parentNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageClass) [leafNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageUrl) [leafNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageClass) [imageUrlKey](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlKey) [imageUrlXPath](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlXPath) |
...
---|---|---
[Configure parent and leaf node images using a URL](#example_configure_using_url) | [parentNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageUrl)  <br/> [leafNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageUrl) | string URL <br/> string URL
[Configure parent and leaf node images using CSS](#example_configure_using_css) | [parentNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageClass)  <br/> [leafNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageClass) | string CSS class name <br/> string CSS class name
[Configure node images for individual data items through binding](#example_configure_through_binding) | [imageUrlKey](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlKey) <br/> (for XML) <br/> [imageUrlXPath](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlXPath) | string data member with URL to images <br/> string XPath to the image URL when bound to XML
...
<table class="table tale-bordered">
	...
	<tbody>
        <tr>
            <td>[parentNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageUrl)</td>
            <td>"../../Content/images/DocumentsFolder.png"</td>
            <td rowspan="2">![](images/igTree_Configure_Node_Images_Pic02.png)</td>
</tr>

        <tr>
            <td>[leafNodeImageUrl](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageUrl)</td>
...
Option | Setting
---|---
[parentNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:parentNodeImageClass) | "sprite-DocumentsFolder"
[leafNodeImageClass](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:leafNodeImageClass) | "sprite-Documents"
...
---|---|---
[imageUrlKey](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlKey) | ImageUrl|![](images/igTree_Configure_Node_Images_Pic03.png)
[imageUrlXPath](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options:bindings.imageUrlXPath)|@ImageUrl|-
...
-   [igTree Options](&#123;environment:jQueryApiUrl&#125;/ui.igTree#options)
