---
title: "Configure Node Images in igTree"
slug: igtree-configure-node-images
---
...
### Required background
You need to first read the [Getting Started with igTree](/igtree-getting-started.mdx) topic.
...
| --- | --- | --- |
| Configure node images | Images can be configured through binding, CSS, or URL to show next to each node in the `igTree` control. | <ApiLink type="igTree" member="parentNodeImageUrl" section="options" label="parentNodeImageUrl" /> <ApiLink type="igTree" member="parentNodeImageClass" section="options" label="parentNodeImageClass" /> <ApiLink type="igTree" member="leafNodeImageUrl" section="options" label="leafNodeImageUrl" /> <ApiLink type="igTree" member="leafNodeImageClass" section="options" label="leafNodeImageClass" /> <ApiLink type="igTree" member="bindings.imageUrlKey" section="options" label="imageUrlKey" /> <ApiLink type="igTree" member="bindings.imageUrlXPath" section="options" label="imageUrlXPath" /> |
...
---|---|---
[Configure parent and leaf node images using a URL](#example_configure_using_url) | <ApiLink type="igTree" member="parentNodeImageUrl" section="options" label="parentNodeImageUrl" />  <br/> <ApiLink type="igTree" member="leafNodeImageUrl" section="options" label="leafNodeImageUrl" /> | string URL <br/> string URL
[Configure parent and leaf node images using CSS](#example_configure_using_css) | <ApiLink type="igTree" member="parentNodeImageClass" section="options" label="parentNodeImageClass" />  <br/> <ApiLink type="igTree" member="leafNodeImageClass" section="options" label="leafNodeImageClass" /> | string CSS class name <br/> string CSS class name
[Configure node images for individual data items through binding](#example_configure_through_binding) | <ApiLink type="igTree" member="bindings.imageUrlKey" section="options" label="imageUrlKey" /> <br/> (for XML) <br/> <ApiLink type="igTree" member="bindings.imageUrlXPath" section="options" label="imageUrlXPath" /> | string data member with URL to images <br/> string XPath to the image URL when bound to XML
...
<table class="table tale-bordered">
	...
	<tbody>
        <tr>
            <td><ApiLink type="igTree" member="parentNodeImageUrl" section="options" label="parentNodeImageUrl" /></td>
            <td>"../../Content/images/DocumentsFolder.png"</td>
            <td rowspan="2">![](images/igTree_Configure_Node_Images_Pic02.png)</td>
</tr>

        <tr>
            <td><ApiLink type="igTree" member="leafNodeImageUrl" section="options" label="leafNodeImageUrl" /></td>
            <td>"../../Content/images/Documents.png"</td>
</tr>
    </tbody>
</table>
...
Option | Setting
---|---
<ApiLink type="igTree" member="parentNodeImageClass" section="options" label="parentNodeImageClass" /> | "sprite-DocumentsFolder"
<ApiLink type="igTree" member="leafNodeImageClass" section="options" label="leafNodeImageClass" /> | "sprite-Documents"
...
---|---|---
<ApiLink type="igTree" member="bindings.imageUrlKey" section="options" label="imageUrlKey" /> | ImageUrl|![](images/igTree_Configure_Node_Images_Pic03.png)
<ApiLink type="igTree" member="bindings.imageUrlXPath" section="options" label="imageUrlXPath" />|@ImageUrl|-
...
-   <ApiLink type="igTree" label="igTree Options" />

## Related Topics
Following are some other topics you may find useful.

-   [Configuring Nodes in igTree](/igtree-configure-nodes.mdx)
