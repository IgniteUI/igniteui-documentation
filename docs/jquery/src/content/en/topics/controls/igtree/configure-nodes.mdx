---
title: "Configure Nodes in igTree"
...
### Expand and collapse configuration settings
...
### Example: expand a node that is in view
...
### Example: expand all parent nodes of a child node
...
### Expand and collapse settings reference
...
## Handling expand and collapse events
...
### Expand and collapse event configuration settings
...
## Example: configure the expansion events during instantiation
...
### Example: configure the collapse events using bind and live
...
-   [Configuring Node Images with igTree](/igtree-configure-node-images.mdx)
