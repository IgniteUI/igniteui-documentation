---
title: "Styling igPieChart with Themes"
...
-	[Styling and Theming in &#123;environment:ProductName&#125;](//general-and-getting-started/styling-and-theming/deployment-guide-styling-and-theming.mdx): Provides general information and procedure for updating styles and themes in &#123;environment:ProductName&#125;™ library.
...
Detailed information for using themes with &#123;environment:ProductName&#125; library is available in the [Styling and Theming](//general-and-getting-started/styling-and-theming/deployment-guide-styling-and-theming.mdx) topic.
...
Description
IG Theme
Path: &#123;IG CSS root&#125;/themes/Infragistics/ File: infragistics.theme.css
This theme defines general visual features for all &#123;environment:ProductName&#125; controls. Detailed information for using the IG theme is available in the <a href="Deployment-Guide-Styling-and-Theming.html" data-auto-update-caption="true">Styling and Theming in &#123;environment:ProductName&#125;</a> topic.
Chart Structure
Theme
Description
IG Theme
...
This theme defines general visual features for all &#123;environment:ProductName&#125; controls. Detailed information for using the IG theme is available in the <a href="Deployment-Guide-Styling-and-Theming.html" data-auto-update-caption="true">Styling and Theming in &#123;environment:ProductName&#125;</a> topic.
Chart Structure
\*Path:\* `&#123;IG CSS root&#125;/structure/modules/` \*File:\* `infragistics.ui.chart.css`
...
1. <a id="copy-css-style"></a>Copy the default chart CSS file 
	...
	**Copy the CSS file with the default chart styles ( `infragistics.ui.chart.css` ) from the &#123;environment:ProductName&#125; installation to the themes folder of your web site or application.**
...
- [igPieChart Overview](/igpiechart-overview.mdx): Provides conceptual information about the `igPieChart` control including its main features, minimum requirements for using charts and user functionality.

- [Adding an igPieChart](/igpiechart-adding.mdx): Demonstrates how to create add the `igPieChart` control and bind it to data.
