...
This topic walks through instantiating an [`igSparkline`](&#123;environment:jQueryApiUrl&#125;/ui.igSparkline.html)™ in an ASP.NET MVC view and bind to a .NET collection of objects.
