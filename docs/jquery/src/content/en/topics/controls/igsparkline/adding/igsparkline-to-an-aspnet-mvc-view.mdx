---
title: "Adding igSparkline to an ASP.NET MVC View"
...
This topic walks through instantiating an <ApiLink type="igSparkline.html" label="igSparkline" />™ in an ASP.NET MVC view and bind to a .NET collection of objects.
...
## Adding igSparkline to an ASP.NET MVC View – Conceptual Overview
...
1. Adding a reference to `Infragistics.Web.Mvc.dll`
	...
	Add a reference to the `Infragistics.Web.Mvc.dll` in your ASP.NET application if you have not done so already. The details for adding this assembly are available in the [Adding Controls to an MVC Project](../../../01_General-and-Getting-Started/00_Adding IgniteUI Controls to an MVC Project.mdx) topic.
...
- [jQuery and MVC API Links (igSparkline)](/igsparkline-jquery-and-aspnet-mvc-api.mdx): This topic provides links to the API documentation for jQuery and ASP.NET MVC helper class for the `igSparkline` control.
...
- [Bind Collection](&#123;environment:SamplesUrl&#125;/sparkline/bind-collection): This sample shows binding with the ASP.NET MVC helper.
