---
title: "Accessibility Compliance (igSparkline)"
slug: igsparkline-accessibility-compliance
---
...
This topic explains [`igSparkline`](&#123;environment:jQueryApiUrl&#125;/ui.igSparkline.html)™ accessibility features and provides specific advice on achieving accessibility compliance for pages containing an `igSparkline`.
...
- [Adding igSparkline Overview](/adding/igsparkline-adding-igsparkline-overview.mdx): This topic provides an overview of the various ways of adding `igSparkline` to an application.


## Accessibility Compliance Reference
### Introduction

All of the Infragistics® &#123;environment:ProductName&#125;® controls and components comply with Section 508, Subpart 1194.22 of the Rehabilitation Act of 1973. The table below contains the specific rules of Subpart 1194.22 that pertain to the control. Also detailed is how the `igSparkline` control complies with each rule.
