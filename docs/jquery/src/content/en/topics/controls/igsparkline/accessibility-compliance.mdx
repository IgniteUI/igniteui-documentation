...
This topic explains <ApiLink type="igSparkline.html" label="igSparkline" />™ accessibility features and provides specific advice on achieving accessibility compliance for pages containing an `igSparkline`.
