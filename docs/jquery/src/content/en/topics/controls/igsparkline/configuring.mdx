...
This topic provides an overview of the various ways to configure the [`igSparkline`](&#123;environment:jQueryApiUrl&#125;/ui.igSparkline.html)™ control and links to the related API members.
...
- [Adding igSparkline to an HTML Document](/adding/igsparkline-adding-igsparkline-to-an-html-document.mdx): This topic explains how to add the `igSparkline` to an HTML page and bind to a JavaScript array.

- [Adding igSparkline to an ASP.NET MVC View](/adding/igsparkline-adding-igsparkline-to-an-aspnet-mvc-view.mdx): This topic walks through how to instantiate an `igSparkline` in an ASP.NET MVC view and bind to a .NET collection of objects.
...
- [igSparkline Visual Elements](/igsparkline-visual-elements.mdx): This topic provides an overview and images explaining the visual elements of the `igSparkline`.
...
- [Normal Range and Trend Lines](&#123;environment:SamplesUrl&#125;/sparkline/normal-range-and-trend-lines): Sample demonstrating the normal range and trend line features.

- [Tooltips and Markers](&#123;environment:SamplesUrl&#125;/sparkline/tooltips-and-markers): Sample demonstrating the tooltip and marker features.