...
<table class="table table-bordered">
	<tbody>
        ...
        <tr>
            ...
            <td><ApiLink type="igBulletGraph" member="ranges.startValue" section="options" label="startValue" /></td>
            <td>Not set</td>
</tr>
        <tr>
            <td><ApiLink type="igBulletGraph" member="ranges.endValue" section="options" label="endValue" /></td>
            <td>Not set</td>
</tr>
        <tr>
            <td><ApiLink type="igBulletGraph" member="ranges.innerStartExtent" section="options" label="innerStartExtent" /></td>
            <td>Not set</td>
</tr>
        <tr>
            <td><ApiLink type="igBulletGraph" member="ranges.innerEndExtent" section="options" label="innerEndExtent" /></td>
            <td>Not set</td>
</tr>

        <tr>
            <td><ApiLink type="igBulletGraph" member="ranges.outerStartExtent" section="options" label="outerStartExtent" /></td>
            <td>Not set</td>
</tr>
        <tr>
            <td><ApiLink type="igBulletGraph" member="ranges.outerEndExtent" section="options" label="outerEndExtent" /></td>
            <td>Not set</td>
</tr>
        <tr>
            <th rowspan="3">\*\*Look-and-feel\*\*</th>
            <th>Fill color</th>
            <td><ApiLink type="igBulletGraph" member="ranges.brush" section="options" label="brush" /></td>
            <td>Defined in the default theme</td>
</tr>

        <tr>
            <th>Border color</th>
            <td><ApiLink type="igBulletGraph" member="ranges.outline" section="options" label="outline" /></td>
            <td>Defined in the default theme</td>
</tr>
        <tr>
            <th>Border thickness</th>
            <td><ApiLink type="igBulletGraph" member="ranges.strokeThickness" section="options" label="strokeThickness" /></td>
            <td>\*1.0\*</td>
</tr>
        <tr>
...
<table class="table table-bordered">
	<tbody>
        ...
        <tr>
            ...
            <td><ApiLink type="igBulletGraph" member="ranges.name" section="options" label="name" /></td>
        ...
        <tr>
            ...
            <td>The position of the inner vertex of the starting edge across the scale relative to the edge of the [Reserved area](../../00_igBulletGraph_Overview.mdx#logical-areas). (Inner vertex is the point of the starting edge that is the closest to the edge of the Reserved area.)</td>
            <td><ApiLink type="igBulletGraph" member="ranges.innerStartExtent" section="options" label="innerStartExtent" /></td>
            <td>The desired value as a relative part of the height/width of the [Graph area](../../00_igBulletGraph_Overview.mdx#logical-areas) depending on the orientation (horizontal / vertical) presented as a fraction of 1 (e.g. \*0.2\*)</td>
</tr>
        <tr>
...
Property | Value
---|---
<ApiLink type="igBulletGraph" member="ranges.brush" section="options" label="brush" /> | “Green”
<ApiLink type="igBulletGraph" member="ranges.name" section="options" label="name" /> | “range1”
<ApiLink type="igBulletGraph" member="ranges.startValue" section="options" label="startValue" /> | “6”
<ApiLink type="igBulletGraph" member="ranges.endValue" section="options" label="endValue" /> | “89”
<ApiLink type="igBulletGraph" member="ranges.innerStartExtent" section="options" label="innerStartExtent" /> | “0.5”
<ApiLink type="igBulletGraph" member="ranges.innerEndExtent" section="options" label="innerEndExtent" /> | “0.5”
<ApiLink type="igBulletGraph" member="ranges.outerStartExtent" section="options" label="outerStartExtent" /> | “0.8”
<ApiLink type="igBulletGraph" member="ranges.outerEndExtent" section="options" label="outerEndExtent" /> | “0.8”
<ApiLink type="igBulletGraph" member="ranges.outline" section="options" label="outline" /> | “Black”
