...
Apart from its [`startValue`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:ranges) and [`endValue`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:ranges), a [`name`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:ranges) must be assigned to the individual range, so that its extent is specified.
