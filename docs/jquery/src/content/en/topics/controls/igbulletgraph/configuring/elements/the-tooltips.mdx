...
<table class="table table-bordered">
	...
	<tbody>
        ...
        <tr>
            ...
            <td>Depends on whether [valueName](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:valueName) has been initialized (see [\*\*Configuring a Custom Tooltip for the Performance Bar\*\*](#performance-bar))</td>
</tr>
        <tr>
...
---|---|---
Enable tooltips | [showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:showToolTip) | true
Disable tooltips | [showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:showToolTip) | false
...
In order to: | Use this property: | And set it to:
---|---|---
Configure the initial delay before the tooltip is displayed | [showToolTipTimeout](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:showToolTipTimeout) | The desired value in milliseconds
...
The default value of the tooltip is pre-configured depending on whether the [`valueName`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:valueName) property has been initialized.
...
In order to: | Use this property: | And set it to:
---|---|---
Set a custom tooltip for the performance bar | [valueToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:valueToolTipTemplate) | The id of the desired template.
...
In order to: | Use this property: | And set it to:
---|---|---
Set a custom tooltip for the comparative marker | [targetValueToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:targetValueToolTipTemplate) | The id of the desired template
...
In order to: | Use this property: | And set it to:
--|--|--
Set a custom tooltip for the comparative range(s) | [rangeToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:rangeToolTipTemplate) | The id of the desired template
...
This sample demonstrates what can be achieved when combining all of the custom tooltips mentioned above. It includes templates for all of the configurable areas where you can have a tooltip - the [performance bar](&#123;environment:jQueryApiUrl&#125;/ui.igbulletgraph#options:valueToolTipTemplate), [comparative marker](&#123;environment:jQueryApiUrl&#125;/ui.igbulletgraph#options:targetValueToolTipTemplate) and [ranges](&#123;environment:jQueryApiUrl&#125;/ui.igbulletgraph#options:rangeToolTipTemplate). 
