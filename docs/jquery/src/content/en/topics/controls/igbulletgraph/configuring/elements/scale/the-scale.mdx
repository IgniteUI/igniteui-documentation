...
The scale’s size and position within the `igBulletGraph` control in the along-the scale-dimension is determined relative the [Graph area](../../../00_igBulletGraph_Overview.mdx#logical-areas). This is done through a pair of properties ([`scaleStartExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:scaleStartExtent) and [`scaleEndExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:scaleEndExtent)).
...
The values of the scale are defined by specifying its value range, that is, its minimum and maximum values. This is done with the [`minimumValue`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:minimumValue) and [`scaleEndExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:scaleEndExtent) properties.
...
The major tick marks are defined in terms of starting and ending points (the positions of the first and the last tick marks relative to the edges of the [Graph area](../../../00_igBulletGraph_Overview.mdx#logical-areas) and the interval (the distance from each other) at which they occur. (This is done through the [`ticksPostInitial`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:ticksPostInitial), [`ticksPreTerminal`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:ticksPreTerminal), and [`interval`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:interval) properties.) This way, defining the starting and ending points of the major tick marks essentially defines the position and length of the scale.
...
In the across-the-scale dimension, the length and position of the line segments that form the major tick marks is configured relative to the edges of the [Graph area](../../../00_igBulletGraph_Overview.mdx#logical-areas). (This is done through the [`tickStartExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:tickStartExtent) and [`tickEndExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:tickEndExtent) properties.)
...
The minor tick marks are defined as a count (the number of minor tick marks between two adjacent major tick marks). (This is done through the [`minorTickCount`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:minorTickCount) property; setting this property to *0* disables (hides) the minor tick marks.) When the count is set, the specified number of minor tick marks is placed evenly between every two adjacent major tick marks, from the first one, to the last.
...
-   **The interval** (the distance from each other) at which they occur. (This is done through the [`labelsPostInitial`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:labelsPostInitial), [`labelsPreTerminal`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:labelsPreTerminal) and [`labelInterval`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:labelInterval) properties.)
-   **The position of the label row** in the across-the-scale dimension – the default is at the bottom / on the left of the control (for horizontal or vertical orientation, respectively); the entire row can be shifted vertically at horizontal scale orientation or the horizontally at vertical scale orientation. (This is done through the [`labelExtent`](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#options:labelExtent) property.)
...
---|---
Format the labels | [formatLabel](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#events:formatLabel)
Align the labels | [alignLabel](&#123;environment:jQueryApiUrl&#125;/ui.igBulletGraph#events:alignLabel)
