...
This topic explains the features supported by the [`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ control from developer perspective.
...
-   [Configuring Button Items](/configuring/items/igradialmenu-configuring-button-items.mdx)
...
-   [Configuring Color Items](/configuring/items/igradialmenu-configuring-color-items.mdx)
...
-   [Configuring Numeric Items](/configuring/items/igradialmenu-configuring-numeric-items.mdx)
...
-   [Items/Sub-Items Configuration Overview](/configuring/items/igradialmenu-items-sub-items-configuration-overview.mdx)
...
-   [Configuring Tooltips](/configuring/igradialmenu-configuring-tooltips.mdx)
...
- [igRadialMenu Visual Elements](/igradialmenu-visual-elements.mdx): This topic provides an overview of the visual elements of the control.
