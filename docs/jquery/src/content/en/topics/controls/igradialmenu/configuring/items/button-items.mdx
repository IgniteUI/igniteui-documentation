---
title: "Configuring Button Items (igRadialMenu)"
slug: igradialmenu-configuring-button-items
---
...
This topic explains the [`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ button items.
...
- [Button Items](&#123;environment:SamplesUrl&#125;/radial-menu/button-items): This sample demonstrates how to define and configure button items.
