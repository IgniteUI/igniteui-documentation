---
title: "Configuring Color Items (igRadialMenu)"
...
This topic explains the [`igRadialMenu`](&#123;environment:jQueryApiUrl&#125;/ui.igRadialMenu#options)™ color items.
...
- [Items/Sub-Items Configuration Overview](/igradialmenu-items-sub-items-configuration-overview.mdx): This topic explains in general the menu items and their common configuration properties.
...
| --- | --- | --- |
| [Color Item](#color-items) | Displays a header text Displays an icon Displays the associated color | `coloritem` |
| [Color Well](#color-well) | Displays the associated color in both the item area and outer ring | `colorwell` |
