---
title: "User Interaction and Usability (igRadialMenu)"
...
- [Items/Sub-Items Configuration Overview](/configuring/items/igradialmenu-items-sub-items-configuration-overview.mdx): This topic explains the menu items and their configuration properties in general.
