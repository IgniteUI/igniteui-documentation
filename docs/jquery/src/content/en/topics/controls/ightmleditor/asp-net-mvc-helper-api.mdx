...
-	[Adding igHtmlEditor](/ightmleditor-adding-ightmleditor.mdx): This topic describes how to add `igHtmlEditor` to a web page.
...
-	[igHtmlEditor jQuery API](&#123;environment:jQueryApiUrl&#125;/ui.igHtmlEditor): The documentation contains an overview of the control and full list of options, events, and methods with code snippets.
