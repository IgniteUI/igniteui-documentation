---
title: "igHtmlEditor API Reference"
...
-	[Working with the igHtmlEditor](/working/ightmleditor-working-with-ightmleditor.mdx):  This is landing page for all topics on configuration capabilities of `igHtmlEditor`.
