---
title: "Modifying Contents Programmatically"
...
## Get the contents of the igHtmlEditor
...
## Set the contents of the igHtmlEditor
...
## Apply formatting to the igHtmlEditor’s contents
...
## Printing the igHtmlEditor’s contents
...
-	[Configuring Toolbars and Buttons](/ightmleditor-configuring-toolbars-and-buttons.mdx): This topic explains how to configure the igHtmlEditor toolbars and buttons.