---
title: "Accessibility Compliance (igFunnelChart)"
...
### igFunnelChart accessibility compliance summary chart
...
- [Accessibility Compliance](//general-and-getting-started/accessibility-compliance.mdx): This topic provides reference information for accessibility compliance of all controls in the Infragistics &#123;environment:ProductName&#125; product.
