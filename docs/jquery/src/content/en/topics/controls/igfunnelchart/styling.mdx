...
Property | Description
--- | ---
[brushes](&#123;environment:jQueryApiUrl&#125;/ui.igfunnelchart#options:brushes) | Defines the palette for selecting automatically assigned slice colors.
[outlines](&#123;environment:jQueryApiUrl&#125;/ui.igfunnelchart#options:outlines) | Defines the palette for automatically assigned slice outline colors.
[outlineThickness](&#123;environment:jQueryApiUrl&#125;/ui.igfunnelchart#options:outlineThickness) | Defines the thickness of slices’ outlines.
