...
| Set up geographic scatter area series | These mandatory setting configures the type of the map series to geographic scatter area and sets the series’ name. | In JavaScript: [series.type](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) [series.name](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options), Value:, **series.type: “geographicScatterArea”** **series.type: “seriesName”**, , In ASP.NET MVC:, [MapSeriesBuilder&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1.html) [.GeographicScatterArea()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1~GeographicScatterArea.html), Value:, , **series.GeographicScatterArea(“seriesName”)** |
| Bind to an ITF file | Use this setting to configure for triangulation file’s URL. | In JavaScript: [series.triangulationDataSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangulationDataSource) In ASP.NET MVC: [GeographicScatterAreaSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicScatterAreaSeries`1.html) [.TriangulationDataSource()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangulationDataSource.html) |
| Bind to a custom triangles data source | Use These settings to configure an array of objects with geospatial data that describe a field of geographical points and their associated numeric values. | In JavaScript: [series.dataSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.dataSource) [series.longitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.longitudeMemberPath) [series.latitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.latitudeMemberPath) [series.colorMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.colorMemberPath) Optional: [series.triangleVertexMemberPath1](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath1) [series.triangleVertexMemberPath2](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath2) [series.triangleVertexMemberPath3](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath3) In ASP.NET MVC: [GeographicScatterAreaSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicScatterAreaSeries`1.html) [.LongitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~LongitudeMemberPath.html) [.LatitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~LatitudeMemberPath.html) [.ColorMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicScatterAreaSeries`1~ColorMemberPath.html) Optional: [GeographicScatterAreaSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicScatterAreaSeries`1.html) [.TriangleVertexMemberPath1()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath1.html) [.TriangleVertexMemberPath2()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath2.html) [.TriangleVertexMemberPath3()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath3.html) |
| Color palette | Use this mandatory setting to configure the color palette for the triangles values. There is no default color palette value. | In JavaScript: [series.colorScale.palette](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.colorScale.palette) In ASP.NET MVC: [CustomPalette.Palette()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.CustomPalette~Palette.html) |
| Interpolation mode for values to colors mapping | Use this setting to configure the logic that maps values to colors. | In JavaScript: [series.colorScale.interpolationMode](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.colorScale.interpolationMode) In ASP.NET MVC: [CustomPalette.InterpolationMode()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.CustomPalette~InterpolationMode.html) |
| Minimum value for color palette | Use this setting to configure the minimum value for calculating value sub ranges. | In JavaScript: [series.colorScale.minimumValue](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.colorScale.minimumValue) In ASP.NET MVC: [CustomPalette.MinimumValue()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.CustomPalette~MinimumValue.html) |
| Maximum value for color palette | Use this setting to configure the maximum value for calculating value sub ranges. | In JavaScript: [series.colorScale.maximumValue](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.colorScale.maximumValue) In ASP.NET MVC: [CustomPalette.MaximumValue()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.CustomPalette~MaximumValue.html) |
