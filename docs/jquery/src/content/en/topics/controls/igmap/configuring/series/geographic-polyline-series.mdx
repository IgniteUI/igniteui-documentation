...
| --- | --- | --- |
| Setting up the series type | These mandatory settings configure the type of the map series to Geographic Polyline and set series name. | **In JavaScript:** [series.type](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.type) [series.name](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.name) Value:, **series.type: “geographicPolyline”** **series.type: “seriesName”**, In ASP.NET MVC :, [MapSeriesBuilder Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1.html) [.GeographicPolyline()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1~GeographicPolyline.html) Value:, **series.GeographicPolyline(“seriesName”)** |
| Data binding options | These mandatory settings configure the URLs belonging to the shape and database files, or a custom data source. | In JavaScript: [series.shapeDataSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.shapeDataSource) [series.databaseSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.databaseSource) In ASP.NET MVC: [GeographicPolylineSeries Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicPolylineSeries`1.html) [.ShapeDataSource()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicShapeSeriesBase`3~ShapeDataSource.html) [.DatabaseSource()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicShapeSeriesBase`3~DatabaseSource.html) |
| Polyline color | This aspect configures the color of polylines whose default outline is white. | In JavaScript: [series.outline](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.outline) [series.shapeStyle.stroke](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.shapeStyle) In ASP.NET MVC: [GeographicPolylineSeries Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicPolylineSeries`1.html) [.Outline()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.Series`3~Outline.html) [.ShapeStyle()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicShapeSeriesBase`3~ShapeStyle.html) |
| Polyline thickness | This aspect configures the thickness of the polylines whose default thickness is 0. | In JavaScript: [series.thickness](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.thickness) [series.shapeStyle.thickness](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.shapeStyle) In ASP.NET MVC: [GeographicPolylineSeries Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicPolylineSeries`1.html) [.Thickness()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.Series`3~Thickness.html) [.ShapeStyle()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicShapeSeriesBase`3~ShapeStyle.html) |
