---
title: "Accessibility Compliance (igMap)"
...
All of the \{environment:ProductName\}™ controls and components comply with Section 508, Subpart 1194.22 of the Rehabilitation Act of 1973. Table 1 contains the specific rules of Subpart 1194.22 that pertain to the control. Also, detailed is how the igMap control complies with each rule.
...
-	[Accessibility Compliance](//general-and-getting-started/accessibility-compliance.mdx):Provides reference information for accessibility compliance of all controls in the \{environment:ProductName\} product.
