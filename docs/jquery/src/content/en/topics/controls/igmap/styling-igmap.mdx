...
### Map styling options reference summary chart
...
## Code Example: Changing the Marker Fill and Outline
...
## Code Example: Changing the Shape Fill and Outline
...
## Code Example: Applying a Color Scale
...
## Code Example: Applying a Fill Scale
...
## Code Example: Providing Custom Logic for the Shape Style
