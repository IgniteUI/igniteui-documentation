...
| Set up geographic contour line series | Use these mandatory settings to configure the type of the map series to geographic contour line and set series name. | In JavaScript: [series.type](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.type) [series.name](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.name) Value: series.type: “geographicContourLine”, series.type: “seriesName” In ASP.NET MVC: [MapSeriesBuilder&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1.html) [.GeographicContourLine()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1~GeographicContourLine.html) Value: series.GeographicContourLine(“seriesName”) |
| Bind to an ITF file | Configures the triangulation file’s URL. | In JavaScript: [series.triangulationDataSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangulationDataSource) In ASP.NET MVC: [GeographicContourLineSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicContourLineSeries`1.html) [.TriangulationDataSource()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangulationDataSource.html) |
| Bind to a custom triangles data source | Configure an array of objects with geospatial data that describe a field of geographical points and their corresponding numeric values. | In JavaScript: [series.dataSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.dataSource) [series.longitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.longitudeMemberPath) [series.latitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.latitudeMemberPath) [series.valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.valueMemberPath) Optional: [series.triangleVertexMemberPath1](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath1) [series.triangleVertexMemberPath2](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath2) [series.triangleVertexMemberPath3](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.triangleVertexMemberPath3) In ASP.NET MVC: [GeographicContourLineSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicContourLineSeries`1.html) [.LongitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~LongitudeMemberPath.html) [.LatitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~LatitudeMemberPath.html) [.ValueMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicContourLineSeries`1~ValueMemberPath.html) Optional: [GeographicContourLineSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicContourLineSeries`1.html) [.TriangleVertexMemberPath1()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath1.html) [.TriangleVertexMemberPath2()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath2.html) [.TriangleVertexMemberPath3()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicXYTriangulatingSeries`3~TriangleVertexMemberPath3.html) |
| Color palette | This mandatory setting configures the color palette for the triangles values. There is no default value for the setting. | In JavaScript: [series.fillScale.brushes](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.fillScale.brushes) In ASP.NET MVC: [FillScale.Brushes()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.FillScale`1~Brushes.html) |
| Minimum value for color palette | Configure the minimum value for calculating value sub ranges. | In JavaScript: [series.fillScale.minimumValue](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.fillScale.minimumValue) In ASP.NET MVC: [FillScale.MinimumValue()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.ValueBrushScale~MinimumValue.html) |
| Maximum value for color palette | Configure the maximum value for calculating value sub ranges. | In JavaScript: [series.fillScale.maximumValue](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.fillScale.maximumValue) In ASP.NET MVC: [FillScale.MaximumValue()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.ValueBrushScale~MaximumValue.html) |
| Set logarithmic color palette | Configure the map series to use logarithmic mapping of values to colors. | In JavaScript: [series.fillScale.isLogarithmic](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.fillScale.isLogarithmic) [series.fillScale.logarithmBase](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options:series.fillScale.logarithmBase) In ASP.NET MVC: [FillScale.IsLogarithmic()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.ValueBrushScale~IsLogarithmic.html) [FillScale.LogarithmBase()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.ValueBrushScale~LogarithmBase.html) |
