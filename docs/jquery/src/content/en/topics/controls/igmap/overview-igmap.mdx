...
<img src="images/Overview_igMap_1.png" alt="" />
...
| Geographic Symbol Series | Visualizes markers on the map based on geographic coordinates., Related Topics: [Configuring Geographic Symbol Series](/configuring/series/igmap-configuring-geographic-symbol-series.mdx) | geographicSymbol | <ApiLink type="igMap" member="series.latitudeMemberPath" section="options" label="latitudeMemberPath" /> <ApiLink type="igMap" member="series.longitudeMemberPath" section="options" label="longitudeMemberPath" /> |
| Geographic Shapes Series | Visualizes enclosed areas on a map like countries or regions based on shape data provided by shape (SHP) files or a custom shape data source., Related Topics: [Configuring Geographic Shapes Series](/configuring/series/igmap-configuring-geographic-shapes.mdx) | geographicShape | <ApiLink type="igMap" member="series.shapeDataSource" section="options" label="shapeDataSource" /> <ApiLink type="igMap" member="series.databaseSource" section="options" label="databaseSource" /> <ApiLink type="igMap" member="series.shapeMemberPath" section="options" label="shapeMemberPath" /> |
| Geographic Polyline Series | Visualizes open paths on a map like roads, rivers or daily supply routes based on shape data provided by shape (SHP )files or a custom shape data source., , Related Topics: [Configuring Geographic Polyline Series](/configuring/series/igmap-configuring-geographic-polyline-series.mdx) | geographicPolyline | <ApiLink type="igMap" member="series.shapeDataSource" section="options" label="shapeDataSource" /> <ApiLink type="igMap" member="series.databaseSource" section="options" label="databaseSource" /> <ApiLink type="igMap" member="series.shapeMemberPath" section="options" label="shapeMemberPath" /> |
| Geographic Scatter Area Series | Visualizes colored geographic area based on triangular irregular networks (TINs) defined in a triangulated (ITF) file or other custom triangulation data source. Geographic coordinates and a value member are also needed. This can be used to depict terrain elevation, population density, average/current temperature and others., Related Topics: [Configuring Geographic Scatter Area Series](/configuring/series/igmap-configuring-geographic-scatter-area-series.mdx) | geographicScatterArea | <ApiLink type="igMap" member="series.triangulationDataSource" section="options" label="triangulationDataSource" /> Optional: <ApiLink type="igMap" member="series.triangleVertexMemberPath1" section="options" label="triangleVertexMemberPath1" /> <ApiLink type="igMap" member="series.triangleVertexMemberPath2" section="options" label="triangleVertexMemberPath2" /> <ApiLink type="igMap" member="series.triangleVertexMemberPath3" section="options" label="triangleVertexMemberPath3" /> <ApiLink type="igMap" member="series.longitudeMemberPath" section="options" label="longitudeMemberPath" /> <ApiLink type="igMap" member="series.latitudeMemberPath" section="options" label="latitudeMemberPath" /> <ApiLink type="igMap" member="series.colorMemberPath" section="options" label="colorMemberPath" /> |
| Geographic Contour Line Series | Visualizes colored closed paths based on triangular irregular networks (TINs) defined in a triangulated (ITF) file or other custom triangulation data source. Geographic coordinates and a value member are also needed. This can be used to depict terrain elevation, population density, average/current temperature or others., Related Topics: [Configuring Geographic Contour Line Series](/configuring/series/igmap-configuring-geographic-contour-line-series.mdx) | geographicContourLine | <ApiLink type="igMap" member="series.triangulationDataSource" section="options" label="triangulationDataSource" /> Optional: <ApiLink type="igMap" member="series.triangleVertexMemberPath1" section="options" label="triangleVertexMemberPath1" /> <ApiLink type="igMap" member="series.triangleVertexMemberPath2" section="options" label="triangleVertexMemberPath2" /> <ApiLink type="igMap" member="series.triangleVertexMemberPath3" section="options" label="triangleVertexMemberPath3" /> <ApiLink type="igMap" member="series.longitudeMemberPath" section="options" label="longitudeMemberPath" /> <ApiLink type="igMap" member="series.latitudeMemberPath" section="options" label="latitudeMemberPath" /> <ApiLink type="igMap" member="series.valueMemberPath" section="options" label="valueMemberPath" /> |
...
---|---
<img src="images/Overview_igMap_7.png" alt="" />|<img src="images/Overview_igMap_8.png" alt="" />
...
---|---
<img src="images/Overview_igMap_12.png" alt="" />|<img src="images/Overview_igMap_13.png" alt="" />
...
<img src="images/Overview_igMap_14.png" alt="" />
...
<img src="images/Overview_igMap_15.png" alt="" />
...
<img src="images/Overview_igMap_16.png" alt="" />
...
<img src="images/Overview_igMap_17.png" alt="" />
...
<img src="images/Overview_igMap_18.png" alt="" />
...
<img src="images/Overview_igMap_19.png" alt="" />
