...
| Set up geographic high density scatter series | These mandatory settings are where you configure the type of map series to the geographic shape and set series name. | In JavaScript: [series.type](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) [series.name](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) Value:, series.type: “geographicHighDensityScatterSeries”,, series.type: “seriesName”, In ASP.NET MVC: [MapSeriesBuilder&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.MapSeriesBuilder`1.html) [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) Value:, series.GeographicHighDensityScatterSeries(“seriesName”) |
| Data binding options of geographic high density scatter series | These mandatory settings are where you configure the URLs for the shape and database files, or a custom shape data source. | In JavaScript: [series.itemsSource](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) [series.longitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) [series.latitudeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) In ASP.NET MVC: [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) [.ItemsSource()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) [.LongitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1~LongitudeMemberPath.html) [.LatitudeMemberPath()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeriesModel~LatitudeMemberPath.html) |
| Tooltips visibility | Configure to enable tooltips rendering. By default, tooltips are disabled. | In JavaScript: [series.showTooltip](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) In ASP.NET MVC: [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) [.ShowTooltip()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.Series`3~ShowTooltip.html) |
| Tooltip template | Configure to specify which template to use for rendering tooltips. | In JavaScript: [series.tooltipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) In ASP.NET MVC: [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) [.TooltipTemplate()](Infragistics.Web.Mvc~Infragistics.Web.Mvc.Series`3~TooltipTemplate.html) |
| Heat maximum color | Configure the color of the heat maximum color. The default color is red. | In JavaScript: [series.heatMaximumColor](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) In ASP.NET MVC: [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) .HeatMaximumColor() |
| Heat minimum color | Configure the color of the heat minimum color. The default color is black. | In JavaScript: [series.heatMinimumColor](&#123;environment:jQueryApiUrl&#125;/ui.igMap#options) In ASP.NET MVC: [GeographicHighDensityScatterSeries&lt;T&gt; Class](Infragistics.Web.Mvc~Infragistics.Web.Mvc.GeographicHighDensityScatterSeries`1.html) .HeatMinimumColor() |
