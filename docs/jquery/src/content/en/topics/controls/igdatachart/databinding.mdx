---
title: "Binding igDataChart to Data"
...
| Data structure | JSON (client side or from a web or WCF service) XML (client side or from a web or WCF service) JavaScript array IQueryable&lt;T&gt; in ASP.NET MVC |
...
-   An HTML5 web page
-   All required JavaScript and CSS files added to your web site or web application project. For detailed information on instantiation and configuration of an igDataChart see [Adding igDataChart](/igdatachart-adding.mdx).
...
<Sample src="/data-chart/json-binding/index.html" height={428} alt="Data Chart Json Binding"/>
...
<Sample src="/data-chart/xml-binding/index.html" height={428} alt="Data Chart Xml Binding"/>
