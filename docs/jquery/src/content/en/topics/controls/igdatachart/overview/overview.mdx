...
| --- | --- | --- | --- | --- |
| Bar and Column | Bar | Visualizes categorized data with horizontal bars. | bar | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Column | Visualizes categorized data with vertical columns. | column | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
| Category | Line | Visualizes categorized data with a line with sharp edges on data points. | line | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Area | Visualizes categorized data with colored area below a line with sharp edges on data points. | area | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Spline | Visualizes categorized data with a line with smooth edges on data points. | spline | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Spline Area | Visualizes categorized data with colored area below a line with smooth edges on data points. | splineArea | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Waterfall | Visualizes categorized data with vertical columns where the first column for the first category starts from the x-axis and each next category starts where the previous one ends. | waterfall | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
| Financial | Candlestick | Displays opening, closing, highest and lowest value of a financial (investment) instrument in the form of a candlestick. | candlestick | [openMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:openMemberPath) [closeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:closeMemberPath) [highMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:highMemberPath) [lowMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:lowMemberPath) |
|  | OHLC | Abbreviation for Open, High, Low, Close. Displays opening, closing, highest and lowest value of a financial (investment) instrument in the form of vertical lines with markings for opening and closing values. | ohlc | [openMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:openMemberPath) [closeMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:closeMemberPath) [highMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:highMemberPath) [lowMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:lowMemberPath) |
| Polar | Polar Scatter | Visualizes data with dots (or other types of markers) in a polar coordinate system. | polarScatter | [angleMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:angleMemberPath) [radiusMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:radiusMemberPath) |
|  | Polar Line | Visualizes data with a line with sharp edges on data points in a polar coordinate system. | polarLine | [angleMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:angleMemberPath) [radiusMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:radiusMemberPath) |
|  | Polar Area | Visualizes data with colored area below a line with sharp edges on data points in a polar coordinate system. | polarArea | [angleMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:angleMemberPath) [radiusMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:radiusMemberPath) |
| Radial | Radial Line | Visualizes categorized data with a line with sharp edges on data points with all categories distributed in a circle. | radialLine | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Radial Column | Visualizes categorized data with columns starting from a common center and turned on different angles. | radialColumn | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
|  | Radial Pie | Visualizes categorized data with pie-slice shaped elements starting from a common center and turned on different angles. | radialPie | [valueMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:valueMemberPath) |
| Range Category | Range Area | Visualizes categorized data in ranges between two values with colored area between two lines with sharp edges on data points. | rangeArea | [lowMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:lowMemberPath) [highMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:highMemberPath) |
|  | Range Column | Visualizes categorized data in ranges between two values with columns. | rangeColumn | [lowMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:lowMemberPath) [highMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:highMemberPath) |
| Bubble | Bubble | Visualizes data described by multiple parameters with colored circles with different diameter. | bubble | [xMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:xMemberPath) [yMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:yMemberPath) [radiusMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:radiusMemberPath) [fillMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:fillMemberPath) [labelMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:labelMemberPath) |
| Scatter | Scatter | Visualizes data with dots in Cartesian coordinate system. | scatter | [xMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:xMemberPath) [yMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:yMemberPath) |
|  | Scatter Line | Visualizes data with a line with sharp edges on data points in Cartesian coordinate system. | scatterLine | [xMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:yMemberPath) [yMemberPath](&#123;environment:jQueryApiUrl&#125;/ui.igDataChart#options:yMemberPath) |
