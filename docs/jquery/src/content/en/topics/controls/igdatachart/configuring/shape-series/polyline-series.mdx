---
title: "Configuring the Scatter Polyline Series (igDataChart)"
...
- [Configuring the Scatter Polygon Series](/shapeseries-polygon-series.mdx): This topic explains how to configure the scatter polygon series for the `igDataChart` control.
