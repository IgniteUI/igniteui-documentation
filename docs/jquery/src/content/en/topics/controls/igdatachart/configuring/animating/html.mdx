---
title: "Animating Charts in HTML and JavaScript (igDataChart)"
...
-	[igDataChart Overview](//overview/igdatachart-overview.mdx): Contains basic information about the `igDataChart`™ control for displaying various kinds of charts in web pages.

-	[Adding igDataChart](//igdatachart-adding.mdx): Shows how to implement a chart with a simple step by step example.

-	[igDataSource Overview](////data-sources/igdatasource/igdatasource-overview.mdx): This topic is an introduction into the `igDataSource` control.

-	[Infragistics Motion Framework for Charts](/igdatachart-motion-framework.mdx): This topic provides an overview of the Infragistics® Motion Framework for charts.
...
## Animating Charts in HTML and JavaScript
...
1. Create an empty HTML view.
 ...
 Follow the steps in the [Adding igDataChart](//igdatachart-adding.mdx) topic to create a skeleton HTML/MVC view which incorporates chart. Only the first two steps, [Add references to required resources](../../01_igDataChart_Adding.mdx#add-references-to-required-resources) and [Add HTML markup required by the igDataChart](../../01_igDataChart_Adding.mdx#add-html-markup) are required for the purposes of this sample.
