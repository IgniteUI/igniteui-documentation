---
title: "Configuring the Scatter Contour Series (igDataChart)"
...
- [Configuring the Scatter Area Series](/triangulationseries-area-series.mdx): This topic explains how to configure the Scatter Area Series for the `igDataChart` control.