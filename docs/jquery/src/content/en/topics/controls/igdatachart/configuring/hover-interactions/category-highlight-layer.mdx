---
title: "Configuring the Category Highlight Layer (igDataChart)"
...
You can change the color of the highlighting area by setting the `brush` property. For more information on this property see the [Hover Interactions Property Reference (igDataChart)](/hoverinteractions-common-properties.mdx) topic.
...
<div class="embed-sample">
   [Category Highlight Layer](\{environment:SamplesEmbedUrl\}/data-chart/category-highlight-layer)
   ![](images/jQuery_Category_Highlight_Layer_01.png)
</div>
