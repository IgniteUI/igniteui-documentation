---
title: "Configuring the OrdinalTimeXAxis (igDataChart)"
...
- [Configuring Time X-Axis](/igdatachart-configuring-timexaxis.mdx): This topic demonstrates how to use TimeXAxis in the `igDataChart` control.