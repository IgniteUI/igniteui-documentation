---
title: "Configuring the PercentChangeYAxis (igDataChart)"
...
- [Configuring Ordinal Time X-Axis](/igdatachart-configuring-ordinaltimexaxis.mdx): This topic demonstrates how to use OrdinalTimeXAxis in the `igDataChart` control.