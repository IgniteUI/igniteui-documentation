...
This topic walks through using &#123;environment:ProductNameMVC&#125; to instantiate an [`igDoughnutChart`](&#123;environment:jQueryApiUrl&#125;/ui.igDoughnutChart#options)™ in an ASP.NET MVC application.
