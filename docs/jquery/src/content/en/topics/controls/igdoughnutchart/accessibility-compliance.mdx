...
This topic explains the <ApiLink type="igDoughnutChart" label="igDoughnutChart" />™ control's accessibility features and demonstrates how to achieve accessibility compliance for pages containing doughnut charts.
