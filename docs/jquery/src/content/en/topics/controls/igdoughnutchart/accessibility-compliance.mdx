...
This topic explains the [`igDoughnutChart`](&#123;environment:jQueryApiUrl&#125;/ui.igDoughnutChart#options)™ control's accessibility features and demonstrates how to achieve accessibility compliance for pages containing doughnut charts.
