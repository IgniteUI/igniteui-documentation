...
| --- | --- | --- |
| Multiple selection | Multiple selection allows users to select more than one item in the combo from the dropdown or by typing multiple values in the text box. | [multiSelection](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:multiSelection) |
| Clear selection | Programmatically clears the selection from the igCombo control. | [deselectAll](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#methods:deselectAll) |
| Handle selection events | Capture selection events to perform logic in response to a selection operation occurring. | [selectionChanging](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanging) |
| Handle selection events | Capture selection events to perform logic in response to a selection operation occurring. | [selectionChanging](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanging), [selectionChanged](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanged) |
| Cancel Selection | Cancel the selection changing event to cancel a selection operation. | [selectionChanging](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanging) |
...
| --- | --- | --- |
| Multiple selection | [**multiSelection.enabled**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:multiSelection.enabled) | true |
| Show checkboxes | [**multiSelection.showCheckboxes**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:multiSelection.showCheckboxes) | true |
...
| --- | --- |
| Clear selection | [**delesectAll**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#methods:delesectAll) |
| Handle an event after selection has been changed | [**selectionChanged**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanged) |
...
| --- | --- | --- |
| Handle an event prior to selection being changed | [**selectionChanging**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanging) | `function()` |
| Handle an event after selection has been changed | [**selectionChanged**](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#events:selectionChanged) | `function()` |
