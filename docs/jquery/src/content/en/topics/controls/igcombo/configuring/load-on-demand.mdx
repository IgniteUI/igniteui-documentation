...
| --- | --- | --- |
| Drop-down list paging | Sets the page size of the drop-down list | [loadOnDemandSettings.pageSize](&#123;environment:jQueryApiUrl&#125;/ui.igcombo#options:loadOnDemandSettings.pageSize) |
| Drop-down list header | Sets the heading label of the drop-down list through a header template | [headerTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igcombo#options:headerTemplate) |
| Drop-down list footer | Sets the heading label of the drop-down list through a header template | [footerTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igcombo#options:footerTemplate) |
