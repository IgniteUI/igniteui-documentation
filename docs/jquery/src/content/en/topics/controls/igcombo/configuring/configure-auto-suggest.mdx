...
| --- | --- | --- |
| Enable auto-suggest filtering | [filteringType](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:filteringType) | local |
| Enable match highlighting for all instances within a single item | [highlightMatchesMode](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:highlightMatchesMode) | multi |
| Configure the filtering to find only items that start with the entered text | [filteringCondition](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:filteringCondition) | startsWith |
| Configure the filtering to find all items that contain the entered text | [filteringCondition](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:filteringCondition) | contains |
| Configure match highlighting to match only items that start with the entered text | [highlightMatchesMode](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:highlightMatchesMode) | startsWith |
| Configure match highlighting to match only one instance of the entered text within each item | [highlightMatchesMode](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:highlightMatchesMode) | contains |
| Make filtering case sensitive | [caseSensitive](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:caseSensitive) | true |
| Enable auto-complete | [autoComplete](&#123;environment:jQueryApiUrl&#125;/ui.igCombo#options:autoComplete) | true |
...
-   [igCombo Options](&#123;environment:jQueryApiUrl&#125;/ui.igcombo#options)
