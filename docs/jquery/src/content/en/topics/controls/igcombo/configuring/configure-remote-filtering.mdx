...
### OData list filtering configuration details
...
### OData list filtering configuration property settings
...
### OData list filtering configuration example
...
## Configure ASP.NET MVC list filtering
...
### ASP.NET MVC list filtering configuration example
