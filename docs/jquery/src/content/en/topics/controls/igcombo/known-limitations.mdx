---
title: "Known Issues and Limitations (igCombo)"
...
### In IE9 and lower versions placeHolder text is not previewed
...
### When virtualization is enabled, all ItemTemplate elements should have equal heights
...
```
### When Grouping and Virtualization are used some items are not rendered properly
...
### When loadOnDemand is used, initialSelectedItems option won't work as expected
...
### Autocomplete breaks the "Backspace" and "ESC" functionalities of Japanese IME composition in some browsers
