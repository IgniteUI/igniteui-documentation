---
title: "Creating Cascading igCombos"
...
-	[igCombo Overview](/igcombo-overview.mdx): This topic provides an overview of the `igCombo` control including its features, binding to data sources, requirements, and templates.

-	[Binding igCombo to Data](/igcombo-data-binding.mdx): This topic discusses the different ways to data bind the `igCombo` control, as well as some other details related to data binding.

-   [Configuring Selection](/configuring/igcombo-configure-selection.mdx): This topic discusses how to implement selection, including information on how to handle selection events.
