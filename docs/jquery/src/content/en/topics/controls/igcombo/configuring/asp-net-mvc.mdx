---
title: "Configuring ASP.NET MVC Combo"
...
-	[Binding igCombo to Data Overview](/binding/igcombo-data-binding.mdx): This topic discusses the different ways to data bind the `igCombo` control as well as other details related to data binding.
