...
Event|Description
---|---
[showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing)|Fired before showing the popover.
[shown](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:shown)|Fired after showing the popover is shown.
[hiding](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:hiding)|Fired before hiding the popover.
[hidden](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:hidden)|Fired after hiding the popover is hidden.
...
Example|Description
---|---
[Handling the Event Upon Initialization in jQuery](#jquery-handling)|This example assigns an event handling function to the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing)event at initialization.
[Handling the Event at Run-Time in ASP.NET MVC](#mvc-handling)|This example assigns an event hander to the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing) event at run-time.
[Modifying the Content of igPopover in the Handler of the Event](#modify-content)|This example demonstrates how to change the content of igPopover’s container using the handler for the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing) event.
[Re-Positioning igPopover in the Handler of the Event](#re-positioning-igPopover)|This example demonstrates how to change the position of the popover container using the [shown](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:shown) event at run-time.
...
This example assigns an event handling function to the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing) event at initialization.
...
This example assigns an event handler for the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing) event at run-time.
...
This example demonstrates how to change the content of `igPopover`’s container using the handler for the [showing](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:showing) event.
...
container using the
[shown](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#events:shown)
event at run-time.
