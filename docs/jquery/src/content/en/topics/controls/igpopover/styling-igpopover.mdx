...
| Header | The classes applied to the header container have effect only if the header has been defined in the options (i.e. the [headerTemplate.title](&#123;environment:jQueryApiUrl&#125;/ui.igpopover#options:headerTemplate.title) property has been set). | ui-igpopover-title |
