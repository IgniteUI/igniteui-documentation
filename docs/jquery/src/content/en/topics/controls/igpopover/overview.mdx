...
---|---
Body|<ApiLink type="igpopover" member="contentTemplate" section="options" label="contentTemplate" />
Header|<ApiLink type="igpopover" member="headerTemplate.title" section="options" label="headerTemplate.title" />
Close button|<ApiLink type="igpopover" member="headerTemplate.closeButton" section="options" label="headerTemplate.closeButton" />
...
[**Single/multiple targets**](#single-multiple-targets)|You can configure the popover display over multiple targets. Using the option <ApiLink type="igpopover" member="selectors" section="options" label="selectors" />, can specify which elements should display popovers.
...
The side of the target on which the popover is displayed is called “direction” and is configured by setting the  <ApiLink type="igpopover" member="direction" section="options" label="direction" /> option.
...
If the popover is larger than the target you can further configure its position along of the target DOM element. This is done with the <ApiLink type="igpopover" member="position" section="options" label="position" /> option.

In addition to that you can further restrict the positioning by providing a container (DIV element for example) whose boundaries serve to restrict the area within which the popover can be shown. The restricting area where the popover should be shown is configurable through the <ApiLink type="igpopover" member="containment" section="options" label="containment" /> for the popover.
...
-   [Configuring igPopover](/configuring-igpopover.mdx)
...
You can control the event on which the popover to be shown. This is managed with the <ApiLink type="igpopover" member="showOn" section="options" label="showOn" /> option. The user actions on which `igPopover` can be activated are:
...
-   [Configuring igPopover](/configuring-igpopover.mdx)
-   [igPopover Property Reference](./07_API Links/00_igPopover_Property_Reference.mdx)

### <a id="single-multiple-targets"></a>Single/multiple targets

You can configure the popover display over multiple targets. Using the <ApiLink type="igpopover" member="selectors" section="options" label="selectors" /> option you can specify on which elements the popovers should appear.
...
<table class="table table-bordered">
	<thead>
		<tr>
            <th width="70" colspan="2">Configurable aspect</th>
            <th>Details</th>
            <th>Properties</th>
</tr>
	</thead>
	<tbody>
        ...
        <tr>
            <td width="70" colspan="2">Target</td>
        ...
        <tr>
            <td width="70" colspan="2">Activation</td>
        ...
        <tr>
            <td width="70" colspan="2">Size and dimensions</td>
        ...
        <tr>
            <td width="70" colspan="2">Pointer</td>
...
The <ApiLink type="igpopover" member="direction" section="options" label="direction" /> and <ApiLink type="igpopover" member="position" section="options" label="position" /> in which the popover shows relative to the target element are also configurable.
...
For a listing of `igPopover`‘s default property settings, refer to the [igPopover Property Reference](./07_API Links/00_igPopover_Property_Reference.mdx) topic.
...
- [Configuring igPopover](/configuring-igpopover.mdx): This topic explains how to configure the features and behavior of the `igPopover` control.
