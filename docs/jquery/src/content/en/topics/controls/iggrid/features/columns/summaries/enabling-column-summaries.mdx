---
title: "Enabling Column Summaries (igGrid)"
...
-   The required scripts for both jQuery and MVC sample are the same because both render jQuery widgets. You will need:
    ...
    3.  The &#123;environment:ProductName&#125; library scripts
...
5. Running sample
    <Sample src="/grid/summaries/index.html" height={428} alt="igGrid Summaries"/>
...
- [Configuring Column Summaries (igGrid)](/iggrid-configuring-column-summaries.mdx)
...
-   [Column Summaries](&#123;environment:SamplesUrl&#125;/grid/summaries)
-   [Summaries (Remote Calculation)](&#123;environment:SamplesUrl&#125;/grid/summaries-remote)
-   [Custom Summaries](&#123;environment:SamplesUrl&#125;/grid/summaries-custom)
