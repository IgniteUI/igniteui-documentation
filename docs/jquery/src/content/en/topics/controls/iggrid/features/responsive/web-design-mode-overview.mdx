...
| --- | --- | --- |
| Column hiding | You can specify which columns to be visible and which – hidden in each respective RWD mode profile. **Related topics** [Configuring Column Hiding](/configure/iggrid-responsive-web-design-mode-configuring-column-hiding.mdx) | When configuring on CSS Media Queries basis (using CSS classes): <ApiLink type="iggridresponsive" member="columnSettings" section="options" label="columnSettings" /> <ApiLink type="iggridresponsive" member="columnSettings.columnKey" section="options" label="columnSettings.columnKey" /> <ApiLink type="iggridresponsive" member="columnSettings.classes" section="options" label="columnSettings.classes" /> When configuring on a per-column basis(using configuration settings): <ApiLink type="iggridresponsive" member="columnSettings" section="options" label="columnSettings" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration" section="options" label="columnSettings.configuration.desktop.hidden" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration" section="options" label="columnSettings.configuration.tablet.hidden" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration" section="options" label="columnSettings.configuration.phone.hidden" /> columnSettings.configuration.&lt;custom_mode&gt;.hidden |
| Column template | You can specify an individual column template for each RWD mode profile. Column templates are defined individually for each column. **Related topics** [Configuring Column Templates](/configure/iggrid-responsive-web-design-mode-configuring-row-and-column-templates.mdx) | <ApiLink type="iggridresponsive" member="columnSettings" section="options" label="columnSettings" /> <ApiLink type="iggridresponsive" member="columnSettings.columnKey" section="options" label="columnSettings.columnKey" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration.desktop.template" section="options" label="columnSettings.configuration.desktop.template" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration.tablet.template" section="options" label="columnSettings.configuration.tablet.template" /> <ApiLink type="iggridresponsive" member="columnSettings.configuration.phone.template" section="options" label="columnSettings.configuration.phone.template" /> columnSettings.configuration.&lt;custom_mode&gt;.template |
| RWD mode profiles | You can specify custom RWD mode profiles in addition to the pre-defined profiles. **Related topics** [Creating Custom Responsive Web Design (RWD) Mode Profiles](/configure/iggrid-responsive-web-design-mode-creating-custom-profile.mdx) | <ApiLink type="iggridresponsive" member="responsiveModes" section="options" label="responsiveModes" /> responsiveModes.&lt;custom_mode&gt; |
...
By default, RWD mode is configured to use `$.ig.InfragisticsMode` class as a provider for the RWD mode configuration. This is done in the <ApiLink type="iggridresponsive" member="responsiveModes" section="options" label="responsiveModes" /> option, which contains the RWD mode profiles where each profile is a string containing the name of the class which implements the logic of profile switching. The following table lists the default settings of the respective properties.

Property | Type | Default Value | Description
---|---|---|---
<ApiLink type="iggridresponsive" member="responsiveModes.desktop" section="options" label="responsiveModes.desktop" /> | string | “infragistics” | The desktop profile is provided by `$.ig.InfragisticsMode` class.
<ApiLink type="iggridresponsive" member="responsiveModes.tablet" section="options" label="responsiveModes.tablet" /> | string | “infragistics” | The tablet profile is provided by `$.ig.InfragisticsMode` class.
<ApiLink type="iggridresponsive" member="responsiveModes.phone" section="options" label="responsiveModes.phone" /> | string | “infragistics” | The phone profile is provided by `$.ig.InfragisticsMode` class.
