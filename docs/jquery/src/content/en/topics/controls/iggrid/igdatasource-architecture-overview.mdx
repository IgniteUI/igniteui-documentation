---
title: "igGrid/igDataSource Architecture Overview"
...
> **Note:** The controls listed above are included in the \{environment:ProductName\} data source JavaScript library.
