...
---|---|---
Configure tooltip style for touch devices | The `igGrid` Tooltip is configured to show as popover and to be compatible for touch devices | <ApiLink type="iggridtooltips" member="style" section="options" label="style" />
...
---|---|---
Show popover tooltip on click/tap | <ApiLink type="iggridtooltips" member="style" section="options" label="style" /> | popover
...
> **Note:** The table below lists the tooltip properties, which are ignored when the <ApiLink type="iggridtooltips" member="style" section="options" label="style" /> is set to popover. This is because they are Desktop specific and don’t work in touch browsers.

Property | State when popover style is enabled
---|---
<ApiLink type="iggridtooltips" member="hideDelay" section="options" label="hideDelay" /> | ignored
<ApiLink type="iggridtooltips" member="showDelay" section="options" label="showDelay" /> | ignored
<ApiLink type="iggridtooltips" member="cursorLeftOffset" section="options" label="cursorLeftOffset" /> | ignored
<ApiLink type="iggridtooltips" member="cursorTopOffset" section="options" label="cursorTopOffset" /> | ignored
...
| --- | --- | --- | --- |
| <ApiLink type="iggridtooltips" member="style" section="options" label="style" /> | string | This property allows you to change the look and behavior of the `igGrid` tooltip feature., Recommended Value:, `popover` | tooltip |
