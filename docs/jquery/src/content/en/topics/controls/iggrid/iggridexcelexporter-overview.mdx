---
title: "Grid Excel Exporter Overview"
...
## Required Background
- [&#123;environment:ProductName&#125; Overview](IgniteUI-for-jQuery-Overview.html "&#123;environment:ProductName&#125; Overview") - General information on the &#123;environment:ProductName&#125;™ library.  
...
For more information on all the available properties of the exporter you can explore the [API documentation](&#123;environment:jQueryApiUrl&#125;/ig.gridexcelexporter#overview).


### <a id="Preview"></a>Preview
The following is a preview of the final result.

<Sample src="/grid/export-basic-grid/index.html" height={428} alt="Grid Export Basic Grid"/>
 
## Related Content

### Topics
- [Using the JavaScript Excel Library](../../09_JavaScript Excel Library/01_Using/~Using_The_JavaScript_Excel_Library.mdx)
- [JavaScript Excel Library Overview](../../09_JavaScript Excel Library/00_Understanding/JavaScript_Excel_Library_Overview.mdx)

### <a id="samples"></a> Samples

-   [Export Basic Grid to Excel](&#123;environment:SamplesUrl&#125;/grid/export-basic-grid)
-   [Exporting Grid to Excel with Features](&#123;environment:SamplesUrl&#125;/grid/export-feature-rich-grid)
-   [Customizing Grid Excel Export](&#123;environment:SamplesUrl&#125;/grid/export-client-events)
