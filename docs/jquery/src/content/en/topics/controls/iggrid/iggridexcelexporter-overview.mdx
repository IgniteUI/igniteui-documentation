...
For more information on all the available properties of the exporter you can explore the <ApiLink pkg="ig" type="gridexcelexporter" label="API documentation" />.
