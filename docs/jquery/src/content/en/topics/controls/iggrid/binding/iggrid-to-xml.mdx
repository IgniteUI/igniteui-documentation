...
The &#123;environment:ProductName&#125;™ data source control , or `igDataSource`, can seamlessly bind to both namespaced, as well as non-namespaced XML documents. 
...
![](../../../data-sources/igdatasource/images/Binding_to_XML_01.png)


<Sample src="/grid/xml-binding/index.html" height={428} alt="XML Binding"/>

## Related Topics

-   [igDataSource Overview](///data-sources/igdatasource/igdatasource-overview.mdx)
-   [Performing Data Transformations Using DataSchema (igDataSource)](///data-sources/igdatasource/using-dataschema.mdx)
