...
- [Creating a Basic Column Template in the igGrid](./00_Creating a Basic Column Template in the igGrid.mdx): This topic demonstrates how to create basic column template for the `igGrid`
