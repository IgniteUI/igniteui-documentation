---
title: "Extending igGrid Modal Dialog"
...
- [Custom Modal Dialog](\{environment:SamplesUrl\}/grid/customize-updating)

### <a id="topics"></a> Topics

-   [Row Edit Dialog (igGrid)](/updating/row-template/iggrid-updating-roweditdialog-landingpage.mdx)
-   [Configuring the Column Chooser (igGrid)](/columns/hiding/iggrid-hiding-column-chooser.mdx)
-   [Group By Dialog Overview (igGrid)](/columns/grouping/iggrid-group-by-dialog-overview.mdx)
-   [Column Moving Overview (igGrid)](/columns/moving/iggrid-columnmoving-overview.mdx)
-   [Filtering (igGrid)](/columns/iggrid-filtering.mdx)
-   [Multiple Sorting Dialog (igGrid)](/columns/sorting/iggrid-multiple-sorting-dialog.mdx)