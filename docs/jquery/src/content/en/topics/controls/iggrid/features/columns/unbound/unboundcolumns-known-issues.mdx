---
title: "Known Issues and Limitations (Unbound Columns, igGrid)"
...
## Remote Filtering, Sorting and GroupBy features
...
## Using GridModel.SetUnboundValues(&lt;Column key&gt;, &lt;Dictionary of values &gt;) requires setting PrimaryKey
...
## Unbound Columns and chaining with remote URL
...
## Remote data source, Paging and initial unboundValues
...
## When MergeUnboundColumns=true then formula can’t be used to set values of unbound column
...
## MergeUnboundColumns = false and a boolean unbound column
...
- [Known Issues and Limitations (igGrid)](///iggrid-known-issues.mdx): This topic explains the known issues of the `igGrid` control.

- [Known Issues Revision History](/////known-issues/known-issues-revision-history/revision-history.mdx): This group of topics explains the known issues of &#123;environment:ProductName&#125; controls between the volume releases.
