...
-   Enabling/disabling column resizing. This feature is managed through the <ApiLink type="igGridResizing" member="columnSettings.allowResizing" section="options" label="allowResizing" /> property.

-   Enabling auto-sizing on double click – when enabled, resizes the column to the width of the widest cell content (including header and footer cells) that is currently visible. This feature is managed through the <ApiLink type="igGridResizing" member="allowDoubleClickToResize" section="options" label="allowDoubleClickToResize" /> option.

-   Maximum/minimum column width – the minimum/maximum width to which the user can change the width of a column when performing resizing. This feature is managed through the <ApiLink type="igGridResizing" member="columnSettings.minimumWidth" section="options" label="minimumWidth" />/<ApiLink type="igGridResizing" member="columnSettings.maximumWidth" section="options" label="maximumWidth" /> properties, respectively.

-   Deferred resizing - resizing is deferred until the user finishes resizing or applied immediately. This feature is managed through the <ApiLink type="igGridResizing" member="deferredResizing." section="options" label="deferredResizing" /> option.

-   Configurable resizing handle – the width in pixels of the resizing handle on the right of each resizable column header can be customized. This feature is managed through the <ApiLink type="igGridResizing" member="handleTreshold" section="options" label="handleTreshold" /> option.

-   Column Key – specifies a column which will apply specified column settings. This feature is managed through the <ApiLink type="igGridResizing" member="columnSettings.columnKey" section="options" label="columnKey" /> option.

-   Column index - specifies a column which will apply specified column settings.This feature is managed through the <ApiLink type="igGridResizing" member="columnSettings.columnIndex" section="options" label="columnIndex" /> option.
...
| --- | --- |
| <ApiLink type="igGridResizing" member="columnResizing" section="events" label="columnResizing" /> | columnIndex: Current selected grid column index, columnKey: Current selected grid column key, owner: Reference to the resizing widget object, desiredWidth: The desired width of the current selected column |
| <ApiLink type="igGridResizing" member="columnResized" section="events" label="columnResized" /> | columnIndex: Current selected grid column index, columnKey: Current selected grid column key, owner: Reference to the resizing widget object, originalWidth: The original width of the current selected column, newWidth: The new width of the current selected column |
...
--------------|------------------------|------------
<ApiLink type="igGridResizing" member="allowDoubleClickToResize" section="options" label="allowDoubleClickToResize" /> | Boolean (default: True) | Enables/disables Resize the column to the size of the longest currently visible cell value
<ApiLink type="igGridResizing" member="deferredResizing" section="options" label="deferredResizing" /> | Boolean (default: False) | Specifies whether the resizing should be deferred until the user finishes resizing or the resizing should be applied immediately.
<ApiLink type="igGridResizing" member="handleTreshold" section="options" label="handleTreshold" /> | Int (default: 5) | The width in pixels of the resizing handle which is position at the right side of each resizeable column header.
...
-   [igGrid Features](/iggrid-features-landing-page.mdx)
