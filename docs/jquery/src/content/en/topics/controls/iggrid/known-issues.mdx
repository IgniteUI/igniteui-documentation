...
### <a id="updating-edit-virtualization"></a> Updating rows/cells when the Updating and Continuous Virtualization features are enabled while <ApiLink type="iggrid" member="autoCommit" section="options" label="autoCommit" /> is disabled is not supported.
