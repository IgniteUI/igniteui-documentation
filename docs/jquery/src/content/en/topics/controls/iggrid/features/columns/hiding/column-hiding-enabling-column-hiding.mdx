---
title: "Enabling Column Hiding (igGrid)"
...
- [igGrid Configuration: Columns](/iggrid-configure-column-hiding.mdx)
...
- [Column Management](&#123;environment:SamplesUrl&#125;/grid/column-management)
