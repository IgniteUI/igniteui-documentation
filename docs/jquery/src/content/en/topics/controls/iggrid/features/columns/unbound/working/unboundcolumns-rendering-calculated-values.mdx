---
title: "Rendering Calculated Values (Unbound Columns, igGrid)"
...
- [Populating Unbound Columns Locally (igGrid)](/populate/iggrid-unboundcolumns-populating-with-data-locally.mdx): This topic demonstrates, with code samples how to set unbound column values on the client.

- [Populating Unbound Columns Remotely (igGrid)](/populate/iggrid-unboundcolumns-populating-with-data-remotely.mdx): This topic demonstrates, with code samples how to set unbound column values on the server.
