---
title: "Row Edit Dialog Overview (igGrid)"
...
- [igGrid Overview](///iggrid-overview.mdx): The `igGrid` is a jQuery-based client-side grid that is responsible for presenting and manipulating tabular data. Its whole lifecycle is on the client-side, which makes it independent from server-side technology.

- [Updating Overview (igGrid)](/iggrid-updating.mdx): This topic explains how to use the updating feature of the `igGrid`™ control.

- [igTemplating](../../../../../06_Infragistics-Templating-Engine/~Infragistics Templating Engine.mdx): This topic covers the use the Infragistics® Templating Engine.
...
| --- | --- | --- | --- |
| [editMode](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:editMode) | “row\|cell\|**dialog**\|none\|null” | The `editMode` property has a new value added, **dialog** | row |
...
You can use the public API methods [startEdit](&#123;environment:jQueryApiUrl&#125;/ui.igGridUpdating#methods:startEdit) and [endEdit](&#123;environment:jQueryApiUrl&#125;/ui.igGridUpdating#methods:endEdit) in order to open/close the row edit dialog.
...
- [showReadonlyEditors](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:showReadonlyEditors)
...
- [containment](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.containment)
...
- [dialogTemplate](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.dialogTemplate:"")
...
- [editorsTemplate](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.editorsTemplate:"")
...
- [dialogTemplateSelector](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.dialogTemplateSelector)
...
- [editorsTemplateSelector](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.editorsTemplateSelector)
...
- [height](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.height)
...
- [width](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.width)
...
- [namesColumnWidth](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:rowEditDialogOptions.namesColumnWidth)
...
- [startEditTriggers](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:startEditTriggers)
...
- [doneLabel](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:doneLabel)

	This property controls the text for the *Done* button in the row edit dialog.

- [cancelLabel](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#options:cancelLabel)
...
|Event|Description|
|---|---|
|[rowEditDialogBeforeOpen](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#events:rowEditDialogBeforeOpen)|This event is fired before the row edit dialog is opened. It is not cancelable.|
|[rowEditDialogAfterOpen](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#events:rowEditDialogAfterOpen)|This event is fired after the row edit dialog is opened.|
|[rowEditDialogContentsRendered](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#events:rowEditDialogContentsRendered)|This event is fired after the contents of the row edit dialog are rendered.|
|[rowEditDialogBeforeClose](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#events:rowEditDialogBeforeClose)|This event is fired before the row edit dialog is closed. It is not cancelable.|
|[rowEditDialogAfterClose](&#123;environment:jQueryApiUrl&#125;/ui.iggridupdating#events:rowEditDialogAfterClose)|This event is fired after the row edit dialog is closed.|
...
<Sample src="/grid/row-edit-dialog/index.html" height={428} alt="Row Edit Dialog"/>