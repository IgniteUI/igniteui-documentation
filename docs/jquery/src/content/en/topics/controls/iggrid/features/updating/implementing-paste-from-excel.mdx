---
title: "Implementing Paste from Excel in igGrid"
...
1. Configure an igGrid with Updating and Selection features.
    ...
    - [Enabling Updating](./00_igGrid_Updating.mdx#enable)
    - [Enabling Selection](../03_Selection/00_igGrid_Selection_Overview.mdx#enabling-selection)
...
<Sample src="/grid/paste-from-excel/index.html" height={428} alt="Paste from Excel"/>
