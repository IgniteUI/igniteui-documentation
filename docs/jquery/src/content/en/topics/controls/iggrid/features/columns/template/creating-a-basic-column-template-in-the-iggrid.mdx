---
title: "Creating a Basic Column Template (igGrid)"
slug: creating-a-basic-column-template-in-the-iggrid
---
...
<Sample src="/grid/column-template/index.html" height={428} alt="Column Template"/>
