...
-   [`moveColumn`](&#123;environment:jQueryApiUrl&#125;/ui.iggridcolumnmoving#methods:moveColumn) – moves the columns in the grid to a specified position defined as relative to another column in the grid
-   [`destroy`](&#123;environment:jQueryApiUrl&#125;/ui.iggridcolumnmoving#methods:destroy) – destroys the feature
