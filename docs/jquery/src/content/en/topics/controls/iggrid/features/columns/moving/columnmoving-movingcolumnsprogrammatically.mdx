---
title: "Moving Columns Programmatically (igGrid)"
...
-   <ApiLink type="iggridcolumnmoving" member="moveColumn" section="methods" label="moveColumn" /> – moves the columns in the grid to a specified position defined as relative to another column in the grid
-   <ApiLink type="iggridcolumnmoving" member="destroy" section="methods" label="destroy" /> – destroys the feature
...
Example | Description
---|---
[Moving a Column By Re-Rendering the Grid](#example-render) | This code example demonstrates moving a column using [Grid Re-Rendering](./00_igGrid_ColumnMoving_Overview.mdx#type).
[Moving a Column By DOM Manipulation](#example-dom) | This code example demonstrates moving a column using [DOM Manipulation](./00_igGrid_ColumnMoving_Overview.mdx#type).
...
The code in this example moves the Product Number column between the Product ID and Product Name column. The actual moving is performed by [Grid Re-Rendering](./00_igGrid_ColumnMoving_Overview.mdx#type).
...
The code in this example moves the Product Number column between the Product ID and Product Name column. The actual moving is performed by [DOM Manipulation](./00_igGrid_ColumnMoving_Overview.mdx#type).
...
The [move type](./00_igGrid_ColumnMoving_Overview.mdx#type) in the example is DOM Manipulation (`inDOM` is *true*).
