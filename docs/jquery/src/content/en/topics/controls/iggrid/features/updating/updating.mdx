...
## <a id="adding-using-CLI"></a> Adding igGrid with Updating feature enabled using the &#123;environment:ProductFamilyName&#125; CLI
...
<Sample src="/grid/editing-api-events/index.html" height={428} alt="igGrid Editing API and Events"/>
