---
title: "Configuring Single Column Template (igGrid, RWD Mode)"
...
The templates per specific profile are specified via the <ApiLink type="iggridresponsive" member="singleColumnTemplate" section="options" label="singleColumnTemplate" /> option of the Responsive Web Design Mode feature. 
...
<Sample src="/grid/responsive-single-column-template/index.html" height={428} alt="Responsive Single Column Template"/>
