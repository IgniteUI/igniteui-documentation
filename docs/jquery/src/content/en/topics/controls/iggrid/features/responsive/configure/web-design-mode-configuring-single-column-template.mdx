...
The templates per specific profile are specified via the [`singleColumnTemplate`](&#123;environment:jQueryApiUrl&#125;/ui.iggridresponsive#options:singleColumnTemplate) option of the Responsive Web Design Mode feature. 
