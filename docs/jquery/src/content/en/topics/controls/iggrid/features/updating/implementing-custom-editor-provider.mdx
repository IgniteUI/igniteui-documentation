---
title: "Implementing Custom Editor Provider"
...
Updating comes with a set of editor providers that wrap the [&#123;environment:ProductName&#125; Editors](igEditors-LandingPage.html) to provide feature rich experience for the end user.
...
## Implementing custom editor providers
...
### Example on how to wrap HTML 5 number INPUT into an editor provider
...
-	[Editing: Custom Editor Provider](&#123;environment:NewSamplesUrl&#125;/grid/editing-custom-editor-provider)