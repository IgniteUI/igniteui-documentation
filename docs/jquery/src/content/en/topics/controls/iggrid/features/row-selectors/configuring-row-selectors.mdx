...
## RowSelectors Configuration Overview
...
Selection checkboxes | Determines whether the row selectors column should contain checkboxes | <ApiLink type="iggridrowselectors" member="enableCheckBoxes" section="options" label="enableCheckBoxes" />
Row numbering | The row selectors column can contain row numbers if a property is enabled. | <ApiLink type="iggridrowselectors" member="enableRowNumbering" section="options" label="enableRowNumbering" />
Canceling the check box state changing event | Hook to `checkBoxStateChanging` event and cancel it on some condition. | –
Row numbering seed | The seed is added to the default numbering. | <ApiLink type="iggridrowselectors" member="rowNumberingSeed" section="options" label="rowNumberingSeed" />
Width of the row selectors column. | The width of row selectors column is configurable by setting a property. | <ApiLink type="iggridrowselectors" member="rowSelectorColumnWidth" section="options" label="rowSelectorColumnWidth" />
...
Require Selection | Requires the selection feature to be enabled. If selection is not enabled, an exception is thrown | <ApiLink type="iggridrowselectors" member="requireSelection" section="options" label="requireSelection" />
...
## Enabling Selection across all pages
...
### Property settings for enabling "Select All" functionality
...
### Property settings for enabling checkboxes
...
### Property settings for enabling row numbering
...
## Canceling the Check Box State Changing Event
