...
-   Feature name is changed from “igGridLoadOnDemand” to “[igGridAppendRowsOnDemand](&#123;environment:jQueryApiUrl&#125;/ui.igGridAppendRowsOnDemand)”. You need to replace all your API calls to the new feature name.
-   In igGrid [features](&#123;environment:jQueryApiUrl&#125;/ui.iggrid#options:features) option array the feature is renamed from “LoadOnDemand” to “AppendRowsOnDemand”
