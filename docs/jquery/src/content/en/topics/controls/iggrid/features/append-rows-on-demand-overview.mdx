---
title: "Append Rows On Demand Overview"
...
As noted previously the feature was renamed from “Load on Demand” to “Append Rows on Demand” in order to differentiate from other functionality with the same name. In order to upgrade from previous versions of &#123;environment:ProductName&#125; you need to know the following information:
...
-   Feature name is changed from “igGridLoadOnDemand” to “<ApiLink type="igGridAppendRowsOnDemand" label="igGridAppendRowsOnDemand" />”. You need to replace all your API calls to the new feature name.
-   In igGrid <ApiLink type="iggrid" member="features" section="options" label="features" /> option array the feature is renamed from “LoadOnDemand” to “AppendRowsOnDemand”
...
- [Feature Matrix (igGrid)](./14_Feature_Compatibility_Matrix(igGrid).mdx)
...
<Sample src="/grid/append-rows-on-demand/index.html" height={428} alt="Append Rows on Demand"/>