...
### <a id="adding-using-CLI"></a> Create igGrid with Excel Exporting configured using the &#123;environment:ProductFamilyName&#125; CLI
...
<Sample src="/grid/export-client-events/index.html" height={428} alt="Grid Export Client Events"/>