---
title: "Binding igGrid to DataTable"
...
- [igGrid/igDataSource Architecture Overview](/iggrid-igdatasource-architecture-overview.mdx): This topic explains the inner workings of `igGrid` and how it collaborates with `igDataSource` to enable binding to different data sources.

- [igGrid Updating](/features/updating/iggrid-updating.mdx): This topic explains how to use the Updating feature of the `igGrid` control.

- [Developing ASP.NET MVC Applications with igGrid](/iggrid-developing-asp-net-mvc-applications-with-iggrid.mdx): This topic explains how to use `igGrid` in ASP.NET MVC Applications
...
### Manually creating the columns of \{environment:ProductNameMVC\} Grid in the view
...
- [Binding igHierarchicalGrid to DataSet](//ighierarchicalgrid/bind/binding-to-dataset.mdx): This topic shows how to configure the `igHierarchicalGrid` ™ control in order to bind it to `DataSet`
