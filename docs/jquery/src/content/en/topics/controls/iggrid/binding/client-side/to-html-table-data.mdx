---
title: "Binding igGrid to HTML Table Data"
...
The &#123;environment:ProductName&#125;® `igGrid`, allows binding to existing plain HTML tables, through the `igDataSource` control. There are several points to consider when binding to a HTML table.
...
**Running Sample**
<Sample src="/grid/html-binding/index.html" height={428} alt="Grid Html Binding"/>
## Known Issues and Limitations
The `igGrid` has [known limitations](//iggrid-known-issues.mdx) that should be taken into account.
## Related topics
