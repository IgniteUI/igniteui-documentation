---
title: "Cell Merging Overview (igGrid)"
slug: iggrid-cellmerging-overview
---
...
You may use the predefined CSS classes in order to customize the look of the merged cells. For more information regarding the styling, please refer to the <ApiLink type="iggridcellmerging" label="CSS Classes Reference" /> topic.


#### Physical Cell Merging
...
The resulting merged cells can be styled through a custom CSS class called <ApiLink type="iggridcellmerging" label="*ui-iggrid-physicalmergedcell*" />. It could be used to position the text of the cells differently.
...
### Enabling Cell Merging in JavaScript
...
### Enabling Cell Merging in ASP.NET MVC
...
## Configuring when Cell Merging is applied
...
- [igGrid Cell Merging - Advanced Cutomization](/iggrid-cellmerging-advanced.mdx)
