...
You may use the predefined CSS classes in order to customize the look of the merged cells. For more information regarding the styling, please refer to the [CSS Classes Reference](&#123;environment:jQueryApiUrl&#125;/ui.iggridcellmerging#theming) topic.
...
The resulting merged cells can be styled through a custom CSS class called [*ui-iggrid-physicalmergedcell*](&#123;environment:jQueryApiUrl&#125;/ui.iggridcellmerging#theming:ui-iggrid-physicalmergedcell). It could be used to position the text of the cells differently.
...
<Sample src="/grid/cell-merging/index.html" height={428} alt="Cell Merging"/>
