---
title: "Enabling Tooltips (igGrid)"
...
-   jQuery-specific requirements
    -   An HTML web page with an [`igGrid`](//iggrid-overview.mdx) connected to a data source.
-   MVC-specific requirements
    -   An MVC 4 or above project in MS Visual Studio® with a [&#123;environment:ProductNameMVC&#125; Grid](//iggrid-overview.mdx) connected to a data source
...
## Adding &#123;environment:ProductNameMVC&#125; Grid Tooltips
...
- [igGrid Known Issues](//iggrid-known-issues.mdx)
