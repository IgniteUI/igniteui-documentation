---
title: "GroupBy Summaries Feature Overview (igGrid)"
...
In order to enable the group summaries feature the [`groupSummaries`](&#123;environment:jQueryApiUrl&#125;/ui.iggridgroupby#options:groupSummaries) option should be enabled:
...
---|---
[columnSettings.groupSummaries](&#123;environment:jQueryApiUrl&#125;/ui.iggridgroupby#options:columnSettings.groupSummaries) | The particular column only.
[groupSummaries](&#123;environment:jQueryApiUrl&#125;/ui.iggridgroupby#options:groupSummaries) | All columns.
