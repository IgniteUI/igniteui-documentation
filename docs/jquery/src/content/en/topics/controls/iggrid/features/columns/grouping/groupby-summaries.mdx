...
In order to enable the group summaries feature the <ApiLink type="iggridgroupby" member="groupSummaries" section="options" label="groupSummaries" /> option should be enabled:
...
---|---
<ApiLink type="iggridgroupby" member="columnSettings.groupSummaries" section="options" label="columnSettings.groupSummaries" /> | The particular column only.
<ApiLink type="iggridgroupby" member="groupSummaries" section="options" label="groupSummaries" /> | All columns.
