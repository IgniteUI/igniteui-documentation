---
title: "Virtualization Overview (igGrid)"
...
Checkout the [Feature Compatibility Matrix (igGrid)](../14_Feature_Compatibility_Matrix(igGrid).mdx) for the list of the grid features that work in combination with Fixed Row Virtualization.
...
-   [Enabling and Configuring Virtualization (Fixed)](./01_igGrid_Enabling_and_Configuring_Virtualization.mdx#fixed-row)
...
Checkout the [Feature Compatibility Matrix (igGrid)](../14_Feature_Compatibility_Matrix(igGrid).mdx) for the list of the grid features that work in combination with Column Virtualization.
...
-   [Enabling and Configuring Virtualization (Column)](./01_igGrid_Enabling_and_Configuring_Virtualization.mdx#column)
...
Checkout the [Feature Compatibility Matrix (igGrid)](../14_Feature_Compatibility_Matrix(igGrid).mdx) for the list of the grid features that work in combination with Continuous Row Virtualization.
...
-   [Enabling and Configuring Virtualization (Continuous)](./01_igGrid_Enabling_and_Configuring_Virtualization.mdx#continuous)
...
- [Enabling and Configuring Virtualization](/iggrid-enabling-and-configuring-virtualization.mdx): This topic explains, with code examples, how to enable and configure the Virtualization feature in the `igGrid`.
- [Performance Guide](//iggrid-performance-guide.mdx): This topic explains in more details the different grid settings that can further improve the performance.
- [Feature Compatibility Matrix (igGrid)](../14_Feature_Compatibility_Matrix(igGrid).mdx): This topic show the compatible feature combinations in `igGrid`.
