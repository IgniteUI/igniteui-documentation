...
4. Once the above setup is complete, begin to **set options** including *ID*, *columns* and *dataSource*.
    ...
    1.  [columns](&#123;environment:jQueryApiUrl&#125;/ui.iggrid#options:columns) – the column object definition for `igGrid`
    ...
    2.  [dataSource](&#123;environment:jQueryApiUrl&#125;/ui.iggrid#options:dataSource) – the data that the `igGrid` is displaying data for. Options include:
	    -   JSON object
	    -   JavaScript array
	    -   XML
	    -   Remote data
