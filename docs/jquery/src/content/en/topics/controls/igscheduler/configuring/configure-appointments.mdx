...
A collection of all appointments for the given time range can be retrieved by the [getAppointmentsInRange method](&#123;environment:jQueryApiUrl&#125;/ui.igscheduler#methods:getAppointmentsInRange)
...
Appointments can be added by using the [createAppointment method](&#123;environment:jQueryApiUrl&#125;/ui.igscheduler#methods:createAppointment) by passing the appointment object as an argument .
...
Appointments can be edited by using the [editAppointment method](&#123;environment:jQueryApiUrl&#125;/ui.igscheduler#methods:editAppointment) that is taking as parameters the appointment object and an object containing the properties that will be changed.
...
Appointments can be deleted by using the [deleteAppointment method](&#123;environment:jQueryApiUrl&#125;/ui.igscheduler#methods:deleteAppointment) which needs to be passed the appointment object as an argument.
