---
title: "Configuring Appointments (igScheduler)"
...
A collection of all appointments for the given time range can be retrieved by the <ApiLink type="igscheduler" member="getAppointmentsInRange" section="methods" label="getAppointmentsInRange method" />
...
Appointments can be added by using the <ApiLink type="igscheduler" member="createAppointment" section="methods" label="createAppointment method" /> by passing the appointment object as an argument .
...
Appointments can be edited by using the <ApiLink type="igscheduler" member="editAppointment" section="methods" label="editAppointment method" /> that is taking as parameters the appointment object and an object containing the properties that will be changed.
...
Appointments can be deleted by using the <ApiLink type="igscheduler" member="deleteAppointment" section="methods" label="deleteAppointment method" /> which needs to be passed the appointment object as an argument.
