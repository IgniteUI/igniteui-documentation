...
4.  Once the above setup is complete, initialize the text editor and set needed options, such as [`width`](&#123;environment:jQueryApiUrl&#125;/ui.igTextEditor#options:width), [`placeHolder`](&#123;environment:jQueryApiUrl&#125;/ui.igTextEditor#options:placeHolder) etc. 
