---
title: "igMaskEditor Accessibility Compliance"
...
| (n) | When `igMaskEditor` is on focus(edit mode) keyboard navigation is available. See the [Editors Keyboard Navigation topic](/igmaskeditor-keyboard-navigation.mdx) for a detailed list of available key operations and their respective action. |
