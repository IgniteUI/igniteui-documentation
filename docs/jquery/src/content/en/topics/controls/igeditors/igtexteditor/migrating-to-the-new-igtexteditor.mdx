---
title: "Migrating to the new igTextEditor"
slug: migrating-to-the-new-igtexteditor
---
import ApiLink from 'docs-template/components/mdx/ApiLink.astro';

# Migrating to the new igTextEditor

With the 15.2 release of &#123;environment:ProductName&#125;™ a new set of editor controls were introduced including a reworked `igTextEditor`. With a new design focused on simplicity and better UX out-of-the-box some features and their API were revised, removed and new ones added. This topic will cover the differences that will be helpful for developers migrating their applications to the new editors.
...
Option| Description
---|---
<ApiLink type="igtexteditor" member="allowNullValue" section="options" label="allowNullValue" />|<a name='allowNullValue'></a>If that option is false, and editor has no value, then value is set to an empty string.
<ApiLink type="igtexteditor" member="disabled" section="options" label="disabled" />|<a name='disabled'></a>Use to set the disabled attribute. Does not allow editing. Disables all the buttons and iteracitons applied. On submit the current value is not sent into the request: `$('#textEditor').igTextEditor({ disabled: true })`.
<ApiLink type="igtexteditor" member="buttonType" section="options" label="buttonType" />|<a name='buttonType'></a>Sets gets visibility of spin, clear and drop-down button.
<ApiLink type="igtexteditor" member="listItemHoverDuration" section="options" label="listItemHoverDuration" />|<a name='listItemHoverDuration'></a>Use to set the hover/unhover animation duration of items inside the dropdown list: `$('#textEditor').igTextEditor({ listItems: ["A", "B", "C", "D"], listItemHoverDuration: 400 })`.
<ApiLink type="igtexteditor" member="dropDownAttachedToBody" section="options" label="dropDownAttachedToBody" />|<a name='dropDownAttachedToBody'></a>Gets sets location of drop-down list.
<ApiLink type="igtexteditor" member="dropDownAnimationDuration" section="options" label="dropDownAnimationDuration" />|<a name='dropDownAnimationDuration'></a>Gets sets show/hide drop-down list animation duration in milliseconds.
<ApiLink type="igtexteditor" member="visibleItemsCount" section="options" label="visibleItemsCount" />|<a name='visibleItemsCount'></a>Use to set how many items should be shown at once: `$('#textEditor').igTextEditor({ listItems: ["A", "B", "C", "D"], visibleItemsCount: 2 })`.
<ApiLink type="igtexteditor" member="isLimitedToListValues" section="options" label="isLimitedToListValues" />|<a name='isLimitedToListValues'></a>Use to set the ability to allow values only set into the list items. Matching is case-insensitive: `$('#textEditor').igTextEditor({ listItems: ["A", "B", "C", "D"], isLimitedToListValues: true })`.
<ApiLink type="igtexteditor" member="placeHolder" section="options" label="placeHolder" />|<a name='placeHolder'></a>Gets sets text which appears in editor when editor has no focus and "value" in editor is null or empty string.
<ApiLink type="igtexteditor" member="revertIfNotValid" section="options" label="revertIfNotValid" />|<a name='revertIfNotValid'></a>Use to set the editor to revert value to previous value in case of not valid value on blur, or enter key. If set to false clear is called: `$('#textEditor').igTextEditor({ listItems: ["A", "B", "C", "D"], isLimitedToListValues: true, revertIfNotValid: false })`.
<ApiLink type="igtexteditor" member="preventSubmitOnEnter" section="options" label="preventSubmitOnEnter" />|<a name='preventSubmitOnEnter'></a>Use to set the ability of the editor to prevent form submition on enter key pressed: `$('#textEditor').igTextEditor({ preventSubmitOnEnter: true })`.
<ApiLink type="igtexteditor" member="dropDownOrientation" section="options" label="dropDownOrientation" />|<a name='dropDownOrientation'></a>Use to set drop down opening orientation for the dorp down list when open button is clicked: `$('#textEditor').igTextEditor({ listItems: ["A", "B", "C", "D"], dropDownOrientation: 'top' })`.
<ApiLink type="igtexteditor" member="suppressNotifications" section="options" label="suppressNotifications" />|<a name='suppressNotifications'></a>Disables default notifications for basic validation scenarios built in the editors such as required list selection, value wrapping around or spin limits.

<ApiLink type="igtexteditor" label="See all options" />
...
Method|Description
---|---
<ApiLink type="igtexteditor" member="inputName" section="methods" label="inputName" />|<a name='inputName'></a>Gets sets name attribute applied to the editor element.
<ApiLink type="igtexteditor" member="displayValue" section="methods" label="displayValue" />|<a name='displayValue'></a>Returns a string with all the characters shown in the input.
<ApiLink type="igtexteditor" member="editorContainer" section="methods" label="editorContainer" />|<a name='editorContainer'></a>Gets reference to jquery object which is used as top/outer element of igEditor.
<ApiLink type="igtexteditor" member="dropDownContainer" section="methods" label="dropDownContainer" />|<a name='dropDownContainer'></a>Gets reference to jquery object which is used as container of drop-down.
<ApiLink type="igtexteditor" member="showDropDown" section="methods" label="showDropDown" />|<a name='showDropDown'></a>Show the dropdown list.
<ApiLink type="igtexteditor" member="hideDropDown" section="methods" label="hideDropDown" />|<a name='hideDropDown'></a>Hide the dropdown list.
<ApiLink type="igtexteditor" member="dropDownVisible" section="methods" label="dropDownVisible" />|<a name='dropDownVisible'></a>Returns the visibility state of the drop down listing the items.
<ApiLink type="igtexteditor" member="dropDownButton" section="methods" label="dropDownButton" />|<a name='dropDownButton'></a>Returns a reference to the dropdown button of the editor.
<ApiLink type="igtexteditor" member="clearButton" section="methods" label="clearButton" />|<a name='clearButton'></a>Returns a reference to the clear button of the editor.
<ApiLink type="igtexteditor" member="getSelectionStart" section="methods" label="getSelectionStart" />|<a name='getSelectionStart'></a>Gets start index of the selected text in editor.
<ApiLink type="igtexteditor" member="getSelectionEnd" section="methods" label="getSelectionEnd" />|<a name='getSelectionEnd'></a>Gets end index of the selected text in editor.
<ApiLink type="igtexteditor" member="insert" section="methods" label="insert" />|<a name='insert'></a>Paste text at location of caret.
<ApiLink type="igtexteditor" member="spinUp" section="methods" label="spinUp" />|<a name='spinUp'></a>Selects the previous item from the drop-down list.
<ApiLink type="igtexteditor" member="spinDown" section="methods" label="spinDown" />|<a name='spinDown'></a>Selects the next item from the drop-down list.
<ApiLink type="igtexteditor" member="spinUpButton" section="methods" label="spinUpButton" />|<a name='spinUpButton'></a>Returns a reference to the spin up button of the editor.
<ApiLink type="igtexteditor" member="spinDownButton" section="methods" label="spinDownButton" />|<a name='spinDownButton'></a>Returns a reference to the spin down button of the editor.

<ApiLink type="igtexteditor" label="See all API methods" />
...
Event|Description
---|---
<ApiLink type="igtexteditor" member="rendering" section="events" label="rendering" />|<a name='rendering'></a>Event which is raised before rendering of the editor completes.
<ApiLink type="igtexteditor" member="rendered" section="events" label="rendered" />|<a name='rendered'></a>Event which is raised after rendering of the editor completes.
<ApiLink type="igtexteditor" member="dropDownListOpening" section="events" label="dropDownListOpening" />|<a name='dropDownListOpening'></a>Event which is raised when the drop down is opening.
<ApiLink type="igtexteditor" member="dropDownListOpened" section="events" label="dropDownListOpened" />|<a name='dropDownListOpened'></a>Event which is raised when the drop down is already opened.
<ApiLink type="igtexteditor" member="dropDownListClosing" section="events" label="dropDownListClosing" />|<a name='dropDownListClosing'></a>Event which is raised when the drop down is closing.
<ApiLink type="igtexteditor" member="dropDownListClosed" section="events" label="dropDownListClosed" />|<a name='dropDownListClosed'></a>Event which is raised when the drop down is already closed.
<ApiLink type="igtexteditor" member="dropDownItemSelecting" section="events" label="dropDownItemSelecting" />|<a name='dropDownItemSelecting'></a>Event which is raised when the drop down list item is selecting.
<ApiLink type="igtexteditor" member="dropDownItemSelected" section="events" label="dropDownItemSelected" />|<a name='dropDownItemSelected'></a>Event which is raised when the drop down list item is selected.
<ApiLink type="igtexteditor" member="mouseout" section="events" label="mouseout" />|<a name='mouseout'></a>Event which is raised on mouseleave at any part of editor including drop-down list.

<ApiLink type="igtexteditor" label="See all events" />
