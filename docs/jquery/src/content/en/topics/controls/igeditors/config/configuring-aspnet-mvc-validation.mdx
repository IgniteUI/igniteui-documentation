---
title: "Configuring ASP.NET MVC Validation"
...
-	[igNumericEditor Overview](/ignumericeditor/overview.mdx): To familiarize you with the basics of using the igNumericEditor in ASP.NET MVC

-	[Getting Started with igCombo](//igcombo/getting-started.mdx): To familiarize you with the basics of using the igCombo in ASP.NET MVC
...
## Configuring ASP.NET MVC Data Annotation Validation
