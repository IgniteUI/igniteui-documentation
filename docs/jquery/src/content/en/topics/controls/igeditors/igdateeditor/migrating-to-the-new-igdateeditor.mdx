---
title: "Migrating to the new igDateEditor"
slug: migrating-to-the-new-igdateeditor
---
...
With the 15.2 release of \{environment:ProductName\}™ a new set of editor controls were introduced including a reworked `igDateEditor`. With a new design focused on simplicity and better UX out-of-the-box some features and their API were revised, removed and new ones added. This topic will cover the differences that will be helpful for developers migrating their applications to the new editors.
...
Option| Description
---|---
<ApiLink type="igdateeditor" member="limitSpinToCurrentField" section="options" label="limitSpinToCurrentField" />|<a name='limitSpinToCurrentField'></a>Sets gets ability to modify only 1 date field on spin events.
<ApiLink type="igdateeditor" member="allowNullValue" section="options" label="allowNullValue" />|<a name='allowNullValue'></a>If that option is false, and editor has no value, then value is set to an empty string.
<ApiLink type="igdateeditor" member="disabled" section="options" label="disabled" />|<a name='disabled'></a>Use to set the disabled attribute. Does not allow editing. Disables all the buttons and iteracitons applied. On submit the current value is not sent into the request: `$('#dateEditor').igDateEditor({ disabled: true })`.
<ApiLink type="igdateeditor" member="buttonType" section="options" label="buttonType" />|<a name='buttonType'></a>Sets gets visibility of spin, clear and drop-down button.
<ApiLink type="igdateeditor" member="placeHolder" section="options" label="placeHolder" />|<a name='placeHolder'></a>Gets sets text which appears in editor when editor has no focus and "value" in editor is null or empty string.
<ApiLink type="igdateeditor" member="revertIfNotValid" section="options" label="revertIfNotValid" />|<a name='revertIfNotValid'></a>Use to set the editor to revert value to previous value in case of not valid value on blur, or enter key.
<ApiLink type="igdateeditor" member="preventSubmitOnEnter" section="options" label="preventSubmitOnEnter" />|<a name='preventSubmitOnEnter'></a>Use to set the ability of the editor to prevent form submition on enter key pressed: `$('#dateEditor').igDateEditor({ preventSubmitOnEnter: true })`.
<ApiLink type="igdateeditor" member="suppressNotifications" section="options" label="suppressNotifications" />|<a name='suppressNotifications'></a>Disables default notifications for basic validation scenarios built in the editors such as required list selection, value wrapping around or spin limits.

<ApiLink type="igdateeditor" label="See all options" />
...
Method|Description
---|---
<ApiLink type="igdateeditor" member="getSelectedDate" section="methods" label="getSelectedDate" />|Gets selected date.
<ApiLink type="igdateeditor" member="selectDate" section="methods" label="selectDate" />|Sets selected date.
<ApiLink type="igdateeditor" member="inputName" section="methods" label="inputName" />|<a name='inputName'></a>Gets sets name attribute applied to the editor element.
<ApiLink type="igdateeditor" member="displayValue" section="methods" label="displayValue" />|<a name='displayValue'></a>Returns a string with all the characters shown in the input.
<ApiLink type="igdateeditor" member="editorContainer" section="methods" label="editorContainer" />|<a name='editorContainer'></a>Gets reference to jquery object which is used as top/outer element of igEditor.
<ApiLink type="igdateeditor" member="clearButton" section="methods" label="clearButton" />|<a name='clearButton'></a>Returns a reference to the clear button of the editor.
<ApiLink type="igdateeditor" member="getSelectionStart" section="methods" label="getSelectionStart" />|<a name='getSelectionStart'></a>Gets start index of the selected text in editor.
<ApiLink type="igdateeditor" member="getSelectionEnd" section="methods" label="getSelectionEnd" />|<a name='getSelectionEnd'></a>Gets end index of the selected text in editor.
<ApiLink type="igdateeditor" member="insert" section="methods" label="insert" />|<a name='insert'></a>Paste text at location of caret.
<ApiLink type="igdateeditor" member="spinUp" section="methods" label="spinUp" />|<a name='spinUp'></a>Increase date-time period, depending on the cursor position.
<ApiLink type="igdateeditor" member="spinDown" section="methods" label="spinDown" />|<a name='spinDown'></a>Decrease date-time period, depending on the cursor position.
<ApiLink type="igdateeditor" member="spinUpButton" section="methods" label="spinUpButton" />|<a name='spinUpButton'></a>Returns a reference to the spin up button of the editor.
<ApiLink type="igdateeditor" member="spinDownButton" section="methods" label="spinDownButton" />|<a name='spinDownButton'></a>Returns a reference to the spin down button of the editor.
...
<ApiLink type="igdateeditor" label="See all API methods" />
...
Event|Description
---|---
<ApiLink type="igdateeditor" member="rendering" section="events" label="rendering" />|<a name='rendering'></a>Event which is raised before rendering of the editor completes.
<ApiLink type="igdateeditor" member="rendered" section="events" label="rendered" />|<a name='rendered'></a>Event which is raised after rendering of the editor completes.
<ApiLink type="igdateeditor" member="mouseout" section="events" label="mouseout" />|<a name='mouseout'></a>Event which is raised on mouseleave at any part of editor including drop-down list.

<ApiLink type="igdateeditor" label="See all events" />
