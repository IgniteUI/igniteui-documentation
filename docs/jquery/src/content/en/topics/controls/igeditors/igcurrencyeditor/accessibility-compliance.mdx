---
title: "igCurrencyEditor Accessibility Compliance"
slug: igcurrencyeditor-igcurrencyeditor-accessibility-compliance
---

# igCurrencyEditor Accessibility Compliance

All of the &#123;environment:ProductName&#125;™ controls and components comply with Section 508, Subpart 1194.22 of the Rehabilitation Act of 1973. Table 1 contains the specific rules of Subpart 1194.22 that pertain to the control. Also detailed is how the `igCurrencyEditor` control complies with each rule.
...
(n)| [Keyboard Navigation (igCurrencyEditor)](/igcurrencyeditor-keyboard-navigation.mdx)
