---
title: "Migrating to the new igDatePicker"
...
With the 15.2 release of &#123;environment:ProductName&#125;™ a new set of editor controls were introduced including a reworked `igDatePicker`. With a new design focused on simplicity and better UX out-of-the-box some features and their API were revised, removed and new ones added. This topic will cover the differences that will be helpful for developers migrating their applications to the new editors.
...
Option| Description
---|---
<ApiLink type="igdatepicker" member="limitSpinToCurrentField" section="options" label="limitSpinToCurrentField" />|<a name='limitSpinToCurrentField'></a>Sets gets ability to modify only 1 date field on spin events.
<ApiLink type="igdatepicker" member="allowNullValue" section="options" label="allowNullValue" />|<a name='allowNullValue'></a>If that option is false, and editor has no value, then value is set to an empty string.
<ApiLink type="igdatepicker" member="disabled" section="options" label="disabled" />|<a name='disabled'></a>Use to set the disabled attribute. Does not allow editing. Disables all the buttons and iteracitons applied. On submit the current value is not sent into the request: `$('#datePicker').igDatePicker({ disabled: true })`.
<ApiLink type="igdatepicker" member="buttonType" section="options" label="buttonType" />|<a name='buttonType'></a>Sets gets visibility of spin, clear and drop-down button.
<ApiLink type="igdatepicker" member="dropDownAttachedToBody" section="options" label="dropDownAttachedToBody" />|<a name='dropDownAttachedToBody'></a>Gets sets location of drop-down list.
<ApiLink type="igdatepicker" member="dropDownAnimationDuration" section="options" label="dropDownAnimationDuration" />|<a name='dropDownAnimationDuration'></a>Gets sets show/hide drop-down list animation duration in milliseconds.
<ApiLink type="igdatepicker" member="placeHolder" section="options" label="placeHolder" />|<a name='placeHolder'></a>Gets sets text which appears in editor when editor has no focus and "value" in editor is null or empty string.
<ApiLink type="igdatepicker" member="revertIfNotValid" section="options" label="revertIfNotValid" />|<a name='revertIfNotValid'></a>Use to set the editor to revert value to previous value in case of not valid value on blur, or enter key. If set to false clear is called.
<ApiLink type="igdatepicker" member="preventSubmitOnEnter" section="options" label="preventSubmitOnEnter" />|<a name='preventSubmitOnEnter'></a>Use to set the ability of the editor to prevent form submition on enter key pressed: `$('#datePicker').igDatePicker({ preventSubmitOnEnter: true })`.
<ApiLink type="igdatepicker" member="dropDownOrientation" section="options" label="dropDownOrientation" />|<a name='dropDownOrientation'></a>Use to set drop down opening orientation for the dorp down list when open button is clicked.
<ApiLink type="igdatepicker" member="suppressNotifications" section="options" label="suppressNotifications" />|<a name='suppressNotifications'></a>Disables default notifications for basic validation scenarios built in the editors such as required list selection, value wrapping around or spin limits.

<ApiLink type="igdatepicker" label="See all options" />
...
Method|Description
---|---
<ApiLink type="igdatepicker" member="getSelectedDate" section="methods" label="getSelectedDate" />|Gets selected date.
<ApiLink type="igdatepicker" member="selectDate" section="methods" label="selectDate" />|Sets selected date.
<ApiLink type="igdatepicker" member="getCalendar" section="methods" label="getCalendar" />|<a name='getCalendar'></a>Returns a reference to the jQuery calendar used as a picker selector.
<ApiLink type="igdatepicker" member="inputName" section="methods" label="inputName" />|<a name='inputName'></a>Gets sets name attribute applied to the editor element.
<ApiLink type="igdatepicker" member="displayValue" section="methods" label="displayValue" />|<a name='displayValue'></a>Returns a string with all the characters shown in the input.
<ApiLink type="igdatepicker" member="editorContainer" section="methods" label="editorContainer" />|<a name='editorContainer'></a>Gets reference to jquery object which is used as top/outer element of igEditor.
<ApiLink type="igdatepicker" member="showDropDown" section="methods" label="showDropDown" />|<a name='showDropDown'></a>Show the dropdown list.
<ApiLink type="igdatepicker" member="hideDropDown" section="methods" label="hideDropDown" />|<a name='hideDropDown'></a>Hide the dropdown list.
<ApiLink type="igdatepicker" member="dropDownVisible" section="methods" label="dropDownVisible" />|<a name='dropDownVisible'></a>Returns the visibility state of the drop down listing the items.
<ApiLink type="igdatepicker" member="dropDownButton" section="methods" label="dropDownButton" />|<a name='dropDownButton'></a>Returns a reference to the dropdown button of the editor.
<ApiLink type="igdatepicker" member="clearButton" section="methods" label="clearButton" />|<a name='clearButton'></a>Returns a reference to the clear button of the editor.
<ApiLink type="igdatepicker" member="getSelectionStart" section="methods" label="getSelectionStart" />|<a name='getSelectionStart'></a>Gets start index of the selected text in editor.
<ApiLink type="igdatepicker" member="getSelectionEnd" section="methods" label="getSelectionEnd" />|<a name='getSelectionEnd'></a>Gets end index of the selected text in editor.
<ApiLink type="igdatepicker" member="insert" section="methods" label="insert" />|<a name='insert'></a>Paste text at location of caret.
<ApiLink type="igdatepicker" member="spinUp" section="methods" label="spinUp" />|<a name='spinUp'></a>Increase date-time period, depending on the cursor position.
<ApiLink type="igdatepicker" member="spinDown" section="methods" label="spinDown" />|<a name='spinDown'></a>Decrease date-time period, depending on the cursor position.
<ApiLink type="igdatepicker" member="spinUpButton" section="methods" label="spinUpButton" />|<a name='spinUpButton'></a>Returns a reference to the spin up button of the editor.
<ApiLink type="igdatepicker" member="spinDownButton" section="methods" label="spinDownButton" />|<a name='spinDownButton'></a>Returns a reference to the spin down button of the editor.

<ApiLink type="igdatepicker" label="See all API methods" />
...
Event|Description
---|---
<ApiLink type="igdatepicker" member="rendering" section="events" label="rendering" />|<a name='rendering'></a>Event which is raised before rendering of the editor completes.
<ApiLink type="igdatepicker" member="rendered" section="events" label="rendered" />|<a name='rendered'></a>Event which is raised after rendering of the editor completes.
<ApiLink type="igdatepicker" member="dropDownListOpening" section="events" label="dropDownListOpening" />|<a name='dropDownListOpening'></a>Event which is raised when the drop down is opening.
<ApiLink type="igdatepicker" member="dropDownListOpened" section="events" label="dropDownListOpened" />|<a name='dropDownListOpened'></a>Event which is raised when the drop down is already opened.
<ApiLink type="igdatepicker" member="dropDownListClosed" section="events" label="dropDownListClosed" />|<a name='dropDownListClosed'></a>Event which is raised when the drop down is already closed.
<ApiLink type="igdatepicker" member="mouseout" section="events" label="mouseout" />|<a name='mouseout'></a>Event which is raised on mouseleave at any part of editor including drop-down list.

<ApiLink type="igdatepicker" label="See all events" />
