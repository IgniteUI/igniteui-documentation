---
title: "How to localize the Editors"
...
<Sample src="/editors/localizing-editors/index.html" height={428} alt="Editors Localizing Editors"/>

## <a id="_Related_Topics"></a>Related Topics

-   [Editors Help Overview](igeditors-landingpage.html)
-   [Customizing the Localization of &#123;environment:ProductName&#125; Controls](///general-and-getting-started/customizing-the-localization-of-igniteui-for-jquery-controls.mdx)
