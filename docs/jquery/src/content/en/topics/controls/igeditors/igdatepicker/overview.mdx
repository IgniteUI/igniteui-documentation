...
The sample below shows to configure `igDatePicker` with different [`dataMode`](&#123;environment:jQueryApiUrl&#125;/ui.igdatepicker#options:dataMode) settings and the expected submitted values.
