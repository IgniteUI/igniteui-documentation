---
title: "Known Issues and Limitations (igPivotGrid)"
...
The following table summarizes the known issues and limitations of the `igPivotGrid`™ control for the &#123;environment:ProductName&#125;™ &#123;environment:ProductVersionShort&#125; release. Detailed explanations of some of the issues and the existing workarounds are provided for some of the issues after the summary table.
...
### The igPivotGrid does not render correctly in Android-based browsers
...
### Horizontal scrollbar not visible on Mac OS when its "Show scrollbars only when scrolling" option is set to true
...
- [igPivotGrid](/igpivotgrid.mdx): This is a group of topics explaining the `igPivotGrid` component and its use.
