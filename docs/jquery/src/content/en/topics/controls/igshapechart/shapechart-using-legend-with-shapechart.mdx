---
title: "Using Legend (igShapeChart)"
...
-	[Using Legend](\{environment:SamplesUrl\}/shape-charts/using-legend):  This sample demonstrates usage of a legend with the `igShapeChart` control.