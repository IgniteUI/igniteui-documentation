---
title: "Configuring Axis Labels (igShapeChart)"
...
- [Getting Started with ShapeChart](/shapechart-getting-started-with-shapechart.mdx)

- [Binding to Shapefile Data](/shapechart-binding-shapefile-data.mdx)
...
-	[Configuring Axis Labels](&#123;environment:SamplesUrl&#125;/shape-charts/axis-labels):  This sample demonstrates how to configure the axis labels for the `igShapeChart` control.