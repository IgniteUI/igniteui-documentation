---
title: "Configuring Chart Markers"
slug: shapechart-configuring-chart-markers
---
...
#### <a id="requiredbackground"></a> Required Background
Topic|Purpose
---|---
...
[Getting Started with igShapeChart](/shapechart-getting-started-with-shapechart.mdx)|This topic explains how to bind data to the igShapeChart control.

#### <a id="supportedcharttypes"></a> Supported Chart Types
...
#### <a id="markerproperties"></a> Marker Properties
...
#### <a id="markertypes"></a> Marker Types
Property Name|Property Type|Description
---|---|---
...
#### <a id="markerbrushesandoutlines"></a> Marker Brush and Outline
...
- [Configuring Axis Labels](/shapechart-configuring-axis-labels.mdx)

- [Configuring Axis Range](/shapechart-configuring-axis-ranges.mdx)