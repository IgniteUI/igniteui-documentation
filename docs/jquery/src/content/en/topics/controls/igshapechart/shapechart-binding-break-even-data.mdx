---
title: "Binding Break-Even Data (igShapeChart)"
...
-	[Binding Break Even Data](&#123;environment:SamplesUrl&#125;/shapechart/binding-break-even-data):  This sample demonstrates the `igShapeChart` control binding to break-even data.