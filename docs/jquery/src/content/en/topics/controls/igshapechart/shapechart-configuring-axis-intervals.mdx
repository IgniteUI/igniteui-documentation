---
title: "Configuring Axis Intervals (igShapeChart)"
slug: shapechart-configuring-axis-intervals
---
...
### <a id="ConfiguringXAxis"></a>Configuring XAxis and YAxis Major and Minor Intervals
...
-	[Configuring Axis Intervals](&#123;environment:SamplesUrl&#125;/shape-charts/axis-intervals):  This sample demonstrates how to configure the axis intervals for the `igShapeChart` control.