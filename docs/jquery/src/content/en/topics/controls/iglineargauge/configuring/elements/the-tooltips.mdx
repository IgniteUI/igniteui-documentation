...
<table cellspacing="0" cellpadding="0" class="table">
	...
	<tbody>    
        ...
        <tr>
            ...
            <td>Depends on whether [needleName](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleName) has been initialized (see [Configuring a Custom Tooltip for the Needle](#config-custom-tooltip))</td>
</tr>
        <tr>
...
---|---|---
Enable tooltips|[showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options;showToolTip)|true
Disable tooltips|[showToolTip](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:showToolTip)|false
...
In order to:|Use this property:|And set it to:
---|---|---
Configure the initial delay before the tooltip is displayed|[showToolTipTimeout](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:showToolTipTimeout)|The desired value in milliseconds
...
The default value of the tooltip is pre-configured depending on whether the [needleName](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleName) property has been initialized.
...
In order to:|Use this property:|And set it to:
---|---|---
Set a custom tooltip for the needle|[needleToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleToolTipTemplate)|The id of the desired template.
...
-	Property: [needleToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:needleToolTipTemplate)
...
In order to:|Use this property:|And set it to:
---|---|---
Set a custom tooltip for the comparative range(s)|[rangeToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:rangeToolTipTemplate)|The id of the desired template
...
-	Property: [rangeToolTipTemplate](&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:rangeToolTipTemplate)
