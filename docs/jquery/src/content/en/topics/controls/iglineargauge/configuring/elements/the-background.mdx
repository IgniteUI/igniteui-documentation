...
<table cellspacing="0" cellpadding="0" class="table">
	<tbody>
		...
		<tr>
			...
			<td><a href="&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:backingInnerExtent" target="_blank">backingInnerExtent</a></td>
			<td>0</td>
</tr>

		<tr>
			<td><a href="&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:backingOuterExtent" target="_blank">backingOuterExtent</a></td>
			<td>1.0</td>
</tr>
		...
		<tr>
			...
			<th>Fill color</th>
			<td><a href="&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:backingBrush" target="_blank">backingBrush</a></td>
			<td>Defined in the default theme</td>
</tr>

		<tr>
			<th>Border color</th>
			<td><a href="&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:backingOutline" target="_blank">backingOutline</a></td>
			<td>Defined in the default theme</td>
</tr>

		<tr>
			<th>Border thickness</th>
			<td><a href="&#123;environment:jQueryApiUrl&#125;/ui.igLinearGauge#options:backingStrokeThickness" target="_blank">backingStrokeThickness</a></td>
			<td>2.0</td>
</tr>
	</tbody>
</table>
