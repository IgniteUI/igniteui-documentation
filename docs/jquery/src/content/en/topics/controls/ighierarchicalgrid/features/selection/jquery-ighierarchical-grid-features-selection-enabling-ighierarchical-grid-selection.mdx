---
title: "Enabling Selection (igHierarchicalGrid)"
...
## Enabling Selection in ASP.NET MVC
### Introduction
...
- [igHierarchicalGrid Selection Overview](/jquery-ighierarchical-grid-selection-overview.mdx): Describes Selection feature of igHierarchicalGrid.
- [igHierarchicalGrid Columns and Layouts](/ighierarchicalgrid-columns-and-layouts.mdx): Demonstrates how to define columns and layouts in igHierarchicalGrid including through auto-configuration.
- [igHierarchicalGrid Feature Inheritance](/ighierarchicalgrid-feature-inheritance.mdx): Demonstrates how to inherit features in the child layouts in igHierarchicalGrid.

### Samples

The following samples provide additional information related to this topic.

- [Selection](&#123;environment:SamplesUrl&#125;/hierarchical-grid/selection-rowselectors): This sample demonstrates configuration of selection in igHierarchicalGrid.