...
------------------|----------|---------|-----------
Binding the View-Model object’s field to the column keys| Yes | The Knockout binding requires the key property of the grid’s columns to be specified. This enables the data exchange between the grid and the View-Model. | <ApiLink type="iggrid" member="columns.key" section="options" label="column.key" />
Specifying the data source | Yes |  The data source option should be set to the observable data. | <ApiLink type="iggrid" member="dataSource" section="options" label="dataSource" />
Specifying the column layouts | Yes | The columnLayouts option should be specified. | <ApiLink type="ighierarchicalgrid" member="columnLayouts" section="options" label="columnLayouts" />
