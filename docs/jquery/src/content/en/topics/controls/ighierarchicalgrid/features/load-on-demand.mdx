---
title: "Load-on-Demand (igHierarchicalGrid)"
...
The &#123;environment:ProductNameMVC&#125; hierarchical grid, on the other hand, has a Load On Demand property that if set to true will make the control send data only for the requested layout to the client.

The text blocks that follow demonstrate how to implement each of these two approaches.

## Loading the Whole Data Set
### Loading the whole data set in jQuery
...
### Loading the whole data set in MVC
...
### Loading data on demand in jQuery
...
### Load On Demand parameters in MVC
