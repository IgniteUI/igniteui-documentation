---
title: "Configuring Multi-Column Headers (igHierarchicalGrid)"
...
- [Multi-Column Headers (igGrid)](//iggrid/features/columns/multi-headers/multicolumnheaders-multicolumnheaders.mdx): This topic explains the *igGrid* multi-column headers feature.
...
-   &#123;environment:ProductName&#125; JavaScript and theme files added to an ASP.NET MVC project
...
- [igHierarchicalGrid Features](/ighierarchicalgrid-features-landingpage.mdx): Landing page for topics related to igHierarchicalGrid features.
- [igHierarchicalGrid Feature Inheritance](/ighierarchicalgrid-feature-inheritance.mdx): This demonstrates how to inherit features in the child layouts of the igHierarchicalGrid.
- [Row Selectors](/row-selectors/ighierarchicalgrid-row-selectors-landingpage.mdx): Landing page for topics related to the igHierarchicalGrid Row Selectors feature.
- [Selection](/selection/jquery-ighierarchical-grid-selection-landing-page.mdx): Landing page for topics related to the igHierarchicalGrid Selection feature.
- [Grouping Overview](/grouping/ighierarchicalgrid-grouping-overview.mdx): This topic introduces the igHierarchicalGrid control’s grouping feature as well as provides an overview of the configurable aspects of the feature.