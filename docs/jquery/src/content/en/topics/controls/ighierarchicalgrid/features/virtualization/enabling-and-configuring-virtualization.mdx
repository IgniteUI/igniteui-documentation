...
- Virtualization is enabled by setting the <ApiLink type="iggrid_hg" label="virtualization" /> property to `true`. The type of Virtualization is specified though setting the <ApiLink type="iggrid_hg" label="virtualizationMode" /> property to continuous.
