---
title: "Enabling and Configuring Virtualization (igHierarchicalGrid)"
...
- Virtualization is enabled by setting the [`virtualization`](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) property to `true`. The type of Virtualization is specified though setting the [`virtualizationMode`](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) property to continuous.
...
Property | Value
-------- | --------
[virtualization](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) | true
[virtualizationMode](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) | continuous
[height](&#123;environment:jQueryApiUrl&#125;/ui.iggrid_hg#options) | 400px
