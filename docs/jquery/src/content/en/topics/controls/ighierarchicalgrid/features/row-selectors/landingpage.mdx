---
title: "Row Selectors (igHierarchicalGrid)"
...
- [Enabling Row Selectors](/ighierarchicalgrid-enabling-rowselectors.mdx): Explains, with code examples, how to enable the Row Selection feature in jQuery and in ASP.NET MVC.
- [Configuring Row Selectors](/ighierarchicalgrid-configuring-rowselectors.mdx): Demonstrates, with code examples, how to configure the igHierarchicalGrid control’s Row Selection feature.
- [Row Selector Events](/ighierarchicalgrid-rowselectors-events.mdx): Additional reference and usage information about the events related to the igHierarchicalGrid control’s Row Selection feature.