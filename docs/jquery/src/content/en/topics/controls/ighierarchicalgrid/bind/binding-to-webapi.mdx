---
title: "Binding to ASP.NET MVC WebAPI"
...
3. Add reference to &#123;environment:ProductName&#125; Scripts
  - Copy the &#123;environment:ProductName&#125; distributable files to your project Scripts directory
...
> Note: You must change the `ScriptPath` and `CssPath` to match your &#123;environment:ProductName&#125; file locations.
...
- [REST Updating (igGrid)](//iggrid/features/rest-updating.mdx): This topic explains *igGrid* support for REST services.
- [Binding to REST Services (igHierarchicalGrid)](/ighierarchicalgrid-binding-to-rest-services.mdx): This topic explains how to bind the igHierarchicalGrid to a REST Service.
