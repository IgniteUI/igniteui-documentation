...
-------------------- | ------- | -----------
Selection of multiple rows | By default multiple row selection is enabled. This is controlled through the igGridSelection control. | <ApiLink type="iggridselection_hg" label="multipleSelection" /> (igGridSelection™)
Selection with checkboxes | Enables checkboxes in the Row Selectors column. | <ApiLink type="iggridrowselectors_hg" label="enableCheckBoxes" />
Row numbering | When enabled, allows row numbering of the Row Selectors column. | <ApiLink type="iggridselection_hg" label="enableRowNumbering" />
Row numbering starting value | Allows Row numbering to start from a custom value. | <ApiLink type="iggridselection_hg" label="rowNumberingSeed" />
Width of the row selectors column | Sets the width of the row selector column. | <ApiLink type="iggridselection_hg" label="rowSelectorColumnWidth" />
Require a Selection to configure | Causes the control to throw an exception if the Selection feature is disabled. | <ApiLink type="iggridselection_hg" label="requireSelection" />
