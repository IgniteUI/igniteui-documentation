---
title: "Columns and Layouts (igHierarchicalGrid)"
...
- <ApiLink type="ighierarchicalgrid" label="Columns" />: Defines the columns in the grid.
- <ApiLink type="ighierarchicalgrid" label="Layouts" />: Defines the layouts in the grid.
...
## Auto-generate Columns and Layouts
