...
- [Columns](&#123;environment:jQueryApiUrl&#125;/ui.ighierarchicalgrid#options): Defines the columns in the grid.
- [Layouts](&#123;environment:jQueryApiUrl&#125;/ui.ighierarchicalgrid#options): Defines the layouts in the grid.
