---
title: "Enabling Row Selectors (igHierarchicalGrid)"
...
[Initializing the igHierarchicalGrid](//ighierarchicalgrid-initializing.mdx) | Demonstrates how to initialize the igHierarchicalGrid in both jQuery and MVC.
...
## Code Example: Enabling RowSelectors in jQuery
...
## Code Example: Enabling RowSelectors in MVC
...
- [Configuring Row Selectors (igHierarchicalGrid)](/ighierarchicalgrid-configuring-rowselectors.mdx): Explains, with code examples, how to configure the igHierarchicalGrid *control’s* Row Selection feature.
- [Columns and Layouts (igHierarchicalGrid)](/ighierarchicalgrid-columns-and-layouts.mdx):  Explains various ways, including auto-configuration, of using the igHierarchicalGrid control to define columns and layouts.
