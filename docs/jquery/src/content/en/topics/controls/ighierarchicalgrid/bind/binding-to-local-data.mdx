---
title: "igHierarchicalGrid Binding to Local Data"
...
|--------|-------------|--------|
|<ApiLink type="igGrid" member="dataSource" section="options" label="dataSource" />| The source of the data, that the grid will use when displaying data. | A valid json object similar to the above example.|
|<ApiLink type="igGrid" member="responseDataKey" section="options" label="responseDataKey" />| Applicable only if the response is wrapped. This is the property in the responses where data records are held.| "results"|
|<ApiLink type="igHierarchicalGrid" member="dataSource" section="options" label="columnLayouts" /> | List of columnLayout objects that specify the structure of the child grids. | List of the column layouts. The options of the column layout object are the same as in an igGrid with the exception of the "key" property.|
|<ApiLink type="igHierarchicalGrid" member="columnLayouts.key" section="options" label="columnLayouts.key" /> | This is the property that holds the data records for the current column layout.| columnLayouts: [&#123;  key: "Orders", ... &#125;]|
...
<Sample src="/hierarchical-grid/json-binding/index.html" height={428} alt="Hierarchical Grid JSON Binding"/>
...
|Option | Description | Set to:|
|--------|-------------|--------|
|<ApiLink pkg="ig" type="dataschema" member="schema.searchField" section="options" label="searchField" />| Serves as the base node(s) for the XPaths used to define the fields. |"OrgChart"
|childDataProperty| Maps the node to the the child data fields. | "Employee"|
|<ApiLink pkg="ig" type="dataschema" member="schema.fields" section="options" label="fields" /> | The fields collection. | fields: [&#123; name: "Name", xpath: "@Name" &#125;, &#123; name: "Age", xpath: "@Age" &#125;, &#123; name: "Employee", xpath: "Employee" &#125;]|
|<ApiLink pkg="ig" type="dataschema" member="schema.fields.xpath" section="options" label="fields.xpath" /> | The XPath expression to map the node to the field. | &#123; name: "Name", xpath: "@Name" &#125;|
...
<Sample src="/hierarchical-grid/xml-binding/index.html" height={428} alt="Hierarchical Grid XML Binding"/>
