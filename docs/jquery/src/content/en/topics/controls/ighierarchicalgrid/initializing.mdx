---
title: "Initializing igHierarchicalGrid"
...
The required scripts for the jQuery and MVC samples are the same because &#123;environment:ProductNameMVC&#125; renders jQuery widgets.
...
<Sample src="/hierarchical-grid/json-binding/index.html" height={428} alt="igHierarchicalGrid JSON Binding"/>
...
-   [Grid Properties Reference](&#123;environment:jQueryApiUrl&#125;/ui.igGrid#options)
