...
---|---|---|---
[defaultZoomWindow.left](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.left)| number | *35* |The starting (left) edge of the zoom-range window is placed at 35 percent of the total breadth of the `igZoombar` control, counted from its starting (left) edge.
[defaultZoomWindow.width](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.width) | number |*30* |The width of the zoom-range window is set to 30 percent of the total breadth of the `igZoombar` control.
[zoomWindowMinWidth](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomWindowMinWidth) | number | *5* |The zoom-range window can be sized down by the user to 5 percent of the control’s total breadth.
[zoomAction](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomAction) | string |*“immediate”* |The default refresh mode is Immediate.
...
---|---|---
The position of the starting (left) edge of the zoom-range window |[defaultZoomWindow.left](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.left)|The desired percentage number
The breadth of the zoom-range window|[defaultZoomWindow.width](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.width)|The desired percentage number
...
Property | Value
---|---
[defaultZoomWindow.left](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.left)|70
[defaultZoomWindow.width](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:defaultZoomWindow.width)|30
...
---|---|---
The minimum size of the zoom-range window | [zoomWindowMinWidth](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomWindowMinWidth) |The desired number as a percentage of the total width of the control, counted from its starting (left) edge
...
Property | Value
---|---
[zoomWindowMinWidth](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomWindowMinWidth)|10
...
The Refresh mode is configured with the [zoomAction](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomAction) property.
...
---|---|---
Deferred | [zoomAction](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomAction) |“deferred”
Immediate | [zoomAction](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomAction) | “immediate”
...
Property | Value
---|---
[zoomAction](&#123;environment:jQueryApiUrl&#125;/ui.igzoombar#options:zoomAction) | “deferred”
