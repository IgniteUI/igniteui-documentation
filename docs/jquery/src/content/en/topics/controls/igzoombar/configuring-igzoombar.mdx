...
---|---|---|---
<ApiLink type="igzoombar" member="defaultZoomWindow.left" section="options" label="defaultZoomWindow.left" />| number | *35* |The starting (left) edge of the zoom-range window is placed at 35 percent of the total breadth of the `igZoombar` control, counted from its starting (left) edge.
<ApiLink type="igzoombar" member="defaultZoomWindow.width" section="options" label="defaultZoomWindow.width" /> | number |*30* |The width of the zoom-range window is set to 30 percent of the total breadth of the `igZoombar` control.
<ApiLink type="igzoombar" member="zoomWindowMinWidth" section="options" label="zoomWindowMinWidth" /> | number | *5* |The zoom-range window can be sized down by the user to 5 percent of the control’s total breadth.
<ApiLink type="igzoombar" member="zoomAction" section="options" label="zoomAction" /> | string |*“immediate”* |The default refresh mode is Immediate.
...
---|---|---
The position of the starting (left) edge of the zoom-range window |<ApiLink type="igzoombar" member="defaultZoomWindow.left" section="options" label="defaultZoomWindow.left" />|The desired percentage number
The breadth of the zoom-range window|<ApiLink type="igzoombar" member="defaultZoomWindow.width" section="options" label="defaultZoomWindow.width" />|The desired percentage number
...
---|---|---
The minimum size of the zoom-range window | <ApiLink type="igzoombar" member="zoomWindowMinWidth" section="options" label="zoomWindowMinWidth" /> |The desired number as a percentage of the total width of the control, counted from its starting (left) edge
...
The Refresh mode is configured with the <ApiLink type="igzoombar" member="zoomAction" section="options" label="zoomAction" /> property.
...
---|---|---
Deferred | <ApiLink type="igzoombar" member="zoomAction" section="options" label="zoomAction" /> |“deferred”
Immediate | <ApiLink type="igzoombar" member="zoomAction" section="options" label="zoomAction" /> | “immediate”
