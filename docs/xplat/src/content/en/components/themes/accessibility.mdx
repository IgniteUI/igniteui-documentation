...
mentionedTypes: []
llms:
  description: "The {ProductName} theming engine calculates readable text colors at runtime, expresses every type scale in relative units, and ships an opt-in color-vision-deficiency palette for charts."
---
