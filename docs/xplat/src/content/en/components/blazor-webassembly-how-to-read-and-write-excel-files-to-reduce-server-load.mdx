...
mentionedTypes: []
llms:
  description: "Explains how a Blazor WebAssembly application can read and write Excel files locally with the Infragistics Excel Library to reduce server processing."
...
import blazorExcel from '@xplat-images/general/blazor-excel.png';
import lazyLoadingOfAssembly from '@xplat-images/general/lazy-loading-of-assembly.png';
...
<Image src={blazorExcel} alt="blazor-excel.png" />
...
<Image src={lazyLoadingOfAssembly} alt="lazy-loading-of-assembly" />
