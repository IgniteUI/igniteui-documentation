...
<DocsAside type="note">
If several <ApiLink type="Icon" /> elements are inserted, the banner will try to position all of them at the beginning. It is strongly advised to pass only one `Icon` directly to the banner.
</DocsAside>
...
<ApiRef pkg="core" types={["Banner","Card","Icon","Navbar","Toast","Ripple"]} />
