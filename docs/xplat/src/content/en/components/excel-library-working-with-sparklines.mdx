...
llms:
  description: "The Infragistics {Platform} Excel Library has support for adding sparklines to an Excel Worksheet."
...
<Sample src="/excel/excel-library/working-with-sparklines" height={500} alt="{Platform} Working with Sparklines Example" />
