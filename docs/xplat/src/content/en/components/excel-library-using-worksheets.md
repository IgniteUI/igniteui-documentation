...
description: Use Infragistics' {Platform} excel library to input data by working with the worksheet's row and cells and setting their corresponding values. Easily transfer data from {ProductName} excel to your application!
keywords: Excel library, worksheet, {ProductName}, Infragistics
license: commercial
