...
## Code Snippet
The following code shows how to bind the <ApiLink pkg="maps" type="GeographicSymbolSeries" /> to locations of cities loaded from a shape file using the <ApiLink pkg="geo-core" type="ShapefileRecord" suffix={false} />.
