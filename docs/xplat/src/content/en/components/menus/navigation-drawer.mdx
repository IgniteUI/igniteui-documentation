...
The simplest way to start using the <ApiLink type="NavDrawer" /> is as follows:
...
<ApiLink type="NavDrawerHeaderItem" /><br />
<ApiLink type="NavDrawerItem" /><br />
<ApiLink type="NavDrawer" /><br />
