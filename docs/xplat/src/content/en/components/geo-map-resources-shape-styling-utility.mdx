...
The resource topic provides implementation of an utility that helps with styling UI elements of <ApiLink pkg="maps" type="GeographicShapeSeries" /> in {Platform} <ApiLink pkg="maps" type="GeographicMap" /> component.
