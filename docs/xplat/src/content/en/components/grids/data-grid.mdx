...
<ApiRef pkg="grids" types={["Grid","Column","Cell","GridToolbar","Paginator"]} />

<ApiRef pkg="grids" kind="interface" types={["GridRowComponent", "CellTemplateContext","CellType","ColumnPipeArgs"]} />
