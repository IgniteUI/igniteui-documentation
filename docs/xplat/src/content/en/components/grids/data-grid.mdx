...
The flat data binding approach is similar to the one that we already described above, but instead of **cell value** we are going to use the <ApiLink pkg="grids" type="GridRow" member="data" label="Data" /> property of the <ApiLink pkg="grids" type="GridRow" />.
...
<ApiRef pkg="grids" types={["Grid","Column","Cell","CellTemplateContext","GridRowComponent","GridToolbar","Paginator"]} />

<ApiRef pkg="grids" kind="interface" types={["CellType","ColumnPipeArgs"]} />
