...
When properly implemented, the cell editing template also ensures that the cell's <ApiLink pkg="grids" kind="interface" type="CellType" member="editValue" label="EditValue" exclude="Blazor" /> will correctly pass through the grid [editing event cycle](grid/editing.md#event-arguments-and-sequence).
...
Make sure to check the API for the <ApiLink pkg="grids" type="CellType" kind="interface" suffix={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" type="CellType" kind="class" suffix={false} /></PlatformBlock> in order to get accustomed with the provided properties you can use in your templates.
...
- <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="format" label="Format" suffix={false} exclude="Blazor" /> - determines what date/time parts are displayed, defaults to `'mediumDate'`, equivalent to **'MMM d, y'**
- <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="timezone" label="Timezone" suffix={false} exclude="Blazor" /> - the timezone offset for dates. By default uses the end-user's local system timezone
- <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="digitsInfo" label="DigitsInfo" suffix={false} exclude="Blazor" /> - decimal representation objects. Default to **1.0-3**
...
The `OrderDate` column will respect only the <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="format" label="Format" suffix={false} exclude="Blazor" /> and <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="timezone" label="Timezone" suffix={false} exclude="Blazor" /> properties, while the `UnitPrice` will only respect the <ApiLink pkg="grids" kind="interface" type="ColumnPipeArgs" member="digitsInfo" label="DigitsInfo" suffix={false} exclude="Blazor" />.
...
The flat data binding approach is similar to the one that we already described above, but instead of **cell value** we are going to use the <ApiLink pkg="grids" kind="interface" type="GridRowComponent" member="data" label="Data" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridRow" member="data" label="Data" suffix={false} /></PlatformBlock> property of the <ApiLink pkg="grids" kind="interface" type="GridRowComponent" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridRow" suffix={false} /></PlatformBlock>.
...
<ApiLink type="CellType" pkg="grids" kind="interface" suffix={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="CellType" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
<ApiLink type="GridToolbar" pkg="grids" /><br />
<ApiLink type="Paginator" pkg="grids" /><br />

<ApiLink type="GridRowComponent" pkg="grids" kind="interface" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="GridRow" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
<ApiLink type="CellTemplateContext" pkg="grids" kind="interface" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="CellTemplateContext" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
<ApiLink type="CellType" pkg="grids" kind="interface" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="CellType" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
<ApiLink type="ColumnPipeArgs" pkg="grids" kind="interface" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="ColumnPipeArgs" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
