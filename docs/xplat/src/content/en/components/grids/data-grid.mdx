...
Make sure to check the API for the <ApiLink pkg="grids" type="Cell" /> in order to get accustomed with the provided properties you can use in your templates.
...
The flat data binding approach is similar to the one that we already described above, but instead of **cell value** we are going to use the <ApiLink pkg="grids" kind="interface" type="GridRowComponent" member="data" label="Data" /> property of the <ApiLink pkg="grids" kind="interface" type="GridRowComponent" />.
...
<ApiLink type="Cell" pkg="grids" /><br />
<ApiLink type="GridToolbar" pkg="grids" /><br />
<ApiLink type="Paginator" pkg="grids" /><br />

<ApiLink type="GridRowComponent" pkg="grids" kind="interface" /><br />
<ApiLink type="CellTemplateContext" pkg="grids" kind="interface" /><br />
<ApiLink type="CellType" pkg="grids" kind="interface" /><br />
<ApiLink type="ColumnPipeArgs" pkg="grids" kind="interface" /><br />
