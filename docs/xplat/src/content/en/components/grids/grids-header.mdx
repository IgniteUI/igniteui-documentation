...
| [Row sizing](./_shared/size.mdx) | Adjust the height and density of grid rows. | Balance scanability and the amount of visible data. |
...
## Next Steps
Start with the [{Platform} Data Grid documentation](data-grid.mdx), then choose focused guides for [paging](grid/paging.mdx), [filtering](grid/filtering.mdx), [editing](grid/editing.mdx), [selection](grid/selection.mdx), or [virtualization](grid/virtualization.mdx).
