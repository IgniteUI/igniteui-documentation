...
Each basic dimension configuration requires a <ApiLink pkg="grids" kind="interface" type="PivotDimension" member="memberName" label="MemberName" /> that matches a field from the provided **data**.
...
A dimension can also describe an expandable hierarchy via the <ApiLink pkg="grids" kind="interface" type="PivotDimension" member="childLevel" label="ChildLevel" /> property, for example:
...
The pivot value also provides a <ApiLink pkg="grids" kind="interface" type="PivotDimension" member="displayName" label="DisplayName" /> property. It can be used to display a custom name for this value in the column header.
...
The `Enable` property controls if a given <ApiLink pkg="grids" kind="interface" type="PivotDimension" /> or <ApiLink pkg="grids" kind="interface" type="PivotValue" /> is active and takes part in the pivot view rendered by the Pivot Grid.
...
- Numeric Fields:
  - Created as <ApiLink pkg="grids" kind="interface" type="PivotValue" /> using `PivotNumericAggregate.sum` aggregator.
  - Added to the values collection and enabled by default.

- Non-Numeric Fields:
  - Created as <ApiLink pkg="grids" kind="interface" type="PivotDimension" />.
  - Disabled by default.
...
- Date Fields(only the first `date` field is enabled, the other `date` fields apply non-numeric fields rule):
  - Created as <ApiLink pkg="grids" type="PivotDateDimension" />
  - Enabled by default
...
When overriding the <ApiLink pkg="grids" kind="interface" type="PivotConfiguration" member="pivotKeys" label="PivotKeys" /> in Blazor, currently you will need to define all other keys, since assigning a new PivotKeys object, it replaces completely the default ones:
...
| Setting duplicate <ApiLink pkg="grids" kind="interface" type="PivotDimension" member="memberName" label="MemberName" /> or <ApiLink pkg="grids" kind="interface" type="PivotValue" member="member" label="Member" /> property values for dimensions/values. | These properties should be unique for each dimension/value. Duplication may result in loss of data from the final result. |
...
<PlatformBlock for="Angular,React,WebComponents"><ApiLink type="PivotConfiguration" pkg="grids" kind="interface" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink type="PivotConfiguration" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
<ApiLink type="PivotGrid" pkg="grids" /><br />
<ApiLink type="PivotDataSelector" pkg="grids" /><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink type="PivotDateDimensionOptions" pkg="grids" kind="interface" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink type="PivotDateDimensionOptions" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
