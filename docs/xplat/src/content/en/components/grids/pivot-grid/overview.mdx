...
The {Platform} Pivot Grid shares the same [CSS properties](../grid/theming-grid) as the base Grid. To style it, simply set the desired property values and scope them to the Pivot Grid component.
