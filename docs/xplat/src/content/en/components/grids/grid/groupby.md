...
description: Configure group by that allows visualizing of data records in {Platform} Material table, visualize the grouped data in separate and convenient column group.
keywords: "{Platform}, Grid, {ProductName}, group by, Infragistics"
license: commercial
