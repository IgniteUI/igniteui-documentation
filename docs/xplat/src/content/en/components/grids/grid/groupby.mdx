...
The group row except for the expand/collapse UI is fully templatable. By default it renders a grouping icon and displays the field name and value it represents. The context to render the template against is of type <ApiLink pkg="grids" type="GroupByRecord" kind="interface" />.
...
The <ApiLink pkg="grids" kind='interface' type="GroupByRowSelectorTemplateDetails" member="selectedCount" label="SelectedCount" /> property shows how many of the group records are currently selected while <ApiLink pkg="grids" kind='interface' type="GroupByRowSelectorTemplateDetails" member="totalCount" label="TotalCount" /> shows how many records belong to the group.
...
The <ApiLink pkg="grids" kind='interface' type="GroupByRowSelectorTemplateDetails" member="groupRow" label="GroupRow" /> property returns a reference to the group row.
...
The <ApiLink pkg="grids" kind='interface' type="GroupByRowSelectorTemplateDetails" member="selectedCount" label="SelectedCount" /> and <ApiLink pkg="grids" kind='interface' type="GroupByRowSelectorTemplateDetails" member="totalCount" label="TotalCount" /> properties can be used to determine if the Group By row selector should be checked or indeterminate (partially selected).
...
<ApiRef pkg="core" types={["Grid","Column","Chip"]} />
