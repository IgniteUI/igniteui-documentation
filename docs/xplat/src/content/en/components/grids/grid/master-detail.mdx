...
To configure the <ApiLink pkg="grids" type="Grid" /> to display in master-detail mode you need to specify a template for the grid:
...
The expansion states can be controlled via the <ApiLink pkg="grids" type="Grid" member="expansionStates" label="ExpansionStates" /> input of the <ApiLink pkg="grids" type="Grid" />. States are stored in key-value pairs [row identifier, expansion state]. The property gets/sets the current expansion states and supports two-way binding:
...
- <ApiLink pkg="grids" type="Grid" member="expandAll" label="ExpandAll" />
- <ApiLink pkg="grids" type="Grid" member="collapseAll" label="CollapseAll" />
- <ApiLink pkg="grids" type="Grid" member="toggleRow" label="ToggleRow" />
- <ApiLink pkg="grids" type="Grid" member="expandRow" label="ExpandRow" />
- <ApiLink pkg="grids" type="Grid" member="collapseRow" label="CollapseRow" />
