...
The {ProductName} <ApiLink pkg="grids" type="Grid" /> can read Excel data that is copied to the clipboard. In this section we will show you how to do this with some custom code.

## {Platform} Paste from Excel Example

This sample demonstrates how to implement pasting from Excel into the <ApiLink pkg="grids" type="Grid" /> Material UI table.
