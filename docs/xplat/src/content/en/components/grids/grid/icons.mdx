...
The {ProductName} <ApiLink pkg="grids" type="Grid" /> icons can be customized to use custom icons from a different collection set using the exposed API methods:

<PlatformBlock for="Angular,React,WebComponents">
- <ApiLink kind="function" type="registerIconFromText" prefixed={false} />
- <ApiLink kind="function" type="registerIcon" prefixed={false} />
- <ApiLink kind="function" type="setIconRef" prefixed={false} />
</PlatformBlock>
<PlatformBlock for="Blazor">
- <ApiLink type="Icon" member="RegisterIconFromText(string, string, string)" suffix={false} label="RegisterIconFromText" />
- <ApiLink type="Icon" member="RegisterIcon(string, string, string)" suffix={false} label="RegisterIcon" />
- <ApiLink type="Icon" member="SetIconRefAsync(string, string, IgbIconMeta)" suffix={false} label="SetIconRefAsync" />
</PlatformBlock>
