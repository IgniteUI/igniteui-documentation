...
- <ApiLink type="Icon" member="RegisterIconFromText(string, string, string)" label="RegisterIconFromText" />
- <ApiLink type="Icon" member="RegisterIcon(string, string, string)" label="RegisterIcon" />
- <ApiLink type="Icon" member="SetIconRefAsync(string, string, IgbIconMeta)" label="SetIconRefAsync" />
</PlatformBlock>
