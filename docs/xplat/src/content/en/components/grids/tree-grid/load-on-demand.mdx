...
If you have a way to provide an information whether a row has children prior to its expanding, you could use the <ApiLink pkg="grids" type="TreeGrid" member="hasChildrenKey" label="HasChildrenKey" /> input property. This way you could provide a boolean property from the data objects which indicates whether an expansion indicator should be displayed.
...
If you want to provide your own custom loading indicator, you can use the <ApiLink pkg="grids" type="TreeGrid" member="rowLoadingIndicatorTemplate" label="RowLoadingIndicatorTemplate" /> option to set a custom template.The following code snippet demonstrates how set to it:
