...
<div class="feature">
    <div class="feature__image feature__image--right"><Image src={gridPaging} alt="Icon of data grid paging features on the {Platform} Data Grid" class="b-lazy b-loaded responsive-img" />
    </div>
    <div class="feature__details">
