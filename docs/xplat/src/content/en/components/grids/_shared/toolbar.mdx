...
<DocsAside type="info">
When exporting the <ApiLink type="{ComponentName}" pkg="grids" /> or any of its child grids down the hierarchy, the exported data will be a flat collection of rows
