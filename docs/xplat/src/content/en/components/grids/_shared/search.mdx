...
- (optional) <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="BaseSearchInfo" member="caseSensitive" suffix="{false}"/></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="BaseSearchInfo" member="caseSensitive" suffix="{false}"/></PlatformBlock>: **boolean** (should the search be case sensitive or not, default value is false)
- (optional) <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="BaseSearchInfo" member="exactMatch" suffix="{false}"/></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="BaseSearchInfo" member="exactMatch" suffix="{false}"/></PlatformBlock>: **boolean** (should the search be by an exact match or not, default value is false)
