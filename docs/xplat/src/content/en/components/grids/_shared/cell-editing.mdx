...
Please keep in mind that `DeleteRow` method will remove the specified row only if a <ApiLink pkg="grids" type="{ComponentName}" member="primaryKey" prefixed={false} /> is defined.
