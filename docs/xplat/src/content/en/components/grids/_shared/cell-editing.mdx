...
Another way to update cell is directly through <ApiLink pkg="grids" kind="interface" type="CellType" member="update" label="Update" exclude="Blazor" /> method of `Cell`:
