...
description: Understand how the {Platform} {ComponentTitle} sizing works and learn how to use the width and height in order to accommodate the different scenarios that users can have.
keywords: Sizing , {Platform}, {ComponentKeywords}, {ProductName}, Infragistics
license: commercial
