...
- <ApiLink type="GridEditingActions" /> - includes functionality and UI specifically designed for the <ApiLink type="{ComponentName}" pkg="grids" /> editing. It allows you to quickly toggle edit mode for cells or rows, depending on the <ApiLink type="{ComponentName}" member="rowEditable" pkg="grids" /> option and row deletion of the <ApiLink type="{ComponentName}" pkg="grids" />.

- <ApiLink type="GridPinningActions" /> - includes functionality and UI specifically designed for the <ApiLink type="{ComponentName}" pkg="grids" /> row pinning. It allows you to quickly pin rows and navigate between pinned rows and their disabled counterparts.

They are added inside the <ApiLink type="{ComponentName}" pkg="grids" /> and this is all needed to have an <ApiLink type="ActionStrip" /> providing default interactions.
...
<DocsAside type="info">
When <ApiLink type="ActionStripComponent" /> is a child component of the <ApiLink type="{ComponentName}" pkg="grids" />, hovering a row will automatically show the UI.
</DocsAside>
