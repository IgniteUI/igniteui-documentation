...
<PlatformBlock for="Angular">
<DocsAside type="note">
The predefined actions inherit <ApiLink pkg="grids" type="GridActionsBaseDirective" /> and when creating a custom grid action component, it should also inherit <ApiLink pkg="grids" type="GridActionsBaseDirective" />.
</DocsAside>
