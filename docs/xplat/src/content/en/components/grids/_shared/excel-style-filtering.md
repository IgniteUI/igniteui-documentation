...
description: Learn how to configure Excel filtering in {Platform} {ComponentTitle}. You can enable/disable various options and customize the Excel style filter menu the way you want.
keywords: excel like filter, {Platform}, {ProductName}, Infragistics
license: commercial
