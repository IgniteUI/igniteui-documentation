...
The built-in Column Hiding UI is placed inside an <ApiLink type="Dropdown" /> in the <ApiLink type="{ComponentName}" />'s toolbar. We can show/hide the Column Hiding UI by using this exact dropdown.
