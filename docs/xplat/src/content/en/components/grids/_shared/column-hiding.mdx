...
We can easily prevent the user from being able to hide columns through the column hiding UI by simply setting their <ApiLink pkg="grids" type="{ComponentName}" member="disableHiding" prefixed={false} /> property to true.
...
<ApiRef pkg="grids" types={["Column","GridToolbar","GridToolbarHiding","GridToolbarActions","GridToolbarTitle"]} />
