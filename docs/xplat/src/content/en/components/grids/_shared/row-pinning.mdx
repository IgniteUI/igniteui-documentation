...
<ApiLink type="RowType" pkg="grids" kind="interface" suffix={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="RowType" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
