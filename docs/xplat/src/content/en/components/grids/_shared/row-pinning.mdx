...
Row pinning is controlled through the <PlatformBlock for="Angular,React,WebComponents">
  <ApiLink pkg="grids" kind="interface" type="RowDirective" member="pinned" suffix={false} />
</PlatformBlock>
<PlatformBlock for="Blazor">
  <ApiLink pkg="grids" kind="class" type="RowDirective" member="pinned" suffix={false} />
</PlatformBlock> input of the `Row`. Pinned rows are rendered at the top of the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> by default and stay fixed through vertical scrolling of the unpinned rows in the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> body.
...
A row is pinned below the last pinned row. Changing the order of the pinned rows can be done by subscribing to the <ApiLink pkg="grids" type="{ComponentName}" member="rowPinning" prefixed={false} /> event and changing the <PlatformBlock for="Angular,Blazor">
...
</PlatformBlock> property of the event arguments to the desired position index.
...
<PlatformBlock for="Angular,React,WebComponents">
  <ApiLink type="GridRowComponent" pkg="grids" kind="interface" />
</PlatformBlock>
<PlatformBlock for="Blazor">
  <ApiLink type="GridRow" pkg="grids" kind="class" suffix={false} />
</PlatformBlock><br />
<PlatformBlock for="Angular">
...
<PlatformBlock for="Blazor">
  <ApiLink type="RowType" pkg="grids" kind="class" suffix={false} />
</PlatformBlock><br />
