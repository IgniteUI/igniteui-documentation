...
The {ProductName} <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> component provides three different selection modes - [Row selection](row-selection.md), [Cell selection](cell-selection.md) and [Column selection](column-selection.md). By default only **Multi-cell selection** mode is enabled in the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} />. In order to change/enable selection mode you can use <ApiLink pkg="grids" type="{ComponentName}" member="rowSelection" prefixed={false} />, <ApiLink pkg="grids" type="{ComponentName}" member="cellSelection" prefixed={false} /> or <ApiLink pkg="grids" type="Column" member="selectable" /> properties.
...
The <ApiLink pkg="grids" type="Column" member="selectable" /> property enables you to specify the following options for each <ApiLink pkg="grids" type="Column" />. The corresponding column selection will be enabled or disabled if this property is set to true or false, respectively.
