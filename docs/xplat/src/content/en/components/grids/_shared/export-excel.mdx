...
You can export <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> with defined [multi-column headers](multi-column-headers.md). All headers are reflected in the exported Excel file as they are displayed in the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} />. If you want to exclude the defined multi-column headers from the exported data, set the `ExporterOption` <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" prefixed={false} type="IGridToolbarExportEventArgs" member="ignoreMultiColumnHeaders" /></PlatformBlock><PlatformBlock for="React,WebComponents"><ApiLink pkg="grids" kind="interface" type="GridToolbarExportEventArgs" member="ignoreMultiColumnHeaders" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridToolbarExportEventArgs" member="ignoreMultiColumnHeaders" suffix={false} /></PlatformBlock> to `true`.
