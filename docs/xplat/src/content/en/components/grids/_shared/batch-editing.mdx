...
The Batch Editing feature of the <ApiLink type="{ComponentName}" /> is based on the <ApiLink type="TransactionService" />.<PlatformBlock for="Angular"> Follow the [**Transaction Service class hierarchy**](../transaction-classes.mdx) topic to see an overview of the <ApiLink type="TransactionService" /> and details how it is implemented.</PlatformBlock>

</ComponentBlock>

<ComponentBlock for="TreeGrid">
The Batch Editing feature of the <ApiLink type="{ComponentName}" /> is based on the `HierarchicalTransactionService`.<PlatformBlock for="Angular"> Follow the [**Transaction Service class hierarchy**](../transaction-classes.mdx) topic to see an overview of the `HierarchicalTransactionService` and details how it is implemented.</PlatformBlock>
