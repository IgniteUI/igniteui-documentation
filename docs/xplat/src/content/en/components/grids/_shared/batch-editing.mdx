...
<ApiLink type="Transactions" pkg="grids" prefixed={false} /><br />
<ApiLink type="HierarchicalTransactionService" pkg="grids" prefixed={false} /><br />
<ApiLink type="HierarchicalTransactionServiceFactory" pkg="grids" prefixed={false} /><br />
