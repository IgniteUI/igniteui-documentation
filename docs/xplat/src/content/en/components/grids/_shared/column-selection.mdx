...
The column selection feature can be enabled through the <ApiLink pkg="grids" type="{ComponentName}" member="columnSelection" prefixed={false} /> input, which takes <ApiLink pkg="grids" type="GridSelectionMode" /> values.
