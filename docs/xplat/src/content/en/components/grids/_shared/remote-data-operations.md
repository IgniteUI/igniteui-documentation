...
description: Start using Angular remote data operations like remote filtering, remote sorting, and remote scrolling to load data from a server with {ProductName}.
keywords: Remote Data, Paging, {Platform}, {ComponentKeywords}, {ProductName}, Infragistics
license: commercial
