...
<ComponentBlock for="Grid, HierarchicalGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> input controlling the visibility of the add row button may use the action strip context (which is of type <PlatformBlock for="Angular">
  <ApiLink type="RowType" kind="interface" pkg="grids" prefixed={false} suffix={false} />
</PlatformBlock>
<PlatformBlock for="React,WebComponents">
  <ApiLink type="RowType" kind="interface" pkg="grids" suffix={false} />
</PlatformBlock>
<PlatformBlock for="Blazor">
  <ApiLink pkg="grids" kind="class" type="RowType" suffix={false} />
</PlatformBlock> to fine tune which records the button shows for.

</ComponentBlock>

<ComponentBlock for="TreeGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> inputs controlling the visibility of the add row and add child buttons may use the action strip context (which is of type <PlatformBlock for="Angular">
  <ApiLink type="RowType" kind="interface" pkg="grids" prefixed={false} suffix={false} />
</PlatformBlock>
<PlatformBlock for="React,WebComponents">
  <ApiLink type="RowType" kind="interface" pkg="grids" suffix={false} />
...
<PlatformBlock for="Blazor">
  <ApiLink pkg="grids" kind="class" type="RowType" suffix={false} />
</PlatformBlock> to fine tune which records the buttons show for.
...
Customizing the text of the row adding overlay is possible using the <PlatformBlock for="Angular,React,WebComponents">
  <ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="rowAddTextTemplate" />
</PlatformBlock>
<PlatformBlock for="Blazor">
  <ApiLink pkg="grids" kind="class" type="GridBaseDirective" member="rowAddTextTemplate" />
</PlatformBlock>.
</PlatformBlock>
