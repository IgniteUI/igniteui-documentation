...
<ComponentBlock for="Grid, HierarchicalGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> input controlling the visibility of the add row button may use the action strip context (which is of type <ApiLink pkg="grids" kind="interface" type="RowType" prefixed={false} /> to fine tune which records the button shows for.

</ComponentBlock>

<ComponentBlock for="TreeGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> inputs controlling the visibility of the add row and add child buttons may use the action strip context (which is of type <ApiLink pkg="grids" kind="interface" type="RowType" prefixed={false} /> to fine tune which records the buttons show for.
...
Customizing the text of the row adding overlay is possible using the <ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="rowAddTextTemplate" />.
</PlatformBlock>
