...
<ComponentBlock for="Grid, HierarchicalGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> input controlling the visibility of the add row button may use the action strip context (which is of type <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="RowType" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="RowType" suffix={false} /></PlatformBlock> to fine tune which records the button shows for.

</ComponentBlock>

<ComponentBlock for="TreeGrid">
> **Note**:
> The <ApiLink pkg="grids" type="GridEditingActions" /> inputs controlling the visibility of the add row and add child buttons may use the action strip context (which is of type <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="RowType" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="RowType" suffix={false} /></PlatformBlock> to fine tune which records the buttons show for.
