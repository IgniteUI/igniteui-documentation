...
We expose the <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock> that will be used for validation when editing starts on a row/cell via a <ApiLink pkg="grids" type="{ComponentName}" member="formGroupCreated" prefixed={false} /> event. You can modify it by adding your own validators for the related fields:
...
In that case a custom validator can be used to compare the values in the record via their shared <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock>.
...
The cross-field validator can be added to the <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock> of the row from `FormGroupCreated` event, which returns the new <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock> for each row when entering edit mode:
