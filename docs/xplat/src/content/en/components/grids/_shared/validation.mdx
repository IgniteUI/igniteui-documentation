...
We extend some of the {Platform} Forms validator to directly work with the <ApiLink pkg="grids" type="Column" />. The same validators are available as attributes to be set declaratively in <ApiLink pkg="grids" type="Column" />. The following validators are supported out-of-the-box:
...
We expose the <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="React,WebComponents,Blazor"><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock></PlatformBlock> that will be used for validation when editing starts on a row/cell via a <ApiLink pkg="grids" type="{ComponentName}" member="formGroupCreated" prefixed={false} /> event. You can modify it by adding your own validators for the related fields:
...
The grid exposes a validation service via the <ApiLink pkg="grids" type="{ComponentName}" member="validation" prefixed={false} /> property.
...
- <ApiLink pkg="grids" type="{ComponentName}" member="markAsTouched" prefixed={false} /> - marks the related record/field as touched.
...
- While editing via the cell editor based on the grid's <ApiLink pkg="grids" type="GridValidationTrigger" kind="type" suffix={false} prefixed={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" type="GridValidationTrigger" kind="enum" suffix={false} prefixed={false} /></PlatformBlock>. Either on `Change` while typing in the editor, or on `Blur` when the editor loses focus or closes.
- When updating cells/rows via the API - <ApiLink pkg="grids" type="{ComponentName}" member="updateRow" prefixed={false} />, <ApiLink pkg="grids" type="{ComponentName}" member="updateCell" prefixed={false} />, etc.
- When using batch editing and the `Undo`/`Redo` API of the transaction service.

<DocsAside type="info">
Validation will not trigger for records that have not been edited via user input or via the editing API. Visual indicators on the cell will only shown if the related input is considered touched - either via user interaction or via the <ApiLink pkg="grids" type="{ComponentName}" member="markAsTouched" prefixed={false} /> API of the validation service.
</DocsAside>
...
You can define your own validation directive to use on a <ApiLink pkg="grids" type="Column" /> in the template.
...
In some cases you may want to disallow submitting an invalid value in the data. In that scenario, you can use the <ApiLink pkg="grids" type="{ComponentName}" member="cellEdit" prefixed={false} /> or <ApiLink pkg="grids" type="{ComponentName}" member="rowEdit" prefixed={false} /> events and cancel the event in case the new value is invalid.
...
In that case a custom validator can be used to compare the values in the record via their shared <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="React,WebComponents,Blazor"><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock></PlatformBlock>.
...
The cross-field validator can be added to the <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="React,WebComponents,Blazor"><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock></PlatformBlock> of the row from `FormGroupCreated` event, which returns the new <PlatformBlock for="Angular"><ApiLink pkg="grids" kind="interface" type="IGridFormGroupCreatedEventArgs" prefixed={false} member="formGroup" label="FormGroup" /></PlatformBlock><PlatformBlock for="React,WebComponents,Blazor"><PlatformBlock for="WebComponents,Blazor"><ApiLink pkg="grids" type="FormGroup" /></PlatformBlock></PlatformBlock> for each row when entering edit mode:
