...
The declaration of multi-column headers is achieved by wrapping a set of columns into an <ApiLink pkg="grids" type="ColumnGroup" /> component with `Header` title information passed.
