...
<DocsAside type="info">
Sorting is performed using our <ApiLink pkg="grids" type="GridSortingStrategy" kind="interface" suffix={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" type="GridSortingStrategy" kind="class" suffix={false} /></PlatformBlock> algorithm. Any <ApiLink pkg="grids" type="Column" /> or `ISortingExpression` can use a custom implementation of the <ApiLink pkg="grids" type="GridSortingStrategy" kind="interface" suffix={false} exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink pkg="grids" type="GridSortingStrategy" kind="class" suffix={false} /></PlatformBlock> as a substitute algorithm. This is useful when custom sorting needs to be defined for complex template columns, or image columns, for example.
</DocsAside>
...
<ApiLink type="SortingExpression" pkg="grids" kind="interface" exclude="Blazor" /><PlatformBlock for="Blazor"><ApiLink type="SortingExpression" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
