...
<PlatformBlock for="Angular,React,WebComponents"><ApiLink type="SortingExpression" pkg="grids" kind="interface" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink type="SortingExpression" pkg="grids" kind="class" suffix={false} /></PlatformBlock><br />
