...
llms:
  description: "The {ProductName} Data Sorting feature in {Platform} {ComponentTitle} is enabled on a per-column level, meaning that the {ComponentName} can have a mix of sortable and non-sortable columns."
---
...
The {ProductName} Data Sorting feature in {Platform} {ComponentTitle} is enabled on a per-column level, meaning that the <ApiLink type="{ComponentName}" /> can have a mix of sortable and non-sortable columns. Performing {Platform} sort actions enables you to change the display order of the records based on specified criteria.
...
Additionally there is a custom contextmenu added for sorting using <ApiLink type="{ComponentName}" />'s <ApiLink type="{ComponentName}" member="contextMenu" /> Output.
...
This is done via the <ApiLink type="Column" member="sortable" /> input. With the <ApiLink type="{ComponentName}" /> sorting, you can also set the <ApiLink type="ColumnState" member="sortingIgnoreCase" /> property to perform case sensitive sorting:
...
The <ApiLink type="{ComponentName}" /> provides a solution for this problem by indicating the index of each sorted column.
...
You can sort any column or a combination of columns through the <ApiLink type="{ComponentName}" /> API using the <ApiLink type="{ComponentName}" member="sort" label="Sort" /> method:
...
As with the filtering behavior, you can clear the sorting state by using the <ApiLink type="{ComponentName}" member="clearSort" /> method:
...
<DocsAside type="info">
The <ApiLink type="{ComponentName}" member="sortStrategy" /> of the <ApiLink type="{ComponentName}" /> is of different type compared to the <ApiLink type="{ComponentName}" member="sortStrategy" /> of the <ApiLink type="Column" />, since they work in different scopes and expose different parameters.
</DocsAside>

<DocsAside type="info">
The sorting operation **DOES NOT** change the underlying data source of the <ApiLink type="{ComponentName}" />.
</DocsAside>

## Initial Sorting State

It is possible to set the initial sorting state of the <ApiLink type="{ComponentName}" /> by passing an array of sorting expressions to the <ApiLink type="{ComponentName}" member="sortingExpressions" /> property of the <ApiLink type="{ComponentName}" />.
...
<DocsAside type="info">
If values of type `string` are used by a column of <ApiLink type="{ComponentName}" member="dataType" /> `Date`, the <ApiLink type="{ComponentName}" /> won't parse them to `Date` objects and using <ApiLink type="{ComponentName}" /> `Sorting` won't work as expected. If you want to use `string` objects, additional logic should be implemented on an application level, in order to parse the values to `Date` objects.
</DocsAside>
...
The <ApiLink type="{ComponentName}" /> supports remote sorting, which is demonstrated in the [{ComponentTitle} Remote Data Operations](remote-data-operations.mdx) topic.
...
- <ApiLink type="{ComponentName}" member="sortHeaderIconTemplate" /> – re-templates the sorting icon when no sorting is applied.
...
- <ApiLink type="{ComponentName}" member="sortAscendingHeaderIconTemplate" /> – re-templates the sorting icon when the column is sorted in ascending order.
...
- <ApiLink type="{ComponentName}" member="sortDescendingHeaderIconTemplate" /> – re-templates the sorting icon when the column is sorted in descending order.
