...
- **Columns**
  ...
  - Columns order
  - Column properties defined by the <ApiLink pkg="grids" type="ColumnState" kind="interface" /> interface.
...
<ApiLink type="PivotConfiguration" pkg="grids" kind="interface" /><br />
<ApiLink type="PivotDimension" pkg="grids" kind="interface" /><br />
<ApiLink type="PivotValue" pkg="grids" kind="interface" /><br />
