...
<PlatformBlock for="React, WebComponents">
The <ApiLink pkg="grids" type="{ComponentName}" member="getState" prefixed={false} /> method returns the grid state in a <ApiLink pkg="grids" type="GridStateInfo" /> object, containing all the state info. Additional steps may be required in order to save it.
</PlatformBlock>
...
<PlatformBlock for="Angular">
<ApiLink pkg="grids" type="{ComponentName}" member="setState" prefixed={false} /> - The <ApiLink pkg="grids" type="{ComponentName}" member="setState" prefixed={false} /> method accepts the serialized JSON string or <ApiLink pkg="grids" type="IGridState" /> object as argument and will restore the state of each feature found in the object/JSON string.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
<ApiLink pkg="grids" type="{ComponentName}" member="applyState" prefixed={false} /> - The method accepts a <ApiLink pkg="grids" type="GridStateInfo" /> object as argument and will restore the state of each feature found in the object or specified features as second argument.
</PlatformBlock>
