...
The {ProductName} State Persistence in {Platform} {ComponentTitle} allows developers to easily save and restore the grid state. When the <ApiLink type="GridState" /> is applied on the {Platform} <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} />, it exposes the <ApiLink type="GridState" member="getState" /> and <ApiLink type="{ComponentName}" member="setState" pkg="grids" prefixed={false} /> methods that developers can use to achieve state persistence in any scenario.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
The {ProductName} State Persistence in {Platform} {ComponentTitle} allows developers to easily save and restore the grid state. When the <ApiLink type="GridState" /> is applied on the {Platform} <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} />, it exposes the <ApiLink type="GridState" member="getState" />, <ApiLink type="GridState" member="getStateAsString" />, <ApiLink type="GridState" member="applyState" /> and <ApiLink type="GridState" member="applyStateFromString" /> methods that developers can use to achieve state persistence in any scenario.
</PlatformBlock>

<PlatformBlock for="Blazor">
The {ProductName} State Persistence in {Platform} {ComponentTitle} allows developers to easily save and restore the grid state. When the <ApiLink type="GridState" /> is applied on the {Platform} <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} />, it exposes the `GetStateAsStringAsync` and `ApplyStateFromStringAsync` methods that developers can use to achieve state persistence in any scenario.
</PlatformBlock>

## Supported Features

<ApiLink type="GridState" /> supports saving and restoring the state of the following features:
...
- <ApiLink type="{ComponentName}" member="cellSelection" pkg="grids" prefixed={false} />
- <ApiLink type="{ComponentName}" member="columnSelection" pkg="grids" prefixed={false} />
...
> The <ApiLink type="GridState" /> does not take care of templates. Go to [Restoring Column](state-persistence.md#restoring-columns) section to see how to restore column templates.
...
<PlatformBlock for="React, WebComponents">
The <ApiLink type="GridState" member="getState" /> method returns the grid state in a <ApiLink type="GridStateInfo" /> object, containing all the state info. Additional steps may be required in order to save it.
</PlatformBlock>
...
<PlatformBlock for="Angular">
<ApiLink type="{ComponentName}" member="setState" pkg="grids" prefixed={false} /> - The <ApiLink type="{ComponentName}" member="setState" pkg="grids" prefixed={false} /> method accepts the serialized JSON string or <ApiLink type="IGridState" pkg="grids" kind="interface" prefixed={false} /> object as argument and will restore the state of each feature found in the object/JSON string.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
<ApiLink type="GridState" member="applyState" /> - The method accepts a <ApiLink type="GridStateInfo" /> object as argument and will restore the state of each feature found in the object or specified features as second argument.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
<ApiLink type="GridState" member="applyStateFromString" /> - The method accepts a serialized JSON string as argument and will restore the state of each feature found in the JSON string or specified features as second argument.
</PlatformBlock>
...
<PlatformBlock for="Angular">
The <ApiLink type="GridStateBaseDirective" member="options" label="Options" /> object implements the `IGridStateOptions` interface, i.e. for every key, which is the name of a certain feature, there is the boolean value indicating if this feature state will be tracked. <ApiLink type="GridState" member="getState" /> method will not put the state of these features in the returned value and <ApiLink type="{ComponentName}" member="setState" pkg="grids" prefixed={false} /> method will not restore state for them.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
The <ApiLink type="GridStateBaseDirective" member="options" label="Options" /> object implements the <ApiLink type="GridStateOptions" /> interface, i.e. for every key, which is the name of a certain feature, there is the boolean value indicating if this feature state will be tracked. <ApiLink type="GridState" member="getState" />/<ApiLink type="GridState" member="getStateAsString" /> methods will not put the state of these features in the returned value and <ApiLink type="GridState" member="applyState" />/<ApiLink type="GridState" member="applyStateFromString" /> methods will not restore state for them.
</PlatformBlock>
...
<ApiLink type="GridState" /> will not persist columns templates, column formatters, etc. by default (see [limitations](state-persistence.md#limitations)). Restoring any of these can be achieved with code on application level. Let's show how to do this for templated columns:
...
2 - In the `ColumnInit` event handler, assign the template to the column <ApiLink type="Column" member="bodyTemplate" label="BodyTemplate" /> property:
</PlatformBlock>
...
<ApiLink type="GridState" /> will not persist pivot dimension functions, value formatters, etc. by default (see [limitations](state-persistence.md#limitations)). Restoring any of these can be achieved with code on application level. The <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> exposes two events which can be used to set back any custom functions you have in the configuration: `DimensionInit` and `ValueInit`. Let's show how to do this:
...
> The `DimensionInit` and `ValueInit` events are emitted for each value and dimension defined in the <ApiLink type="{ComponentName}" member="pivotConfiguration" pkg="grids" prefixed={false} /> property.
...
<ApiLink type="GridState" /> will not persist neither remote pivot operations nor custom dimension strategies.
 Restoring any of these can be achieved with code on application level. The <ApiLink type="GridState" /> exposes an event called `StateParsed` which can be used to additionally modify the grid state before it gets applied. Let's show how to do this:

> `StateParsed` is only emitted when we are using <ApiLink type="{ComponentName}" member="setState" pkg="grids" prefixed={false} /> with string argument.
...
<ComponentBlock for="Grid, HierarchicalGrid, TreeGrid">
<PlatformBlock for="Angular">
- <ApiLink type="GridState" member="getState" /> method uses JSON.stringify() method to convert the original objects to a JSON string. JSON.stringify() does not support Functions, thats why the <ApiLink type="GridState" /> directive will ignore the columns <ApiLink type="Column" member="formatter" label="Formatter" />, <ApiLink type="PivotConfiguration" member="filters" label="Filters" />, <ApiLink type="Column" member="summaries" label="Summaries" />, <ApiLink type="{ComponentName}" member="sortStrategy" pkg="grids" prefixed={false} />, <ApiLink type="Column" member="cellClasses" />, <ApiLink type="Column" member="cellStyles" label="CellStyles" />, <ApiLink type="Column" member="headerTemplate" label="HeaderTemplate" /> and <ApiLink type="Column" member="bodyTemplate" label="BodyTemplate" /> properties.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
- <ApiLink type="GridState" member="getStateAsString" /> method uses JSON.stringify() method to convert the original objects to a JSON string. JSON.stringify() does not support Functions, thats why the <ApiLink type="GridState" /> component will ignore the columns <ApiLink type="Column" member="formatter" label="Formatter" />, <ApiLink type="PivotConfiguration" member="filters" label="Filters" />, <ApiLink type="Column" member="summaries" label="Summaries" />, <ApiLink type="{ComponentName}" member="sortStrategy" pkg="grids" prefixed={false} />, <ApiLink type="Column" member="cellClasses" />, <ApiLink type="Column" member="cellStyles" label="CellStyles" />, <ApiLink type="Column" member="headerTemplate" label="HeaderTemplate" /> and <ApiLink type="Column" member="bodyTemplate" label="BodyTemplate" /> properties.
</PlatformBlock>
