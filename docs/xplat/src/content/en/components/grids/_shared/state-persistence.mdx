...
llms:
  description: "The {ProductName} State Persistence in {Platform} {ComponentTitle} allows developers to easily save and restore the grid state."
---
...
<PlatformBlock for="Angular">
  The {ProductName} State Persistence in {Platform} {ComponentTitle} allows
  developers to easily save and restore the grid state. When the{" "}
  <ApiLink type="GridState" /> is applied on the {Platform}{" "}
  <ApiLink type="{ComponentName}" />, it exposes the{" "}
  <ApiLink type="GridState" member="getState" /> and{" "}
  <ApiLink type="{ComponentName}" member="setState" /> methods that developers
  can use to achieve state persistence in any scenario.
</PlatformBlock>
...
<PlatformBlock for="React, WebComponents">
  ...
  <ApiLink type="GridState" member="getStateAsString" />,{" "}
  <ApiLink type="GridState" member="applyState" /> and{" "}
  <ApiLink type="GridState" member="applyStateFromString" /> methods that
  developers can use to achieve state persistence in any scenario.
</PlatformBlock>
...
<PlatformBlock for="Blazor">
  ...
  developers to easily save and restore the grid state. When the{" "}
  <ApiLink type="GridState" /> is applied on the {Platform}{" "}
  <ApiLink type="{ComponentName}" />, it exposes the `GetStateAsStringAsync` and
  `ApplyStateFromStringAsync` methods that developers can use to achieve state
  persistence in any scenario.
</PlatformBlock>

## Supported Features

<ApiLink type="GridState" /> supports saving and restoring the state of the
following features:
...
- **Columns**
  ...
  - Columns order
  - Column properties defined by the <ApiLink type="ColumnState" /> interface.
...
- <ApiLink type="PivotConfiguration" />
  - Pivot Configuration properties defined by the <ApiLink type="PivotConfiguration" /> interface.
...
<PlatformBlock for="Blazor, React">
  ...
  <ApiLink type="PivotConfiguration" /> interface. - Pivot Dimension and Value
  functions are restored using application level code, see [Restoring Pivot
  Configuration](state-persistence.mdx#restoring-pivot-configuration) section.
</PlatformBlock>
...
<PlatformBlock for="Angular">
The <ApiLink type="GridState" member="getState" /> method returns the grid state in a serialized JSON string, so developers can just take it and save it on any data storage (database, cloud, browser localStorage, etc). The method accepts first optional parameter `Serialize`, which determines whether <ApiLink type="GridState" member="getState" /> will return an <ApiLink type="IGridState" /> object or a serialized JSON string.
...
<PlatformBlock for="React, WebComponents">
  The <ApiLink type="GridState" member="getState" /> method returns the grid
  state in a <ApiLink type="GridStateInfo" /> object, containing all the state
  info. Additional steps may be required in order to save it.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
The <ApiLink type="GridState" member="getStateAsString" /> returns a serialized JSON string, so developers can just take it and save it on any data storage (database, cloud, browser localStorage, etc).
...
<PlatformBlock for="Angular">
  <ApiLink type="{ComponentName}" member="setState" /> - The{" "}
  <ApiLink type="{ComponentName}" member="setState" /> method accepts the
  serialized JSON string or <ApiLink type="IGridState" /> object as argument and
  will restore the state of each feature found in the object/JSON string.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
  <ApiLink type="GridState" member="applyState" /> - The method accepts a{" "}
  <ApiLink type="GridStateInfo" /> object as argument and will restore the state
  of each feature found in the object or specified features as second argument.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
  <ApiLink type="GridState" member="applyStateFromString" /> - The method
  accepts a serialized JSON string as argument and will restore the state of
  each feature found in the JSON string or specified features as second
  argument.
</PlatformBlock>

<PlatformBlock for="Blazor">
  `ApplyStateFromStringAsync` - The method accepts a serialized JSON string as
  argument and will restore the state of each feature found in the JSON string
  or specified features as second argument.
</PlatformBlock>

<PlatformBlock for="Angular">
  ```typescript state.setState(gridState);
  state.setState(sortingFilteringStates) ```
</PlatformBlock>

<PlatformBlock for="WebComponents">
  ```typescript gridState.applyState(gridState);
  gridState.applyStateFromString(gridStateString);
  gridState.applyState(sortingFilteringStates) ```
</PlatformBlock>

<PlatformBlock for="React">
  ```tsx gridStateRef.current.applyState(gridState, []);
  gridStateRef.current.applyStateFromString(gridStateString, []);
  gridStateRef.current.applyState(sortingFilteringStates, []) ```
</PlatformBlock>

<PlatformBlock for="Blazor">
  ```csharp gridState.ApplyStateFromStringAsync(gridStateString, new string[0]);
  gridState.ApplyStateFromStringAsync(sortingFilteringStates, new string[0]) ```
</PlatformBlock>

<PlatformBlock for="Angular">
  The <ApiLink type="GridStateBaseDirective" member="options" label="Options" />{" "}
  object implements the `IGridStateOptions` interface, i.e. for every key, which
  is the name of a certain feature, there is the boolean value indicating if
  this feature state will be tracked.{" "}
  <ApiLink type="GridState" member="getState" /> method will not put the state
  of these features in the returned value and{" "}
  <ApiLink type="{ComponentName}" member="setState" /> method will not restore
  state for them.
</PlatformBlock>

<PlatformBlock for="React, WebComponents">
  The <ApiLink type="GridStateBaseDirective" member="options" label="Options" />{" "}
  object implements the <ApiLink type="GridStateOptions" /> interface, i.e. for
  every key, which is the name of a certain feature, there is the boolean value
  indicating if this feature state will be tracked.{" "}
  <ApiLink type="GridState" member="getState" />/
  <ApiLink type="GridState" member="getStateAsString" /> methods will not put
  the state of these features in the returned value and{" "}
  <ApiLink type="GridState" member="applyState" />/
  <ApiLink type="GridState" member="applyStateFromString" /> methods will not
  restore state for them.
</PlatformBlock>
...
<PlatformBlock for="Blazor">
  ...
  object implements the <ApiLink type="GridStateOptions" /> interface, i.e. for
  every key, which is the name of a certain feature, there is the boolean value
  indicating if this feature state will be tracked. `GetStateAsStringAsync`
  methods will not put the state of these features in the returned value and
  `ApplyStateFromStringAsync` methods will not restore state for them.
</PlatformBlock>
...
<ComponentBlock for="Grid, HierarchicalGrid, TreeGrid, PivotGrid">
  <PlatformBlock for="React">
    ```tsx
    <IgrGridState
      options={{ cellSelection: false, sorting: false }}
    ></IgrGridState>
    ```
  </PlatformBlock>
</ComponentBlock>
...
<ApiLink type="GridState" /> will not persist columns templates, column
formatters, etc. by default (see
[limitations](state-persistence.mdx#limitations)). Restoring any of these can be
achieved with code on application level. Let's show how to do this for templated
columns:
...
<PlatformBlock for="Blazor, React, WebComponents">
  2 - In the `ColumnInit` event handler, assign the template to the column{" "}
  <ApiLink type="Column" member="bodyTemplate" label="BodyTemplate" /> property:
</PlatformBlock>
...
<ApiLink type="GridState" /> will not persist pivot dimension functions, value
formatters, etc. by default (see
[limitations](state-persistence.mdx#limitations)). Restoring any of these can be
achieved with code on application level. The <ApiLink type="{ComponentName}" />
exposes two events which can be used to set back any custom functions you have
in the configuration: `DimensionInit` and `ValueInit`. Let's show how to do
this:
...
> The `DimensionInit` and `ValueInit` events are emitted for each value and dimension defined in the <ApiLink type="{ComponentName}" member="pivotConfiguration" /> property.
...
Saving / Restoring state for the child grids is controlled by the <ApiLink type="GridStateInfo" member="rowIslands" label="RowIslands" /> property and is enabled by default. <ApiLink type="GridState" /> will use the same options for saving/restoring features both for the root grid and all child grids down the hierarchy. For example, if we pass the following options:
...
<ComponentBlock for="HierarchicalGrid">
  <PlatformBlock for="React">
    ...
    <IgrHierarchicalGrid>
      <IgrGridState
        options={{ cellSelection: false, sorting: false, rowIslands: true }}
      ></IgrGridState>
    </IgrHierarchicalGrid>
    ```
  </PlatformBlock>
...
<ComponentBlock for="HierarchicalGrid">
Then the <ApiLink type="GridState" member="getState" /> API will return the state for all grids (root grid and child grids) features excluding `Selection` and <ApiLink type="GridStateInfo" member="sorting" label="Sorting" />. If later on the developer wants to restore only the <ApiLink type="GridStateInfo" member="filtering" label="Filtering" /> state for all grids, use:
...
<PlatformBlock for="React">
  ```tsx state.applyState(state, ['filtering', 'rowIslands']); ```
</PlatformBlock>
...
<Sample
  src="/{ComponentSample}/state-persistence-main"
  height={763}
  alt="{Platform} {ComponentTitle} State Persistence "
/>
...
<ApiLink type="GridState" /> will not persist neither remote pivot operations
nor custom dimension strategies. Restoring any of these can be achieved with
code on application level. The <ApiLink type="GridState" /> exposes an event
called `StateParsed` which can be used to additionally modify the grid state
before it gets applied. Let's show how to do this:

> `StateParsed` is only emitted when we are using <ApiLink type="{ComponentName}" member="setState" /> with string argument.
...
<igc-pivot-grid
  ...
  super-compact-mode="true"
  show-pivot-configuration-ui="false"
  height="600px"
  id="grid"
>
  <igc-grid-state id="gridState"></igc-grid-state>
...
<PlatformBlock for="Blazor">```razor Add snippet for blazor ```</PlatformBlock>
...
<PlatformBlock for="React, WebComponents">
  - <ApiLink type="GridState" member="getStateAsString" /> method uses
  JSON.stringify() method to convert the original objects to a JSON string.
  JSON.stringify() does not support Functions, thats why the{" "}
  <ApiLink type="GridState" /> component will ignore the columns{" "}
  <ApiLink type="Column" member="formatter" label="Formatter" />,{" "}
  <ApiLink type="PivotConfiguration" member="filters" label="Filters" />,{" "}
  <ApiLink type="Column" member="summaries" label="Summaries" />,{" "}
  <ApiLink type="{ComponentName}" member="sortStrategy" />,{" "}
  <ApiLink type="Column" member="cellClasses" />,{" "}
  <ApiLink type="Column" member="cellStyles" label="CellStyles" />,{" "}
  <ApiLink type="Column" member="headerTemplate" label="HeaderTemplate" /> and{" "}
  <ApiLink type="Column" member="bodyTemplate" label="BodyTemplate" />{" "}
  properties.
</PlatformBlock>
...
<ComponentBlock for="PivotGrid">
- <ApiLink type="GridState" member="getState" /> method uses JSON.stringify() method to convert the original objects to a JSON string. JSON.stringify() does not support Functions, thats why the <ApiLink type="GridState" /> directive will ignore the pivot dimension <ApiLink type="PivotDimension" member="memberFunction" label="MemberFunction" />, pivot values <ApiLink type="PivotValue" member="member" label="Member" />, <ApiLink type="Column" member="formatter" label="Formatter" />, custom <ApiLink type="PivotValue" member="aggregate" label="Aggregate" /> functions, <ApiLink type="PivotValue" member="styles" label="Styles" /> and pivot configuration strategies: <ApiLink type="PivotConfiguration" member="columnStrategy" label="ColumnStrategy" /> and <ApiLink type="PivotConfiguration" member="rowStrategy" label="RowStrategy" />.
...
<ApiLink type="PivotConfiguration" />
<br />
<ApiLink type="PivotDimension" />
<br />
<ApiLink type="PivotValue" />
<br />
