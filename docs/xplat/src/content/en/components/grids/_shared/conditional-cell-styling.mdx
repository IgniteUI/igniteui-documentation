...
- By setting <ApiLink pkg="grids" type="{ComponentName}" member="rowClasses" prefixed={false} /> input on the `{ComponentName}` component;
- By setting <ApiLink pkg="grids" type="{ComponentName}" member="rowStyles" prefixed={false} /> input on the `{ComponentName}` component;

Further in this topic we will cover both of them in more details.

### Using Row Classes

You can conditionally style the `{ComponentName}` rows by setting the <ApiLink pkg="grids" type="{ComponentName}" member="rowClasses" prefixed={false} /> input and define custom rules.
...
### Using Cell Classes
You can conditionally style the `{ComponentName}` cells by setting the `Column` <ApiLink pkg="grids" type="{ComponentName}" member="cellClasses" prefixed={false} /> input and define custom rules.
