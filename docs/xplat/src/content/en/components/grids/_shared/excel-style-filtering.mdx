...
To turn on the <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> component's Excel-style filtering, two inputs should be set. The <ApiLink type="{ComponentName}" member="allowFiltering" pkg="grids" prefixed={false} /> should be set to **true** and the <ApiLink type="{ComponentName}" member="filterMode" pkg="grids" prefixed={false} /> should be set to `ExcelStyleFilter` value.
...
If you want to further customize the Excel style filter menu, you can use the <ApiLink type="{ComponentName}" member="excelStyleHeaderIconTemplate" pkg="grids" prefixed={false} /> property to define a custom template for the header icon of the menu.

The following code demonstrates how to customize the Excel style filter menu using the <ApiLink type="{ComponentName}" member="excelStyleHeaderIconTemplate" pkg="grids" prefixed={false} />:
