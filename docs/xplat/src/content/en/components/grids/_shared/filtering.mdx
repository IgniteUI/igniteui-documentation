...
- The `Filter` method has new signature. It now accepts the following parameters:
  ...
  - <ApiLink pkg="grids" type="FilteringExpression" member="ignoreCase" label="IgnoreCase" exclude="React,WebComponents" /> (optional) - whether the filtering is case sensitive or not.
