...
<ComponentBlock for="HierarchicalGrid">
<DocsAside type="note">
Both <ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="getNextCell" label="GetNextCell" /> and <ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="getPreviousCell" label="GetPreviousCell" /> are
