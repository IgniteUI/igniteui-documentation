...
In order to specify which edit mode should be enabled, the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> exposes the following boolean properties - <ApiLink pkg="grids" type="{ComponentName}" member="editable" prefixed={false} /> and <ApiLink pkg="grids" type="{ComponentName}" member="rowEditable" prefixed={false} />.

The <ApiLink pkg="grids" type="{ComponentName}" member="editable" prefixed={false} /> property enables you to specify the following options:
...
In the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} />, if you set <ApiLink pkg="grids" type="{ComponentName}" member="rowEditable" prefixed={false} /> property to true, and the <ApiLink pkg="grids" type="{ComponentName}" member="editable" prefixed={false} /> property is not explicitly defined for any column, the editing will be enabled for all the columns except the **primary key**.
...
### Editing Templates
 ...
 If you want to use a data type specific edit templates, you should specify the column's <ApiLink pkg="grids" type="{ComponentName}" member="dataType" prefixed={false} /> property. So let's now see what are the default templates for each type:
...
The grid exposes a wide array of events that provide greater control over the editing experience. These events are fired during the [**Row Editing**](row-editing.md) and [**Cell Editing**](cell-editing.md) lifecycle - when starting, committing or canceling the editing action.
 ...
 | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------- |
 | <ApiLink pkg="grids" type="{ComponentName}" member="rowEditEnter" prefixed={false} />  | If `RowEditing` is enabled, fires when a row enters edit mode                                                                                             | `GridEditEventArgs`     | **true**    |
 | <ApiLink pkg="grids" type="{ComponentName}" member="cellEditEnter" prefixed={false} /> | Fires when a cell **enters edit mode** (after <ApiLink pkg="grids" type="{ComponentName}" member="rowEditEnter" prefixed={false} />)                                                                                             | `GridEditEventArgs`     | **true**    |
 | <ApiLink pkg="grids" type="{ComponentName}" member="cellEdit" prefixed={false} />      | If value is changed, fires just **before** a cell's value is **committed** (e.g. by pressing <kbd>ENTER</kbd>)                                                     | `GridEditEventArgs`     | **true**    |
 | <ApiLink pkg="grids" type="{ComponentName}" member="cellEditDone" prefixed={false} />  | If value is changed, fires **after** a cell has been edited and cell's value is **committed**                                                             | `GridEditDoneEventArgs` | **false**   |
 | <ApiLink pkg="grids" type="{ComponentName}" member="cellEditExit" prefixed={false} />  | Fires when a cell **exits edit mode**                                                                                                                     | `GridEditDoneEventArgs` | **false**   |
 | <ApiLink pkg="grids" type="{ComponentName}" member="rowEdit" prefixed={false} />       | If `RowEditing` is enabled, fires just before a row in edit mode's value is **committed** (e.g. by clicking the `Done` button on the Row Editing Overlay) | `GridEditEventArgs`     | **true**    |
 | <ApiLink pkg="grids" type="{ComponentName}" member="rowEditDone" prefixed={false} />   | If `RowEditing` is enabled, fires **after** a row has been edited and new row's value has been **committed**.                                             | `GridEditDoneEventArgs` | **false**   |
 | <ApiLink pkg="grids" type="{ComponentName}" member="rowEditExit" prefixed={false} />   | If `RowEditing` is enabled, fires when a row **exits edit mode**                                                                                          | `GridEditDoneEventArgs` | **false**   |
