...
**Column resizing** is also enabled per-column level, meaning that the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> can have a mix of resizable and non-resizable columns. This is done via the <ApiLink pkg="grids" type="{ComponentName}" member="resizable" prefixed={false} /> input of the `Column`.
...
You can subscribe to the <ApiLink pkg="grids" type="{ComponentName}" member="columnResized" prefixed={false} /> event of the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> to implement some custom logic when a column is resized. Both, previous and new column widths, as well as the `Column` object, are exposed through the event arguments.
...
You can also configure the minimum and maximum allowable column widths. This is done via the <ApiLink pkg="grids" type="{ComponentName}" member="minWidth" prefixed={false} /> and <ApiLink pkg="grids" type="{ComponentName}" member="maxWidth" prefixed={false} /> inputs of the `Column`. In this case the resize indicator drag operation is restricted to notify the user that the column cannot be resized outside the boundaries defined by <ApiLink pkg="grids" type="{ComponentName}" member="minWidth" prefixed={false} /> and <ApiLink pkg="grids" type="{ComponentName}" member="maxWidth" prefixed={false} />.
...
Each column can be **auto sized** by double clicking the right side of the header - the column will be sized to the longest currently visible cell value, including the header itself. This behavior is enabled by default, no additional configuration is needed. However, the column will not be auto-sized in case <ApiLink pkg="grids" type="{ComponentName}" member="maxWidth" prefixed={false} /> is set on that column and the new width exceeds that <ApiLink pkg="grids" type="{ComponentName}" member="maxWidth" prefixed={false} /> value. In this case the column will be sized according to preset <ApiLink pkg="grids" type="{ComponentName}" member="maxWidth" prefixed={false} /> value.
