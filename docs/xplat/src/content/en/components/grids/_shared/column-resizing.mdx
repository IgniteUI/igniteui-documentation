...
**Column resizing** is also enabled per-column level, meaning that the <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> can have a mix of resizable and non-resizable columns. This is done via the <ApiLink type="Column" member="resizable" /> input of the <ApiLink type="Column" />.
...
You can subscribe to the <PlatformBlock for="Angular,WebComponents"><ApiLink type="GridComponentEventMap" member="columnResized" /></PlatformBlock><PlatformBlock for="React"><ApiLink type="Grid" member="onColumnResized" pkg="grids" kind="class" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink type="Grid" member="columnResized" label="columnResized" /></PlatformBlock> event of the <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> to implement some custom logic when a column is resized. Both, previous and new column widths, as well as the <ApiLink type="Column" /> object, are exposed through the event arguments.
...
You can also configure the minimum and maximum allowable column widths. This is done via the <ApiLink type="Column" member="minWidth" /> and <ApiLink type="ColumnState" member="maxWidth" /> inputs of the <ApiLink type="Column" />. In this case the resize indicator drag operation is restricted to notify the user that the column cannot be resized outside the boundaries defined by <ApiLink type="Column" member="minWidth" /> and <ApiLink type="ColumnState" member="maxWidth" />.
...
Each column can be **auto sized** by double clicking the right side of the header - the column will be sized to the longest currently visible cell value, including the header itself. This behavior is enabled by default, no additional configuration is needed. However, the column will not be auto-sized in case <ApiLink type="ColumnState" member="maxWidth" /> is set on that column and the new width exceeds that <ApiLink type="ColumnState" member="maxWidth" /> value. In this case the column will be sized according to preset <ApiLink type="ColumnState" member="maxWidth" /> value.

You can also auto-size a column dynamically using the exposed <ApiLink type="Column" member="autosize" /> method on <ApiLink type="Column" />.
...
Each column can be set to auto-size on initialization by setting <ApiLink type="{ComponentName}" member="width" pkg="grids" prefixed={false} /> to 'auto':
...
To get started with the styling of the <ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> column resize line, we need to import the index file, where all the theme functions and component mixins live:
...
The simplest approach to achieve this is to create a new theme that extends the <ApiLink type="function-grid-theme" label="grid-theme" kind="sass" module="index.html" /> and accepts many parameters as well as the `$resize-line-color` parameter.
...
Instead of hard-coding the color values, we can achieve greater flexibility in terms of colors by using the <ApiLink type="function-igx-palette" label="igx-palette" kind="sass" module="index.html" /> and <ApiLink type="function-igx-color" label="igx-color" kind="sass" module="index.html" /> functions.
...
And then, with <ApiLink type="function-igx-color" label="igx-color" kind="sass" module="index.html" />, we can easily retrieve the color from the palette.
...
Extend the predefined schema provided for every component, in this case - <ApiLink type="variable-_light-grid" label="light-grid" kind="sass" module="index.html" /> schema:
