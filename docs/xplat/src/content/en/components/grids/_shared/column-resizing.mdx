...
**Column resizing** is also enabled per-column level, meaning that the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> can have a mix of resizable and non-resizable columns. This is done via the <ApiLink pkg="grids" type="Column" member="resizable" /> input of the <ApiLink pkg="grids" type="Column" />.
...
You can subscribe to the <PlatformBlock for="Angular,WebComponents"><ApiLink pkg="grids" kind="interface" type="GridComponentEventMap" member="columnResized" /></PlatformBlock><PlatformBlock for="React"><ApiLink pkg="grids" kind="class" type="Grid" member="onColumnResized" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="Grid" member="columnResized" label="columnResized" suffix={false} /></PlatformBlock> event of the <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> to implement some custom logic when a column is resized. Both, previous and new column widths, as well as the <ApiLink pkg="grids" type="Column" /> object, are exposed through the event arguments.
...
You can also configure the minimum and maximum allowable column widths. This is done via the <ApiLink pkg="grids" type="Column" member="minWidth" /> and <ApiLink pkg="grids" type="Column" member="maxWidth" /> inputs of the <ApiLink pkg="grids" type="Column" />. In this case the resize indicator drag operation is restricted to notify the user that the column cannot be resized outside the boundaries defined by <ApiLink pkg="grids" type="Column" member="minWidth" /> and <ApiLink pkg="grids" type="Column" member="maxWidth" />.
...
The simplest approach to achieve this is to create a new theme that extends the <ApiLink kind="sass" module="index.html" type="function-grid-theme" label="grid-theme" /> and accepts many parameters as well as the `$resize-line-color` parameter.
...
Instead of hard-coding the color values, we can achieve greater flexibility in terms of colors by using the <ApiLink kind="sass" module="index.html" type="function-igx-palette" label="igx-palette" /> and <ApiLink kind="sass" module="index.html" type="function-igx-color" label="igx-color" /> functions.
...
And then, with <ApiLink kind="sass" module="index.html" type="function-igx-color" label="igx-color" />, we can easily retrieve the color from the palette.
...
Extend the predefined schema provided for every component, in this case - <ApiLink kind="sass" module="index.html" type="variable-_light-grid" label="light-grid" /> schema:
