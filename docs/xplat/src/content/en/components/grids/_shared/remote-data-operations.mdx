...
When requesting data, you need to utilize the <ApiLink pkg="grids" type="ForOfState" kind="interface" suffix={false}/> interface, which provides the <ApiLink pkg="grids" type="ForOfState" member="startIndex" /> and <ApiLink pkg="grids" type="ForOfState" member="chunkSize" /> properties.
...
To implement infinite scroll, you have to fetch the data in chunks. The data that is already fetched should be stored locally and you have to determine the length of a chunk and how many chunks there are. You also have to keep a track of the last visible data row index in the grid. In this way, using the <ApiLink pkg="grids" kind="interface" type="ForOfState" member="chunkSize" suffix={false} /> and <ApiLink pkg="grids" kind="interface" type="ForOfState" member="chunkSize" suffix={false} /> properties, you can determine if the user scrolls up and you have to show them already fetched data or scrolls down and you have to fetch more data from the end-point.
