...
When requesting data, you need to utilize the <ApiLink pkg="grids" type="ForOfState" kind="interface" suffix={false} /> interface, which provides the <PlatformBlock for="React"><ApiLink pkg="grids" kind="interface" type="ForOfState" member="startIndex" /></PlatformBlock><ApiLink pkg="grids" type="ForOfState" member="startIndex" /> and <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="ForOfState" member="chunkSize" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="ForOfState" label="chunkSize" suffix={false} /></PlatformBlock> properties.
