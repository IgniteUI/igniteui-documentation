...
When requesting data, you need to utilize the <ApiLink pkg="grids" type="IForOfState" /> interface, which provides the <ApiLink pkg="grids" type="{ComponentName}" member="startIndex" prefixed={false} /> and <ApiLink pkg="grids" type="{ComponentName}" member="chunkSize" prefixed={false} /> properties.
