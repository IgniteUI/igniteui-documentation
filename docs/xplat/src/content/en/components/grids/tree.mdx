...
### Declaring a tree
<ApiLink pkg="inputs" type="TreeItem" suffix={false} /> is the representation of every item that belongs to the <ApiLink pkg="inputs" type="Tree" />.
Items provide <ApiLink pkg="inputs" type="TreeItem" member="disabled" label="Disabled" suffix={false} />, <ApiLink pkg="inputs" type="TreeItem" member="active" label="Active" suffix={false} />, <ApiLink pkg="inputs" type="TreeItem" member="selected" label="Selected" suffix={false} /> and <ApiLink pkg="inputs" type="TreeItem" member="expanded" label="Expanded" suffix={false} /> properties, which give you opportunity to configure the states of the item as per your requirement.
The <ApiLink pkg="inputs" type="TreeItem" member="value" label="Value" suffix={false} /> property can be used to add a reference to the data entry the item represents.
...
<DocsAside type="note">
You can provide a custom slot content for each <ApiLink pkg="inputs" type="TreeItem" suffix={false} />'s indentation, expansion and label area respectively using the provided `indentation`, `indicator` and `label` slots.
</DocsAside>

### Item Interactions

<ApiLink pkg="inputs" type="TreeItem" suffix={false} /> could be expanded or collapsed:
...
You can change the appearance of the <ApiLink pkg="inputs" type="TreeItem" suffix={false} />, by using some of the exposed CSS parts listed below:
