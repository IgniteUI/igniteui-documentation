...
Row Paging is enabled within the {ProductName} Data Table / Data Grid by setting the <ApiLink pkg="grids" type="DataGrid" member="isPagerVisible" label="IsPagerVisible" /> property. In addition, you can limit the maximum number of visible rows by setting <ApiLink pkg="grids" type="DataGrid" member="pageSize" label="PageSize" />.

## {Platform} Row Paging Example

<Sample src="/grids/data-grid/pager" height={600} alt="{Platform} Row Paging Example" />
