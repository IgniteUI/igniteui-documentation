...
license: commercial
mentionedTypes: ["DataGrid", "FilterExpressions", "FilterLogicalOperator", "FilterOperand"]
namespace: Infragistics.Controls.Grids.Implementation
_canonicalLink: "{CanonicalLinkToGridFiltering}"
llms:
  description: "The {ProductName} Data Table / Data Grid includes column filtering with both a filter row and API that gives you the ability to perform expressive sort conditions based on the data type of the column being filtered."
apiTerms: full
---
...
<Sample src="/grids/data-grid/column-filtering" height={600} alt="{Platform} Grid Filtering Example" />
...
<Sample src="/grids/data-grid/column-filter-expressions" height={600} alt="{Platform} Grid Filter Expressions Example" />
...
<Sample src="/grids/data-grid/column-filter-operands" height={600} alt="{Platform} Grid Filtering Example" />
