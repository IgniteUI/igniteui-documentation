...
This is activated by setting the <ApiLink pkg="grids" type="DataGrid" member="useAccessibility" label="UseAccessibility" /> property of the grid to **true**.
...
<Sample src="/grids/data-grid/accessibility" height={600} alt="{Platform} Grid Cell Accessibility Example" />
...
After setting the <ApiLink pkg="grids" type="DataGrid" member="useAccessibility" label="UseAccessibility" /> property to **true**, this will enable a range of keyboard navigation options in the data grid that screen readers can recognize. Below is a description of each of the key presses / combinations and the effect they will have relative to the currently activated cell:
