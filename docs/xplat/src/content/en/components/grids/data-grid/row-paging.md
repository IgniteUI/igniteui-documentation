...
description: View Infragistics' {Platform} grid component's Pager, which was designed to take in an array of data and output portions of that data as a page.
keywords: "{Platform} Table, Data Grid, row, paging, {ProductName}, Infragistics"
