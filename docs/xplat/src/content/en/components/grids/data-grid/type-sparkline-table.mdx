...
The following code example shows how to embed `XamSparkline` component in <ApiLink pkg="grids" type="TemplateColumn" /> of the <ApiLink pkg="grids" type="DataGrid" /> component:
