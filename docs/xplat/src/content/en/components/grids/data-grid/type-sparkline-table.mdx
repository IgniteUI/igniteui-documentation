...
The {ProductName} Data Table / Data Grid supports a Template Column which provides you to a way to embed other components such as {ProductName} sparkline component. Refer to the [Column Types](column-types.md) topic for other types of columns supported in the <ApiLink pkg="grids" type="DataGrid" /> component.
...
The following code example shows how to embed `Sparkline` component in <ApiLink pkg="grids" type="TemplateColumn" /> of the <ApiLink pkg="grids" type="DataGrid" /> component:
