...
The Data Grid contains <ApiLink pkg="grids" type="DataGrid" member="setCustomizedStringAsync" label="SetCustomizedStringAsync" /> for assigning strings associated with the column options. The grid's <ApiLink pkg="grids" type="DataGrid" member="actualDataSource" label="ActualDataSource" /> property also has this method for assigning resource strings necessary for the summaries.
...
<Sample src="/grids/data-grid/localization" height={600} alt="{Platform} Grid Localization Example" />
