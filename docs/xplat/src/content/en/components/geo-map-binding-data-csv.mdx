...
## Code Snippet
The following code loads and binds <ApiLink pkg="maps" type="GeographicHighDensityScatterSeries" /> in the map component to an array of objects created from loaded CSV file with geographic locations.
