...
## Code Snippet
The following code snippet shows how to display {Platform} geographic imagery tiles from Esri imagery servers in <ApiLink pkg="maps" type="GeographicMap" /> using <ApiLink pkg="maps" type="ArcGISOnlineMapImagery" suffix={false} /> class.
