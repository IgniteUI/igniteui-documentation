...
## Code Snippet
The following code loads and binds <ApiLink pkg="maps" type="GeographicHighDensityScatterSeries" /> in the map component to an array of objects created from loaded JSON file with geographic locations:
...
<ApiRef pkg="maps" types={["GeographicHighDensityScatterSeries","GeographicSymbolSeries","GeographicMap"]} />
