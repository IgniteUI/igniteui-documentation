...
## Code Snippet
This code example explicitly sets `backgroundContent` of the map component to the <ApiLink type="OpenStreetMapImagery" /> object which provides geographic imagery from  OpenStreetMap© contributors.
