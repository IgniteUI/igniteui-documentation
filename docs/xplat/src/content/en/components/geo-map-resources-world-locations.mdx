...
description: Use Infragistics' {Platform} map data utility to generate geographic locations of cities and capitals of countries. View {ProductName} map demos!
