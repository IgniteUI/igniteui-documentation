...
- Updated to use the latest `igniteui-webcomponents@7.1.0` including new <ApiLink pkg="inputs" type="Splitter" /> and `Highlight` container components and fixes. See the [full changelog](https://github.com/IgniteUI/igniteui-webcomponents/blob/master/CHANGELOG.md#710---2026-03-19).
