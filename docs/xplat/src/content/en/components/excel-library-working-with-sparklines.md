...
description: Use sparkline charts in Infragistics' {Platform} excel library to visual data trends across a region of cells in your worksheet. View {ProductName} excel engine tutorials!
keywords: Excel library, sparkline chart, {ProductName}, Infragistics
license: commercial
