...
<DocsAside type="info">
The `Default` <ApiLink pkg="inputs" type="Step" /> slot renders the content of the step.
</DocsAside>
...
The {Platform} <ApiLink pkg="inputs" type="Stepper" /> Animations provide the end-users with a beautiful experience interacting with the defined steps. The available animation options differ depending on the orientation of the stepper.
