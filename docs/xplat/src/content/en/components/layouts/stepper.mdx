...
You can customize the stepper orientation through the exposed <ApiLink pkg="core" type="Stepper" member="orientation" label="Orientation" /> property. It could be set to **horizontal** **(default value)** or **vertical**.
