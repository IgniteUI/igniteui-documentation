...
The <ApiLink type="Step" /> is the representation of every step that belongs to the <ApiLink type="Stepper" />. Steps provide <ApiLink type="Step" member="Invalid" label="Step.Invalid" />, <ApiLink type="Step" member="Active" label="Step.Active" />, <ApiLink type="Step" member="Optional" label="Step.Optional" />, <ApiLink type="Step" member="Disabled" label="Step.Disabled" /> and <ApiLink type="Step" member="Complete" label="Step.Complete" /> properties, which give you the ability to configure the step states according to your business requirement.
...
When the <ApiLink type="Stepper" /> is horizontally oriented, the content area height is determined by the step with the most content. All other steps share this fixed height, which may result in visible empty space in steps with less content.
...
The {Platform} <ApiLink type="Stepper" /> Animations provide the end-users with a beautiful experience interacting with the defined steps. The available animation options differ depending on the orientation of the stepper.
...
<ApiLink type="Stepper" /><br />
<ApiLink type="Step" /><br />
