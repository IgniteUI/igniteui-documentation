...
Using the <ApiLink type="Accordion" member="panels" label="Panels" /> accessor you can get a reference to the collection containing all expansion panels children of the <ApiLink pkg="core" type="Accordion" />.
