...
<Sample spacing="sm" height={300} src="/layouts/avatar/overview" showThemePicker alt="{Platform} Avatar overview example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar/variants" showThemePicker alt="{Platform} Avatar variants example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar/shape" showThemePicker alt="{Platform} Avatar shape example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar/size" showThemePicker alt="{Platform} Avatar size example" />
