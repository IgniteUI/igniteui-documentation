...
<Sample spacing="sm" showThemePicker height={300} src="/layouts/avatar/overview" alt="{Platform} Avatar overview example" />
...
<Sample position="center" spacing="sm" showThemePicker height={300} src="/layouts/avatar/variants" alt="{Platform} Avatar variants example" />
...
<Sample position="center" spacing="sm" showThemePicker height={300} src="/layouts/avatar/shape" alt="{Platform} Avatar shape example" />
...
<Sample position="center" spacing="sm" showThemePicker height={300} src="/layouts/avatar/size" alt="{Platform} Avatar size example" />
