...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar/overview" alt="{Platform} Avatar overview example" />
...
<Sample fitContent position="center" spacing="sm" src="/layouts/avatar/styling" alt="{Platform} styled Avatar example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample fitContent spacing="sm" src="/layouts/avatar-styling" alt="{Platform} styled Avatar example" />
...
<Sample position="center" spacing="sm" height={560} src="/layouts/avatar/tailwind-styling" alt="{Platform} Avatar Tailwind styling example" />
