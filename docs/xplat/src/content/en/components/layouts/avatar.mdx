...
description: "Use the {Platform} Avatar component to represent users, entities, or objects with images, initials, icons, or custom content."
...
llms:
  description: "The {ProductName} Avatar topic shows how to render user, entity, or object identity with images, initials, icons, custom content, shape, size, styling, and accessibility guidance."
---
...
<Sample src="/layouts/avatar-sample-4" height={100} alt="{Platform} Avatar icon example" />
...
<Sample fitContent position="center" src="/layouts/avatar/initials" alt="{Platform} Avatar initials example" />

<Sample fitContent position="center" src="/layouts/avatar/image" alt="{Platform} Avatar image example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/avatar-sample-1" height={100} alt="{Platform} Avatar initials example" />

<Sample src="/layouts/avatar-sample-2" height={100} alt="{Platform} Avatar image example" />

<Sample src="/layouts/avatar-sample-3" height={200} alt="{Platform} Avatar content variations example" />
...
<Sample fitContent position="center" src="/layouts/avatar/shape" alt="{Platform} Avatar shape example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/avatar-shape" height={100} alt="{Platform} Avatar shape example" />
...
<Sample fitContent position="center" src="/layouts/avatar/size" alt="{Platform} Avatar size example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/avatar-size" height={100} alt="{Platform} Avatar size example" />
...
<Sample fitContent position="center" src="/layouts/avatar/styling" alt="{Platform} styled Avatar example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/avatar-styling" height={120} alt="{Platform} styled Avatar example" />
...
<Sample src="/layouts/avatar-css-variables" height={100} alt="{Platform} Avatar CSS variables example" />
...
<Sample src="/layouts/avatar-tailwind-styling" height={100} alt="{Platform} Avatar Tailwind styling example" />
...
- [Badge](../badge.mdx) - Use Badge to show counts, status, or notification indicators. Badge can decorate Avatar when the UI needs both identity and status.
