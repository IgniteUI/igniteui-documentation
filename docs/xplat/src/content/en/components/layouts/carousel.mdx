...
<Sample src="/layouts/carousel/overview" showThemePicker height={500} noBackground={true} noBorder={false} alt="{Platform} Carousel overview example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/carousel-overview-sample" showThemePicker height={500} noBackground={true} noBorder={true} alt="Angular Carousel overview example" />
...
<Sample src="/layouts/carousel/configuration" showThemePicker height={460} noBackground={false} alt="{Platform} Carousel configuration example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/carousel-configuration-sample" showThemePicker height={460} noBackground={false} alt="Angular Carousel configuration example" />
...
<Sample src="/layouts/carousel/components" showThemePicker height={480} noBackground={false} alt="{Platform} Carousel with components example" />
...
<Sample src="/layouts/carousel-components-sample" showThemePicker height={500} noBackground={false} alt="Angular Carousel with components example" />
...
<Sample src="/layouts/carousel/animations" showThemePicker height={500} noBackground={false} alt="{Platform} Carousel animations example" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/layouts/carousel-animations" showThemePicker height={460} noBackground={false} alt="Angular Carousel animations example" />
...
<Sample src="/layouts/carousel/thumbnail" showThemePicker height={470} noBackground={false} alt="{Platform} Carousel thumbnail example" />
...
<Sample src="/layouts/carousel-thumbnail" showThemePicker height={470} noBackground={false} alt="Angular Carousel thumbnail indicators example" />
