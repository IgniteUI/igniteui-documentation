...
<Sample src="/layouts/carousel/styling" height={460} noBackground={false} alt="{Platform} Carousel styling example" />
...
<Sample src="/layouts/carousel/tailwind-styling" height={460} noBackground={false} alt="{Platform} Carousel Tailwind styling example" />
