...
Use text, SVG, or <ApiLink type="Icon" /> content in these templates when the default navigation controls do not fit the design.
...
Set the <ApiLink type="Carousel" member="animationType" label="animationType" /> input to `none` to disable animations.
