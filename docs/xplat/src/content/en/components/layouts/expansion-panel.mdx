...
The <ApiLink pkg="core" type="ExpansionPanel" /> control allows all sorts of content to be added inside of its body. It can render [input](../inputs/input.md), charts and even other expansion panels!
...
<Sample src="/layouts/expansion-panel/styling" height={480} alt="{Platform} Expansion Panel Styling" />
