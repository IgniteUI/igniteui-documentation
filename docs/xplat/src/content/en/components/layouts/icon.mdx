...
The second method for registering icons is by passing an SVG string to the <ApiLink type="Icon" member="registerIconFromText" label="RegisterIconFromText" /> method:
