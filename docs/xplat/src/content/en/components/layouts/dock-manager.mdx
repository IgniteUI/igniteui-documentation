...
<PlatformBlock for="WebComponents">
 For more information on this refer to [Split Panes Fixed Size Mode](./dock-manager-customization.mdx#split-panes-fixed-size-mode) topic.
 </PlatformBlock>
...
Practice all of the above mentioned actions in the sample [demo](./dock-manager.mdx#{PlatformLower}-dock-manager-example).
