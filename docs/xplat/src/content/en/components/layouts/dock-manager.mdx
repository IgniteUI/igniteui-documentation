...
This example shows most functionalities and docking options of the <ApiLink pkg="inputs" type="DockManager" suffix={false} /> that you can use in your application.
...
- <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock>
- <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="SplitPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="SplitPane" /></PlatformBlock>
- <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="TabGroupPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="TabGroupPane" /></PlatformBlock>
- <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="DocumentHost" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="DocumentHost" /></PlatformBlock>
...
The <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock> represents a pane with header and content. It can be hosted inside a Split Pane or a Tab Group Pane. Here is how a content pane is defined:
...
<ApiLink pkg="inputs" type="DockManager" suffix={false} /><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="DocumentHost" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="DocumentHost" /></PlatformBlock><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="DockManagerLayout" suffix={false} /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="DockManagerLayout" suffix={false} /></PlatformBlock><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="ContentPane" /></PlatformBlock><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="SplitPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="SplitPane" /></PlatformBlock><br />
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="inputs" type="TabGroupPane" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="inputs" type="TabGroupPane" /></PlatformBlock><br />
