...
Set the <ApiLink pkg="inputs" type="Splitter" member="orientation" label="Orientation" /> property to control pane direction:
...
- <ApiLink pkg="inputs" type="Splitter" member="startSize" label="StartSize" />, <ApiLink pkg="inputs" type="Splitter" member="endSize" label="EndSize" />
- <ApiLink pkg="inputs" type="Splitter" member="startMinSize" label="StartMinSize" />, <ApiLink pkg="inputs" type="Splitter" member="endMinSize" label="EndMinSize" />
- <ApiLink pkg="inputs" type="Splitter" member="startMaxSize" label="StartMaxSize" />, <ApiLink pkg="inputs" type="Splitter" member="endMaxSize" label="EndMaxSize" />
...
- <ApiLink pkg="inputs" type="Splitter" member="disableResize" label="DisableResize" />: disables pane resizing.
- <ApiLink pkg="inputs" type="Splitter" member="disableCollapse" label="DisableCollapse" />: disables pane collapsing.
- <ApiLink pkg="inputs" type="Splitter" member="hideDragHandle" label="HideDragHandle" />: hides the drag handle.
- <ApiLink pkg="inputs" type="Splitter" member="hideCollapseButtons" label="HideCollapseButtons" />: hides collapse and expand buttons.
