...
Set the <ApiLink pkg="inputs" type="Splitter" member="orientation" label="Orientation" exclude="Blazor,WebComponents" /> property to control pane direction:
...
- <ApiLink pkg="inputs" type="Splitter" member="startSize" label="StartSize" exclude="Blazor,WebComponents" />, <ApiLink pkg="inputs" type="Splitter" member="endSize" label="EndSize" exclude="Blazor,WebComponents" />
- <ApiLink pkg="inputs" type="Splitter" member="startMinSize" label="StartMinSize" exclude="Blazor,WebComponents" />, <ApiLink pkg="inputs" type="Splitter" member="endMinSize" label="EndMinSize" exclude="Blazor,WebComponents" />
- <ApiLink pkg="inputs" type="Splitter" member="startMaxSize" label="StartMaxSize" exclude="Blazor,WebComponents" />, <ApiLink pkg="inputs" type="Splitter" member="endMaxSize" label="EndMaxSize" exclude="Blazor,WebComponents" />
...
- <ApiLink pkg="inputs" type="Splitter" member="disableResize" label="DisableResize" exclude="Blazor,WebComponents" />: disables pane resizing.
- <ApiLink pkg="inputs" type="Splitter" member="disableCollapse" label="DisableCollapse" exclude="Blazor,WebComponents" />: disables pane collapsing.
- <ApiLink pkg="inputs" type="Splitter" member="hideDragHandle" label="HideDragHandle" exclude="Blazor,WebComponents" />: hides the drag handle.
- <ApiLink pkg="inputs" type="Splitter" member="hideCollapseButtons" label="HideCollapseButtons" exclude="Blazor,WebComponents" />: hides collapse and expand buttons.
...
- <ApiLink pkg="inputs" type="Splitter" member="onResizeStart" label="ResizeStart" />: fired once when resizing starts.
- <ApiLink pkg="inputs" type="Splitter" member="onResizing" label="Resizing" />: fired continuously while resizing.
- <ApiLink pkg="inputs" type="Splitter" member="onResizeEnd" label="ResizeEnd" />: fired once when resizing ends.
