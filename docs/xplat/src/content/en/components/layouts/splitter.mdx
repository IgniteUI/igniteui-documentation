...
- <ApiLink type="Splitter" member="onResizeStart" label="ResizeStart" pkg="inputs" />: fired once when resizing starts.
- <ApiLink type="Splitter" member="onResizing" label="Resizing" pkg="inputs" />: fired continuously while resizing.
- <ApiLink type="Splitter" member="onResizeEnd" label="ResizeEnd" pkg="inputs" />: fired once when resizing ends.
