...
The {ProductName} map component, the <ApiLink pkg="maps" type="ShapefileConverter" /> class loads geo-spatial data (points/locations, polylines, polygons) from shape files and converts it to a collection of <ApiLink pkg="maps" type="ShapefileRecord" /> objects.
...
<ApiRef pkg="maps" types={["GeographicPolylineSeries","ShapefileConverter"]} />
