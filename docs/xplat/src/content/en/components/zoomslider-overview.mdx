...
The following sample demonstrates how to use <ApiLink pkg="charts" type="ZoomSlider" /> to navigate content in <ApiLink pkg="charts" type="DataChart" />.
...
The <ApiLink pkg="charts" type="ZoomSlider" /> requires the following modules:
