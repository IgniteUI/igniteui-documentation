...
license: MIT
llms:
  description: "The {GridLiteTitle} accepts an array of plain objects as a data source."
---
...
<Sample src="/{GridLiteSample}/data-binding" height={600} alt="{Platform} {GridLiteTitle} Data Binding" />
