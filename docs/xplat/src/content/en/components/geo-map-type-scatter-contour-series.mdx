...
| Property Name  | Property Type   | Description   |
|--------------|---------------| ---------------|
|`GeographicMap.brushes`|BrushCollection|Gets or sets the collection of brushes for filling contours of the `GeographicContourLineSeries`|
...
```json-snippet channel="bindingImports...code" source="/maps/geo-map/type-scatter-contour-series"
{
    "type": "GeographicMap",
    "name": "geoMap",
    "height": "100%",
