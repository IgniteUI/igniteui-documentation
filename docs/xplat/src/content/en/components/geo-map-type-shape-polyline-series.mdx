...
In {Platform} map component, you can use the <ApiLink pkg="maps" type="GeographicPolylineSeries" /> to display geo-spatial data using polylines in a geographic context. This type of geographic series is often used to render roads or connections between geographic locations such as cities or airports.
...
## Code Snippet
The following code shows how to bind the <ApiLink pkg="maps" type="GeographicPolylineSeries" /> to locations of cities loaded from a shape file using the <ApiLink pkg="geo-core" type="ShapefileRecord" suffix={false} />.
