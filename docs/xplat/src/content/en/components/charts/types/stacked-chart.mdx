...
The following example, you can use the drop-down to switch between all of the different types stacked charts available in the {Platform} <ApiLink pkg="charts" type="XamDataChart" /> control.
