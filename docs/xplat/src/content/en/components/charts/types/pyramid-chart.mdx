...
The following example demonstrates how to create Pyramid Chart using `BarSeries` in the <ApiLink pkg="charts" type="DataChart" /> control.
...
<ApiRef pkg="charts" types={["DataChart","BarSeries","CategoryYAxis","NumericXAxis"]} />
