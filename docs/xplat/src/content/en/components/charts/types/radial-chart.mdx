...
In addition, the labels can be configured to appear near or wide from the chart. This can be configured with the `CategoryAngleAxis.labelMode` property for the `CategoryAngleAxis`.
