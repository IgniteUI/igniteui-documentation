...
description: Use Infragistics' {Platform} Treemap control show relative weighting of data points at more than one level supporting strip, squarified, and slice-and-dice algorithms. Learn about {ProductName} treemap!
keywords: "{Platform} Tree Map, Treemap, layout, orientation, {ProductName}, Infragistics"
license: commercial
