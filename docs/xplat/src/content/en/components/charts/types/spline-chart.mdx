...
The following example shows how to create {Platform} Spline Chart in the <ApiLink type="CategoryChart" /> control by binding your data and setting the `chartType` property to `Spline` enum.
...
You can create this type of chart in the <ApiLink type="CategoryChart" /> control by binding your data and setting the `chartType` property to `Spline`, as shown in the example below:
...
| --------------------|--------------------|-------------------------- |
| Spline              | <ApiLink type="CategoryChart" /> | `chartType` = `Spline` |
