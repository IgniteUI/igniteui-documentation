...
You can create more advanced types of {Platform} Point Charts using the <ApiLink pkg="charts" type="DataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control by following these topics:
