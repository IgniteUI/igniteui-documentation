...
You can create the {Platform} Point Chart in the <ApiLink type="CategoryChart" /> control by binding your data to <ApiLink type="CategoryChart" member="dataSource" label="DataSource" pkg="charts" /> property and setting <ApiLink type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to **Point** enum, as shown in the example below.
