...
You can create the {Platform} Point Chart in the `CategoryChart` control by binding your data to `dataSource` property and setting `chartType` property to **Point** enum, as shown in the example below.
