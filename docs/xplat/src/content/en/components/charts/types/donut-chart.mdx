...
You can create Donut Chart using the <ApiLink pkg="charts" type="XamDoughnutChart" /> control by binding your data as shown in the example below.
...
<ApiRef pkg="charts" types={["XamDoughnutChart"]} />
