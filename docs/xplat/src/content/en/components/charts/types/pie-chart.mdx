...
For scenarios where you click on the Others slice, the pie chart will return an object called <ApiLink pkg="charts" type="PieSliceOthersContext" excludeSuffixFor="Angular,WebComponents" />. This object contains a list of the data items contained within the Others slice.
