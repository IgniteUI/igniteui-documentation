...
description: The {Platform} Line chart is capable of handling high volumes of data, ranging into millions of data points, and updating them every few milliseconds. Download free trial.
...
You can create the {Platform} Line Chart in the `CategoryChart` control by binding your data to `dataSource` property and setting `chartType` property to `PolarLineSeries.line` enum, as shown in the example below.
...
You can create this type of chart in the `CategoryChart` control by binding your data and setting the `chartType` property to `PolarLineSeries.line`, as shown in the example below:
...
| ------------------|--------------------|----------------------- |
| Line              | `CategoryChart`    | `chartType` = `PolarLineSeries.line` |
