...
You can create the {Platform} Line Chart in the <ApiLink type="CategoryChart" /> control by binding your data to <ApiLink type="CategoryChart" member="itemsSource" label="ItemsSource" pkg="charts" /> property and setting <ApiLink type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to <ApiLink type="PolarLineSeries" member="line" label="Line" pkg="charts" /> enum, as shown in the example below.
