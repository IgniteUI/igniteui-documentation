...
You can create the {Platform} Line Chart in the `CategoryChart` control by binding your data to `dataSource` property and setting `chartType` property to `line` enum, as shown in the example below.
