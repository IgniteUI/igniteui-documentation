...
The following example demonstrates how to create Gantt Chart using `ScatterPolygonSeries` in the <ApiLink pkg="charts" type="XamDataChart" /> control.
...
<ApiRef pkg="charts" types={["XamDataChart","ScatterPolygonSeries","CategoryYAxis","NumericXAxis","NumericYAxis"]} />
