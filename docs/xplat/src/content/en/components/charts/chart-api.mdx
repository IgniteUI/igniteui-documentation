...
The {ProductName} charts provide simple and easy to use APIs to plot your data in `CategoryChart`, `FinancialChart`, `DataChart`, `DataPieChart`, `DoughnutChart`, `PieChart`, and `Sparkline` UI elements.
