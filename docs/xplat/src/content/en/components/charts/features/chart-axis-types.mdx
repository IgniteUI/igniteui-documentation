...
The `CategoryXAxis` requires you to provide a `ItemsSource` and a `label` in order to plot data with it. It is generally used with the `NumericYAxis` to plot the following type of series:
