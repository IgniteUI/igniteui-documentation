...
description: Use Infragistics {ProductName} chart with the data selection!
keywords: "{Platform} charts, chart data, selection, data selection, {ProductName}, Infragistics"
license: commercial
_language: en
