...
In addition to marker properties, you can implement your own marker by setting a function to the  <ApiLink type="CategoryChart" member="markerTemplate" label="MarkerTemplate" pkg="charts" /> property of a series rendered in the <ApiLink type="CategoryChart" /> control as it is demonstrated in example below.
