...
| -------------------------------------------------- | ----------------------------------- |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `interval`             | `xAxisInterval` (Major Interval) |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `interval`             | `yAxisInterval` (Major Interval) |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `minorInterval`        | `xAxisMinorInterval`    |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `minorInterval`        | `yAxisMinorInterval`    |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `majorStroke`          | `xAxisMajorStroke`    |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `majorStroke`          | `yAxisMajorStroke`    |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `majorStrokeThickness` | `xAxisMajorStrokeThickness` |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `majorStrokeThickness` | `yAxisMajorStrokeThickness` |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `minorStrokeThickness` | `xAxisMinorStrokeThickness` |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `minorStrokeThickness` | `yAxisMinorStrokeThickness` |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `strokeThickness`      | `xAxisStrokeThickness`   |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `strokeThickness`      | `yAxisStrokeThickness`   |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `stroke`               | `xAxisStroke` (Axis Line Color) |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `stroke`               | `yAxisStroke` (Axis Line Color) |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `tickLength`           | `xAxisTickLength`    |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `tickLength`           | `yAxisTickLength`    |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `tickStroke`           | `xAxisTickStroke`    |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `tickStroke`           | `yAxisTickStroke`    |
| `Axes` -> <ApiLink type="NumericXAxis" /> -> `strip`                | `xAxisStrip` (Space between Major Gridlines) |
| `Axes` -> <ApiLink type="NumericYAxis" /> -> `strip`                | `yAxisStrip` (Space between Major Gridlines) |
