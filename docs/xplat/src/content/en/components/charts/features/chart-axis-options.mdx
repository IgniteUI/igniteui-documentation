...
| `Axes` -> `CategoryXAxis` -> `CategoryXAxis.gap`                     | None                   | `CategoryChart.xAxisGap`             |
| `Axes` -> `CategoryXAxis` -> `CategoryXAxis.overlap`                 | None                   | `CategoryChart.xAxisOverlap`         |
| `Axes` -> `TimeXAxis`                                  | `FinancialChart.xAxisMode`            | None                   |
| `Axes` -> `PercentChangeYAxis`                         | `FinancialChart.yAxisMode`            | None                   |
