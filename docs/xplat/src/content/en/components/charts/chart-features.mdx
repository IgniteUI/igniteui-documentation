...
llms:
  description: "The {ProductName} Charts allow you to display many different features to portray the full data story to be told with your chart."
---
...
<Sample src="/charts/data-chart/axis-crossing" height={500} alt="{Platform} Axis Crossing Axes Example" />
...
<Sample src="/charts/category-chart/line-chart-with-annotations" height={500} alt="{Platform} Annotations Example" />
...
<Sample src="/charts/data-chart/chart-navigation" height={500} alt="{Platform} Navigation Example" />
...
<Sample src="/charts/category-chart/high-volume" height={600} alt="{Platform} Chart Performance Example" />
