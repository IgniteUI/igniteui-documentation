...
description: "{ProductName} Charts & Graphs is an extensive library of data visualizations that enable stunning, interactive charts for your web and mobile apps. Try for FREE."
keywords: "{Platform} Charts, Chart, Infragistics"
license: commercial
...
`sample="/charts/data-chart/scatter-bubble-chart-multiple-sources", height="600", alt="{Platform} Bubble Chart"`
