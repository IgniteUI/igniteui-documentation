...
## Code Snippet
The following code shows how to bind the <ApiLink type="GeographicSymbolSeries" /> to a custom data model that contains geographic locations of some cities of the world stored using longitude and latitude coordinates. Also, we use the <ApiLink type="GeographicPolylineSeries" /> to plot shortest geographic path between these locations using the [WorldUtility](geo-map-resources-world-util.md)
