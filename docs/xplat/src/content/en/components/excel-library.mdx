...
llms:
  description: "The Infragistics {Platform} Excel Library allows you to work with spreadsheet data using familiar Microsoft® Excel® spreadsheet objects like Workbook, Worksheet, Cell, Formula and many more."
...
The Infragistics {Platform} Excel Library allows you to work with spreadsheet data using familiar Microsoft® Excel® spreadsheet objects like <ApiLink type="Workbook" />, <ApiLink type="Worksheet" />, <ApiLink type="WorksheetCell" label="Cell" />, <ApiLink type="Formula" /> and many more. The Infragistics {Platform} Excel Library makes it easy for you to represent the data of your application in an Excel spreadsheet as well as transfer data from Excel into your application.
...
<PlatformBlock for="Blazor">
- Set the static <ApiLink type="Workbook" member="InProcessRuntime" label="Workbook.InProcessRuntime" /> to the current runtime. This can be done by using the following code:
</PlatformBlock>
