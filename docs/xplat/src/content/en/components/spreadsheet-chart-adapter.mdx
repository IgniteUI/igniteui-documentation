...
The {Platform} Spreadsheet component allows displaying charts in your <ApiLink pkg="spreadsheet" type="Spreadsheet" exclude="Angular,Blazor,WebComponents" />.
...
The following code snippet demonstrates how to add charts to the currently viewed worksheet in the <ApiLink pkg="spreadsheet" type="Spreadsheet" exclude="Angular,Blazor,WebComponents" /> control:
