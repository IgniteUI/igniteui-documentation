...
In the following code snippet, an external [ExcelUtility](excel-utility.md) class is used to save and load a <ApiLink type="Spreadsheet" member="workbook" label="Workbook" />.
</DocsAside>
