...
The {Platform} Spreadsheet component allows displaying charts in your <ApiLink pkg="spreadsheet" type="Spreadsheet" />.
...
The following code snippet demonstrates how to add charts to the currently viewed worksheet in the <ApiLink pkg="spreadsheet" type="Spreadsheet" /> control:
