...
The {Platform} Spreadsheet component allows displaying charts in your <ApiLink pkg="spreadsheet" type="Spreadsheet" exclude="Blazor" />.

## {Platform} Spreadsheet Chart Adapter Example

<Sample src="/excel/spreadsheet/adapter-chart" height={500} alt="{Platform} Spreadsheet Chart Adapter Example" />
...
Using <ApiLink pkg="spreadsheet" type="SpreadsheetChartAdapterBase" suffix={false} exclude="Blazor" excludePrefixFor="Angular,React,WebComponents" /> you can display the charts in the spreadsheet. The spreadsheet chart adapters creates and initializes chart elements for the spreadsheet based on a Infragistics.Documents.Excel.WorksheetChart instance.
...
When setting up your {Platform} spreadsheet control to add charts, you will need to import the <ApiLink pkg="spreadsheet" type="SpreadsheetChartAdapter" suffix={false} exclude="Angular,Blazor,React,WebComponents" /> class like so:
