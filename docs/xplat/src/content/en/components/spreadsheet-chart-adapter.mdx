...
Using <ApiLink pkg="spreadsheet" type="SpreadsheetChartAdapterBase" prefixed={false} suffix={false} /> you can display the charts in the spreadsheet. The spreadsheet chart adapters creates and initializes chart elements for the spreadsheet based on a Infragistics.Documents.Excel.WorksheetChart instance.
