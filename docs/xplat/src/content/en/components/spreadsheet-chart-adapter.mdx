...
llms:
  description: "The {Platform} Spreadsheet component allows displaying charts in your Spreadsheet."
---
...
The {Platform} Spreadsheet component allows displaying charts in your <ApiLink type="Spreadsheet" />.
...
In order to add a WorksheetChart to a worksheet, you must use the <ApiLink type="WorksheetShapeCollection" member="addChart" label="AddChart" /> method of the worksheet’s Shapes collection. You can find more detail of adding charts in Excel below.
...
In the following code snippet, an external [ExcelUtility](./excel-utility.mdx) class is used to save and load a <ApiLink type="Spreadsheet" member="workbook" label="Workbook" />.
</DocsAside>

When setting up your {Platform} spreadsheet control to add charts, you will need to import the <ApiLink type="SpreadsheetChartAdapter" /> class like so:
...
The following code snippet demonstrates how to add charts to the currently viewed worksheet in the <ApiLink type="Spreadsheet" /> control:
