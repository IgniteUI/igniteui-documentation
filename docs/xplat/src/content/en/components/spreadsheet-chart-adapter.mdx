...
When setting up your {Platform} spreadsheet control to add charts, you will need to import the <ApiLink pkg="spreadsheet" type="SpreadsheetChartAdapter" suffix={false} /> class like so:
