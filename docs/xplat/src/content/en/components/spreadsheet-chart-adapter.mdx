...
Using `IgrSpreadsheetChartAdapterBase` you can display the charts in the spreadsheet. The spreadsheet chart adapters creates and initializes chart elements for the spreadsheet based on a Infragistics.Documents.Excel.WorksheetChart instance.
...
When setting up your {Platform} spreadsheet control to add charts, you will need to import the `IgrSpreadsheetChartAdapter` class like so:
