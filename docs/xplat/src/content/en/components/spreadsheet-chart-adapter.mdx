...
When setting up your {Platform} spreadsheet control to add charts, you will need to import the <ApiLink type="SpreadsheetChartAdapter" pkg="spreadsheet" /> class like so:
