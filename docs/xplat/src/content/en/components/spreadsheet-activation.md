...
description: Learn how to use the activation feature of the  {Platform} spreadsheet control which is split between the cells, panes and worksheets. Check out the {ProductName} spreadsheet demos!
keywords: Excel Spreadsheet, activation, {ProductName}, Infragistics
license: commercial
