...
The resource topic provides implementation of an utility that helps with using <ApiLink type="ArcGISOnlineMapImagery" /> provided by Esri Maps in <ApiLink type="GeographicMap" />.
