...
The resource topic provides implementation of an utility that helps with using <ApiLink pkg="maps" type="ArcGISOnlineMapImagery" suffix={false} /> provided by Esri Maps in <ApiLink pkg="maps" type="GeographicMap" />.
