...
## Code Snippet
The following code gives the `GeographicShapeSeries` a `ShapefileDataSource` pointing at a shape file of the world’s countries, and draws every country in it.
