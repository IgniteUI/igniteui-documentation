...
In {Platform} map component, you can use the <ApiLink pkg="maps" type="GeographicShapeSeries" /> to display geo-spatial data using shape polygons in a geographic context. This type of geographic series is often used to render shapes of countries or regions defined by geographic locations.
...
## Code Snippet
The following code demonstrates how to bind the <ApiLink pkg="maps" type="GeographicShapeSeries" /> to shapes of countries in the world loaded from a shape file using the <ApiLink pkg="geo-core" type="ShapefileRecord" suffix={false} />.
