...
1. Alternatively, paste the full content of the relevant `SKILL.md` files directly into `copilot-instructions.md` for fully offline, self-contained instructions.
2. Copilot will now apply these instructions automatically on every chat and inline suggestion in VS Code.
