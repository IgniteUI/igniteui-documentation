...
After that, you need to import the <ApiLink pkg="inputs" type="DateRangePicker" />, its necessary CSS, and register its module, as follows:
...
After that, you need to import the <ApiLink pkg="inputs" type="DateRangePicker" /> and its necessary CSS, as follows:
...
You also have the ability to add custom content and modify the appearance of the <ApiLink pkg="inputs" type="DateRangePicker" /> component using the available slots.
...
In addition to the slots we've already covered, the following slots are also available in the <ApiLink pkg="inputs" type="DateRangePicker" /> component:
...
<ApiLink type="DateRangePicker" pkg="core" /><br />
