...
<<<<<<< HEAD
<Aside type="note">
The `DatePicker` is a brand new component from {ProductName} version 
</Aside>
=======
<Aside type="note">
The <ApiLink pkg="core" type="DatePicker" /> is a brand new component from {ProductName} version 
...
<ApiRef pkg="core" types={["Input","Calendar","DatePicker"]} />
