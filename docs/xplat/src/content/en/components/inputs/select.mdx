...
Before using the <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> component, you need to register it together with its additional components:
...
You will also need to link an additional CSS file to apply the styling to the <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> component. The following needs to be placed in the **wwwroot/index.html** file in a **Blazor Web Assembly** project or the **Pages/_Host.cshtml** file in a **Blazor Server** project:
...
You will then need to import the <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> and the <ApiLink pkg="inputs" type="SelectItem" suffix={false} /> and its necessary CSS, like so:
...
- Open the <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> using the <kbd>ALT</kbd> + <kbd>↑</kbd> <kbd>↓</kbd> combination or by clicking on the <kbd>SPACE</kbd> or the <kbd>ENTER</kbd> key.
- Close the <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> using the <kbd>ALT</kbd> + <kbd>↑</kbd> or <kbd>↓</kbd> combination or any of the <kbd>ENTER</kbd>, <kbd>SPACE</kbd>, <kbd>ESC</kbd> or <ApiLink pkg="inputs" type="Tab" exclude="WebComponents" /> keys.
...
<DocsAside type="note">
The <ApiLink pkg="inputs" type="Input" member="select" label="Select" exclude="WebComponents" /> component supports only **single** selection of items.
</DocsAside>
