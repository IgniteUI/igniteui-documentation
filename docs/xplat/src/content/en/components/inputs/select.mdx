...
Before using the <ApiLink type="Input" member="select" label="Select" /> component, you need to register it together with its additional components:
...
You will also need to link an additional CSS file to apply the styling to the <ApiLink type="Input" member="select" label="Select" /> component. The following needs to be placed in the **wwwroot/index.html** file in a **Blazor Web Assembly** project or the **Pages/_Host.cshtml** file in a **Blazor Server** project:
...
You will then need to import the <ApiLink type="Input" member="select" label="Select" /> and the <ApiLink type="SelectItem" /> and its necessary CSS, like so:
...
- Open the <ApiLink type="Input" member="select" label="Select" /> using the <kbd>ALT</kbd> + <kbd>↑</kbd> <kbd>↓</kbd> combination or by clicking on the <kbd>SPACE</kbd> or the <kbd>ENTER</kbd> key.
- Close the <ApiLink type="Input" member="select" label="Select" /> using the <kbd>ALT</kbd> + <kbd>↑</kbd> or <kbd>↓</kbd> combination or any of the <kbd>ENTER</kbd>, <kbd>SPACE</kbd>, <kbd>ESC</kbd> or <ApiLink type="Tab" /> keys.
...
<DocsAside type="info">
The <ApiLink type="Input" member="select" label="Select" /> component supports only **single** selection of items.
</DocsAside>
...
## API References
<ApiLink type="Select" />
<ApiLink type="SelectItem" />
<ApiLink type="SelectHeader" />
<ApiLink type="SelectGroup" />
