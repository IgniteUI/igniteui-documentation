...
{ProductName} renders the Color Picker as a web component, so install `igniteui-webcomponents` in your Angular project:
...
<Sample src="/data-entries/color-picker-value" height={555} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker value example" />
...
<Sample src="/data-entries/color-picker-input" height={590} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker input example" />
...
<Sample src="/data-entries/color-picker-format" height={555} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker format example" />
...
<Sample src="/data-entries/color-picker-alpha" height={618} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker alpha example" />
...
Provide a list of predefined colors through the <ApiLink pkg="core" type="ColorPicker" member="swatches" label="swatches" /> property. When set, the picker renders a swatch grid below the color inputs. Clicking a swatch applies it as the current color. There is no limit to the number of swatches you can define.
...
<Sample src="/data-entries/color-picker-swatches" height={717} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker swatches example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/color-picker/swatches" height={717} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker swatches example" />
...
<Sample src="/data-entries/color-picker-states" height={585} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker states" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/color-picker/states" height={585} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker states" />
...
<Sample src="/data-entries/color-picker-sizes" height={635} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker sizes" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/color-picker/sizes" height={635} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker sizes" />

</PlatformBlock>

<PlatformBlock for="Angular">

<Sample src="/data-entries/color-picker-input-sizes" height={665} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker input sizes" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/color-picker/input-sizes" height={665} position="center" noBackground={false} noBorder={false} alt="{Platform} Color Picker input sizes" />
...
<Sample src="/data-entries/color-picker-reactive-form" height={850} position="center" noBackground={false} noBorder={false} alt="Angular Color Picker in a reactive form" />
...
<Sample src="/data-entries/color-picker-styling" height={630} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Color Picker styling example" />
...
<Sample src="/data-entries/color-picker-tailwind-styling" height={660} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Color Picker Tailwind styling example" />
...
<Faq>
  <FaqItem question="How do I bind the Color Picker to a form?" indicatorPosition="end">
    ...
    <PlatformBlock for="Angular">In Angular reactive forms, import `IgcFormControlDirective` and bind the Color Picker with `formControlName`. See [Using the Color Picker in Angular Reactive Forms](#using-the-color-picker-in-angular-forms).</PlatformBlock>
  </FaqItem>
  ...
  <FaqItem question="Which package provides the Color Picker?" indicatorPosition="end">
    <PlatformBlock for="WebComponents, Angular">The Color Picker ships in the `igniteui-webcomponents` package, version 7.3.0 or later.</PlatformBlock>
    <PlatformBlock for="Angular">Angular applications install it directly because `igniteui-angular` does not include the Color Picker.</PlatformBlock>
