...
<Sample src="/data-display/badge-type" height={100} alt="Angular Badge type example" />
...
<Sample src="/data-display/badge-size" height={100} alt="Angular Badge size example" />
...
<Sample src="/inputs/badge/type" height={100} alt="{Platform} Badge type example" />
...
<Sample src="/inputs/badge/size" height={100} alt="{Platform} Badge size example" />
...
<Faq>
  ...
  <FaqItem question="Can a Badge display both an icon and text?" indicatorPosition="end">
  ...
  <FaqItem question="How do I display a notification dot without content?" indicatorPosition="end">
    Set the platform-specific `dot` property or attribute. A dot Badge intentionally renders without text or other content.
  </FaqItem>

  <FaqItem question="Which package should I install for Badge?" indicatorPosition="end">
