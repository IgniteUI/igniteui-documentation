...
<Sample noBackground="false" fitContent noBorder="false" spacing='md' position='center' src="/data-display/badge-overview" height={100} alt="Angular Badge example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/badge/overview" fitContent position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge example" />
...
<Sample src="/data-display/badge-tailwind-styling" height={340} />
