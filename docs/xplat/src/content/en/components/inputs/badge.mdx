...
<Sample src="/data-display/badge-overview" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="Angular Badge example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/badge/overview" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge example" />
...
<Sample src="/data-display/badge-type" height={212} position="center" noBackground={false} alt="Angular Badge type example" />
...
<Sample src="/data-display/badge-icon" height={212} position="center" noBackground={false} alt="Angular Badge icon example" />
...
<Sample src="/data-display/badge-dot" height={212} position="start center" noBackground={false} alt="Angular Badge dot example" />
...
<Sample src="/data-display/badge-size" height={316} position="center" noBackground={false} alt="Angular Badge size example" />
...
<Sample src="/data-display/badge-shape" height={212} position="center" noBackground={false} alt="Angular Badge shape example" />
...
<Sample src="/data-display/badge-variants" height={212} position="center" noBackground={false} alt="Angular Badge variants example" />
...
<Sample src="/inputs/badge/type" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge type example" />
...
<Sample src="/inputs/badge/icon" height={212} position="center" noBackground={false} alt="{Platform} Badge icon example" />
...
<Sample src="/inputs/badge/dot" height={212} position="start center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge dot example" />
...
<Sample src="/inputs/badge/size" height={316} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge size example" />
...
<Sample src="/inputs/badge/shape" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge Example" />
...
<Sample src="/inputs/badge/variants" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge variants example" />
...
<Sample src="/data-display/badge-outlined" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="Angular Badge outlined example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/badge/outlined" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge Example" />
...
<Sample src="/data-display/badge-styling" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="Angular Badge styling example" />
...
<Sample src="/data-display/badge-tailwind-styling" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="Angular Badge tailwind styling example"/>

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/badge/styling" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge styling example" />
...
<Sample src="/inputs/badge/tailwind-styling" height={212} position="center" noBackground={false} noBorder={false} spacing="md" alt="{Platform} Badge tailwind styling example" />
