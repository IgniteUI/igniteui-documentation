---
title: "Badge"
description: "The {ProductName} Badge displays a short status, category, count, or notification indicator alongside avatars, navigation menus, and other components."
keywords: "{Platform} Badge, {ProductName}, badge indicator"
license: MIT
mentionedTypes: ["Badge"]
last_updated: "2026-07-24"
llms:
  description: "The {ProductName} Badge component displays a short status, category, count, or notification indicator alongside avatars, navigation menus, and other components."
---
...
<Sample src="/inputs/badge/overview" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} Badge example" />
...
<Sample src="/inputs/badge/type" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} Badge type example" />
...
<Sample src="/inputs/badge/icon" showThemePicker height={212} position="center" alt="{Platform} Badge icon example" />
...
<Sample src="/inputs/badge/dot" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Badge dot example" />
...
<Sample src="/inputs/badge/size" showThemePicker height={316} position="center" noBorder={false} spacing="md" alt="{Platform} Badge size example" />
...
<Sample src="/inputs/badge/shape" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} Badge Example" />
...
<Sample src="/inputs/badge/variants" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} Badge variants example" />
...
<Sample src="/data-display/badge-outlined" showThemePicker height={250} position="center" noBorder={false} spacing="md" alt="Angular Badge outlined example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/badge/outlined" showThemePicker height={250} position="center" noBorder={false} spacing="md" alt="{Platform} Badge Example" />
...
The {Platform} Badge requires a theme stylesheet to apply its visual styling. See the framework-specific setup in <PlatformBlock for="Angular">[**Getting Started**](../general-getting-started.mdx)</PlatformBlock><PlatformBlock for="React,WebComponents,Blazor">[**Getting Started**](../general-getting-started.mdx)</PlatformBlock>.
