...
<Sample src="/data-display/qr-code-overview" height={595} position="center" noBackground={false} showThemePicker={true} noBorder={false} alt="Angular QR Code example" />
