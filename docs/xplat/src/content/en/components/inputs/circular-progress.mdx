...
The progress bar can be customized to use a color gradient instead of a solid color by using the **gradient** slot and the <ApiLink type="CircularGradient" /> component, which defines the gradient stops.
