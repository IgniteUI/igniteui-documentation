...
The {ProductName} <ApiLink type="Combo" /> component supports most of the <ApiLink type="Input" /> properties, such as <ApiLink type="Combo" member="required" label="Required" />, <ApiLink type="Combo" member="disabled" label="Disabled" />, <ApiLink type="Combo" member="autofocus" label="Autofocus" />, <ApiLink type="Combo" member="invalid" label="Invalid" />, etc. The component also exposes two methods bound to its validation:
