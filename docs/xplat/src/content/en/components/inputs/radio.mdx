...
Before using the <ApiLink type="Radio" exclude="WebComponents" /> and the <ApiLink type="RadioGroup" />, you need to register them as follows:
...
You will then need to import the <ApiLink type="Radio" exclude="WebComponents" /> and the <ApiLink type="RadioGroup" />, its necessary CSS, and register its module, like so:
...
You will also need to link an additional CSS file to apply the styling to the <ApiLink type="Radio" exclude="WebComponents" /> and the <ApiLink type="RadioGroup" /> components. The following needs to be placed in the **wwwroot/index.html** file in a **Blazor Web Assembly** project or the **Pages/_Host.cshtml** file in a **Blazor Server** project:
...
The simplest way to start using the <ApiLink type="Radio" exclude="WebComponents" /> is as follows:
...
The <ApiLink type="Radio" exclude="WebComponents" /> component doesn't work with the standard `<form>` element. Use `Form` instead.
</DocsAside>
...
To provide a meaningful label for the <ApiLink type="Radio" exclude="WebComponents" />, simply place some text between the opening and closing tags:
...
You can specify if the label should be positioned before or after the <ApiLink type="Radio" exclude="WebComponents" /> button by setting the `label-position` attribute. Allowed values are `before` and `after`(default):
...
The <ApiLink type="Radio" exclude="WebComponents" /> can also be labelled by elements external to it. In this case the user is given full control to position and style the label in accordance to their needs.
...
The <ApiLink pkg="inputs" type="Radio" exclude="WebComponents" /> component exposes several CSS parts (`base`, `control`, and `label`) to give you full control over its styling.
...
<ApiLink type="Radio" pkg="core" exclude="WebComponents" /><br />
