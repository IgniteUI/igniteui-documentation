...
<Sample src="/data-entries/button-group-alignment-sample" height={220} alt="Angular Button Group Alignment Example" />
...
<Sample src="/data-entries/button-group-selection-sample" height={170} alt="Angular Button Group Selection Example" />
...
<Sample src="/data-entries/button-group-layout-sample" height={120} alt="{Platform} Button Group Layout Template Example" />
...
<Sample src="/data-entries/button-group-toggle-sample" height={90} alt="Angular Button Group Custom Toggle Buttons Example" />
...
<Sample src="/data-entries/button-group-size-sample" height={80} alt="Angular Button Group Size Example" />
...
<Sample src="/data-entries/button-group-style-sample" height={200} alt="Angular Button Group styling example" />
...
<Sample src="/data-entries/button-group-tailwind-style-sample" height={100} iframeOnly alt="Angular Button Group Tailwind styling example" />
