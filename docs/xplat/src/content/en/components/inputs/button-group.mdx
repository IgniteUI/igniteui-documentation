...
<Sample src="/data-entries/button-group-overview" height={480} position="center" noBorder={false} spacing="md" alt="Angular Button Group Example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button-group/overview" height={480} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group Example" />
...
Use only the number of buttons needed for the related actions in the group, and keep the Button Group sized to its content so that the buttons do not contain unnecessary empty space. In Figma, the Button Group uses auto layout to adjust to the number of buttons you choose. Hide any extra nested buttons in the Layers panel.

<PlatformBlock for="Angular">

<Sample src="/data-entries/button-group-buttons-amount" height={212} position="start center" noBorder={false} spacing="md" alt="Angular Button Group buttons amount example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button-group/buttons-amount" height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Group buttons amount example" />
...
<Sample src="/data-entries/button-group-interaction-states" height={316} position="center" noBorder={false} spacing="md" alt="Angular Button Group interaction states example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button-group/interaction-states" height={316} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group interaction states example" />
...
<Sample src="/data-entries/button-group-states" height={316} position="start center" noBorder={false} spacing="md" alt="Angular Button Group states example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button-group/states" height={316} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Group states example" />
