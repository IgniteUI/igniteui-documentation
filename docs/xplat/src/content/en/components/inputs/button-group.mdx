...
import buttonGroupAnatomy from '@xplat-images/button-group/button-group-anatomy-schema.png';
...
<Image src={buttonGroupAnatomy} alt="Button Group anatomy" class="responsive-img" style="margin: 50px 0;" />
...
<Sample src="/data-entries/button-group-tailwind-styling" height={100} iframeOnly alt="Angular Button Group Tailwind styling example" />
...
<FaqItem question="Which selection modes does the Button Group support?" indicatorPosition="end">
...
<FaqItem question="How do I set a selected button with selectedItems?" indicatorPosition="end">
...
<FaqItem question="Can I display icons in a Button Group?" indicatorPosition="end">
