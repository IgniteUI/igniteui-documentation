...
A <ApiLink type="ToggleButton" /> could be marked as selected via its <ApiLink type="ToggleButton" member="selected" label="Selected" /> attribute or through the <ApiLink type="ButtonGroup" /> <ApiLink type="PieChartBase" member="selectedItems" label="SelectedItems" /> attribute:
...
<DocsAside type="info">
Setting <ApiLink type="ToggleButton" /> <ApiLink type="ToggleButton" member="value" label="Value" /> attribute is mandatory for using the <ApiLink type="PieChartBase" member="selectedItems" label="SelectedItems" /> property of the <ApiLink type="ButtonGroup" />.
</DocsAside>
