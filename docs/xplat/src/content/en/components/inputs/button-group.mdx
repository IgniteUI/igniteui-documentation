...
<Sample src="/inputs/button-group/overview" showThemePicker height={520} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group Example" />
...
<Sample src="/inputs/button-group/alignment" showThemePicker height={316} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Group Alignment Example" />
...
<Sample src="/inputs/button-group/selection" showThemePicker height={316} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group Selection Example" />
...
<Sample src="/inputs/button-group/states" showThemePicker height={316} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group interaction states example" />
...
<Sample src="/inputs/button-group/interaction-states" showThemePicker height={316} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Group states example" />
...
<Sample src="/inputs/button-group/layout" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Group Layout Template Example" />
...
<Sample src="/inputs/button-group/custom-toggle" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Web Components Button Group Custom Toggle Buttons Example" />
...
<Sample src="/inputs/button-group/custom-toggle" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="React Button Group Custom Toggle Buttons Example" />
...
<Sample src="/inputs/button-group/custom-toggle" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Blazor Button Group Custom Toggle Buttons Example" />
...
<Sample src="/inputs/button-group/size" showThemePicker height={316} position="center" noBorder={false} spacing="md" alt="{Platform} Button Group Size Example" />
