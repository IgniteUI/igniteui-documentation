...
<Sample src="/data-entries/button-layout" height={212} position="start center" noBorder={false} spacing="md" alt="Angular Button layout example" />
...
<Sample src="/inputs/button/layout" height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button layout example" />
