...
```razor
<!-- This will NOT fire -->
<IgbButton @onclick="HandleClick">Click me</IgbButton>
```
...
> **Note:** This behavior is specific to `IgbButton`. For other Ignite UI for Blazor components that expose dedicated event parameters, use those component event parameters as documented.
