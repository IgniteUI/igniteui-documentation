...
<Sample src="/data-entries/button-overview" showThemePicker height={404} position="center" noBorder={false} spacing="md" alt="Angular Button Example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/overview" showThemePicker height={404} position="center" noBorder={false} spacing="md" alt="{Platform} Button Example" />
...
<Sample src="/data-entries/button-contained" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Angular Button contained" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/contained" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} button contained" />
...
<Sample src="/data-entries/button-outlined" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Angular Button outlined" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/outlined" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} button outlined" />
...
<Sample src="/data-entries/button-flat" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Angular Button flat" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/flat" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} button flat" />
...
<Sample src="/data-entries/button-fab" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Angular Button floating action button" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/fab" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} button fab" />
</PlatformBlock>
...
<Sample src="/data-entries/button-states" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="Angular Button states example" />
...
<Sample src="/inputs/button/states" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button states example" />
...
<Sample src="/data-entries/button-interaction-states" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="Angular Button interaction states example" />
...
<Sample src="/inputs/button/interaction-states" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button interaction states example" />
...
<Sample src="/data-entries/button-layout" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="Angular Button layout example" />
...
<Sample src="/inputs/button/layout" showThemePicker height={212} position="start center" noBorder={false} spacing="md" alt="{Platform} Button layout example" />
...
<Sample src="/data-entries/button-size" showThemePicker height={404} position="start center" noBorder={false} spacing="md" alt="Angular Button sizing example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/size" showThemePicker height={404} position="start center" noBorder={false} spacing="md" alt="{Platform} Button Sizing Example" />
...
<Sample src="/data-entries/button-download" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="Angular Button download example" />

</PlatformBlock>

<PlatformBlock for="React,WebComponents,Blazor">

<Sample src="/inputs/button/download" showThemePicker height={212} position="center" noBorder={false} spacing="md" alt="{Platform} button download" />
