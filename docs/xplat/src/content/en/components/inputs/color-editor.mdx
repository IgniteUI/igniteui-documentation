...
Before using the <ApiLink pkg="inputs" type="ColorEditor" />, you need to register the following modules as follows:
...
The simplest way to start using the <ApiLink pkg="inputs" type="ColorEditor" /> is as follows:
...
<ApiLink type="ColorEditor" pkg="inputs" /><br />
