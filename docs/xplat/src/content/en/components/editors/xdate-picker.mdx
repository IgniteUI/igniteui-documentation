...
The `XDatePicker` component is deprecated from version 
</DocsAside>
...
18.7.0
 ...
 of {ProductName}. For the latest supported {ProductName} Date Picker component refer to its respective page under "Scheduling".

## {Platform} XDate Picker Example

This sample demonstrates how to create `XDatePicker` with option to select a single date.

<Sample src="/editors/x-date-picker/overview" height={350} alt="{Platform} XDate Picker Example" />
...
<Sample src="/editors/x-date-picker/editing" height={300} alt="{Platform} XDate Picker Editing Example" />
...
<Sample src="/editors/x-date-picker/date-limits" height={360} alt="{Platform} XDate Picker Date Limits Example" />
...
<Sample src="/editors/x-date-picker/format" height={350} alt="{Platform} XDate Picker Format Example" />
...
<Sample src="/editors/x-date-picker/range" height={300} alt="{Platform} XDate Picker Date Range Example" />
...
<ApiRef pkg="inputs" types={["XDatePicker"]} />
