...
description: Infragistics' {Platform} combo component helps you select the best chart to display your data. Improve your graphs and visualization with Ignite UI for  {Platform}!
keywords: "{Platform} combo, drop down, {ProductName}, Infragistics"
mentionedTypes: []
---
