...
The {Platform} `GeographicMap` has the following API members:
...
The {Platform} `GeographicMap` has 7 types of series and they have the `ItemsSource` property for data binding.
