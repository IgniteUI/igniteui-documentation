...
The following code snippet shows how to display geographic imagery tiles from Azure Maps in {Platform} <ApiLink pkg="maps" type="XamGeographicMap" /> using <ApiLink pkg="maps" type="AzureMapsImagery" /> class.
...
The following code snippet shows how to display geographic imagery tiles on top of a background imagery joining eg. traffic with a dark grey map for the {Platform} <ApiLink pkg="maps" type="XamGeographicMap" /> using <ApiLink pkg="maps" type="AzureMapsImagery" /> and <ApiLink pkg="maps" type="GeographicTileSeries" /> classes.
