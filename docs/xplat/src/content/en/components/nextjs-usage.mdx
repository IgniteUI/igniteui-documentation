...
mentionedTypes: []
llms:
  description: "Explore the seamless integration of {ProductName} into your Next.js project."
---
...
First we have to import the required modules of the components we want to use. We will go ahead and do this for the [**GeographicMap**](./geo-map.mdx) component.
...
However, if a more complex component is used like the [**IgrGrid**](./grids/data-grid.mdx), which typically contains child components, it is essential not to dynamically import each and every child component. The component should be used like this:
...
- [Ignite UI for React](../components/general-getting-started.mdx)
- [Grid Overview](../components/grids/data-grid.mdx)
