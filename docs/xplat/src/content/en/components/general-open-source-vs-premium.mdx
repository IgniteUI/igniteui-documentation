...
llms:
  description: "{ProductName} offers two distinct paths for building modern, data-driven applications: Open-Source Components and Premium Components."
---
...
All Open-Source components are marked in the header of their topics with: <Badge variant="opensource" />
