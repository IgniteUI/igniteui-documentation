...
<PlatformBlock for="Angular,React,WebComponents,WinUI">
...
```json-snippet
{
    ...
    "$styleOptions": {
        ...
        "numericAttributeStyle": { "react": "braced" },
        "selfCloseEmptyElements": { "react": true }
    },
    "height": "100px",
    "width": "300px",
    "minimumValue": 5,
...
<igGauges:XamBulletGraph
    ...
    Value="70"
    TargetValue="90">
    <igGauges:XamBulletGraph.Ranges>
        <igGauges:LinearGraphRange
            Brush="#ff9800"
            Outline="#ff9800"
            StartValue="0"
            EndValue="40"
