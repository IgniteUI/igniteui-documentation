...
The {Platform} <ApiLink pkg="spreadsheet" type="Spreadsheet" /> component allows you to conditionally format the cells of a worksheet. This allows you to highlight different pieces of your data based on a condition.
...
The following lists the supported conditional formats in the {Platform} <ApiLink pkg="spreadsheet" type="Spreadsheet" /> control:
...
<ApiLink type="AverageConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="BlanksConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="ColorScaleConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="DataBarConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="DateTimeConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="DuplicateConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="ErrorsConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="FormulaConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="IconSetConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="NoBlanksConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="NoErrorsConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="OperatorConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="RankConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="TextOperatorConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="UniqueConditionalFormat" pkg="spreadsheet" /><br />
<ApiLink type="FormatConditionTextOperator" pkg="spreadsheet" /><br />
