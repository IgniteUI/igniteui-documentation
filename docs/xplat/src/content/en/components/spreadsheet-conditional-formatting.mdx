...
`AverageConditionalFormat`<br />
`BlanksConditionalFormat`<br />
`ColorScaleConditionalFormat`<br />
`DataBarConditionalFormat`<br />
`DateTimeConditionalFormat`<br />
`DuplicateConditionalFormat`<br />
`ErrorsConditionalFormat`<br />
`FormulaConditionalFormat`<br />
`IconSetConditionalFormat`<br />
`NoBlanksConditionalFormat`<br />
`NoErrorsConditionalFormat`<br />
`OperatorConditionalFormat`<br />
`RankConditionalFormat`<br />
`TextOperatorConditionalFormat`<br />
`UniqueConditionalFormat`<br />
`FormatConditionTextOperator`<br />
