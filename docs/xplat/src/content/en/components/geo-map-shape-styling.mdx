...
The four styling classes each section uses — **ShapeRandomStyling**, **ShapeScaleStyling**, **ShapeRangeStyling** and **ShapeComparisonStyling** — come from the [Shape Styling Utility](./geo-map-resources-shape-styling-utility.mdx), which publishes the file to copy into your own project.
