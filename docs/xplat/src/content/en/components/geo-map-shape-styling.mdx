...
This topic explains how to apply custom styling to the <ApiLink pkg="maps" type="GeographicShapeSeries" /> in the {Platform} <ApiLink pkg="maps" type="GeographicMap" />.
...
<ApiRef pkg="maps" types={["GeographicShapeSeries","GeographicMap"]} />
