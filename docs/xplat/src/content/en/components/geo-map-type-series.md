...
description: Use Infragistics {Platform} map's series to display geo-spatial data as points such as locations of cities, polylines such as road connections, or polygons such as shape of countries in a geographic context. Learn more about {ProductName} map's series!
keywords: "{Platform} map, geographic series, {ProductName}, Infragistics"
license: commercial
