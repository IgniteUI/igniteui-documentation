...
mentionedTypes: []
llms:
  description: "In this quick how-to article, we will explain how to use the marker display customization function with Ignite UI for Blazor to display a scatter plot with markers of different sizes and fill colors depending on the properties of the bound items."
---

import PlatformBlock from 'igniteui-astro-components/components/mdx/PlatformBlock.astro';
import { Image } from 'astro:assets';
import blazorWasmApp from '@xplat-images/general/blazor-wasm-app.png';
import blazorWasmApp2 from '@xplat-images/general/blazor-wasm-app-2.png';
...
<Image src={blazorWasmApp} alt="blazor-wasm-app" />
...
<Image src={blazorWasmApp2} alt="blazor-wasm-app-2" />
