...
keywords: "{ProductName}, agent skills, ai assisted development, github copilot, cursor, windsurf, claude, gemini cli, junie"
license: MIT
mentionedTypes: []
last_updated: "2026-04-24"
llms:
  description: "{ProductName} ships with Agent Skills - structured knowledge files that teach AI coding assistants (GitHub Copilot, Cursor, Windsurf, Claude, Gemini CLI, JetBrains Junie, etc.) how to work with {ProductName}."
---
