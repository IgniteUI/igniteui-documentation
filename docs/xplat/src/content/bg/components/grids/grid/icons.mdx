...
llms:
  description: "Explains how to replace the default {ProductName} Grid icons with custom icons from another icon collection."
---
...
The {ProductName} <ApiLink type="Grid" /> icons can be customized to use custom icons from a different collection set using the exposed API methods:
