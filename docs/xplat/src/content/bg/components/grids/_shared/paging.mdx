...
<DocsAside type="info">
The <ApiLink pkg="core" type="Color" /> and `Palette` are powerful functions for generating and retrieving colors. Please refer to [Palettes](../themes/sass/palettes.md) topic for detailed guidance on how to use them.
</DocsAside>
