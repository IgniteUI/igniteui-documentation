...
To enable the [Advanced filtering](advanced-filtering.md) however, you need to set the <ApiLink type="{ComponentName}" member="allowAdvancedFiltering" /> input property to **true**
</ComponentBlock>
...
The <ApiLink type="{ComponentName}" /> supports remote filtering, which is demonstrated in the [{ComponentTitle} Remote Data Operations](remote-data-operations.md) topic.
</ComponentBlock>
</PlatformBlock>
