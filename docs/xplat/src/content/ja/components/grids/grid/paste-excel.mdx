...
llms:
  description: "The {ProductName} Grid can read Excel data that is copied to the clipboard."
---
...
The {ProductName} <ApiLink type="Grid" /> can read Excel data that is copied to the clipboard. In this section we will show you how to do this with some custom code.

## {Platform} Paste from Excel Example

This sample demonstrates how to implement pasting from Excel into the <ApiLink type="Grid" /> Material UI table.
