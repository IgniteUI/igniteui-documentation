...
llms:
  description: "The Ignite UI for {Platform} Tree Grid can be rendered in such way that it requires the minimal amount of data to get from the server so the user could see it as quickly as possible."
---
...
If you want to provide your own custom loading indicator, you can use the <ApiLink type="TreeGrid" member="rowLoadingIndicatorTemplate" label="RowLoadingIndicatorTemplate" /> option to set a custom template.The following code snippet demonstrates how set to it:
