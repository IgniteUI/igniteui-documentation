...
<ApiLink type="AverageConditionalFormat" pkg="spreadsheet" />
<ApiLink type="BlanksConditionalFormat" pkg="spreadsheet" />
<ApiLink type="ColorScaleConditionalFormat" pkg="spreadsheet" />
<ApiLink type="DataBarConditionalFormat" pkg="spreadsheet" />
<ApiLink type="DateTimeConditionalFormat" pkg="spreadsheet" />
<ApiLink type="DuplicateConditionalFormat" pkg="spreadsheet" />
<ApiLink type="ErrorsConditionalFormat" pkg="spreadsheet" />
<ApiLink type="FormulaConditionalFormat" pkg="spreadsheet" />
<ApiLink type="IconSetConditionalFormat" pkg="spreadsheet" />
<ApiLink type="NoBlanksConditionalFormat" pkg="spreadsheet" />
<ApiLink type="NoErrorsConditionalFormat" pkg="spreadsheet" />
<ApiLink type="OperatorConditionalFormat" pkg="spreadsheet" />
<ApiLink type="RankConditionalFormat" pkg="spreadsheet" />
<ApiLink type="TextOperatorConditionalFormat" pkg="spreadsheet" />
<ApiLink type="UniqueConditionalFormat" pkg="spreadsheet" />
<ApiLink type="FormatConditionTextOperator" pkg="spreadsheet" />
