...
mentionedTypes: []
llms:
  description: "{ProductName} は、MIT または商用ライセンスで利用可能なパッケージで構成されています。"
---
...
import generateToken from '@xplat-images/general/generate-token.jpg';
import azureCiNewVariable2 from '@xplat-images/general/azure-ci-new-variable-2.jpg';
import azureCiAddTokenVariable1 from '@xplat-images/general/azure-ci-add-token-variable-1.jpg';
...
どのライセンスがパッケージのどの部分に適用されるかを理解することが重要です。どのコンポーネントにどのライセンスが適用されるかは、[オープン ソースとプレミアム](./general-open-source-vs-premium.mdx) トピックに詳しく記載されています。
...
Infragistics {ProductName} は npm パッケージで提供され、[いくつかの簡単な手順](./general-getting-started.mdx)でプロジェクトの依存関係として追加できます。この方法を選択する場合、npm を構成する必要はありません。商用ライセンスのパッケージをインストールする場合、製品の **{ProductName} のトライアル版バージョン** の使用を開始します。
...
<Image src={generateToken} alt="New Token Generated" class="responsive-img" style="margin-bottom:10px; -webkit-box-shadow: 4px 4px 4px 4px #ccc; -moz-box-shadow: 4px 4px 4px 4px #ccc; box-shadow: 4px 4px 4px 4px #ccc; max-width: 600px" />
...
<Image src={azureCiNewVariable2} alt="Set npm Registry and token variables" class="responsive-img" style="margin-bottom:10px; -webkit-box-shadow: 4px 4px 4px 4px #ccc; -moz-box-shadow: 4px 4px 4px 4px #ccc; box-shadow: 4px 4px 4px 4px #ccc; max-width: 600px" />

<Image src={azureCiAddTokenVariable1} alt="npm Registry and token variables" class="responsive-img" style="margin-bottom:10px; -webkit-box-shadow: 4px 4px 4px 4px #ccc; -moz-box-shadow: 4px 4px 4px 4px #ccc; box-shadow: 4px 4px 4px 4px #ccc; max-width: 380px" />
