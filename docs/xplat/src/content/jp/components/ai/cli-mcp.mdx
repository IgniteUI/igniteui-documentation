...
セットアップ後の完全なビルド フローを確認したい場合は、[Ignite UI CLI MCP と Ignite UI Theming MCP を使用したアプリのエンドツーエンドのビルド](../general-how-to-mcp-e2e.mdx)を参照してください。
</PlatformBlock>
...
<PlatformBlock for="React, WebComponents">
プロジェクト テンプレート、CLI コマンド オプション、`ig add` などのコンポーネント スキャフォールディング コマンドの詳細については、[Ignite UI CLI](../general-cli-overview.mdx) を参照してください。
</PlatformBlock>
...
<PlatformBlock for="React, WebComponents">
主要なハンズオン ワークフローについては、[Ignite UI CLI MCP と Ignite UI Theming MCP を使用したアプリのエンドツーエンドのビルド](../general-how-to-mcp-e2e.mdx)を参照してください。
</PlatformBlock>
...
<PlatformBlock for="React, WebComponents">
- [Ignite UI CLI MCP と Ignite UI Theming MCP を使用したアプリのエンドツーエンドのビルド](../general-how-to-mcp-e2e.mdx)
</PlatformBlock>
- [Ignite UI を使った AI 支援開発](./ai-assisted-development-overview.mdx)
- [{ProductName} スキル](./skills.mdx)
