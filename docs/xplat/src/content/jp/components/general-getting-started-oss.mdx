...
mentionedTypes: []
llms:
  description: "このトピックでは、Visual Studio を使用して Ignite UI for Blazor オープン ソース ライブラリで Blazor アプリケーションを作成するための段階的な手順を説明します。"
---
...
軽量パッケージに含まれるコンポーネントの詳細については、[オープン ソースとプレミアム コンポーネント](./general-open-source-vs-premium.mdx) トピックを参照してください。


Grid Lite の機能と構成の詳細については、[Grid Lite の概要](./grid-lite/overview.mdx)トピックを参照してください。

## その他のリソース

- [オープン ソースとプレミアム コンポーネント](./general-open-source-vs-premium.mdx)
