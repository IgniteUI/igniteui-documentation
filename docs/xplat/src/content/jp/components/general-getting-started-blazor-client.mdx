...
mentionedTypes: []
llms:
  description: "このトピックでは、Visual Studio および Ignite UI for Blazor を使用して Blazor WebAssembly アプリケーションを作成するための手順を説明します。"
---
...
[.NET 6 以降のアプリケーション](./general-getting-started-blazor-client.mdx#net-6-and-later-applications) セクションの手順 2 に進みます。
