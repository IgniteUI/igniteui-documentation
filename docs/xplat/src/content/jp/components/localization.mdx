...
_language: ja
llms:
  description: "{ProductName} のローカライゼーション (i18n) 機能を使用して、グリッドやその他のコンポーネントのリソース文字列を翻訳・カスタマイズする方法を説明します。"
...
{ProductName} が必要な言語のリソース文字列を提供していない場合、カスタム リソース文字列を常に提供できます。
