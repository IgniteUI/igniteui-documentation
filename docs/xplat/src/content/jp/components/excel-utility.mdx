...
_language: ja
llms:
  description: "Excel ライブラリには、Microsoft Excel ファイルの読み込みや保存が可能なユーティリティ関数があります。"
...
[Excel ライブラリ](./excel-library.mdx)には、Microsoft Excel ファイルの読み込みや保存が可能なユーティリティ関数があります。
...
<ApiLink type="WorkbookFormat" /><br />
<ApiLink type="WorkbookSaveOptions" /><br />
