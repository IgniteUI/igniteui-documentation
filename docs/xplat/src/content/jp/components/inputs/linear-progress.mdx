...
<ApiLink type="LinearProgress" member="labelFormat" label="LabelFormat" /> プロパティを使用して、<ApiLink type="LinearProgress" /> のデフォルト ラベルをカスタマイズできます。
...
<ApiLink type="LinearProgress" /><br />
