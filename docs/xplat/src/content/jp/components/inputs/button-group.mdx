...
<ApiLink type="ToggleButton" /> は、<ApiLink type="ToggleButton" member="selected" label="Selected" /> 属性または <ApiLink type="ButtonGroup" /> の <ApiLink type="PieChartBase" member="selectedItems" label="SelectedItems" /> 属性を通じて選択済みとしてマークできます。
...
<ApiLink type="ButtonGroup" /> の <ApiLink type="PieChartBase" member="selectedItems" label="SelectedItems" /> プロパティを使用するには、<ApiLink type="ToggleButton" /> <ApiLink type="ToggleButton" member="value" label="Value" /> 属性の設定が必須です。
</DocsAside>
...
<ApiLink type="ButtonGroup" /><br />
<ApiLink type="ToggleButton" /><br />
