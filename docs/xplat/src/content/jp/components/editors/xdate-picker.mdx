...
<Sample src="/editors/x-date-picker/overview" height={350} alt="{Platform} XDate Picker の例" />
...
<Sample src="/editors/x-date-picker/editing" height={300} alt="{Platform} XDate Picker 編集の例" />
...
<Sample src="/editors/x-date-picker/date-limits" height={360} alt="{Platform} XDate Picker Date 制限の例" />
...
<Sample src="/editors/x-date-picker/format" height={350} alt="{Platform} XDate Picker 書式の例" />
...
<Sample src="/editors/x-date-picker/range" height={300} alt="{Platform} XDate Picker 日付範囲の例" />
