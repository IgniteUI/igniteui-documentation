...
| 名前              | 説明                                                                                                                                                          |
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `messages`        | チャットに表示されるメッセージの配列 (<ApiLink type="ChatMessage" kind="interface" prefixed={true} suffix={false} />[])。表示するメッセージを制御するためにバインド可能。                                                  |
...
| コンテキスト タイプ                    | 提供データ                                                                                                   |
|-------------------------------|-----------------------------------------------------------------------------------------------------------|
| <ApiLink type="ChatRenderContext" prefixed={false} kind="interface" suffix={false} />           | `instance` (チャット コンポーネント インスタンス).                                                                         |
| <ApiLink type="ChatInputRenderContext" prefixed={false} kind="interface" suffix={false} />      | <ApiLink type="ChatRenderContext" prefixed={false} kind="interface" suffix={false} /> を継承し、`attachments` (<ApiLink type="ChatMessageAttachment" prefixed={true} kind="interface" suffix={false} /> の配列) と `value` (現在の入力テキスト) を追加。 |
| <ApiLink type="ChatMessageRenderContext" prefixed={false} kind="interface" suffix={false} />    | <ApiLink type="ChatRenderContext" prefixed={false} kind="interface" suffix={false} /> を継承し、`ChatMessage` (レンダリングされる <ApiLink type="ChatMessage" prefixed={true} kind="interface" suffix={false} />) を追加。                                 |
| <ApiLink type="ChatAttachmentRenderContext" prefixed={false} kind="interface" suffix={false} /> | <ApiLink type="ChatMessageRenderContext" prefixed={false} kind="interface" suffix={false} /> を継承し、`attachment` (レンダリングされる <ApiLink type="ChatMessageAttachment" prefixed={true} kind="interface" suffix={false} />) を追加。                 |
