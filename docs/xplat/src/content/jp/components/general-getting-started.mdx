...
ウィザードのウォークスルーと認証アドオン フローについては、[Ignite UI CLI を使用したステップ バイ ステップ ガイド](general-step-by-step-guide-using-cli.md)を参照してください。コマンド、テンプレート ID、直接認証テンプレートの全リファレンスについては、[CLI の概要](general-cli-overview.md)を参照してください。
