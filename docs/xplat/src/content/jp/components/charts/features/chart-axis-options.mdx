...
チャートでは数値軸または時間軸の範囲の最小値と最大値を定義できます。範囲の最小値は軸の最小値で、範囲の最大値は軸の最大値です。これらは、`CategoryChart.yAxisMinimumValue` および `CategoryChart.yAxisMaximumValue` オプションを設定することによって設定されます。
...
| ------------------------------------------------------ | ---------------------- | ---------------------- |
| `Axes` -> `NumericYAxis` -> `maximumValue`             | `FinancialChart.yAxisMaximumValue`    | `CategoryChart.yAxisMaximumValue`    |
| `Axes` -> `NumericYAxis` -> `minimumValue`             | `FinancialChart.yAxisMinimumValue`    | `CategoryChart.yAxisMinimumValue`    |
| `Axes` -> `NumericYAxis` -> `isLogarithmic`            | `FinancialChart.yAxisIsLogarithmic`   | `CategoryChart.yAxisIsLogarithmic`   |
| `Axes` -> `NumericYAxis` -> `logarithmBase`            | `FinancialChart.yAxisLogarithmBase`   | `CategoryChart.yAxisLogarithmBase`   |
| `Axes` -> `CategoryXAxis` -> `CategoryXAxis.gap`                     | なし                   | `CategoryChart.xAxisGap`             |
| `Axes` -> `CategoryXAxis` -> `CategoryXAxis.overlap`                 | なし                   | `CategoryChart.xAxisOverlap`         |
| `Axes` -> `TimeXAxis`                                  | `FinancialChart.xAxisMode`            | なし                   |
| `Axes` -> `PercentChangeYAxis`                         | `FinancialChart.yAxisMode`            | なし                   |
| `Axes` -> `NumericYAxis` -> `labelSettings.angle`      | `FinancialChart.yAxisLabelAngle`      | `CategoryChart.yAxisLabelAngle`      |
| `Axes` -> `NumericXAxis` -> `labelSettings.angle`      | `FinancialChart.xAxisLabelAngle`      | `CategoryChart.xAxisLabelAngle`      |
| `Axes` -> `NumericYAxis` -> `labelSettings.textColor`  | `FinancialChart.YAxisLabelForeground` | `CategoryChart.YAxisLabelForeground` |
| `Axes` -> `NumericXAxis` -> `labelSettings.textColor`  | `FinancialChart.XAxisLabelForeground` | `CategoryChart.XAxisLabelForeground` |
| `Axes` -> `NumericYAxis` -> `labelSettings.visibility` | `FinancialChart.yAxisLabelVisibility` | `CategoryChart.yAxisLabelVisibility` |
| `Axes` -> `NumericXAxis` -> `labelSettings.visibility` | `FinancialChart.xAxisLabelVisibility` | `CategoryChart.xAxisLabelVisibility` |
