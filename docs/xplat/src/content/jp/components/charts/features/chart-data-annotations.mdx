...
- `startLabelYMemberPath`: このプロパティは、y 軸上の <ApiLink type="DataAnnotationBandLayer" />、<ApiLink type="DataAnnotationLineLayer" />、<ApiLink type="DataAnnotationRectLayer" /> の開始位置の軸ラベルを表すデータ列へのマッピングです。
- `endLabelYMemberPath`: このプロパティは、y 軸上の <ApiLink type="DataAnnotationBandLayer" />、<ApiLink type="DataAnnotationLineLayer" />、<ApiLink type="DataAnnotationRectLayer" /> の終了位置の軸ラベルを表すデータ列へのマッピングです。
