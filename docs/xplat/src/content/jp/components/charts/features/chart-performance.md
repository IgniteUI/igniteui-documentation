...
- [カテゴリ ポイント チャート](../types/point-chart.md) や[散布マーカー チャート](../types/scatter-chart.md#{PlatformLower}-散布マーカー-チャート) の代わりに[散布高密度チャート](../types/scatter-chart.md#{PlatformLower}-散布高密度チャート)
...
| チャート グループ     | チャート タイプ |
| ----------------|--------------------------------- |
| 円チャート       | - [円チャート](../types/pie-chart.md) <br> - [ドーナツ チャート](../types/donut-chart.md) <br> - [ラジアル円チャート](../types/radial-chart.md#{PlatformLower}-ラジアル円チャート) <br> |
| 折れ線チャート      | - [カテゴリ折れ線チャート](../types/line-chart.md#{PlatformLower}-カテゴリ折れ線チャート) <br> - [カテゴリ スプライン チャート](../types/spline-chart.md#{PlatformLower}-カテゴリ-スプライン-チャート) <br> - [ステップ折れ線チャート](../types/step-chart.md#{PlatformLower}-ステップ折れ線チャート) <br> - [ラジアル折れ線チャート](../types/radial-chart.md#{PlatformLower}-ラジアル折れ線チャート) <br> - [極座標折れ線チャート](../types/polar-chart.md#{PlatformLower}-極座標型折れ線チャート) <br> - [散布折れ線チャート](../types/scatter-chart.md#{PlatformLower}-散布折れ線チャート) <br> - [散布ポリライン チャート](../types/shape-chart.md#{PlatformLower}-散布ポリライン-チャート) (\*)  <br> - [散布等高線チャート](../types/scatter-chart.md#{PlatformLower}-散布等高線チャート) <br> - [積層型折れ線チャート](../types/stacked-chart.md#{PlatformLower}-積層型折れ線チャート) <br> - [積層型 100% 折れ線チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-折れ線チャート) <br> |
| エリア チャート      | - [カテゴリ エリア チャート](../types/area-chart.md#{PlatformLower}-エリア-チャートの例) <br> - [ステップ エリア チャート](../types/step-chart.md#{PlatformLower}-ステップ-エリア-チャート) <br> - [範囲エリア チャート](../types/area-chart.md#{PlatformLower}-範囲エリア-チャート) <br> - [ラジアル エリア チャート](../types/radial-chart.md#{PlatformLower}-ラジアル-エリア-チャート) <br> - [極座標エリア チャート](../types/polar-chart.md#{PlatformLower}-極座標エリア-チャート) <br> - [散布ポリゴン チャート](../types/shape-chart.md#{PlatformLower}-散布ポリゴン-チャート) (\*) <br> - [散布エリア チャート](../types/scatter-chart.md#{PlatformLower}-散布エリア-チャート) <br> - [積層型エリア チャート](../types/stacked-chart.md#{PlatformLower}-積層型エリア-チャート) <br> - [積層型 100% エリア チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-エリア-チャート) <br> |
| 縦棒チャート    | - [縦棒チャート](../types/column-chart.md#{PlatformLower}-縦棒チャートの例) <br> - [棒チャート](../types/bar-chart.md#{PlatformLower}-棒チャートの例) <br> - [ウォーターフォール チャート](../types/column-chart.md#{PlatformLower}-ウォーターフォール-チャート) <br> - [範囲縦棒チャート](../types/column-chart.md#{PlatformLower}-範囲縦棒チャート) <br> - [ラジアル縦棒チャート](../types/radial-chart.md#{PlatformLower}-ラジアル縦棒チャート) <br> - [積層型縦棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型縦棒チャート) <br> - [積層型棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型棒チャート) <br> - [積層型 100% 縦棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-縦棒チャート) <br> - [積層型 100% 棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-棒チャート) |
| スプライン チャート    | - [カテゴリ スプライン チャート](../types/spline-chart.md#{PlatformLower}-スプライン-チャートの例) <br> - [極座標スプライン チャート](../types/polar-chart.md#{PlatformLower}-極座標スプラインーチャート) <br> - [散布スプライン チャート](../types/scatter-chart.md#{PlatformLower}-散布スプライン-チャート) <br> - [積層型スプライン チャート](../types/stacked-chart.md#{PlatformLower}-積層型スプライン-チャート) <br> - [積層型 100% スプライン チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-スプライン-チャート) <br> |
| ポイント チャート     | - [カテゴリ ポイント チャート](../types/point-chart.md) <br> - [散布高密度チャート](../types/scatter-chart.md#{PlatformLower}-散布高密度チャート)  <br> - [散布マーカー チャート](../types/scatter-chart.md#{PlatformLower}-散布マーカー-チャート) <br> - [散布バブル チャート](../types/bubble-chart.md) <br> - [極座標型マーカーチャート](../types/polar-chart.md#{PlatformLower}-極座標型マーカー-チャート) <br> |
...
| 散布図   | - [散布高密度チャート](../types/scatter-chart.md#{PlatformLower}-散布高密度チャート) <br> - [散布マーカー チャート](../types/scatter-chart.md#{PlatformLower}-散布マーカー-チャート) <br> - [散布折れ線チャート](../types/scatter-chart.md#{PlatformLower}-散布折れ線チャート) <br> - [散布バブル チャート](../types/bubble-chart.md) <br> - [散布スプライン チャート](../types/scatter-chart.md#{PlatformLower}-散布スプライン-チャート) <br> - [散布エリア チャート](../types/scatter-chart.md#{PlatformLower}-散布エリア-チャート) <br> - [散布等高線チャート](../types/scatter-chart.md#{PlatformLower}-散布等高線チャート) <br> - [散布ポリライン チャート](../types/shape-chart.md#{PlatformLower}-散布ポリライン-チャート) (\*) <br> - [散布ポリゴン チャート](../types/shape-chart.md#{PlatformLower}-散布ポリゴン-チャート) (\*) <br> |
| ラジアル チャート    | - [ラジアル折れ線チャート](../types/radial-chart.md#{PlatformLower}-ラジアル折れ線チャート) <br> - [ラジアル エリア チャート](../types/radial-chart.md#{PlatformLower}-ラジアル-エリア-チャート) <br> - [ラジアル円チャート](../types/radial-chart.md#{PlatformLower}-ラジアル円チャート) <br> - [ラジアル縦棒チャート](../types/radial-chart.md#{PlatformLower}-ラジアル縦棒チャート) <br> |
| 極座標チャート     | - [極座標型マーカー チャート](../types/polar-chart.md#{PlatformLower}-極座標型マーカー-チャート) <br> - [極座標型折れ線チャート](../types/polar-chart.md#{PlatformLower}-極座標型折れ線チャート) <br> - [極座標エリア チャート](../types/polar-chart.md#{PlatformLower}-極座標エリア-チャート) <br> - [極座標スプライン チャート](../types/polar-chart.md#{PlatformLower}-極座標スプライン-チャート) <br> - [極座標スプライン エリア チャート](../types/polar-chart.md#{PlatformLower}-極座標スプライン-エリア-チャート) <br> |
| 積層型チャート   | - [積層型折れ線チャート](../types/stacked-chart.md#{PlatformLower}-積層型折れ線チャート) <br> - [積層型エリア チャート](../types/stacked-chart.md#{PlatformLower}-積層型エリア-チャート) <br> - [積層型縦棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型縦棒チャート) <br> - [積層型棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型棒チャート) <br> - [積層型スプライン チャート](../types/stacked-chart.md#{PlatformLower}-積層型スプライン-チャート) <br> - [積層型 100% 折れ線チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-折れ線チャート) <br> - [積層型 100% エリア チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-エリア-チャート) <br> - [積層型 100% 縦棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-縦棒チャート) <br> - [積層型 100% 棒チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-棒チャート) <br> - [積層型 100% スプライン チャート](../types/stacked-chart.md#{PlatformLower}-積層型-100-スプライン-チャート) <br> |
