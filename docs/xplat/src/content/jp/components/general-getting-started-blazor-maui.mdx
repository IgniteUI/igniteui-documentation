...
mentionedTypes: []
llms:
  description: "Visual Studio 2022 と .NET MAUI を使用して Ignite UI for Blazor の Blazor Hybrid アプリを作成する手順を説明します。"
---
...
import newBlazorProjectMaui from '@xplat-images/general/new-blazor-project-maui.jpg';
import newBlazorProjectConfigureMaui from '@xplat-images/general/new-blazor-project-configure-maui.jpg';
import gettingStartedBlazorCardWindows from '@xplat-images/general/getting-started-blazor-card-windows.jpg';
...
<Image src={newBlazorProjectMaui} alt="new-blazor-project-maui" />

プロジェクト名と場所を入力し、**[作成]** をクリックします。

<Image src={newBlazorProjectConfigureMaui} alt="new-blazor-project-configure-maui" />
