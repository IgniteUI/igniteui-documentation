...
description: "{ProductName} ツリー グリッドは、階層データまたはフラット データを簡単に表示および操作するために使用されます。わずかなコーディングでデータをすばやくバインドできます。無料でお試しください。"
...
上記のコードの結果は、この記事の冒頭の[ツリー グリッドの例](./overview.md#例)セクションで確認できます。
