...
<ApiLink type="Transactions" pkg="grids" prefixed={false} exclude="Blazor,React,WebComponents" />
<ApiLink type="HierarchicalTransactionService" pkg="grids" prefixed={false} exclude="Blazor,React,WebComponents" />
<ApiLink type="HierarchicalTransactionServiceFactory" pkg="grids" prefixed={false} exclude="Blazor,React,WebComponents" />
