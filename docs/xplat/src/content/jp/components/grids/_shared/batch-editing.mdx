...
<ApiLink pkg="grids" type="HierarchicalTransactionService" /> と <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> を使用した場合も各アイランドに個別のトランザクション ログを累積させるには、代わりにサービス ファクトリが必要です。エクスポートされると `HierarchicalTransactionServiceFactory` として利用できます。
...
これにより、`Transaction` サービスの適切なインスタンスが <ApiLink pkg="grids" type="{ComponentName}" prefixed={false} /> に提供されます。適切な <ApiLink pkg="grids" type="TransactionService" /> は `TransactionFactory` を通じて提供されます。
...
<ComponentBlock for="Grid">
以下のコード例は、<ApiLink pkg="grids" type="TransactionService" /> API (undo、redo、commit) の使用方法を示します。
...
<ComponentBlock for="TreeGrid">
以下のコード例は、<ApiLink pkg="grids" type="HierarchicalTransactionService" /> API (undo、redo、commit) の使用方法を示します。
...
<ApiLink type="{ComponentName}" pkg="grids"","Transactions","HierarchicalTransactionService","HierarchicalTransactionServiceFactory"]} prefixed={false} />
<ApiLink type="Transactions" pkg="grids"","Transactions","HierarchicalTransactionService","HierarchicalTransactionServiceFactory"]} prefixed={false} />
<ApiLink type="HierarchicalTransactionService" pkg="grids"","Transactions","HierarchicalTransactionService","HierarchicalTransactionServiceFactory"]} prefixed={false} />
<ApiLink type="HierarchicalTransactionServiceFactory" pkg="grids"","Transactions","HierarchicalTransactionService","HierarchicalTransactionServiceFactory"]} prefixed={false} />
