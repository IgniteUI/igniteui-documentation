...
- <kbd>SPACE</kbd> - グループ行上 - <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="rowSelection" label="RowSelection" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridBaseDirective" member="rowSelection" label="RowSelection" /></PlatformBlock> プロパティが複数に設定されている場合、グループ内のすべての行を選択します。
...
<ComponentBlock for="HierarchicalGrid">
<DocsAside type="info" title="情報">
<PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="getNextCell" label="GetNextCell" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridBaseDirective" member="getNextCell" label="GetNextCell" /></PlatformBlock> および <PlatformBlock for="Angular,React,WebComponents"><ApiLink pkg="grids" kind="interface" type="GridBaseDirective" member="getPreviousCell" label="GetPreviousCell" /></PlatformBlock><PlatformBlock for="Blazor"><ApiLink pkg="grids" kind="class" type="GridBaseDirective" member="getPreviousCell" label="GetPreviousCell" /></PlatformBlock> は現在のレベルで使用し、上位または下位レベルのセルにアクセスできません。
</DocsAside>
</ComponentBlock>
