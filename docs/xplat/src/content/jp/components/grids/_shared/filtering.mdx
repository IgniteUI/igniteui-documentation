...
- `BooleanFilteringOperand` は、_boolean_ 型のすべてのデフォルト フィルタリング条件を定義します。
- `NumberFilteringOperand` は、_numeric_ 型のすべてのデフォルト フィルタリング条件を定義します。
- `StringFilteringOperand` は、_string_ 型のすべてのデフォルト フィルタリング条件を定義します。
- `DateFilteringOperand` は、_date_ 型のすべてのデフォルト フィルタリング条件を定義します。
