...
<PlatformBlock for="Angular">
<DocsAside type="info" title="情報">
事前定義された操作は <ApiLink pkg="grids" type="GridActionsBaseDirective" /> を継承します。カスタム グリッド アクション コンポーネントを作成する場合、<ApiLink pkg="grids" type="GridActionsBaseDirective" /> も継承する必要があります。
</DocsAside>
