...
<ApiLink type="SummaryOperand" pkg="grids" suffix={false} />
<ApiLink type="NumberSummaryOperand" pkg="grids" suffix={false} />
<ApiLink type="DateSummaryOperand" pkg="grids" suffix={false} />
