...
<ComponentBlock for="Grid, HierarchicalGrid">
> **注**:
> [行の追加] のボタンの表示状態を制御する <ApiLink pkg="grids" type="GridEditingActions" /> 入力は、アクション ストリップ コンテキスト (タイプ <PlatformBlock for="Angular">
...
</PlatformBlock> を使用して、ボタンが表示するレコードを調整できます。
