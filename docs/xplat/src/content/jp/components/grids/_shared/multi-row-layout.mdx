...
<ApiLink type="{ComponentName}" pkg="grids" prefixed={false} /> を使用すると、[{ProductName} テーマ ライブラリ](../themes/styles.md)でスタイルを設定できます。<ApiLink type="Theme" /> は、グリッドのすべての機能をカスタマイズできるさまざまなプロパティを公開します。
