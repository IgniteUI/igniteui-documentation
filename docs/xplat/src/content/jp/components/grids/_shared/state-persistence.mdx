...
<ApiLink type="GridState" pkg="grids" />
<ApiLink type="PivotConfiguration" pkg="grids" kind="interface" />
<ApiLink type="PivotDimension" pkg="grids" kind="interface" />
<ApiLink type="PivotValue" pkg="grids" kind="interface" />
