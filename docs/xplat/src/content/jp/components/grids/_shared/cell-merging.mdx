...
<ApiLink type="{ComponentName}" member="cellMergeMode" label="CellMergeMode" /><br />
<ApiLink type="GridCellMergeMode" /><br />
<ApiLink type="GridMergeStrategy" /><br />
<ApiLink type="DefaultMergeStrategy" /><br />
