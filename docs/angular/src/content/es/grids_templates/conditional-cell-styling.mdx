...
license: commercial
llms:
  description: "If you need to provide any custom styling in the {ComponentName} component, you can do it on either row or cell level."
---
...
- <ApiLink kind="sass" module="themes" type="mixin-grid" label="{ComponentName}Component Styles" />
