...
llms:
  description: "Ignite UI for Angular allows you to change the shape of components by setting their roundness to a value between 0 and 1."
---
...
Please refer to the <ApiLink kind="sass" module="schemas" label="Schema" /> documentation for each component to find out what the default and min/max radius values are for each theme.
