...
license: commercial
llms:
  description: "Copy to clipboard operations are now available in the {ComponentTitle}."
---
...
- <ApiLink type="Grid" member="gridCopy" label="gridCopy" /> Emitted when a copy operation is executed. Fired only if copy behavior is enabled through the <ApiLink type="Grid" member="clipboardOptions" label="clipboardOptions" />
