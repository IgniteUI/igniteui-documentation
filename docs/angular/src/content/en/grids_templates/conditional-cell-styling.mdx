...
- By setting [`rowClasses`]({environment:angularApiUrl}/classes/igxgridcomponent.html#rowClasses) input on the {ComponentName} component;
- By setting [`rowStyles`]({environment:angularApiUrl}/classes/igxgridcomponent.html#rowStyles) input on the {ComponentName} component;
</ComponentBlock>
<ComponentBlock for="TreeGrid">

- By setting [`rowClasses`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#rowClasses) input on the {ComponentName} component;
- By setting [`rowStyles`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#rowStyles) input on the {ComponentName} component;
</ComponentBlock>
<ComponentBlock for="HierarchicalGrid">

- By setting [`rowClasses`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#rowClasses) input on the {ComponentName} component;
- By setting [`rowStyles`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#rowStyles) input on the {ComponentName} component;
</ComponentBlock>
...
You can conditionally style the {ComponentName} rows by setting the [`rowClasses`]({environment:angularApiUrl}/classes/igxgridcomponent.html#rowClasses) input and define custom rules.
</ComponentBlock>
<ComponentBlock for="TreeGrid">

You can conditionally style the {ComponentName} rows by setting the [`rowClasses`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#rowClasses) input and define custom rules.
</ComponentBlock>
<ComponentBlock for="HierarchicalGrid">

You can conditionally style the {ComponentName} rows by setting the [`rowClasses`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#rowClasses) input and define custom rules.
</ComponentBlock>
...
You can conditionally style the {ComponentName} cells by setting the [`IgxColumnComponent`]({environment:angularApiUrl}/classes/igxcolumncomponent.html) [`cellClasses`]({environment:angularApiUrl}/classes/igxcolumncomponent.html#cellClasses) input and define custom rules.
