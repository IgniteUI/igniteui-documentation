...
_description: Take advantage of the capability to show\hide smaller and concise set of data with the use of collapsible column groups in our Angular {ComponentTitle}. Try it now!
_keywords: collapsible column headers, ignite ui for angular, infragistics
_license: commercial
