...
You may also use the {ComponentTitle}'s [`pinColumn`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html#pinColumn) or [`unpinColumn`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html#unpinColumn) methods of the [`{ComponentName}Component`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html) to pin or unpin columns by their field name:
...
A column is pinned to the right of the rightmost pinned column. Changing the order of the pinned columns can be done by subscribing to the [`columnPin`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html#columnPin) event and changing the [`insertAtIndex`]({environment:angularApiUrl}/interfaces/ipincolumneventargs.html#insertAtIndex) property of the event arguments to the desired position index.
...
You can change the column pinning position via the [`pinning`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html#pinning) configuration option. It allows you to set the columns position to either Start or End.
