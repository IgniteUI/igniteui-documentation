...
_description: Perform data manipulation without affecting the underlying data with {ComponentTitle} Batch Editing and Angular CRUD, using Angular Data Grid. See demos & examples!
