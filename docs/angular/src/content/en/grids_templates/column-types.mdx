...
The {ComponentTitle} accepts date values of type _Date object_, _Number (milliseconds)_, _An ISO date-time string_. This section shows [how to configure a custom display format](./grid.mdx#custom-display-format).
...
Upon editing of cell's value the _currency symbol_ will be visible as suffix or prefix. More about that could be found in the official [Cell editing topic](./cell-editing.mdx#cell-editing-templates).
...
- [{ComponentTitle} overview topic](./{ComponentMainTopic}.mdx)
- [Editing topic](./editing.mdx)
- [Summaries topic](./summaries.mdx)
