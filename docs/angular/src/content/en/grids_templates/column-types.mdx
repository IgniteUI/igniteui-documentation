...
_license: commercial
llms:
  description: "Ignite UI for Angular {ComponentTitle} provides a default handling of number, string, date, boolean, currency and percent column data types, based on which the appearance of the default and editing templates will be present."
---
...
- dateTime - <ApiLink type="DateTimeEditorDirective" /> will be used. This editor will give you a mask directions for the input elements part of the DateTime object.
- date - <ApiLink type="DatePicker" /> will be used.
- time - <ApiLink type="TimePicker" /> will be used.
