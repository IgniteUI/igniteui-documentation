...
Upon editing of cell's value the _currency symbol_ will be visible as suffix or prefix. More about that could be found in the official [Cell editing topic](cell-editing#cell-editing-templates).
...
See the editing templates part of [{ComponentTitle} Editing topic](editing#editing-templates)
...
- [{ComponentTitle} overview topic]({ComponentMainTopic})
