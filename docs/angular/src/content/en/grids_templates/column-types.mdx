...
# Angular {ComponentTitle} Column Types

Ignite UI for Angular {ComponentTitle} provides a default handling of _number_, _string_, _date_, _boolean_, _currency_ and _percent_ column data types, based on which the appearance of the default and editing templates will be present.

<ComponentBlock for="Grid">

## Angular Column Types Example

<Sample src="/grid/grid-column-data-types" height={550} alt="" />
</ComponentBlock>
...
Upon editing of cell's value the _currency symbol_ will be visible as suffix or prefix. More about that could be found in the official [Cell editing topic](/{igPath}/cell-editing#cell-editing-templates).
...
See the editing templates part of [{ComponentTitle} Editing topic](/{igPath}/editing#editing-templates)
...
- {ComponentTitle} <ApiLink type="Grid" member="locale" label="locale" />
...
- [Editing topic](/{igPath}/editing)
- [Summaries topic](/{igPath}/summaries)
