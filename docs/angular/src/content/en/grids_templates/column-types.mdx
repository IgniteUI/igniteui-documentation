...
- dateTime - <ApiLink type="DateTimeEditorDirective" suffix={false} /> will be used. This editor will give you a mask directions for the input elements part of the DateTime object.
