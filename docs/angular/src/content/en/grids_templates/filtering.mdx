...
To enable the [Advanced filtering](/{igPath}/advanced-filtering) however, you need to set the [`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/{ComponentTypeDoc}.html#allowAdvancedFiltering) input properties to `true`.
