...
API <ApiLink type="{ComponentApiType}" member="filter" label="filter()" /> method is used to apply _contains_ condition on the _ProductName column_ through external _igxInputGroup component_.
</ComponentBlock>
