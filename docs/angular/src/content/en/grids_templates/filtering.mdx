...
To enable the [Advanced filtering](advanced-filtering) however, you need to set the <ApiLink type="{ComponentApiType}" member="allowAdvancedFiltering" label="allowAdvancedFiltering" /> input properties to `true`.
...
To set the initial filtering state of the {ComponentTitle}, set the <ApiLink type="{ComponentApiType}" /> <ApiLink type="{ComponentApiType}" member="filteringExpressionsTree" label="filteringExpressionsTree" /> property to an array of <ApiLink type="IFilteringExpressionsTree" kind="interface" suffix={false} prefixed={false} /> for each column to be filtered.
...
The {ComponentTitle} supports remote filtering, which is demonstrated in the [`{ComponentTitle} Remote Data Operations`](/{igPath}/remote-data-operations) topic.
...
- <ApiLink type="{ComponentApiType}" member="filteringDone" label="filteringDone" /> event now have only one parameter of type <ApiLink type="IFilteringExpressionsTree" kind="interface" suffix={false} prefixed={false} /> which contains the filtering state of the filtered column.
