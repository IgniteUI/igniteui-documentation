...
In Ignite UI for Angular, the <ApiLink type="{ComponentApiType}" /> control now utilizes the <ApiLink type="ForOfDirective" suffix={false} label="igxForOf" /> directive and virtualizes its content both vertically and horizontally.
