...
<DocsAside type="info">
The {ComponentTitle} uses internally a provider <ApiLink type="BaseTransactionService" suffix={false} /> that holds pending cell changes, until row state submitted or cancelled.
</DocsAside>
