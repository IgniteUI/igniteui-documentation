---
title: Editing and Validation in Angular {ComponentTitle} - Infragistics
description: Validate the input of the users in grid and notify them if it's valid or not while using Angular {ComponentTitle}. See demos & examples!
