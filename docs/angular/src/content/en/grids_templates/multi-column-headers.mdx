...
Every [`igx-column-group`]({environment:angularApiUrl}/classes/igxcolumngroupcomponent.html) supports [`moving`](/{igPath}/column-moving), [`pinning`](/{igPath}/column-pinning) and [`hiding`](/{igPath}/column-hiding).
<Aside type="note">
