...
<Sample src="/notifications/toast-sample-4/" height={200} iframeOnly />
...
Following the simplest approach, we create a new theme that extends the <ApiLink kind="sass" module="themes" type="function-toast-theme" label="toast-theme" code={true} /> and provide the `$background`, `$text-color` and `$border-radius` parameters.
...
You can find the full list of properties in the <ApiLink kind="sass" module="themes" type="function-toast-theme" label="IgxToast Theme" />. The syntax is as follows:
...
<hr/>
- <ApiLink type="Toast" />
- <ApiLink kind="sass" module="themes" type="function-toast-theme" label="IgxToastComponent Styles" />
