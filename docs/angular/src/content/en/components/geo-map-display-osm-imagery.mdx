...
## Code Snippet
This code example explicitly sets <ApiLink pkg="maps" type="GeographicMap" member="BackgroundContent" label="BackgroundContent" /> of the map component to the <ApiLink pkg="maps" type="OpenStreetMapImagery" suffix={false} /> object which provides geographic imagery from  OpenStreetMap© contributors.
