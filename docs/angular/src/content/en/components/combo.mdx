...
<DocsAside type="info">
The combobox uses `igxForOf` directive internally hence all `igxForOf` limitations are valid for the combobox. For more details see [`igxForOf Known Issues`](/for-of#known-limitations) section.
</DocsAside>
