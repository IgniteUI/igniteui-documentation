...
And do not forget to import the <ApiLink type="IgxTextAlign" kind="variable" /> enumerator in your component if you're using the `textAlign` property.
...
- <ApiLink type="IgxTextAlign" kind="variable" />
