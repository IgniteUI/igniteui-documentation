...
And do not forget to import the <ApiLink type="IgxTextAlign" kind="enum" prefixed={false} /> enumerator in your component if you're using the `textAlign` property.
...
- <ApiLink type="IgxTextAlign" kind="enum" prefixed={false} />
