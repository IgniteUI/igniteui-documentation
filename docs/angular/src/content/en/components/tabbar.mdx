...
<Sample src="/layouts/tabbar-sample-1" height={200} alt="Angular Bottom Navigation Example" />
...
Following the simplest approach, we create a new theme that extends the <ApiLink kind="sass" module="themes" type="function-bottom-nav-theme" label="bottom-nav-theme" code={true} /> and accepts various parameters that allow us to style the tab groups.
...
If we take a look at the <ApiLink kind="sass" module="themes" type="function-bottom-nav-theme" label="bottom-nav-theme" code={true} />, we will notice that there are even more parameters available to us in order to style our bottom navigation component!
...
You can find the full list of properties in the <ApiLink kind="sass" module="themes" type="function-bottom-nav-theme" label="IgxBottomNav Theme" />. The syntax is as follows:
...
- <ApiLink kind="sass" module="themes" type="function-bottom-nav-theme" label="IgxBottomNavComponent Styles" />
- <ApiLink type="Icon" />
