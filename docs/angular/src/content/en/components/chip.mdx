...
```html
<igx-chip [draggable]="true" [hideBaseOnDrag]="false" [animateOnRelease]="false">
  Drag Me
</igx-chip>
```
...
```html
<igx-chip variant="primary">Primary</igx-chip>
<igx-chip variant="success">Success</igx-chip>
<igx-chip variant="warning">Warning</igx-chip>
<igx-chip variant="danger">Danger</igx-chip>
<igx-chip variant="info">Info</igx-chip>
```
...
```html
<igx-chip [disabled]="true">Disabled</igx-chip>
```
...
```html
<igx-chip [color]="'#6a4cff'">Custom Color</igx-chip>
```
...
```html
<igx-chip [selectable]="true" [(selected)]="isSelected">Tag</igx-chip>
```
...
```html
<igx-chip [selectable]="true" (selectedChanging)="onSelectionChanging($event)">Locked</igx-chip>
```
