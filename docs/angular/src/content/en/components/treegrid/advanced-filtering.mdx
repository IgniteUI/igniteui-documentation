...
<Sample src="/tree-grid/treegrid-advanced-filtering" height={510} alt="Angular Tree Grid Advanced Filtering Example" />
...
To enable the advanced filtering, the <ApiLink type="TreeGrid" member="allowAdvancedFiltering" label="allowAdvancedFiltering" /> input property should be set to `true`.
...
It's super easy to configure the advanced filtering to work outside of the Tree Grid. All you need to do is to create the dialog and set its <ApiLink type="GridToolbarAdvancedFiltering" member="grid" label="grid" /> property:
...
- [Excel Style Filtering](/treegrid/excel-style-filtering)
