...
<Sample src="/tree-grid/tree-grid-validator-service" height={600} alt="Angular Tree Grid Validation Basic Example" />
...
<Sample src="/tree-grid/tree-grid-validator-service-extended" height={570} alt="Angular Tree Grid Custom Validation Example" />
...
<igx-column field="row_valid" header=" " [editable]="false" [dataType]="'number'" [pinned]="true" [width]="'150px'">
    <ng-template igxCell let-cell="cell">
        <div *ngIf="isRowValid(cell)" [igxTooltipTarget]="tooltipRef"  style="margin: 'auto';">
            <img width="18" src="/treegrid/assets/images/grid/active.png"/>
        </div>
        <div *ngIf="!isRowValid(cell)" [igxTooltipTarget]="tooltipRef" style="margin: 'auto';">
            <img width="18" src="/treegrid/assets/images/grid/expired.png"/>
        </div>
...
<Sample src="/tree-grid/tree-grid-cross-field-validator-service" height={620} alt="Angular Tree Grid Cross-field Validation Example" />
