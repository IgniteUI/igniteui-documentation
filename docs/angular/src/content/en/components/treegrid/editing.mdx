...
|-------|-------------|-----------|-------------|
| <ApiLink type="TreeGrid" member="rowEditEnter" label="rowEditEnter" /> | If `rowEditing` is enabled, fires when a row enters edit mode | <ApiLink type="IGridEditEventArgs" kind="interface" prefixed={false} /> | `true` |
| <ApiLink type="TreeGrid" member="cellEditEnter" label="cellEditEnter" /> | Fires when a cell **enters edit mode** (after `rowEditEnter`) | <ApiLink type="IGridEditEventArgs" kind="interface" prefixed={false} /> | `true` |
| <ApiLink type="TreeGrid" member="cellEdit" label="cellEdit" /> | If value is changed, fires just **before** a cell's value is **committed** (e.g. by pressing `Enter`) | <ApiLink type="IGridEditEventArgs" kind="interface" prefixed={false} /> | `true` |
| <ApiLink type="TreeGrid" member="celleditdone" label="cellEditDone" /> | If value is changed, fires **after** a cell has been edited and cell's value is **committed** | <ApiLink type="IGridEditDoneEventArgs" kind="interface" prefixed={false} /> | `false` |
| <ApiLink type="TreeGrid" member="cellEditExit" label="cellEditExit" /> | Fires when a cell **exits edit mode** | [IGridEditDoneEventArgs]({environment:angularApiUrl}/interfaces/igridediteventargs.html) | `false` |
| <ApiLink type="TreeGrid" member="rowEdit" label="rowEdit" /> | If `rowEditing` is enabled, fires just before a row in edit mode's value is **committed** (e.g. by clicking the `Done` button on the Row Editing Overlay) | <ApiLink type="IGridEditEventArgs" kind="interface" prefixed={false} /> | `true` |
| <ApiLink type="TreeGrid" member="rowEditDone" label="rowEditDone" /> | If `rowEditing` is enabled, fires **after** a row has been edited and new row's value has been **committed**. | [IGridEditDoneEventArgs]({environment:angularApiUrl}/interfaces/igridediteventargs.html) | `false` |
| <ApiLink type="TreeGrid" member="rowEditExit" label="rowEditExit" /> | If `rowEditing` is enabled, fires when a row **exits edit mode** | [IGridEditDoneEventArgs]({environment:angularApiUrl}/interfaces/igridediteventargs.html) | `false` |
