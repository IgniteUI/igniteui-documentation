...
description: Perform data manipulation without affecting the underlying data with Tree Grid Batch Editing and Angular CRUD, using Angular Data Grid. See demos & examples!
