...
To set the initial filtering state of the Tree Grid, set the <ApiLink type="TreeGrid" /> <ApiLink type="TreeGrid" member="filteringExpressionsTree" label="filteringExpressionsTree" /> property to an array of <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> for each column to be filtered.
...
- <ApiLink type="TreeGrid" member="filteringDone" label="filteringDone" /> event now have only one parameter of type <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> which contains the filtering state of the filtered column.
...
- Custom filters can be provided to the Tree Grid columns by populating the <ApiLink type="FilteringOperand" suffix={false} member="operations" label="operations" /> property of the <ApiLink type="FilteringOperand" suffix={false} /> with operations of <ApiLink type="IFilteringOperation" kind="interface" prefixed={false} /> type.
