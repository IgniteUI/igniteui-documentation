...
<Sample src="/tree-grid/treegrid-column-resizing" height={550} alt="Angular Tree Grid Column Resizing Example" />

<div class="divider--half"></div>

**Column resizing** is also enabled per-column level, meaning that the <ApiLink type="TreeGrid" /> can have a mix of resizable and non-resizable columns. This is done via the <ApiLink type="Column" member="resizable" label="resizable" /> input of the <ApiLink type="Column" label="igx-column" />.

```html
<igx-column [field]="'ID'" width="100px" [resizable]="true"></igx-column>
```

You can subscribe to the <ApiLink type="TreeGrid" member="columnResized" label="columnResized" /> event of the <ApiLink type="TreeGrid" /> to implement some custom logic when a column is resized. Both, previous and new column widths, as well as the <ApiLink type="Column" /> object, are exposed through the event arguments.
...
<Sample src="/tree-grid/tree-grid-columnAutoSizing-sample" height={550} alt="Angular Tree Grid Column Resizing Example" />
