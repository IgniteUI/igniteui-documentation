...
<Sample src="/tree-grid/treegrid-add-row" height={520} alt="Angular Tree Grid Row Adding Example" />
...
The internal <ApiLink type="BaseTransactionService" suffix={false} /> is automatically provided for Tree Grid. It holds pending cell changes until the row state is submitted or cancelled.
