...
- groupingExpressions - an array of <ApiLink kind="interface" type="IGroupingExpression" /> objects which contains information about the fields used to generate the hierarchy and the sorting details for each group
