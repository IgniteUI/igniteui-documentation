...
- Using <ApiLink type="Dialog" member="open" label="open" /> method and pass a valid [`overlaySettings`]({environment:angularApiUrl}/interfaces/overlaysettings.html). Example:
