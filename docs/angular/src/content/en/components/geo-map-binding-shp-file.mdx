...
llms:
  description: "The Ignite UI for Angular map component, the ShapefileRecord class loads geo-spatial data (points/locations, polylines, polygons) from shape files and converts it to a collection of IgxShapefileRecord objects."
---
...
The Ignite UI for Angular map component, the <ApiLink type="ShapefileRecord" /> class loads geo-spatial data (points/locations, polylines, polygons) from shape files and converts it to a collection of `IgxShapefileRecord` objects.
