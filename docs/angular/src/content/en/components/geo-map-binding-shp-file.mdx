...
The Ignite UI for Angular map component, the <ApiLink pkg="geo-core" type="ShapefileRecord" suffix={false} /> class loads geo-spatial data (points/locations, polylines, polygons) from shape files and converts it to a collection of `IgxShapefileRecord` objects.
