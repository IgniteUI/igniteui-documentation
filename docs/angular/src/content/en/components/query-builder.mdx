...
The <ApiLink type="QueryBuilder" member="expressionTree" label="expressionTree" /> is a two-way bindable property which means a corresponding <ApiLink type="QueryBuilder" member="expressionTreeChange" label="expressionTreeChange" /> output is implemented that emits when the end-user changes the UI by creating, editing or removing conditions. It can also be subscribed separately to receive notifications and react to such changes.
