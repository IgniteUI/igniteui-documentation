...
You can force the component to select all of the input text on focus using <ApiLink type="TextSelectionDirective" suffix={false} />. Find more info on `igxTextSelection` at [Label & Input](/label-input#focus--text-selection).
