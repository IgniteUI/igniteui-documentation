...
Create data sources for all geographic series that you want to display in the Ignite UI for Angular map. For example, you can the use [WorldConnections](/geo-map-resources-world-connections) script.
