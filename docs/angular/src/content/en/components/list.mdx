...
We can always provide our own template for the look of our empty list by simply using the <ApiLink type="EmptyListTemplateDirective" suffix={false} /> directive. In this case, the default template will not be used:
...
<igx-list>
  ...
  <igx-list-item *ngFor="let contact of contacts">
    ...
    <p igxListLineSubTitle>{{ contact.phone }}
</div>
  </igx-list-item>
</igx-list>
```
...
<igx-list>
  ...
  <igx-list-item #item *ngFor="let contact of contacts;">
      ...
      <h4 igxListLineTitle>{{ contact.name }}</h4>
      <p igxListLineSubTitle class="phone">{{ contact.phone }}
</div>
...
It's time to import the `IgxFilterModule` and the `IgxInputGroupModule` in our app.module.ts file and <ApiLink type="FilterOptions" suffix={false} /> in our contacts component:
