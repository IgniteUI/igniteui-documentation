...
## Contour Fill Scale
Use the `FillScale` property of the <ApiLink pkg="maps" type="GeographicContourLineSeries" /> to resolve fill brushes of the contour lines of the geographic series.
