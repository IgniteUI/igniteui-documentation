...
The column selection feature can be enabled through the <ApiLink type="HierarchicalGrid" member="columnSelection" label="columnSelection" /> input, which takes [GridSelectionMode]({environment:angularApiUrl}/index.html#gridselectionmode) values.
