...
<Sample src="/hierarchical-grid/hierarchical-grid-validator-service" height={680} alt="Angular Hierarchical Grid Validation Basic Example" />
...
<Sample src="/hierarchical-grid/hierarchical-grid-validator-service-extended" height={640} alt="Angular Hierarchical Grid Custom Validation Example" />
...
<igx-column field="row_valid" header=" " [editable]="false" [dataType]="'number'" [pinned]="true" [width]="'50px'">
        <ng-template igxCell let-cell="cell">
            ...
            >
                <img width="18" src="/hierarchicalgrid/assets/images/grid/active.png"/>
            </div>
            <div *ngIf="!isRowValid(cell)" [igxTooltipTarget]="tooltipRef"
            >
                <img width="18" src="/hierarchicalgrid/assets/images/grid/expired.png"/>
            </div>
...
<Sample src="/hierarchical-grid/hierarchical-grid-cross-field-validation" height={620} alt="Angular Hierarchical Grid Cross-field Validation Example" />
...
- [Hierarchical Grid Transactions](/hierarchicalgrid/batch-editing)
