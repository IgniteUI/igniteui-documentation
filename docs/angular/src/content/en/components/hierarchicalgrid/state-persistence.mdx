...
>[!NOTE]
> The [`IgxGridState`]({environment:angularApiUrl}/classes/igxgridstatedirective.html) directive does not take care of templates. Go to [Restoring Column](/hierarchicalgrid/state-persistence#restoring-columns) section to see how to restore column templates.
