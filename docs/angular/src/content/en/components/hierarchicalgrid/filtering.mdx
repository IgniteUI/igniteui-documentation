...
To set the initial filtering state of the Hierarchical Grid, set the <ApiLink type="HierarchicalGrid" /> <ApiLink type="HierarchicalGrid" member="filteringExpressionsTree" label="filteringExpressionsTree" /> property to an array of <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> for each column to be filtered.
