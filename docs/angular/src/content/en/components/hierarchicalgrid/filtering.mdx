...
In order to specify if filtering is enabled and which filtering mode should be used, the Hierarchical Grid exposes the following boolean properties - [`allowFiltering`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowFiltering), [`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowAdvancedFiltering), [`filterMode`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filterMode) and [`filterable`]({environment:angularApiUrl}/classes/igxcolumncomponent.html#filterable).

Property **[allowFiltering]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowfiltering)** enables you to specify the following options:
...
Property **[allowAdvancedFiltering]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowAdvancedFiltering)** enables you to specify the following options:
...
Property **[filterMode]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filterMode)** enables you to specify the following options:
...
To enable the [Advanced filtering](/hierarchicalgrid/advanced-filtering) however, you need to set the [`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowAdvancedFiltering) input properties to `true`.
...
Filtering feature is enabled for the Hierarchical Grid component by setting the [`allowFiltering`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowFiltering) input to `true`. The default [`filterMode`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filterMode) is `quickFilter` and it **cannot** be changed run time. To disable this feature for a certain column – set the [`filterable`]({environment:angularApiUrl}/classes/igxcolumncomponent.html#filterable) input to `false`.
...
You can filter any column or a combination of columns through the Hierarchical Grid API. The Hierarchical Grid exposes several methods for this task - [`filter`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filter), [`filterGlobal`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filterglobal) and [`clearFilter`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#clearFilter).

- [`filter`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filter) - filter a single column or a combination of columns.
...
- [`filterGlobal`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filterGlobal) - clears all existing filters and applies the new filtering condition to all Hierarchical Grid's columns.
...
- [`clearFilter`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#clearFilter) - removes any applied filtering from the target column. If called with no arguments it will clear the filtering of all columns.
...
To set the initial filtering state of the Hierarchical Grid, set the [`IgxHierarchicalGridComponent`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html) [`filteringExpressionsTree`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filteringExpressionsTree) property to an array of [`IFilteringExpressionsTree`]({environment:angularApiUrl}/interfaces/ifilteringexpressionstree.html) for each column to be filtered.
...
The [`filteringLogic`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#filteringlogic) property of the Hierarchical Grid controls how filtering multiple columns will resolve in the Hierarchical Grid. You can change it at any time through the Hierarchical Grid API, or through the Hierarchical Grid input property.
