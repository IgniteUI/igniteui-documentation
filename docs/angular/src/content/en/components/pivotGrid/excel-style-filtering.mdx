...
description: Learn how to configure Excel filtering in Angular Pivot Grid. You can enable/disable various options and customize the Excel style filter menu the way you want.
