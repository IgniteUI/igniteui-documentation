...
When setting up your Angular spreadsheet control to add charts, you will need to import the <ApiLink type="SpreadsheetChartAdapter" pkg="spreadsheet" /> class like so:
