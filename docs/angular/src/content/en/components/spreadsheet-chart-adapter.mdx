...
The Angular Spreadsheet component allows displaying charts in your <ApiLink type="Spreadsheet" />.
...
When setting up your Angular spreadsheet control to add charts, you will need to import the <ApiLink type="SpreadsheetChartAdapter" pkg="spreadsheet" suffix={false} exclude="Angular,Blazor,React,WebComponents" /> class like so:
