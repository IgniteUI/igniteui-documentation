...
When setting up your Angular spreadsheet control to add charts, you will need to import the <ApiLink pkg="spreadsheet" type="SpreadsheetChartAdapter" suffix={false} exclude="Angular,Blazor,React,WebComponents" /> class like so:
