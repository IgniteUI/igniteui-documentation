...
<Sample src="/grid-lite/sorting-simple" height={510} alt="Angular Grid Lite Sorting Config" />
...
<Sample src="/grid-lite/sorting-events" height={510} alt="Angular Grid Lite Sorting Config Events" />
