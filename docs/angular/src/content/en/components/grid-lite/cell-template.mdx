...
You also need to import <ApiLink type="GridLiteCellTemplateDirective" />
...
The custom cell renderer is passed an <ApiLink type="GridLiteCellTemplateContext" kind="type" /> object as a parameter with the following props:
