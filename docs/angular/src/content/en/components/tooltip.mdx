...
In the following example, you can see how we create descriptive tooltips by using the <ApiLink type="List" />, <ApiLink type="Avatar" />, <ApiLink type="Icon" />, <ApiLink type="Badge" />, <ApiLink type="ButtonDirective" suffix={false} />, <ApiLink type="Card" /> and [`IgxCategoryChart`]({environment:dvApiBaseUrl}/products/ignite-ui-angular/api/docs/typescript/latest/classes/igniteui_angular_charts.igxcategorychartcomponent.html) components.
...
Following the simplest approach, we create a new theme that extends the <ApiLink kind="sass" module="themes" type="function-tooltip-theme" label="tooltip-theme" code={true} /> and provide the `$text-color`, `$background` and the `$border-radius` parameters.
...
You can find the full list of properties in the <ApiLink kind="sass" module="themes" type="function-tooltip-theme" label="IgxTooltip Theme" />. The syntax is as follows:
...
Styles:
- <ApiLink kind="sass" module="themes" type="function-tooltip-theme" label="IgxTooltipDirective Styles" />
- <ApiLink kind="sass" module="themes" type="function-avatar-theme" label="IgxAvatarComponent Styles" />
