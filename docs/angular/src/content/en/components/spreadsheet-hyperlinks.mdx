...
When setting up your Angular spreadsheet control to use hyperlinks, you will need to import the <ApiLink pkg="excel" type="WorksheetHyperlink" prefixed={false} suffix={false} /> class like so:
