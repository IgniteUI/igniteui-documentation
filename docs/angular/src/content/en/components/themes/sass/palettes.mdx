...
- <ApiLink kind="sass" module="palettes" type="function-palette" label="Palettes" />
- <ApiLink kind="sass" module="palettes" type="function-color" label="Getting Palette Colors" />
- <ApiLink kind="sass" module="palettes" type="function-contrast-color" label="Getting Contrast Colors" />
- <ApiLink kind="sass" module="utilities" type="mixin-color-classes" label="Generating Color Classes" />
