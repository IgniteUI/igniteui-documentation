...
As you can see from the example above, the component schema defines the properties the <ApiLink kind="sass" module="themes" type="function-avatar-theme" label="Avatar Theme" /> consumes. It just prescribes the colors the avatar should use, without referencing a concrete color palette map.
...
- <ApiLink kind="sass" module="schemas" type="variable-light-material-schema" label="Light Components Schema" />
- <ApiLink kind="sass" module="schemas" type="variable-dark-material-schema" label="Dark Components Schema" />
