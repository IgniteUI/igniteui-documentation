...
| [**Fluent Light**](presets/fluent)                           | `$light-fluent-schema`    | $light-fluent-palette <br /> $light-fluent-excel-palette <br /> $light-fluent-word-palette |
| [**Fluent Dark**](presets/fluent#fluent-dark-theme)          |  `$dark-fluent-schema`    | $dark-fluent-palette <br /> $dark-fluent-excel-palette <br /> $dark-fluent-word-palette    |
