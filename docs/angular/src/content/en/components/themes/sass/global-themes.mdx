...
| ----------------------------------------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------- |
| [**Material Light**](/themes/sass/presets/material#default-theme)           |  `$light-material-schema`          | $light-material-palette                                                                |
| [**Material Dark**](/themes/sass/presets/material#material-dark-theme)      |  `$dark-material-schema`           | $dark-material-palette                                                                 |
| [**Fluent Light**](/themes/sass/presets/fluent)                             | `$light-fluent-schema`             | $light-fluent-palette <br/> $light-fluent-excel-palette <br/> $light-fluent-word-palette |
| [**Fluent Dark**](/themes/sass/presets/fluent#fluent-dark-theme)            |  `$dark-fluent-schema`             | $dark-fluent-palette <br/> $dark-fluent-excel-palette <br/> $dark-fluent-word-palette    |
| [**Bootstrap Light**](/themes/sass/presets/bootstrap)                       | `$light-bootstrap-schema`          | $light-bootstrap-palette                                                               |
| [**Bootstrap Dark**](/themes/sass/presets/bootstrap#bootstrap-dark-theme)   |  `$dark-bootstrap-schema`         | $dark-bootstrap-palette                                                                |
| [**Indigo Light**](/themes/sass/presets/indigo)                             | `$light-indigo-schema`             | $light-indigo-palette                                                                  |
| [**Indigo Dark**](/themes/sass/presets/indigo#indigo-dark-theme)            |   `$dark-indigo-schema`           | $dark-indigo-palette                                                                   |
