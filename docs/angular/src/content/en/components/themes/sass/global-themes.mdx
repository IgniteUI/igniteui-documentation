...
llms:
  description: "The global theme allows you to quickly generate a theme that uses your custom color palette, schema, and elevations."
---
...
To use any of the versions, you would simply need to pass it to our <ApiLink kind="sass" module="themes" type="mixin-theme" label="theme" /> mixin:
