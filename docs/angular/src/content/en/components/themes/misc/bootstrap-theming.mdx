...
import igxCards from '../../../images/igx-cards.png';
import igxDialog from '../../../images/igx-dialog.png';
import ngbAccordion from '../../../images/ngb-accordion.png';
import darkVariant from '../../../images/dark-variant.png';
...
<Sample src="/theming/bootstrap-sample" height={1000} alt="" />
...
Next, we have added an [`ngb-accordion`](https://ng-bootstrap.github.io/#/components/accordion/examples) showing information about credit cards. Inside its content, there is an <ApiLink type="List" label="igx-list" /> and `igx-button`.
...
First, we are going to define Sass variables that extract values from the <ApiLink kind="sass" module="palettes" type="variable-light-bootstrap-palette" label="$light-bootstrap-palette" code={true} />:
...
Ignite UI for Angular comes with predefined themes inspired by the [Bootstrap 4](https://getbootstrap.com/) library. To use them, first, you have to include our `core` mixin and then our built-in theme mixin - <ApiLink kind="sass" module="themes" type="mixin-bootstrap-light-theme" label="bootstrap-light-theme" />. We will also make use of our predefined bootstrap palette - <ApiLink kind="sass" module="palettes" type="variable-light-bootstrap-palette" label="$light-bootstrap-palette" />.
...
Ignite UI for Angular exposes four default type scales for each of its themes, which can be used inside the <ApiLink kind="sass" module="typography" type="mixin-typography" label="typography" code={true} /> mixin to define the global typography styles of an application. In our example, we are going to apply the bootstrap predefined `typeface` and `type-scale` but you can create custom ones if you wish.
...
- <ApiLink kind="sass" module="palettes" type="variable-light-bootstrap-palette" label="Light Bootstrap Palette" />
- <ApiLink kind="sass" module="palettes" type="variable-dark-bootstrap-palette" label="Dark Bootstrap Palette" />
- <ApiLink kind="sass" module="themes" type="mixin-bootstrap-light-theme" label="Light Bootstrap Theme" />
- <ApiLink kind="sass" module="themes" type="mixin-bootstrap-dark-theme" label="Dark Bootstrap Theme" />
