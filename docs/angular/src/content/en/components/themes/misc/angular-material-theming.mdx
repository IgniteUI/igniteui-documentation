...
Next, we have added an <ApiLink type="ExpansionPanel" label="igx-expansion-panel" /> showing information about some credit cards. Inside its content, there are [`mat-sliders`](https://material.angular.io/components/slider/overview), an <ApiLink type="Divider" label="igx-divider" /> and a [`mat-stepper`](https://material.angular.io/components/stepper/overview) with [`mat-form-fields`](https://material.angular.io/components/form-field/overview).
