...
The Grid accepts date values of type _Date object_, _Number (milliseconds)_, _An ISO date-time string_. This section shows [how to configure a custom display format](/grid/grid#custom-display-format).
...
Upon editing of cell's value the _currency symbol_ will be visible as suffix or prefix. More about that could be found in the official [Cell editing topic](/grid/cell-editing#cell-editing-templates).
...
See the editing templates part of [Grid Editing topic](/grid/editing#editing-templates)
...
- Grid <ApiLink type="Grid" member="locale" label="locale" />
...
- [Grid overview topic](/grid/grid)
- [Editing topic](/grid/editing)
- [Summaries topic](/grid/summaries)
