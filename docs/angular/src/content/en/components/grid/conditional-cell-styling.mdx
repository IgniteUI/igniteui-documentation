...
- By setting <ApiLink type="Grid" member="rowClasses" label="rowClasses" /> input on the IgxGrid component;
- By setting <ApiLink type="Grid" member="rowStyles" label="rowStyles" /> input on the IgxGrid component;

Further in this topic wi will cover both of them in more details.

### Using rowClasses

You can conditionally style the IgxGrid rows by setting the <ApiLink type="Grid" member="rowClasses" label="rowClasses" /> input and define custom rules.
...
You can conditionally style the IgxGrid cells by setting the <ApiLink type="Column" /> <ApiLink type="Column" member="cellClasses" label="cellClasses" /> input and define custom rules.
