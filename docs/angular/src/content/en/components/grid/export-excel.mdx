...
Whether your audience needs a spreadsheet for deeper analysis or a polished PDF they can share right away, the Ignite UI exporters help you deliver the right file from the IgxGrid in seconds. Inject the <ApiLink type="ExcelExporterService" suffix={false} /> or <ApiLink type="PdfExporterService" suffix={false} />, call the respective <ApiLink type="ExcelExporterService" suffix={false} member="export" label="export" />/<ApiLink type="PdfExporterService" suffix={false} member="export" label="export" /> method, and the component handles the rest—from honoring filters and sorting to shaping the output format.
</p>
