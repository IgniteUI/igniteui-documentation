...
<Sample lob src="/grid/grid-nested-data-binding-2" height={460} alt="Angular grid nested data example" />
...
<Sample lob src="/grid/grid-nested-data-binding" height={460} alt="Angular grid nested data binding example" />

<div class="divider--half"></div>

### Working with Flat data

The flat data binding approach is similar to the one that we already described above, but instead of **cell value** we are going to use the <ApiLink type="GridRow" suffix={false} member="data" /> property of the <ApiLink type="GridRow" />.
...
<Sample lob src="/grid/grid-composite-data-binding" height={550} alt="Angular grid composite data binding example" />
