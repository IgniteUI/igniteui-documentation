...
The column selection feature can be enabled through the <ApiLink type="Grid" member="columnSelection" label="columnSelection" /> input, which takes <ApiLink kind="enum" type="GridSelectionMode" /> values.
