...
IgniteUI for Angular Grid component provides three different selection modes - [Row selection](/grid/row-selection), [Cell selection](/grid/cell-selection) and [Column selection](/grid/column-selection). By default only **Multi-cell selection** mode is enabled in the Grid. In order to change/enable selection mode you can use <ApiLink type="Grid" member="rowSelection" label="rowSelection" />, <ApiLink type="Grid" member="cellSelection" label="cellSelection" /> or <ApiLink type="Column" member="selectable" label="selectable" /> properties.
...
> Go to [Row selection topic](/grid/row-selection) for more information.
...
> Go to [Cell selection topic](/grid/cell-selection) for more information.
...
> Go to [Column selection topic](/grid/column-selection) for more information.
