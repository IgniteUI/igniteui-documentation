...
The Ignite UI for Angular <ApiLink type="Grid" /> can read Excel data that is copied to the clipboard. In this section we will show you how to do this with some custom code.
...
<Sample lob src="/grid/grid-paste" height={570} alt="Angular Paste from Excel Example" />
