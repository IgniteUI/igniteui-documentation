...
To set the initial filtering state of the Grid, set the <ApiLink type="Grid" /> <ApiLink type="Grid" member="filteringExpressionsTree" label="filteringExpressionsTree" /> property to an array of <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> for each column to be filtered.
...
- <ApiLink type="Grid" member="filteringDone" label="filteringDone" /> event now have only one parameter of type <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> which contains the filtering state of the filtered column.
...
- Custom filters can be provided to the Grid columns by populating the <ApiLink type="FilteringOperand" suffix={false} member="operations" label="operations" /> property of the <ApiLink type="FilteringOperand" suffix={false} /> with operations of <ApiLink type="IFilteringOperation" kind="interface" prefixed={false} /> type.
