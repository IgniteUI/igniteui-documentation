...
The Summaries are allowing for customization of the basic Summary feature functionality through extending one of the base classes, <ApiLink type="SummaryOperand" suffix={false} />, <ApiLink type="NumberSummaryOperand" suffix={false} /> or <ApiLink type="DateSummaryOperand" suffix={false} />, depending on the column data type and your needs.  
