...
The following example demonstrates styling the Angular Data Chart series brush with the Color Editor tool. <Sample src="/charts/toolbar/color-editor-support" height={600} alt="Angular Color Editor Support" />
