...
The <ApiLink type="Splitter" /> emits the following events during pane resizing:
...
<igx-splitter
    ...
    <igx-splitter-pane>Left</igx-splitter-pane>
    <igx-splitter-pane>Right</igx-splitter-pane>
</igx-splitter>
```
