...
<Sample src="/layouts/splitter-horizontal-sample" height={400} alt="Angular Splitter Example" />
...
The splitter can be vertical or horizontal, which is defined by the <ApiLink type="Splitter" member="type" label="type" /> input. The default value is Vertical.
...
You can make the splitter collapsible or not by showing or hiding the splitter's handle and expanders, using the <ApiLink type="Splitter" member="nonCollapsible" label="nonCollapsible" /> input. The default value is false, so the splitter is collapsible.
...
The **igxSplitterPane** component contains several input properties. You can set the initial pane size by using the <ApiLink type="SplitterPane" member="size" label="size" /> input property. The <ApiLink type="SplitterPane" member="minSize" label="minSize" /> and <ApiLink type="SplitterPane" member="maxSize" label="maxSize" /> input properties can be used to set the minimum or maximum allowed size of the pane. Resizing beyond `minSize` and `maxSize` is not allowed.
...
You can also forbid the resizing of a pane by setting its <ApiLink type="SplitterPane" member="resizable" label="resizable" /> input property to **false**.
...
You can change the default styles of the splitter by creating a new theme that extends the <ApiLink kind="sass" module="themes" type="function-splitter-theme" label="splitter-theme" code={true} />. By providing just the base parameters, the theme will automatically generate all necessary styles for the interaction states.
...
You can find the full list of properties in the <ApiLink kind="sass" module="themes" type="function-splitter-theme" label="splitter-theme" />. The syntax is as follows:
...
- <ApiLink kind="sass" module="themes" type="function-splitter-theme" label="IgxSplitterComponent Styles" />
<hr/>
## Theming Dependencies

- <ApiLink kind="sass" module="themes" type="function-drop-down-theme" label="IgxDropDown Theme" />
- <ApiLink kind="sass" module="themes" type="function-icon-theme" label="IgxIcon Styles" />
