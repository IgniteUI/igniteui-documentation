...
In Angular map component, you can use the <ApiLink type="GeographicPolylineSeries" /> to display geo-spatial data using polylines in a geographic context. This type of geographic series is often used to render roads or connections between geographic locations such as cities or airports.
