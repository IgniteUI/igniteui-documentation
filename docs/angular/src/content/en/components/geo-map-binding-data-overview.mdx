...
The Ignite UI for Angular map component is designed to display geo-spatial data from shape files and/or geographic locations from data models on geographic imagery maps. The <ApiLink type="GeographicMap" member="ItemsSource" label="ItemsSource" pkg="maps" /> property of geographic series is used for the purpose of binding to data models.
