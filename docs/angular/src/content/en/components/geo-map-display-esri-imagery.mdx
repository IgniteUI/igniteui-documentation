...
## Code Snippet
The following code snippet shows how to display Angular geographic imagery tiles from Esri imagery servers in <ApiLink pkg="maps" type="GeographicMap" /> using <ApiLink pkg="maps" type="ArcGISOnlineMapImagery" suffix={false} /> class.
