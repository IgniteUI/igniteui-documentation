...
<ApiRef types={["CellFillLinearGradient","CellFillPattern","CellFillRectangularGradient","CellFill","CellFormat","Formula","WorkbookColorInfo","WorkbookStyle","Workbook","WorksheetCell","WorksheetColumn","WorksheetRegion","WorksheetRow","Worksheet"]} pkg="excel" />
