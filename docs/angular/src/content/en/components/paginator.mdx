...
**Step 1** - Import `IPaginatorResourceStrings` interface and <ApiLink kind="function" type="changei18n" /> function:
...
**Step 3** - Pass the object to the <ApiLink kind="function" type="changei18n" /> function as a parameter in order to change the global i18n for the component on app.module level. This will change the resource string of all Paging components part of your application:
