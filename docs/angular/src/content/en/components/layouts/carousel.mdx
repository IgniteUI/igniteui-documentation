...
<Sample src="/layouts/carousel-thumbnail" height={470} alt="Angular Carousel thumbnail indicators example" />
...
<tbody>
<tr>
<td style="border: 1px solid #d3d3d3; padding: 16px 20px;"><Image src={carouselDo1} srcset={`${carouselDo1.src} 1x, ${carouselDo1_2x.src} 2x`} alt="Angular Carousel do guidance" class="responsive-img" style="display: block; width: 100%; max-width: 100%; height: auto;" /></td>
<td style="border: 1px solid #d3d3d3; padding: 16px 20px;"><Image src={carouselDoNot1} srcset={`${carouselDoNot1.src} 1x, ${carouselDoNot1_2x.src} 2x`} alt="Angular Carousel don't guidance" class="responsive-img" style="display: block; width: 100%; max-width: 100%; height: auto;" /></td>
</tr>
<tr>
<td style="border: 1px solid #d3d3d3; padding: 16px 20px;"><Image src={carouselDo2} srcset={`${carouselDo2.src} 1x, ${carouselDo2_2x.src} 2x`} alt="Angular Carousel do guidance with visual slides" class="responsive-img" style="display: block; width: 100%; max-width: 100%; height: auto;" /></td>
<td style="border: 1px solid #d3d3d3; padding: 16px 20px;"><Image src={carouselDoNot2} srcset={`${carouselDoNot2.src} 1x, ${carouselDoNot2_2x.src} 2x`} alt="Angular Carousel don't guidance with dense content" class="responsive-img" style="display: block; width: 100%; max-width: 100%; height: auto;" /></td>
</tr>
</tbody>
</table>
</div>
