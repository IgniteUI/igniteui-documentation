...
<Sample src="/layouts/avatar-sample-4" height={100} alt="Angular Avatar icon example" />
...
<Sample src="/layouts/avatar-sample-1" height={100} alt="Angular Avatar initials example" />

<Sample src="/layouts/avatar-sample-2" height={100} alt="Angular Avatar image example" />

<Sample src="/layouts/avatar-sample-3" height={200} alt="Angular Avatar content variations example" />
...
<Sample src="/layouts/avatar-shape" height={100} alt="Angular Avatar shape example" />
...
<Sample src="/layouts/avatar-size" height={100} alt="Angular Avatar size example" />
...
<Sample src="/layouts/avatar-styling" height={120} alt="Angular styled Avatar example" />
...
<Sample src="/layouts/avatar-css-variables" height={100} alt="Angular Avatar CSS variables example" />

### Tailwind

Use the Angular Tailwind utility syntax when your application styles Ignite UI components through Tailwind classes.

<Sample src="/layouts/avatar-tailwind-styling" height={100} alt="Angular Avatar Tailwind styling example" />
