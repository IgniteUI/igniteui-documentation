...
<Sample spacing="sm" height={300} src="/layouts/avatar-overview" showThemePicker alt="Angular Avatar overview example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar-variants" showThemePicker alt="Angular Avatar variants example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar-shape" showThemePicker alt="Angular Avatar shape example" />
...
<Sample position="center" spacing="sm" height={300} src="/layouts/avatar-size" showThemePicker alt="Angular Avatar size example" />
