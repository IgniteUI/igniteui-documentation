...
The resource topic provides implementation of an utility that helps with styling UI elements of <ApiLink type="GeographicShapeSeries" /> in Angular <ApiLink type="GeographicMap" /> component.
