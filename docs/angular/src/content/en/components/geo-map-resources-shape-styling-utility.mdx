...
The resource topic provides implementation of an utility that helps with styling UI elements of <ApiLink pkg="maps" type="GeographicShapeSeries" /> in Angular <ApiLink pkg="maps" type="XamGeographicMap" /> component.
