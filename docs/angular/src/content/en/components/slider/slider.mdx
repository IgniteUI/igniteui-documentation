...
During the showcase above, we've intentionally shown how we can provide our custom `label` template, by using both  <ApiLink type="ThumbFromTemplateDirective" /> and <ApiLink type="ThumbToTemplateDirective" /> directives. Intuitively we can assume that <ApiLink type="ThumbFromTemplateDirective" /> corresponds to the  <ApiLink type="Slider" member="lowerLabel" label="lowerLabel" /> and <ApiLink type="ThumbToTemplateDirective" /> to the <ApiLink type="Slider" member="upperLabel" label="upperLabel" />. <br/>
...
We also rotate all viable labels by setting the <ApiLink type="TickLabelsOrientation" kind="variable" label="TickLabelsOrientation" /> to <ApiLink kind="variable" type="TickLabelsOrientation" />
