...
<DocsAside type="note">
To use the <ApiLink type="FocusDirective" suffix={false} /> directive, you have to import the <ApiLink type="FocusModule" suffix={false} />.
</DocsAside>
...
<DocsAside type="note">
To use the <ApiLink type="TextSelectionDirective" suffix={false} /> directive, you have to import the <ApiLink type="TextSelectionModule" suffix={false} />.
</DocsAside>
