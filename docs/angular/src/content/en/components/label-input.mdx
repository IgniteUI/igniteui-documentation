...
You can add logic to force `focus` on input elements using the <ApiLink type="FocusDirective" suffix={false} /> directive.
...
<DocsAside type="note">
To use the <ApiLink type="FocusDirective" suffix={false} /> directive, you have to import the <ApiLink type="FocusDirective" suffix={false} />.
</DocsAside>

If you want the text in an input element, marked with `igxInput`, to be selected on focus, you have to enable the <ApiLink type="TextSelectionDirective" suffix={false} /> directive.
...
<DocsAside type="note">
To use the <ApiLink type="TextSelectionDirective" suffix={false} /> directive, you have to import the <ApiLink type="TextSelectionDirective" suffix={false} />.
</DocsAside>
