...
The resource topic provides implementation of data utility for generating locations of airports, flight paths, and geographic gridlines. You can use these data sources as reference point for creating your own geographic data. Note that this utility depends on [WorldUtil](/geo-map-resources-world-util) and [WorldLocations](/geo-map-resources-world-locations) scripts.
