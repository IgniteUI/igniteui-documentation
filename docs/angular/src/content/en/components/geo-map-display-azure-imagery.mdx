...
llms:
  description: "The Angular AzureMapsImagery is geographic imagery mapping service provided by Microsoft®."
---
...
The following code snippet shows how to display geographic imagery tiles from Azure Maps in Angular <ApiLink type="GeographicMap" /> using <ApiLink type="AzureMapsImagery" /> class.
...
The following code snippet shows how to display geographic imagery tiles on top of a background imagery joining eg. traffic with a dark grey map for the Angular <ApiLink type="GeographicMap" /> using <ApiLink type="AzureMapsImagery" /> and <ApiLink type="GeographicTileSeries" /> classes.
