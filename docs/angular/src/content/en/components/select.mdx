...
You can create custom <ApiLink type="OverlaySettings" kind="interface" />. To do this you first define your template like so:
...
You can see that we create a <ApiLink kind="interface" type="PositionSettings" /> object that is directly passed to our <ApiLink type="ConnectedPositioningStrategy" />, it is not required to do it, but since we want to define a custom positioning, we use them to override the strategy's default settings.
...
You can also pass in a customized <ApiLink type="OverlaySettings" kind="interface" /> object to the <ApiLink type="Select" member="open" label="IgxSelectComponent" />'s open function, where your template should look like this:
...
- <ApiLink type="OverlaySettings" kind="interface" />
- <ApiLink type="ConnectedPositioningStrategy" />
- <ApiLink type="GlobalPositionStrategy" member="constructor" label="GlobalPositionStrategy" />
- <ApiLink type="AbsoluteScrollStrategy" />
- <ApiLink type="PositionSettings" kind="interface" />
