...
You can create custom <ApiLink type="OverlaySettings" kind="interface" prefixed={false} />. To do this you first define your template like so:
...
You can also pass in a customized <ApiLink type="OverlaySettings" kind="interface" prefixed={false} /> object to the <ApiLink type="Select" member="open" label="IgxSelectComponent" />'s open function, where your template should look like this:
...
- <ApiLink type="OverlaySettings" kind="interface" prefixed={false} />
...
- <ApiLink type="PositionSettings" kind="interface" prefixed={false} />
