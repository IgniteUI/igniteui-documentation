...
Once the root <ApiLink type="FilteringExpressionsTree" suffix={false} prefixed={false} /> is created, adding conditions, groups or subqueries, could be done by setting its `filteringOperands` property to an array of <ApiLink type="IFilteringExpression" kind="interface" prefixed={false} /> (single expression or a group) or <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> (subquery).
Each <ApiLink type="IFilteringExpression" kind="interface" prefixed={false} /> and <ApiLink type="IFilteringExpressionsTree" kind="interface" prefixed={false} /> should have a `fieldName` that is the name of the column where the filtering expression is placed, and either a `condition` of type <ApiLink type="IFilteringOperation" kind="interface" prefixed={false} /> or a `conditionName`. If required, you could also set a `searchVal`, `searchTree` of type <ApiLink type="IExpressionTree" kind="interface" prefixed={false} />, and `ignoreCase` properties.
