...
Use the <ApiLink type="RippleDirective" member="rippleTarget" label="igxRippleTarget" /> property to attach a ripple effect to a specific element inside a parent element.
