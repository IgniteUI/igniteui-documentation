...
<DocsAside type="info">
If <ApiLink type="NavbarActionDirective" label="igx-navbar-action" /> or <ApiLink type="NavbarActionDirective" label="igxNavbarAction" /> is provided, the default <ApiLink type="Navbar" member="actionButtonIcon" label="actionButtonIcon" /> will not be used.
</DocsAside>
...
<DocsAside type="info">
If <ApiLink type="NavbarTitleDirective" label="igx-navbar-title" /> or <ApiLink type="NavbarTitleDirective" label="igxNavbarTitle" /> is provided, the default <ApiLink type="Navbar" member="title" label="title" /> will not be used.
</DocsAside>
...
Following the simplest approach, we create a new theme that extends the <ApiLink kind="sass" module="themes" type="function-navbar-theme" label="navbar-theme" code={true} /> and provide just the `$background` and `$idle-icon-color` parameters. The theme will automatically compute all of the necessary background and foreground colors for various interaction states. If need, you can also manually override specific properties for finer control over the appearance.
...
You can find the full list of properties in the <ApiLink kind="sass" module="themes" type="function-navbar-theme" label="navbar-theme" />. The syntax is as follows:
...
- <ApiLink kind="sass" module="themes" type="function-navbar-theme" label="IgxNavbarComponent Styles" />
Additional components and/or directives with relative APIs that were used:
- <ApiLink type="Icon" />
- <ApiLink kind="sass" module="themes" type="function-icon-theme" label="IgxIconComponent Styles" />
## Theming Dependencies

- <ApiLink kind="sass" module="themes" type="function-icon-theme" label="IgxIconComponent Theme" />
- <ApiLink kind="sass" module="themes" type="function-button-theme" label="IgxButtonComponent Theme" />
