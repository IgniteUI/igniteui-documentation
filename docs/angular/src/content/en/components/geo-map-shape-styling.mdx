...
This topic explains how to apply custom styling to the <ApiLink pkg="maps" type="GeographicShapeSeries" /> in the Angular <ApiLink pkg="maps" type="XamGeographicMap" />.

## Angular Shape Styling on Geographic Shape Series Example


<Sample src="/maps/geo-map/shape-styling" height={500} alt="Angular Shape Styling on Geographic Shape Series Example" />
