...
Note that the following code examples are using the [Shape Styling Utility](/geo-map-resources-shape-styling-utility) file that provides four different ways of styling shapes:
