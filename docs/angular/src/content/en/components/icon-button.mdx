...
If you want to disable an icon button, you can use the <ApiLink type="disabled" suffix={false} member="disabled" label="disabled" /> property. In this sample we also demonstrate how to use icons from different families with the `igxIconButton` directive:
