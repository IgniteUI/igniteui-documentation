...
The Ignite UI for Angular charts provide simple and easy to use APIs to plot your data in `CategoryChart`, `FinancialChart`, `XamDataChart`, `DataPieChart`, `XamDoughnutChart`, `XamPieChart`, and `XamSparkline` UI elements.
...
The Angular `XamDataChart` has the following API members:
...
The Angular `XamDataChart` can use the following type of series that inherit from `Series`:
...
The Angular `XamDataLegend` has the following API members:
...
The Angular `XamDoughnutChart` has the following API members:
...
The Angular `XamPieChart` has the following API members:
...
The Angular `XamSparkline` has the following API members:
