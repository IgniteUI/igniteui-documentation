...
You can create more advanced types of Angular Point Charts using the <ApiLink pkg="charts" type="XamDataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control by following these topics:
