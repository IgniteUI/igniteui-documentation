...
The following example, you can use the drop-down to switch between all of the different types stacked charts available in the Angular <ApiLink pkg="charts" type="DataChart" /> control.

<Sample src="/charts/data-chart/stacked-chart-types" height={600} alt="Angular Stacked Chart Types" />
...
<Sample src="/charts/data-chart/stacked-column-chart" height={600} alt="Angular Stacked Column Chart" />
...
<Sample src="/charts/data-chart/stacked-100-column-chart" height={600} alt="Angular Stacked 100 Column Chart" />
...
<Sample src="/charts/data-chart/stacked-spline-chart" height={600} alt="Angular Stacked Spline Chart" />
...
<Sample src="/charts/data-chart/stacked-100-spline-chart" height={600} alt="Angular Stacked 100 Spline Chart" />
