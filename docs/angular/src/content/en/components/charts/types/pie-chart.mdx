...
You can create the Angular Pie Chart in the <ApiLink pkg="charts" type="PieChart" /> by binding your data items with a string and a numeric data value. These data values will add up to a value of 100% of visualization. In this case, the example shows the overall breakdown of budget spend by department.
...
<Sample src="/charts/pie-chart/legend" height={600} alt="Angular Pie Chart Legend" />
...
<Sample src="/charts/pie-chart/others" height={600} alt="Angular Pie Chart Others" />
...
<Sample src="/charts/pie-chart/explosion" height={600} alt="Angular Pie Chart Explosion" />
...
<Sample src="/charts/pie-chart/selection" height={600} alt="Angular Pie Chart Selection" />
...
<Sample src="/charts/pie-chart/animation" height={600} alt="Angular Pie Chart Animation" />
...
<Sample src="/charts/pie-chart/styling" height={600} alt="Angular Pie Chart Styling" />
