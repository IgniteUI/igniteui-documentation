...
You can create Angular Bar Chart in the <ApiLink pkg="charts" type="XamDataChart" /> control by binding your data sources to multiple <ApiLink pkg="charts" type="BarSeries" />, as shown in the example below:
