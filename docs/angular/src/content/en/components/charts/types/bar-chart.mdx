...
You can create Angular Bar Chart in the <ApiLink type="DataChart" /> control by binding your data sources to multiple <ApiLink type="BarSeries" />, as shown in the example below:
