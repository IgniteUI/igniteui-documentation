...
The following example shows how to create Angular Spline Chart in the <ApiLink type="CategoryChart" /> control by binding your data and setting the <ApiLink type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to <ApiLink type="CategoryChartType" member="Spline" label="Spline" /> enum.
...
The following sections explain more advanced types of Angular Spline Charts that can be created using the <ApiLink type="DataChart" /> control instead of <ApiLink type="CategoryChart" /> control with simplified API.
