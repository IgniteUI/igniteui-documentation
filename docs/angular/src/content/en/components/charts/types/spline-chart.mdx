...
The following example shows how to create Angular Spline Chart in the <ApiLink pkg="charts" type="CategoryChart" /> control by binding your data and setting the <ApiLink pkg="charts" type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to <ApiLink pkg="charts" kind="enum" type="CategoryChartType" member="Spline" label="Spline" prefixed={false} /> enum.
...
<Sample src="/charts/category-chart/spline-single-source" height={600} alt="Angular Spline Chart with Single Source" />
...
<Sample src="/charts/category-chart/spline-multiple-sources" height={600} alt="Angular Spline Chart with Multiple Sources" />
...
<Sample src="/charts/category-chart/spline-styling" height={600} alt="Angular Spline Chart Styling" />
...
The following sections explain more advanced types of Angular Spline Charts that can be created using the <ApiLink pkg="charts" type="DataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control with simplified API.
