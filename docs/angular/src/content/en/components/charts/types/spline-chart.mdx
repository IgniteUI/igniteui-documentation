...
The following example shows how to create Angular Spline Chart in the <ApiLink pkg="charts" type="CategoryChart" /> control by binding your data and setting the <ApiLink pkg="charts" type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to `Spline` enum.
...
You can create this type of chart in the <ApiLink pkg="charts" type="CategoryChart" /> control by binding your data and setting the <ApiLink pkg="charts" type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to `Spline`, as shown in the example below:
...
| --------------------|--------------------|-------------------------- |
| Spline              | <ApiLink pkg="charts" type="CategoryChart" /> | `CategoryChart.ChartType` = `Spline` |
