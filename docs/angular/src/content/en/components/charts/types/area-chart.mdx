...
The following sections explain more advanced types of Angular Area Charts that can be created using the <ApiLink pkg="charts" type="XamDataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control with simplified API.
...
The Angular Range Area Chart allows you show the area as a range between two values over time. You can create this type of chart in <ApiLink pkg="charts" type="XamDataChart" /> control by binding your data to <ApiLink pkg="charts" type="RangeAreaSeries" />, as shown in the example below.
