...
The following sections explain more advanced types of Angular Line Charts that can be created using the <ApiLink pkg="charts" type="XamDataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control with simplified API.
