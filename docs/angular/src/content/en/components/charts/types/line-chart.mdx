...
You can create the Angular Line Chart in the <ApiLink type="CategoryChart" /> control by binding your data to <ApiLink type="CategoryChart" member="dataSource" label="DataSource" /> property and setting <ApiLink type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to <ApiLink type="PolarLineSeries" member="line" label="Line" /> enum, as shown in the example below.
