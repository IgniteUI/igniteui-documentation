...
You can create the Angular Line Chart in the <ApiLink pkg="charts" type="CategoryChart" /> control by binding your data to <ApiLink pkg="charts" type="CategoryChart" member="itemsSource" label="ItemsSource" /> property and setting <ApiLink pkg="charts" type="CategoryChart" member="chartType" label="CategoryChart.ChartType" /> property to <ApiLink pkg="charts" type="PolarLineSeries" member="line" label="Line" /> enum, as shown in the example below.
...
The following sections explain more advanced types of Angular Line Charts that can be created using the <ApiLink pkg="charts" type="DataChart" /> control instead of <ApiLink pkg="charts" type="CategoryChart" /> control with simplified API.
