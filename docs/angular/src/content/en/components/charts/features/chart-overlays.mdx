...
The following example depicts a [Column Chart](/charts/types/column-chart) with a few horizontal value overlays plotted.
...
You can also plot built-in financial overlays and indicators in Angular [Stock Chart](/charts/types/stock-chart).
...
- [Column Chart](/charts/types/area-chart)
