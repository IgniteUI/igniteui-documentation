...
```html
<igx-radio #radio value="option1">Option 1</igx-radio>
```
...
```html
<igx-radio-group (change)="onRadioChange($event)" name="options">
    <igx-radio value="A">Option A</igx-radio>
    <igx-radio value="B">Option B</igx-radio>
</igx-radio-group>
```
