...
description: Learn how to add Ignite UI MCP to an existing Angular project, verify the tools, continue working in the current codebase, and use MCP to ask documentation and API questions.
keywords: Angular, Ignite UI for Angular, Infragistics, MCP, Model Context Protocol, Ignite UI MCP, Ignite UI CLI MCP, Ignite UI Theming MCP, AI, documentation, API
---
