...
description: Learn how to create a new Angular project with Ignite UI CLI, review the generated MCP configuration, and continue with MCP tools in a supported AI client.
keywords: Angular, Ignite UI for Angular, Infragistics, Ignite UI CLI, MCP, Model Context Protocol, Ignite UI MCP, Ignite UI Theming MCP, AI
---
