...
<Sample src="/services/localization-all-resources" height={550} alt="Angular Localization Example" />
...
<Sample src="/services/localization-all-resources-old" height={550} alt="Angular Localization Example" />
