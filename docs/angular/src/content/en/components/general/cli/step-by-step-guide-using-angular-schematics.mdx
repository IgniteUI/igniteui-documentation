...
- **custom** - generates a color palette and theme configuration using the [Theming API](../../themes/sass/index.mdx) in `app/styles.scss`, ready for customization
...
<Image src={igStepByStepTemplateGroup} alt="Step by step prompt: template category selection" class="responsive-img" />
...
<Image src={igStepByStepComponentFeatures} alt="Step by step prompt: optional component feature toggles" class="responsive-img" />
...
<Image src={igStepByStepScenarioTemplates} alt="Step by step prompt: scenario template selection" class="responsive-img" />
