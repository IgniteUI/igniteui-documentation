...
We want to also to mention our samples browser Theming widget. Now, you can change themes at runtime in the [Ignite UI sample browser](/grid/grid) with just one click. Theming widget allows you to change the styles, colors, roundness, and elevation. Customization of theming has never been easier. Once you are ready with your theme, just press "DOWNLOAD SASS" and you have your SCSS file at your disposal and you can use it in your app:

<hr/>

<div>
<Image src={themingwidget1} alt="Theming widget example" class="b-lazy responsive-img" style="-webkit-box-shadow: 8px 9px 9px 5px #ccc; -moz-box-shadow: 8px 9px 9px 5px #ccc; box-shadow: 8px 9px 9px 5px #ccc;" />
</div>
...
<div>
<Image src={scrolling} alt="Scrolling performance" class="b-lazy responsive-img" style="-webkit-box-shadow: 8px 9px 9px 5px #ccc; -moz-box-shadow: 8px 9px 9px 5px #ccc; box-shadow: 8px 9px 9px 5px #ccc;" />
</div>
