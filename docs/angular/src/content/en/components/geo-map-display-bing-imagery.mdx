...
## Code Snippet
The following code snippet shows how to display geographic imagery tiles from Bing Maps in Angular `XamGeographicMap` using `BingMapsMapImagery` class.
...
<ApiRef pkg="maps" types={["BingMapsImageryStyle","BingMapsMapImagery","XamGeographicMap"]} />
