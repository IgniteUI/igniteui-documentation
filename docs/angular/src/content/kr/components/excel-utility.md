...
description: Use the Excel Utility to load and save Microsoft Excel files using Excel Library.
keywords: Excel Utility, Excel library, Ignite UI for Angular, Infragistics
license: commercial
_language: kr
