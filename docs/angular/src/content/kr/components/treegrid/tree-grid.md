---
title: 트리 그리드 컴포넌트
description: The Ignite UI for Angular Tree Grid control features the fastest, touch-responsive data-rich grid with popular features.
...
- [`IgxGridCell`]({environment:angularApiUrl}/classes/igxgridcell.html) - 셀의 행 수준을 기반으로 한 값, 인디케이터의 전개/축소, 인덴트 div 요소가 포함된 트리 셀입니다. 행 컴포넌트의 수준은 내부 [`treeRow`]({environment:angularApiUrl}/classes/igxtreegridrow.html#treerow)의 [`level`]({environment:angularApiUrl}/interfaces/itreegridrecord.html#level) 속성을 통해 접근할 수 있습니다.
