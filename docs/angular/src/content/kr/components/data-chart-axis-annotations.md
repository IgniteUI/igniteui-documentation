...
description: Create a data chart that displays multiple instances of visual elements in the same plot area in order to create composite chart views.
keywords: data chart, Ignite UI for Angular, Infragistics
