---
title: "Angular 분산 버블 시리즈의 샘플 데이터 소스"
제목: 데이터 차트 구성 요소 - 네이티브 Angular | Ignite UI for Angular
description: 컴포지트 차트 뷰를 만들기 위해 동일한 플롯 영역에 여러 개의 시각적 요소 인스턴스를 표시하는 데이터 차트를 만듭니다.
keywords: Ignite UI for Angular, Angular, Native Angular Components Suite, Native Angular Controls, Native Angular Components, Native Angular Components Library, Angular Chart, Angular Data Chart Control, Angular Data Chart Example, Angular Data Chart Component, Angular Data Chart
_language: kr
---
...
export class SampleScatterStats {
    ...
    public static getCountries(): Country[] {
        ...
        data.push(new Country("ATG",89069,13406,4388,193,"Antigua and Barbuda","America"));
        data.push(new Country("ARG",41086927,14680,7759,141,"Argentina","America"));
        data.push(new Country("ARM",2969081,3354,1584,130,"Armenia","Asia"));
        data.push(new Country("ABW",102384,0,4935,130,"Aruba","America"));
        ...
        data.push(new Country("BHS",371960,21908,1067,119,"Bahamas","America"));
        ...
        data.push(new Country("BRB",283221,14917,2456,125,"Barbados","America"));
        ...
        data.push(new Country("BLZ",324060,4852,3079,63,"Belize","America"));
        data.push(new Country("BEN",10050702,751,308,74,"Benin","Asia"));
        data.push(new Country("BMU",64798,84471,2575,136,"Bermuda","America"));
        data.push(new Country("BTN",741822,2509,1193,55,"Bhutan","Asia"));
        data.push(new Country("BOL",10496285,2576,275,71,"Bolivia","America"));
        data.push(new Country("BIH",3833916,4396,2052,81,"Bosnia","Europe"));
        data.push(new Country("BWA",2003910,7255,1208,120,"Botswana","Africa"));
        data.push(new Country("BRA",198656019,11320,1608,101,"Brazil","America"));
        ...
        data.push(new Country("CAN",34754312,52409,29625,76,"Canada","America"));
        data.push(new Country("CYM",57570,0,2078,181,"Cayman Islands","America"));
        data.push(new Country("CAF",4525209,479,270,23,"Central Republic","Africa"));
        data.push(new Country("TCD",12448175,1035,160,25,"Chad","Africa"));
        data.push(new Country("CHL",17464814,15245,5867,116,"Chile","America"));
        data.push(new Country("CHN",1350695000,6093,2221,63,"China","Asia"));
        data.push(new Country("COL",47704427,7763,1269,96,"Colombia","America"));
        ...
        data.push(new Country("CRI",4805295,9443,1874,67,"Costa Rica","America"));
        ...
        data.push(new Country("CUB",11270957,0,1780,9,"Cuba","America"));
        data.push(new Country("CUW",152056,0,0,138,"Curacao","America"));
        ...
        data.push(new Country("DMA",71684,6913,3000,148,"Dominica","America"));
        data.push(new Country("DOM",10276621,5733,1162,89,"Dominican Republic","America"));
        data.push(new Country("ECU",15492264,5425,995,99,"Ecuador","America"));
        data.push(new Country("EGY",80721874,3256,391,91,"Egypt","Africa"));
        data.push(new Country("SLV",6297394,3782,1953,124,"El Salvador","America"));
        ...
        data.push(new Country("GRD",105483,7598,3402,116,"Grenada","America"));
        data.push(new Country("GTM",15082831,3341,1216,126,"Guatemala","America"));
        data.push(new Country("GIN",11451273,493,305,37,"Guinea","Asia"));
        data.push(new Country("GNB",1663558,494,722,43,"Guinea-Bissau","Asia"));
        data.push(new Country("GUY",795369,3585,1049,71,"Guyana","America"));
        data.push(new Country("HTI",10173775,776,36,40,"Haiti","America"));
        data.push(new Country("HND",7935846,2339,465,125,"Honduras","America"));
        ...
        data.push(new Country("JAM",2707805,5464,4660,116,"Jamaica","America"));
        ...
        data.push(new Country("MEX",120847477,9818,1956,78,"Mexico","America"));
        ...
        data.push(new Country("NIC",5991733,1777,693,68,"Nicaragua","America"));
        data.push(new Country("NER",17157042,395,178,23,"Niger","Africa"));
        data.push(new Country("NGA",168833776,2722,71,55,"Nigeria","Africa"));
        data.push(new Country("NAC",348692795,51826,0,90,"America","America"));
        ...
        data.push(new Country("PAN",3802281,9982,3927,181,"Panama","America"));
        data.push(new Country("PNG",7167010,2184,238,28,"Papua New Guinea","Oceania"));
        data.push(new Country("PRY",6687361,3680,382,92,"Paraguay","America"));
        data.push(new Country("PER",29987800,6424,1126,100,"Peru","America"));
        ...
        data.push(new Country("PRI",3651545,27795,15692,79,"Puerto Rico","America"));
        ...
        data.push(new Country("KNA",53584,13658,6408,153,"St. Kitts and Nevis","America"));
        data.push(new Country("LCA",180870,7288,1586,112,"St. Lucia","America"));
        data.push(new Country("VCT",109373,6349,4477,121,"St. Vincent and the Grenadines","America"));
        data.push(new Country("SXM",30959,0,0,0,"Sint Maarten","America"));
        data.push(new Country("SDN",37195349,1695,946,42,"Sudan","Africa"));
        data.push(new Country("SUR",534541,9376,1011,99,"Suriname","America"));
        ...
        data.push(new Country("TTO",1337439,17523,3502,143,"Trinidad and Tobago","America"));
        ...
        data.push(new Country("USA",313873685,51755,52170,91,"United States","America"));
        data.push(new Country("URY",3395253,14728,3989,132,"Uruguay","America"));
        ...
        data.push(new Country("VEN",29954782,12729,1906,96,"Venezuela","America"));
