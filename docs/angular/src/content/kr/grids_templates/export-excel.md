...
_description: Learn how to use the Excel Exporter service in order to export Grid data to MS Excel file. Grid Angular table has a rich set of helpful angular events
