...
description: Set custom column order of the Ignite UI for Angular table by using the column drag feature of the Angular UI grid with the usage of mouse/touch gestures, or by using the Column Moving API.
