...
llms:
  description: "バージョン 9.0 以降、コンポーネントには Bootstrap 4 および ng-bootstrap に基づいて構築された新しいテーマが含まれます。"
---
...
`Material` から `Bootstrap` に切り替えるには、<ApiLink kind="sass" module="themes" type="mixin-theme" label="theme" /> 組み込みのミキシンを使用します。
