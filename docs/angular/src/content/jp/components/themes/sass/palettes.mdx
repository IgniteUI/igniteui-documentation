...
- <ApiLink kind="sass" module="palettes" type="function-palette" label="パレット" />
- <ApiLink kind="sass" module="palettes" type="function-color" label="パレット カラーの取得" />
- <ApiLink kind="sass" module="palettes" type="function-contrast-color" label="コントラスト カラーの取得" />
- <ApiLink kind="sass" module="utilities" type="mixin-color-classes" label="カラー クラスの生成" />
- [スキーマ](./schemas.md)
