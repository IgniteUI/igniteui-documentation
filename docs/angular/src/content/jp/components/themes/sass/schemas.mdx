...
上記の例では、コンポーネント スキーマが <ApiLink kind="sass" module="themes" type="function-avatar-theme" label="Avatar テーマ" /> で使用するプロパティを定義します。具体的なカラー パレット マップを参照せずに、アバターが使用するカラーを指定します。
...
- <ApiLink kind="sass" module="schemas" type="variable-light-material-schema" label="Light コンポーネント スキーマ" />
- <ApiLink kind="sass" module="schemas" type="variable-dark-material-schema" label="Dark コンポーネント スキーマ" />
