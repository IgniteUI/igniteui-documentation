...
llms:
  description: "バージョン 10.1 以降、インフラジスティックスのコンポーネントでは、独自のデザイン言語に基づいて構築された新しいテーマが含まれます。"
---
...
`Material` から `Indigo` に切り替えるには、<ApiLink kind="sass" module="themes" type="mixin-theme" label="theme" /> 組み込みのミキシンを使用します。
