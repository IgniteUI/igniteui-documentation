...
サンプルでは、[Fluent Light](/themes/sass/schemas#predefined-schemas) スキーマを使用します。
</DocsAside>
...
カスタム Tailwind ユーティリティ クラスを使用して `radio button` をスタイル設定できます。まず [Tailwind を設定して](/themes/misc/tailwind-classes)ください。
