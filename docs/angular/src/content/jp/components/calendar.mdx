...
- Angular Calendar 日ビュー - <ApiLink type="igx-days-view" suffix={false} />

- Angular Calendar 月ビュー - <ApiLink type="igx-months-view" suffix={false} />

<Sample src="/scheduling/calendar-days-view" height={400} alt="" />

- Angular Calendar 年ビュー - <ApiLink type="igx-years-view" suffix={false} />

<Sample src="/scheduling/calendar-months-view" height={290} alt="" />

- Angular Calendar Year View  - <ApiLink type="igx-years-view" suffix={false} />
