...
以下のサンプルは、<ApiLink pkg="charts" type="ZoomSlider" /> を使用して <ApiLink pkg="charts" type="DataChart" /> のコンテンツをナビゲートする方法を示しています。
...
<ApiLink pkg="charts" type="ZoomSlider" /> を作成するには、以下のモジュールが必要です。
