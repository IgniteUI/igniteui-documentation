...
_language: ja
llms:
  description: "Ignite UI Dock Manager コンポーネントは、ペインでアプリケーションのレイアウトを管理する方法を提供します。"
---
...
<Sample src="/layouts/dock-manager-sample" height={600} alt="Angular ドック マネージャーの例" />
...
さまざまな Ignite UI for Angular コンポーネントをホストするペインで Dock Manager コンポーネントを使用する高度な例については、このバージョンの[データ分析サンプル](./general/data-analysis.mdx#Dock-Manager-のデータ分析)を参照してください。
