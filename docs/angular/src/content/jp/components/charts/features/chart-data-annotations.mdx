...
- `StartLabelYMemberPath`: このプロパティは、y 軸上の <ApiLink pkg="charts" type="DataAnnotationBandLayer" />、<ApiLink pkg="charts" type="DataAnnotationLineLayer" />、<ApiLink pkg="charts" type="DataAnnotationRectLayer" /> の開始位置の軸ラベルを表すデータ列へのマッピングです。
- `EndLabelYMemberPath`: このプロパティは、y 軸上の <ApiLink pkg="charts" type="DataAnnotationBandLayer" />、<ApiLink pkg="charts" type="DataAnnotationLineLayer" />、<ApiLink pkg="charts" type="DataAnnotationRectLayer" /> の終了位置の軸ラベルを表すデータ列へのマッピングです。
