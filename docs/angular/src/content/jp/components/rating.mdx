...
_language: ja
llms:
  description: "Angular の評価は、星評価システムを使用して、ユーザーが Web ページ上でフィードバックを迅速に提供し、製品またはサービスを評価できるようにするウィジェットを表します。"
---
...
<Sample src="/grid/grid-with-rating" height={550} alt="Angular Rating の例" />
...
<Sample src="/data-entries/rating-form" height={550} alt="Angular Rating の例" />
