...
_language: ja
llms:
  description: "Infragistics Angular Excel Library は、Excel ワークシートにスパークラインを追加する機能があります。"
---
...
<Sample src="/excel/excel-library/working-with-sparklines" height={500} alt="Angular スパークラインを使用した作業の例" />
