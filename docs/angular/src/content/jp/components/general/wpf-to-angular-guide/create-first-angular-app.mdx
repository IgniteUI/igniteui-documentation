...
_language: ja
llms:
  description: "Angular アプリケーションの作成を開始するには、Node.js と npm パッケージ マネージャーをインストールする必要があります。"
---

import { Image } from 'astro:assets';
import wpfProjectStructure from '../../../images/general/WPF_project_structure.png';
import angularProjectStructure from '../../../images/general/Angular_project_structure.png';
import firstAngularApp from '../../../images/general/First_angular_app.png';
...
<Image src={wpfProjectStructure} alt="WPF Project Structure" class="responsive-img" />
<Image src={angularProjectStructure} alt="Angular Project Structure" class="responsive-img" />
...
<Image src={firstAngularApp} alt="First Angular App" class="responsive-img" />
