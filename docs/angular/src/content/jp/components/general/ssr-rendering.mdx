...
_language: ja
llms:
  description: "このトピックは、サーバー サイド レンダリングについて、および Ignite UI for Angular アプリケーションでそれを構成する方法を説明します。"
---
...
1. `ng new` または [Ignite UI CLI](./cli/getting-started-with-cli.mdx) `ig new` コマンドを使用します。または、`ng new --ssr` を使用して、手順 3 をスキップし、新しい Angular SSR プロジェクトを直接作成します。
...
- [Ignite UI for Angular を使用した作業の開始](getting-started.mdx)
- [Ignite UI CLI ガイド](cli/step-by-step-guide-using-cli.mdx)
- [Ignite UI for Angular Schematics](cli/step-by-step-guide-using-angular-schematics.mdx)
