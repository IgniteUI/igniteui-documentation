...
<img class="responsive-img"  src="/images/general/theming-walkthrough/getting-started-appbuilder-theming.png" alt="App Builder のテーマ設定 - 作業の開始" />
...
<img class="responsive-img" src="/images/general/theming-walkthrough/getting-started-dark-app.png" alt="ダーク アプリの作業の開始" />
...
<img class="responsive-img"  src="/images/general/theming-walkthrough/customizing-updated-toolbar.png" alt="更新されたツールバーのカスタマイズ" />
...
>[!NOTE]
> [`tokens`]({environment:sassApiUrl}/themes#mixin-tokens) を使用してすべてのテーマ変数を再度含める代わりに、`igx-grid-toolbar` テーマ オーバーライドを 2 つの変数のみをオーバーライドするように切り替えました。
...
<img class="responsive-img"  src="/images/general/theming-walkthrough/customizing-color-schema-light.png" alt="ライト カラー スキーマのカスタマイズ" />

ダーク OS テーマは次のようになります。

<img class="responsive-img"  src="/images/general/theming-walkthrough/customizing-color-schema-dark.png" alt="ダーク カラー スキーマのカスタマイズ" />
...
<img class="responsive-img"  src="/images/general/theming-walkthrough/optimizing-initial-build.png" alt="初期ビルドの最適化" />
...
<img class="responsive-img"  src="/images/general/theming-walkthrough/optimizing-after-exclude.png" alt="除外後の最適化" />
...
<img class="responsive-img"  src="/images/general/theming-walkthrough/optimizing-after-module-lazyload.png" alt="モジュールの遅延ロード後の最適化" />
