...
各クライアントの詳細なセットアップ リファレンスが必要な場合は、「[Angular Schematics & Ignite UI CLI](~/components/general/cli-overview)」および「[Ignite UI Theming MCP](~/components/ai/theming-mcp)」を参照してください。
...
- [Angular Schematics & Ignite UI CLI](~/components/general/cli-overview)
- [Ignite UI Theming MCP](~/components/ai/theming-mcp)
- [Ignite UI for Angular スキル](~/components/ai/skills)
