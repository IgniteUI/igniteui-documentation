...
_language: ja
llms:
  description: "Ignite UI CLI MCP と Ignite UI Theming MCP を組み合わせることで、AI アシスタントがチャット プロンプトを通じて Ignite UI for Angular アプリケーションのスキャフォールド、拡張、テーマ設定を行えるようになります。"
---
...
各クライアントの詳細なセットアップ リファレンスが必要な場合は、「[Angular Schematics & Ignite UI CLI](../cli-overview.mdx)」および「[Ignite UI Theming MCP](../../ai/theming-mcp.mdx)」を参照してください。
