...
<div>
<Image src={themingwidget1} alt="テーマ ウィジェットの例" class="b-lazy responsive-img" style="-webkit-box-shadow: 8px 9px 9px 5px #ccc; -moz-box-shadow: 8px 9px 9px 5px #ccc; box-shadow: 8px 9px 9px 5px #ccc;" />
</div>
