...
_language: ja
llms:
  description: "バージョン 21.0.0 以降、Ignite UI for Angular はマルチ エントリ ポイントをサポートし、コンポーネントのより優れたツリー シェイキング、コード分割、および遅延読み込みを可能にします。"
---
...
- [Ignite UI for Angular アップデート ガイド](update-guide.mdx)
...
- [Grid](../grid/grid.mdx)
- [Tree Grid](../treegrid/tree-grid.mdx)
- [Hierarchical Grid](../hierarchicalgrid/hierarchical-grid.mdx)
- [Pivot Grid](../pivotgrid/pivot-grid.mdx)