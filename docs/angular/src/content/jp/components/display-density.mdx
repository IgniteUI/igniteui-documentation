...
_language: ja
llms:
  description: "size 設定の表示は、大規模データセットのビジュアル表示を大きく改善します。"
---
...
<Sample src="/theming/density" height={250} alt="Angular サイズの例" />
...
- <ApiLink kind="sass" module="themes" type="mixin-sizable" label="テーマ - Sizable Mixin" />
- <ApiLink kind="sass" module="themes" type="function-sizable" label="テーマ - Sizable Function" />

### サイズと間隔の関数

- <ApiLink kind="sass" module="utilities" type="function-pad" label="ユーティリティ - Pad" />
- <ApiLink kind="sass" module="utilities" type="function-pad-inline" label="ユーティリティ - Pad Inline" />
- <ApiLink kind="sass" module="utilities" type="function-pad-block" label="ユーティリティ - Pad Block" />
