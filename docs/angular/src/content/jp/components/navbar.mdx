...
<DocsAside type="info" title="情報">
<ApiLink type="NavbarActionDirective" suffix={false} label="igx-navbar-action" /> または <ApiLink type="NavbarActionDirective" suffix={false} label="igxNavbarAction" /> が指定される場合、デフォルトの <ApiLink type="Navbar" member="actionbuttonicon" label="actionButtonIcon" /> は使用されません。
</DocsAside>
...
<DocsAside type="info" title="情報">
<ApiLink type="NavbarTitleDirective" suffix={false} label="igx-navbar-title" /> または <ApiLink type="NavbarTitleDirective" suffix={false} label="igxNavbarTitle" /> の場合、デフォルト <ApiLink type="Navbar" member="title" label="title" /> が使用されません。
</DocsAside>
