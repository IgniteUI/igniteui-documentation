...
<DocsAside type="info" title="情報">
[`テーマ`](themes/sass/component-themes.md) エンジンを介したスタイル設定に使用可能なすべてのパラメーターを確認するには、<ApiLink kind="sass" module="themes" type="function-expansion-panel-theme" label="API ヘルプ" code={true} />を参照してください。
</DocsAside>
