...
<Sample lob src="/pivot-grid/pivot-grid-datasource" height={870} alt="Angular ピボット セレクターを備えたピボット グリッドの例" />
...
<Sample lob src="/pivot-grid/pivot-grid-basic" height={530} alt="Angular ピボット グリッドの基本例" />
