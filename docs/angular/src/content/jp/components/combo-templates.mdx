...
_language: ja
llms:
  description: "Ignite UI for Angular ComboBox コンポーネントでは、ヘッダー、フッター、項目、空のリスト、追加ボタンなどのさまざまな領域にカスタム テンプレートを定義できます。"
---
...
<Sample src="/lists/combo-template" height={450} alt="Angular コンボボックス テンプレートの例" />
