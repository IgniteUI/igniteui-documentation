...
_language: ja
llms:
  description: "このトピックでは、Angular GeographicMap で GeographicShapeSeries にカスタム スタイリングを適用する方法を説明します。"
---
...
このトピックでは、Angular <ApiLink type="GeographicMap" /> で <ApiLink type="GeographicShapeSeries" /> にカスタム スタイリングを適用する方法を説明します。

## Angular 地理シェイプ シリーズのスタイル設定の例

<Sample src="/maps/geo-map/shape-styling" height={500} alt="Angular 地理シェイプ シリーズのスタイル設定の例" />
