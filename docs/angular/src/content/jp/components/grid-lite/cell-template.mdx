...
<ApiLink type="GridLiteCellTemplateDirective" /> をインポートする必要もあります。
...
カスタム セル レンダラーには <ApiLink type="GridLiteCellTemplateContext" /> オブジェクトがパラメータｖとして渡され、以下のプロパティを持ちます。
...
- <ApiLink type="GridLiteCellTemplateDirective" />
