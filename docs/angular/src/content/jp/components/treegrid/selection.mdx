...
Ignite UI for Angular Tree Grid コンポーネントは、[行選択](/treegrid/row-selection)、[セル選択](/treegrid/cell-selection)、[列選択](/treegrid/column-selection)の 3 つの選択モードを提供します。デフォルトでは、Tree Grid で**複数セル選択**モードのみが有効になっています。選択モードを変更/有効化するには、<ApiLink type="Grid" member="rowSelection" label="rowSelection" />、<ApiLink type="Grid" member="cellSelection" label="cellSelection" /> 、または <ApiLink type="Column" member="selectable" label="selectable" /> プロパティを使用できます。
...
> 詳細については、[行選択トピック](/treegrid/row-selection)を参照してください。
...
> 詳細については、[セル選択トピック](/treegrid/cell-selection)を参照してください。
...
> 詳細については、[列選択トピック](/treegrid/column-selection)を参照してください。
