...
description: グリッドでユーザーの入力を検証し、Angular Tree Grid の使用中に有効かどうかを通知します。デモと例をお試しください。
...
<Sample src="/tree-grid/tree-grid-cross-field-validator-service" height={620} alt="Angular Tree Grid クロス フィールド検証の例" />
...
- [Tree Grid トランザクション](/treegrid/batch-editing)
