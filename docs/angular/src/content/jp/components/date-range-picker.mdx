...
<ApiLink type="DateRangePicker" /> は <ApiLink type="Calendar" label="**IgxCalendarComponent**" /> を使用しますが、タッチ操作のために **BrowserAnimationsModule** と**オプション**の **HammerModule** に依存関係があり、これらも `AppModule` に追加する必要があります。
