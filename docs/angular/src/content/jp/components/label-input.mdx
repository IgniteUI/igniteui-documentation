...
<ApiLink type="FocusDirective" suffix={false} /> ディレクティブを使用して、input 要素に `focus` を強制するロジックを追加できます。
...
<ApiLink type="FocusDirective" suffix={false} /> ディレクティブを使用するには、<ApiLink type="FocusDirective" suffix={false} /> をインポートする必要があります。
</DocsAside>

`igxInput` でマークされた input 要素内のテキストをフォーカス際に選択したい場合、<ApiLink type="TextSelectionDirective" suffix={false} /> ディレクティブを有効にする必要があります。
...
<DocsAside type="note" title="注">
<ApiLink type="TextSelectionDirective" suffix={false} /> ディレクティブを使用するには、<ApiLink type="TextSelectionDirective" suffix={false} /> をインポートする必要があります。
</DocsAside>
