...
<ApiLink type="FocusDirective" suffix={false} /> ディレクティブを使用するには、<ApiLink type="FocusModule" suffix={false} /> をインポートする必要があります。
</DocsAside>
...
<DocsAside type="note" title="注">
<ApiLink type="TextSelectionDirective" suffix={false} /> ディレクティブを使用するには、<ApiLink type="TextSelectionModule" suffix={false} /> をインポートする必要があります。
</DocsAside>
