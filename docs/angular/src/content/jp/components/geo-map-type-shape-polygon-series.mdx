...
## コード スニペット
以下のコードは、<ApiLink pkg="geo-core" type="ShapefileRecord" /> を使用してシェイプ ファイルからロードした世界の国々の図形に <ApiLink pkg="maps" type="GeographicShapeSeries" /> をバインドする方法を示します。
...
<ApiLink pkg="geo-core" type="ShapefileRecord" /><br />
