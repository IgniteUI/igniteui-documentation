...
<div class="highlight">
  Angular Carousel コンポーネントを使用すると、アニメーション、スライド
  トランジション、およびカスタマイズを使用できるため、インターフェイスを簡単に微調整して
  Angular カスタム カルーセルを構築できます。
</div>
...
```html
<igx-carousel [navigation]="false" [indicators]="false"> ... </igx-carousel>
```

<ApiLink type="Carousel" /> は垂直モードをサポートします。これを有効にするには、
<ApiLink type="Carousel" member="vertical" label="vertical" />
プロパティを使用します。
  ...
  <igx-carousel>
      ...
      <div class="slide-content-wrapper">
        ...
        <form #form class="signInForm">
          <igx-input-group>
            ...
            <label style="display: flex;" igxLabel for="username"
              >Username</label
            >
          ...
          <igx-input-group>
            ...
            <label style="display: flex;" igxLabel for="password"
              >Password</label
            >
        ...
        <div class="btn">
          <button igxButton="contained" type="submit" (click)="form.reset()">
            Sign In
          </button>
        </div>
      </div>
    ...
    <igx-slide>
      <div class="slide-content-wrapper">
        ...
        <div class="btn">
          <button igxButton="contained" type="submit" (click)="form2.reset()">
            Search
          </button>
        </div>
      </div>
...
```html
<igx-carousel animationType="fade"> ... </igx-carousel>
```
...
<DocsAside type="info" title="情報">
  自動的なスライド
  トランジションは、デフォルトでユーザーに完全に依存しているわけではありません。スライドの上にマウス
  ポインターを置くと、マウス
  ポインターがスライド領域から出るまで、現在のスライド
  トランジションが中断されます。これは、
  <ApiLink type="Carousel" member="pause" label="pause" /> プロパティを `false`
  に設定することで防止できます。
</DocsAside>
...
<DocsAside type="info" title="情報">
  v15.1.0 以降、`onSlideChanged` の名前が `slideChanged` に変更されました。`ng
  update`
...
<label for="material" class="switch-label">
  Material
</label>
<input type="radio" name="theme" id="fluent" />
<label for="fluent" class="switch-label">
  Fluent
</label>
<input type="radio" name="theme" id="bootstrap" />
<label for="bootstrap" class="switch-label">
  Bootstrap
</label>
<input type="radio" name="theme" id="indigo" />
<label for="indigo" class="switch-label">
  Indigo
</label>
...
<Sample
  src="/layouts/carousel-styling-sample"
  height={310}
  alt="Angular Carousel スタイル設定の例"
/>
...
<DocsAside type="info" title="情報">
  ユーティリティ クラスが優先されるようにするには、感嘆符 (`!`)
  が必要です。Tailwind
  はスタイルをレイヤーに適用しますが、これらのスタイルを重要としてマークしないと、コンポーネントのデフォルトのテーマによってオーバーライドしてしまいます。
</DocsAside>
...
- <ApiLink
    kind="sass"
    module="themes"
    type="function-carousel-theme"
    label="IgxCarouselComponent スタイル"
  />
- <ApiLink type="Slide" />
- <ApiLink type="List" />
