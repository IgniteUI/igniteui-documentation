...
最もシンプルな方法として、<ApiLink kind="sass" module="themes" type="function-toast-theme" label="toast-theme" code={true} /> を拡張する新しいテーマを作成し、`$background`、`$text-color`、`$border-radius` パラメーターを指定します。
...
プロパティの完全なリストは、<ApiLink kind="sass" module="themes" type="function-toast-theme" label="IgxToast テーマ" /> で確認できます。構文は次のとおりです:
...
- <ApiLink type="Toast" />
- <ApiLink kind="sass" module="themes" type="function-toast-theme" label="IgxToastComponent スタイル" />
