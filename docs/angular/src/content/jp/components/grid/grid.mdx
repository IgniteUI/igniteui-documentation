...
<Sample src="/grid/grid" height={700} alt="Angular データ グリッドの例" />
...
フラットデータバインディングのアプローチは既に説明したものと似ていますが、**セル値**の代わりに、<ApiLink type="GridRow" /> の <ApiLink type="GridRow" suffix={false} member="data" /> プロパティを使用します。
