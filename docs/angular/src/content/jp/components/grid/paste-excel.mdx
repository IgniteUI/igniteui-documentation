...
_language: ja
llms:
  description: "Ignite UI for Angular Grid は、クリップボードにコピーした Excel データを読み込むことができます。"
---
...
Ignite UI for Angular <ApiLink type="Grid" /> は、クリップボードにコピーした Excel データを読み込むことができます。このトピックでは、カスタムコードを使用して実装する方法について説明します。
...
<Sample src="/grid/grid-paste" height={570} alt="Angular Excel からデータを貼り付けるデ例" />
