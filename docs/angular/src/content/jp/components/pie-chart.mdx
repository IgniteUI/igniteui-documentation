...
_language: ja
llms:
  description: "Ignite UI for Angular 円チャート コンポネントは、セクションに分割された円形の領域で構成される、円チャートを表示するためのコンポーネントです。"
---
...
<Sample src="/charts/pie-chart-overview" height={350} alt="Angular 円チャートの例" />
...
<Sample src="/charts/pie-chart-legend" height={350} alt="" />
...
<Sample src="/charts/pie-chart-others" height={350} alt="" />
...
<Sample src="/charts/pie-chart-explosion" height={350} alt="" />
...
<Sample src="/charts/pie-chart-selection" height={350} alt="" />
...
<Sample src="/charts/pie-chart-animation" height={350} alt="" />
