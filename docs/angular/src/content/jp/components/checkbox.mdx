...
_language: ja
llms:
  description: "Ignite UI for Angular Checkbox コンポーネントは、特定の条件のバイナリ選択を可能にする選択コントロールです。"
---
...
<ApiLink type="Checkbox" member="labelPosition" label="labelPosition" /> が設定されていない場合、ラベルはチェックボックスの後に配置されます。
