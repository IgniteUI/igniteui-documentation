...
_language: ja
llms:
  description: "Ignite UI for Angular Hierarchical Data Grid は、階層表形式データの表示と操作に使用されます。"
---
...
<Sample src="/hierarchical-grid/hierarchical-grid-styling" height={630} alt="Angular hierarchical grid styling demo" />
