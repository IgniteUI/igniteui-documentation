...
description: グリッドでユーザーの入力を検証し、Angular Hierarchical Grid の使用中に有効かどうかを通知します。デモと例をお試しください。
...
<Sample src="/hierarchical-grid/hierarchical-grid-cross-field-validation" height={620} alt="Angular Hierarchical Grid クロス フィールド検証の例" />
...
[Ignite UI for Angular テーマ ライブラリ](/themes/index)を使用して、編集時のデフォルトの検証スタイルを変更できます。
