  ...
  template: `
    <igx-tabs>
      ...
      <igx-tab-item>
        ...
        <igx-tab-content> This is Tab 2 content. </igx-tab-content>
      </igx-tab-item>
    </igx-tabs>
  `,
...
<igx-tabs>
  ...
  <igx-tab-item>
    ...
    <igx-tab-content> This is Tab 3 content. </igx-tab-content>
  </igx-tab-item>
  <igx-tab-item>
    <igx-tab-header>
      <span igxTabHeaderLabel>Tab 4</span>
    </igx-tab-header>
    <igx-tab-content> This is Tab 4 content. </igx-tab-content>
  </igx-tab-item>
  <igx-tab-item>
    <igx-tab-header>
      <span igxTabHeaderLabel>Tab 5</span>
    </igx-tab-header>
    <igx-tab-content> This is Tab 5 content. </igx-tab-content>
  </igx-tab-item>
</igx-tabs>
```
...
<DocsAside type="info" title="情報">
  ...
  を使用したことがない場合は、続行する前に必ず **app.module.ts** の
  `IgxIconModule` をインポートしてください。
</DocsAside>
...
<igx-tabs>
  <igx-tab-item>
    ...
    <igx-tab-content> Albums </igx-tab-content>
  </igx-tab-item>
  <igx-tab-item>
    <igx-tab-header>
    ...
    <igx-tab-content> Favorite </igx-tab-content>
  </igx-tab-item>
  <igx-tab-item>
    <igx-tab-header>
    ...
    <igx-tab-content> Details </igx-tab-content>
  </igx-tab-item>
</igx-tabs>
```
...
<DocsAside type="info" title="情報">
  routerLink ディレクティブは、直接 `igx-tab-item` ではなく、`igx-tab-header`
  に設定されていることに注意してください。
</DocsAside>
...
<DocsAside type="info" title="情報">
  ...
  <ApiLink
    ...
    code={true}
  />{" "}
  関数を使用してカラーに関してより高い柔軟性を実現することができます。使い方の詳細については[`パレット`](themes/sass/palettes.md)のトピックをご覧ください。
</DocsAside>
...
- <ApiLink
    kind="sass"
    module="themes"
    type="function-tabs-theme"
    label="IgxTabsComponent スタイル"
  />
