...
_language: ja
llms:
  description: "グリッド Excel フィルタリングは、{ComponentTitle} などの Angular テーブルに対して Excel のようなフィルタリング UI を提供します。"
---
...
これで、新しく作成したグリッドテーマを組み込む準備が整いました。Excel スタイル フィルタリング ダイアログに固有のスタイル変更を加えたい場合は、直接対象に指定することができます。
