...
igxGridを使用すると、[Ignite UI for Angular テーマ ライブラリ](/themes/sass/component-themes.md) でスタイルを設定できます。グリッドの<ApiLink kind="sass" module="themes" type="function-grid-theme" label="テーマ" />は、グリッドのすべての機能をカスタマイズできるさまざまなプロパティを公開します。
