...
| :----------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------- | :---------- |
| <ApiLink type="Grid" member="rowEditEnter" label="rowEditEnter" /> | If `rowEditing` is enabled, fires when a row enters edit mode | <ApiLink type="IGridEditEventArgs" kind="interface" /> | `true` |
| <ApiLink type="Grid" member="cellEditEnter" label="cellEditEnter" /> | Fires when a cell **enters edit mode** (after `rowEditEnter`) | <ApiLink type="IGridEditEventArgs" kind="interface" /> | `true` |
| <ApiLink type="Grid" member="cellEdit" label="cellEdit" /> | If value is changed, fires just **before** a cell's value is **committed** (e.g. by pressing `Enter`) | <ApiLink type="IGridEditEventArgs" kind="interface" /> | `true` |
| <ApiLink type="Grid" member="cellEditDone" label="cellEditDone" /> | If value is changed, fires **after** a cell has been edited and cell's value is **committed** | <ApiLink type="IGridEditDoneEventArgs" kind="interface" /> | `false` |
| <ApiLink type="Grid" member="cellEditExit" label="cellEditExit" /> | Fires when a cell **exits edit mode** | <ApiLink kind="interface" type="IGridEditEventArgs" /> | `false` |
| <ApiLink type="Grid" member="rowEdit" label="rowEdit" /> | If `rowEditing` is enabled, fires just before a row in edit mode's value is **committed** (e.g. by clicking the `Done` button on the Row Editing Overlay) | <ApiLink type="IGridEditEventArgs" kind="interface" /> | `true` |
| <ApiLink type="Grid" member="rowEditDone" label="rowEditDone" /> | If `rowEditing` is enabled, fires **after** a row has been edited and new row's value has been **committed**. | <ApiLink kind="interface" type="IGridEditEventArgs" /> | `false` |
| <ApiLink type="Grid" member="rowEditExit" label="rowEditExit" /> | If `rowEditing` is enabled, fires when a row **exits edit mode** | <ApiLink kind="interface" type="IGridEditEventArgs" /> | `false` |
...
and `update` method exposed by the <ApiLink type="GridCell" /> and <ApiLink type="GridRow" /> instances:
