...
license: commercial
llms:
  description: "In Ignite UI for Angular {ComponentTitle}, RowDrag is initialized on the root {ComponentSelector} component and is configurable via the rowDraggable input."
---
...
# Row Dragging in Angular {ComponentTitle}

In Ignite UI for Angular {ComponentTitle}, **RowDrag** is initialized on the root `{ComponentSelector}` component and is configurable via the <ApiLink type="{ComponentApiType}" member="rowDraggable" label="rowDraggable" /> input. Enabling row dragging provides users with a row drag-handle with which they can initiate dragging of a row.

## Angular {ComponentTitle} Row Drag Example

<ComponentBlock for="Grid">

<Sample src="/grid/grid-row-drag-base" height={550} alt="Angular {ComponentTitle} Row Drag Example" />

</ComponentBlock>

<ComponentBlock for="TreeGrid">

<Sample src="/tree-grid/tree-grid-row-drag-base" height={560} alt="Angular {ComponentTitle} Row Drag Example" />

</ComponentBlock>

<ComponentBlock for="HierarchicalGrid">

<Sample src="/hierarchical-grid/hierarchical-row-drag-base" height={560} alt="Angular {ComponentTitle} Row Drag Example" />

</ComponentBlock>

## Configuration

In order to enable row-dragging for your `{ComponentSelector}`, all you need to do is set the grid's <ApiLink type="{ComponentApiType}" member="rowDraggable" label="rowDraggable" /> to **`true`**. Once this is enabled, a row-drag handle will be displayed on each row. This handle can be used to initiate row dragging.
...
Clicking on the drag-handle and _moving the cursor_ while holding down the button will cause the grid's <ApiLink type="{ComponentApiType}" member="rowDragStart" label="rowDragStart" /> event to fire. Releasing the click at any time will cause <ApiLink type="{ComponentApiType}" member="rowDragEnd" label="rowDragEnd" /> event to fire.
...
You may enable animation when a row is dropped on a non-droppable area using the `animation` parameter of the <ApiLink type="{ComponentApiType}" member="rowDragEnd" label="rowDragEnd" /> event. If set to true, the dragged row will animate back to its' original position when dropped over a non-droppable area.
...
Once we've defined our drop-area in the template, we have to declare our handlers for the `igxDrop`'s <ApiLink type="DropDirective" member="enter" label="enter" />, <ApiLink type="DropDirective" member="leave" label="leave" /> and <ApiLink type="DropDirective" member="dropped" label="dropped" /> events in our component's `.ts` file.
...
<ComponentBlock for="TreeGrid">
Once the row is dropped, we just call the row's <ApiLink type="GridRow" label="delete()" /> method
</ComponentBlock>
<ComponentBlock for="HierarchicalGrid">
Once the row is dropped, we just call the row's <ApiLink type="{ComponentApiType}Row" label="delete()" /> method
</ComponentBlock>
...
<Sample src="/grid/grid-multiple-row-drag" height={600} alt="" />

</ComponentBlock>
<ComponentBlock for="TreeGrid">

<Sample src="/tree-grid/tree-grid-multi-row-drag" height={600} alt="" />
...
<Sample src="/hierarchical-grid/hierarchical-grid-multi-row-drag" height={600} alt="" />

</ComponentBlock>

### Templating the drag icon

The drag handle icon can be templated using the grid's <ApiLink type="{ComponentApiType}" member="dragIndicatorIconTemplate" label="dragIndicatorIconTemplate" />. In the example we're building, let's change the icon from the default one (`drag_indicator`) to `drag_handle`.
...
<Sample src="/grid/grid-row-drag-to-grid" height={550} alt="" />

</ComponentBlock>

<ComponentBlock for="TreeGrid">

<Sample src="/tree-grid/tree-grid-row-drag" height={560} alt="" />

</ComponentBlock>

<ComponentBlock for="HierarchicalGrid">

<Sample src="/hierarchical-grid/hierarchical-grid-row-drag" height={560} alt="" />
...
<Sample src="/grid/grid-row-drag" height={560} alt="" />
...
<Sample src="/grid/grid-row-reorder" height={830} alt="" />
...
<Sample src="/tree-grid/tree-grid-row-reordering" height={560} alt="" />
...
<Sample src="/hierarchical-grid/hierarchical-row-reorder" height={560} alt="" />
...
Finally, we create a method that will be used to handle the <ApiLink type="DragDirective" member="dragMove" label="IgxDragDirective.dragMove" /> event (emitted for the dragged row). The method will change the value of the property used in the `igxRowDragGhost` template and force a rerender.
...
In order to track the position of the cursor, we bind to the `dragMove` event of the <ApiLink type="DragDirective" member="dragMove" label="IgxDragDirective" /> when we start dragging a row.
...
<Sample src="/grid/grid-drop-indicator" height={830} alt="" />
</ComponentBlock>
...
## API References
- <ApiLink type="{ComponentApiType}" member="rowDraggable" label="rowDraggable" />
- <ApiLink type="{ComponentApiType}" member="rowDragStart" label="rowDragStart" />
- <ApiLink type="{ComponentApiType}" member="rowDragEnd" label="rowDragEnd" />
