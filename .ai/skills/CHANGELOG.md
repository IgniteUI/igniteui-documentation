...
| FAQ generation is component-specific and web-informed: derive question candidates from verified API/behavior and recurring public user questions, then verify answers against official source/API documentation and audit for generic or duplicated entries. | igniteui-doc-topics/references/house-style.md, references/create-workflow.md, references/audit-rubric.md |
